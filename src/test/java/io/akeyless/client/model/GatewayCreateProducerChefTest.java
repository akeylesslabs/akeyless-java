...
/**
 * Model tests for GatewayCreateProducerChef
 */
public class GatewayCreateProducerChefTest {
    private final GatewayCreateProducerChef model = new GatewayCreateProducerChef();
