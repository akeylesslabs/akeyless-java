...
/**
 * Model tests for RevokeCertificate
 */
public class RevokeCertificateTest {
    private final RevokeCertificate model = new RevokeCertificate();
