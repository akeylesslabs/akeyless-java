...
public class TargetCreateGlobalSignAtlas {
  ...
  public TargetCreateGlobalSignAtlas apiKey(@javax.annotation.Nonnull String apiKey) {
    this.apiKey = apiKey;
    return this;
  }
  ...
  public TargetCreateGlobalSignAtlas apiSecret(@javax.annotation.Nonnull String apiSecret) {
  ...
  public TargetCreateGlobalSignAtlas deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public TargetCreateGlobalSignAtlas description(@javax.annotation.Nullable String description) {
  ...
  public TargetCreateGlobalSignAtlas json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public TargetCreateGlobalSignAtlas key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public TargetCreateGlobalSignAtlas maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public TargetCreateGlobalSignAtlas mtlsCertDataBase64(@javax.annotation.Nullable String mtlsCertDataBase64) {
  ...
  public TargetCreateGlobalSignAtlas mtlsKeyDataBase64(@javax.annotation.Nullable String mtlsKeyDataBase64) {
  ...
  public TargetCreateGlobalSignAtlas name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public TargetCreateGlobalSignAtlas timeout(@javax.annotation.Nullable String timeout) {
  ...
  public TargetCreateGlobalSignAtlas token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public TargetCreateGlobalSignAtlas uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.apiKey, targetCreateGlobalSignAtlas.apiKey) &&
        ...
        Objects.equals(this.deleteProtection, targetCreateGlobalSignAtlas.deleteProtection) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(apiKey, apiSecret, deleteProtection, description, json, key, maxVersions, mtlsCertDataBase64, mtlsKeyDataBase64, name, timeout, token, uidToken);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("api-key", "api-secret", "delete_protection", "description", "json", "key", "max-versions", "mtls-cert-data-base64", "mtls-key-data-base64", "name", "timeout", "token", "uid-token"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to TargetCreateGlobalSignAtlas
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TargetCreateGlobalSignAtlas.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TargetCreateGlobalSignAtlas is not found in the empty JSON string", TargetCreateGlobalSignAtlas.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TargetCreateGlobalSignAtlas.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TargetCreateGlobalSignAtlas` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TargetCreateGlobalSignAtlas.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TargetCreateGlobalSignAtlas.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TargetCreateGlobalSignAtlas' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TargetCreateGlobalSignAtlas> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TargetCreateGlobalSignAtlas.class));

       return (TypeAdapter<T>) new TypeAdapter<TargetCreateGlobalSignAtlas>() {
           @Override
           public void write(JsonWriter out, TargetCreateGlobalSignAtlas value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TargetCreateGlobalSignAtlas read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TargetCreateGlobalSignAtlas given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TargetCreateGlobalSignAtlas
   * @throws IOException if the JSON string is invalid with respect to TargetCreateGlobalSignAtlas
   */
  public static TargetCreateGlobalSignAtlas fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TargetCreateGlobalSignAtlas.class);
  }

  /**
   * Convert an instance of TargetCreateGlobalSignAtlas to an JSON string
   *
   * @return JSON string
   */
