...
public class KerberosConfigPart {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("kerberos_access_id", "kerberos_keytab", "kerberos_krb_5_conf", "kerberos_private_key", "ldap_anonymous_search", "ldap_bind_dn", "ldap_bind_password", "ldap_cert", "ldap_group_attr", "ldap_group_dn", "ldap_group_filter", "ldap_url", "ldap_user_attr", "ldap_user_dn"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!KerberosConfigPart.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in KerberosConfigPart is not found in the empty JSON string", KerberosConfigPart.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!KerberosConfigPart.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `KerberosConfigPart` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("kerberos_access_id") != null && !jsonObj.get("kerberos_access_id").isJsonNull()) && !jsonObj.get("kerberos_access_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `kerberos_access_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("kerberos_access_id").toString()));
      }
      if ((jsonObj.get("kerberos_keytab") != null && !jsonObj.get("kerberos_keytab").isJsonNull()) && !jsonObj.get("kerberos_keytab").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `kerberos_keytab` to be a primitive type in the JSON string but got `%s`", jsonObj.get("kerberos_keytab").toString()));
      }
      if ((jsonObj.get("kerberos_krb_5_conf") != null && !jsonObj.get("kerberos_krb_5_conf").isJsonNull()) && !jsonObj.get("kerberos_krb_5_conf").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `kerberos_krb_5_conf` to be a primitive type in the JSON string but got `%s`", jsonObj.get("kerberos_krb_5_conf").toString()));
      }
      if ((jsonObj.get("kerberos_private_key") != null && !jsonObj.get("kerberos_private_key").isJsonNull()) && !jsonObj.get("kerberos_private_key").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `kerberos_private_key` to be a primitive type in the JSON string but got `%s`", jsonObj.get("kerberos_private_key").toString()));
      }
