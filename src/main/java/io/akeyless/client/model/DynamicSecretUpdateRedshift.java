...
public class DynamicSecretUpdateRedshift {
  ...
  public DynamicSecretUpdateRedshift creationStatements(@javax.annotation.Nullable String creationStatements) {
  ...
  public DynamicSecretUpdateRedshift customUsernameTemplate(@javax.annotation.Nullable String customUsernameTemplate) {
  ...
  public DynamicSecretUpdateRedshift deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public DynamicSecretUpdateRedshift description(@javax.annotation.Nullable String description) {
  ...
  public DynamicSecretUpdateRedshift putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public DynamicSecretUpdateRedshift json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public DynamicSecretUpdateRedshift name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public DynamicSecretUpdateRedshift newName(@javax.annotation.Nullable String newName) {
  ...
  public DynamicSecretUpdateRedshift passwordLength(@javax.annotation.Nullable String passwordLength) {
  ...
  public DynamicSecretUpdateRedshift producerEncryptionKey(@javax.annotation.Nullable String producerEncryptionKey) {
  ...
  public DynamicSecretUpdateRedshift redshiftDbName(@javax.annotation.Nullable String redshiftDbName) {
  ...
  public DynamicSecretUpdateRedshift redshiftHost(@javax.annotation.Nullable String redshiftHost) {
  ...
  public DynamicSecretUpdateRedshift redshiftPassword(@javax.annotation.Nullable String redshiftPassword) {
  ...
  public DynamicSecretUpdateRedshift redshiftPort(@javax.annotation.Nullable String redshiftPort) {
  ...
  public DynamicSecretUpdateRedshift redshiftUsername(@javax.annotation.Nullable String redshiftUsername) {
  ...
  public DynamicSecretUpdateRedshift secureAccessEnable(@javax.annotation.Nullable String secureAccessEnable) {
  ...
  public DynamicSecretUpdateRedshift secureAccessHost(@javax.annotation.Nullable List<String> secureAccessHost) {
  ...
  public DynamicSecretUpdateRedshift ssl(@javax.annotation.Nullable Boolean ssl) {
    this.ssl = ssl;
    return this;
  }
  ...
  public DynamicSecretUpdateRedshift tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public DynamicSecretUpdateRedshift targetName(@javax.annotation.Nullable String targetName) {
  ...
  public DynamicSecretUpdateRedshift token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public DynamicSecretUpdateRedshift uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public DynamicSecretUpdateRedshift useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public DynamicSecretUpdateRedshift useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public DynamicSecretUpdateRedshift useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public DynamicSecretUpdateRedshift useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public DynamicSecretUpdateRedshift userTtl(@javax.annotation.Nullable String userTtl) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.creationStatements, dynamicSecretUpdateRedshift.creationStatements) &&
        ...
        Objects.equals(this.useCapitalLetters, dynamicSecretUpdateRedshift.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, dynamicSecretUpdateRedshift.useLowerLetters) &&
        Objects.equals(this.useNumbers, dynamicSecretUpdateRedshift.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, dynamicSecretUpdateRedshift.useSpecialCharacters) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to DynamicSecretUpdateRedshift
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicSecretUpdateRedshift.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicSecretUpdateRedshift is not found in the empty JSON string", DynamicSecretUpdateRedshift.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicSecretUpdateRedshift.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DynamicSecretUpdateRedshift` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DynamicSecretUpdateRedshift.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DynamicSecretUpdateRedshift.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DynamicSecretUpdateRedshift' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DynamicSecretUpdateRedshift> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DynamicSecretUpdateRedshift.class));

       return (TypeAdapter<T>) new TypeAdapter<DynamicSecretUpdateRedshift>() {
           @Override
           public void write(JsonWriter out, DynamicSecretUpdateRedshift value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DynamicSecretUpdateRedshift read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DynamicSecretUpdateRedshift given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DynamicSecretUpdateRedshift
   * @throws IOException if the JSON string is invalid with respect to DynamicSecretUpdateRedshift
   */
  public static DynamicSecretUpdateRedshift fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DynamicSecretUpdateRedshift.class);
  }

  /**
   * Convert an instance of DynamicSecretUpdateRedshift to an JSON string
   *
   * @return JSON string
   */
