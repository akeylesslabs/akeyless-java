...
public class GatewayGetTmpUsers {
  ...
  public GatewayGetTmpUsers inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public GatewayGetTmpUsers addInputRuleItem(String inputRuleItem) {
  ...
  public GatewayGetTmpUsers outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public GatewayGetTmpUsers addOutputRuleItem(String outputRuleItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.inputRule, gatewayGetTmpUsers.inputRule) &&
        Objects.equals(this.json, gatewayGetTmpUsers.json) &&
        Objects.equals(this.name, gatewayGetTmpUsers.name) &&
        Objects.equals(this.outputRule, gatewayGetTmpUsers.outputRule) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GatewayGetTmpUsers.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GatewayGetTmpUsers is not found in the empty JSON string", GatewayGetTmpUsers.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GatewayGetTmpUsers.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GatewayGetTmpUsers` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
