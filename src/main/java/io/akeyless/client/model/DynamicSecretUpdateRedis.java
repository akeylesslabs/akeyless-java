...
public class DynamicSecretUpdateRedis {
  ...
  public DynamicSecretUpdateRedis inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public DynamicSecretUpdateRedis addInputRuleItem(String inputRuleItem) {
  ...
  public DynamicSecretUpdateRedis itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public DynamicSecretUpdateRedis putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public DynamicSecretUpdateRedis outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public DynamicSecretUpdateRedis addOutputRuleItem(String outputRuleItem) {
  ...
  public DynamicSecretUpdateRedis useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public DynamicSecretUpdateRedis useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public DynamicSecretUpdateRedis useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public DynamicSecretUpdateRedis useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.aclRules, dynamicSecretUpdateRedis.aclRules) &&
        ...
        Objects.equals(this.inputRule, dynamicSecretUpdateRedis.inputRule) &&
        Objects.equals(this.itemCustomFields, dynamicSecretUpdateRedis.itemCustomFields) &&
        ...
        Objects.equals(this.outputRule, dynamicSecretUpdateRedis.outputRule) &&
        ...
        Objects.equals(this.useCapitalLetters, dynamicSecretUpdateRedis.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, dynamicSecretUpdateRedis.useLowerLetters) &&
        Objects.equals(this.useNumbers, dynamicSecretUpdateRedis.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, dynamicSecretUpdateRedis.useSpecialCharacters) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(aclRules, customUsernameTemplate, deleteProtection, description, host, inputRule, itemCustomFields, json, name, newName, outputRule, password, passwordLength, port, producerEncryptionKeyName, ssl, sslCertificate, tags, targetName, token, uidToken, useCapitalLetters, useLowerLetters, useNumbers, useSpecialCharacters, userTtl, username);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("acl-rules", "custom-username-template", "delete_protection", "description", "host", "input-rule", "item-custom-fields", "json", "name", "new-name", "output-rule", "password", "password-length", "port", "producer-encryption-key-name", "ssl", "ssl-certificate", "tags", "target-name", "token", "uid-token", "use-capital-letters", "use-lower-letters", "use-numbers", "use-special-characters", "user-ttl", "username"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicSecretUpdateRedis.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicSecretUpdateRedis is not found in the empty JSON string", DynamicSecretUpdateRedis.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicSecretUpdateRedis.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DynamicSecretUpdateRedis` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("acl-rules") != null && !jsonObj.get("acl-rules").isJsonNull()) && !jsonObj.get("acl-rules").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `acl-rules` to be a primitive type in the JSON string but got `%s`", jsonObj.get("acl-rules").toString()));
      }
