...
public class GatewayCreateMigration {
  ...
  public GatewayCreateMigration hashiMetadataMode(@javax.annotation.Nullable String hashiMetadataMode) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.serviceAccountKeyDecoded, gatewayCreateMigration.serviceAccountKeyDecoded) &&
        ...
        Objects.equals(this.hashiMetadataMode, gatewayCreateMigration.hashiMetadataMode) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GatewayCreateMigration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GatewayCreateMigration is not found in the empty JSON string", GatewayCreateMigration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GatewayCreateMigration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GatewayCreateMigration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
