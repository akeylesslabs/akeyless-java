...
public class DynamicSecretCreateRedis {
  ...
  public DynamicSecretCreateRedis aclRules(@javax.annotation.Nullable String aclRules) {
  ...
  public DynamicSecretCreateRedis customUsernameTemplate(@javax.annotation.Nullable String customUsernameTemplate) {
  ...
  public DynamicSecretCreateRedis deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public DynamicSecretCreateRedis description(@javax.annotation.Nullable String description) {
  ...
  public DynamicSecretCreateRedis host(@javax.annotation.Nullable String host) {
    this.host = host;
    return this;
  }
  ...
  public DynamicSecretCreateRedis inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public DynamicSecretCreateRedis addInputRuleItem(String inputRuleItem) {
  ...
  public DynamicSecretCreateRedis itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public DynamicSecretCreateRedis putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public DynamicSecretCreateRedis json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public DynamicSecretCreateRedis name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public DynamicSecretCreateRedis outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public DynamicSecretCreateRedis addOutputRuleItem(String outputRuleItem) {
  ...
  public DynamicSecretCreateRedis password(@javax.annotation.Nullable String password) {
  ...
  public DynamicSecretCreateRedis passwordLength(@javax.annotation.Nullable String passwordLength) {
  ...
  public DynamicSecretCreateRedis port(@javax.annotation.Nullable String port) {
    this.port = port;
    return this;
  }
  ...
  public DynamicSecretCreateRedis producerEncryptionKeyName(@javax.annotation.Nullable String producerEncryptionKeyName) {
  ...
  public DynamicSecretCreateRedis ssl(@javax.annotation.Nullable Boolean ssl) {
    this.ssl = ssl;
    return this;
  }
  ...
  public DynamicSecretCreateRedis sslCertificate(@javax.annotation.Nullable String sslCertificate) {
  ...
  public DynamicSecretCreateRedis tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }

  public DynamicSecretCreateRedis addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public DynamicSecretCreateRedis targetName(@javax.annotation.Nullable String targetName) {
  ...
  public DynamicSecretCreateRedis token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public DynamicSecretCreateRedis uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public DynamicSecretCreateRedis useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public DynamicSecretCreateRedis useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public DynamicSecretCreateRedis useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public DynamicSecretCreateRedis useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public DynamicSecretCreateRedis userTtl(@javax.annotation.Nullable String userTtl) {
  ...
  public DynamicSecretCreateRedis username(@javax.annotation.Nullable String username) {
  ...
  public boolean equals(Object o) {
    ...
    DynamicSecretCreateRedis dynamicSecretCreateRedis = (DynamicSecretCreateRedis) o;
    return Objects.equals(this.aclRules, dynamicSecretCreateRedis.aclRules) &&
        Objects.equals(this.customUsernameTemplate, dynamicSecretCreateRedis.customUsernameTemplate) &&
        Objects.equals(this.deleteProtection, dynamicSecretCreateRedis.deleteProtection) &&
        Objects.equals(this.description, dynamicSecretCreateRedis.description) &&
        Objects.equals(this.host, dynamicSecretCreateRedis.host) &&
        Objects.equals(this.inputRule, dynamicSecretCreateRedis.inputRule) &&
        Objects.equals(this.itemCustomFields, dynamicSecretCreateRedis.itemCustomFields) &&
        Objects.equals(this.json, dynamicSecretCreateRedis.json) &&
        Objects.equals(this.name, dynamicSecretCreateRedis.name) &&
        Objects.equals(this.outputRule, dynamicSecretCreateRedis.outputRule) &&
        Objects.equals(this.password, dynamicSecretCreateRedis.password) &&
        Objects.equals(this.passwordLength, dynamicSecretCreateRedis.passwordLength) &&
        Objects.equals(this.port, dynamicSecretCreateRedis.port) &&
        Objects.equals(this.producerEncryptionKeyName, dynamicSecretCreateRedis.producerEncryptionKeyName) &&
        Objects.equals(this.ssl, dynamicSecretCreateRedis.ssl) &&
        Objects.equals(this.sslCertificate, dynamicSecretCreateRedis.sslCertificate) &&
        Objects.equals(this.tags, dynamicSecretCreateRedis.tags) &&
        Objects.equals(this.targetName, dynamicSecretCreateRedis.targetName) &&
        Objects.equals(this.token, dynamicSecretCreateRedis.token) &&
        Objects.equals(this.uidToken, dynamicSecretCreateRedis.uidToken) &&
        Objects.equals(this.useCapitalLetters, dynamicSecretCreateRedis.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, dynamicSecretCreateRedis.useLowerLetters) &&
        Objects.equals(this.useNumbers, dynamicSecretCreateRedis.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, dynamicSecretCreateRedis.useSpecialCharacters) &&
        Objects.equals(this.userTtl, dynamicSecretCreateRedis.userTtl) &&
        Objects.equals(this.username, dynamicSecretCreateRedis.username);
  }

  @Override
  public int hashCode() {
    return Objects.hash(aclRules, customUsernameTemplate, deleteProtection, description, host, inputRule, itemCustomFields, json, name, outputRule, password, passwordLength, port, producerEncryptionKeyName, ssl, sslCertificate, tags, targetName, token, uidToken, useCapitalLetters, useLowerLetters, useNumbers, useSpecialCharacters, userTtl, username);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DynamicSecretCreateRedis
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicSecretCreateRedis.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicSecretCreateRedis is not found in the empty JSON string", DynamicSecretCreateRedis.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicSecretCreateRedis.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DynamicSecretCreateRedis` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DynamicSecretCreateRedis.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DynamicSecretCreateRedis.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DynamicSecretCreateRedis' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DynamicSecretCreateRedis> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DynamicSecretCreateRedis.class));

       return (TypeAdapter<T>) new TypeAdapter<DynamicSecretCreateRedis>() {
           @Override
           public void write(JsonWriter out, DynamicSecretCreateRedis value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DynamicSecretCreateRedis read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DynamicSecretCreateRedis given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DynamicSecretCreateRedis
   * @throws IOException if the JSON string is invalid with respect to DynamicSecretCreateRedis
   */
  public static DynamicSecretCreateRedis fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DynamicSecretCreateRedis.class);
  }

  /**
   * Convert an instance of DynamicSecretCreateRedis to an JSON string
   *
   * @return JSON string
   */
