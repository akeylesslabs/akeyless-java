...
public class DynamicSecretCreateRedis {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(aclRules, customUsernameTemplate, deleteProtection, description, host, inputRule, itemCustomFields, json, name, outputRule, password, passwordLength, port, producerEncryptionKeyName, ssl, sslCertificate, tags, targetName, token, uidToken, userTtl, username);
  }
