...
public class DynamicSecretCreateAws {
  ...
  public DynamicSecretCreateAws inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public DynamicSecretCreateAws addInputRuleItem(String inputRuleItem) {
  ...
  public DynamicSecretCreateAws outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public DynamicSecretCreateAws addOutputRuleItem(String outputRuleItem) {
  ...
  public DynamicSecretCreateAws useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public DynamicSecretCreateAws useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public DynamicSecretCreateAws useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public DynamicSecretCreateAws useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessMode, dynamicSecretCreateAws.accessMode) &&
        ...
        Objects.equals(this.inputRule, dynamicSecretCreateAws.inputRule) &&
        ...
        Objects.equals(this.outputRule, dynamicSecretCreateAws.outputRule) &&
        ...
        Objects.equals(this.useCapitalLetters, dynamicSecretCreateAws.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, dynamicSecretCreateAws.useLowerLetters) &&
        Objects.equals(this.useNumbers, dynamicSecretCreateAws.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, dynamicSecretCreateAws.useSpecialCharacters) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicSecretCreateAws.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicSecretCreateAws is not found in the empty JSON string", DynamicSecretCreateAws.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicSecretCreateAws.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DynamicSecretCreateAws` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
