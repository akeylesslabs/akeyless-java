...
public class CertificateVersionInfo {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("not_after", "not_before", "status"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CertificateVersionInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CertificateVersionInfo is not found in the empty JSON string", CertificateVersionInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CertificateVersionInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CertificateVersionInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
