...
public class GatewayCreateProducerNativeK8S {
  ...
  public GatewayCreateProducerNativeK8S customUsernameTemplate(@javax.annotation.Nullable String customUsernameTemplate) {
  ...
  public GatewayCreateProducerNativeK8S deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public GatewayCreateProducerNativeK8S inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public GatewayCreateProducerNativeK8S addInputRuleItem(String inputRuleItem) {
  ...
  public GatewayCreateProducerNativeK8S itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public GatewayCreateProducerNativeK8S putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public GatewayCreateProducerNativeK8S json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public GatewayCreateProducerNativeK8S k8sAllowedNamespaces(@javax.annotation.Nullable String k8sAllowedNamespaces) {
  ...
  public GatewayCreateProducerNativeK8S k8sClusterCaCert(@javax.annotation.Nullable String k8sClusterCaCert) {
  ...
  public GatewayCreateProducerNativeK8S k8sClusterEndpoint(@javax.annotation.Nullable String k8sClusterEndpoint) {
  ...
  public GatewayCreateProducerNativeK8S k8sClusterName(@javax.annotation.Nullable String k8sClusterName) {
  ...
  public GatewayCreateProducerNativeK8S k8sClusterToken(@javax.annotation.Nullable String k8sClusterToken) {
  ...
  public GatewayCreateProducerNativeK8S k8sNamespace(@javax.annotation.Nullable String k8sNamespace) {
  ...
  public GatewayCreateProducerNativeK8S k8sPredefinedRoleName(@javax.annotation.Nullable String k8sPredefinedRoleName) {
  ...
  public GatewayCreateProducerNativeK8S k8sPredefinedRoleType(@javax.annotation.Nullable String k8sPredefinedRoleType) {
  ...
  public GatewayCreateProducerNativeK8S k8sRolebindingYamlDef(@javax.annotation.Nullable String k8sRolebindingYamlDef) {
  ...
  public GatewayCreateProducerNativeK8S k8sServiceAccount(@javax.annotation.Nullable String k8sServiceAccount) {
  ...
  public GatewayCreateProducerNativeK8S k8sServiceAccountType(@javax.annotation.Nullable String k8sServiceAccountType) {
  ...
  public GatewayCreateProducerNativeK8S name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public GatewayCreateProducerNativeK8S outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public GatewayCreateProducerNativeK8S addOutputRuleItem(String outputRuleItem) {
  ...
  public GatewayCreateProducerNativeK8S producerEncryptionKeyName(@javax.annotation.Nullable String producerEncryptionKeyName) {
  ...
  public GatewayCreateProducerNativeK8S secureAccessAllowPortForwading(@javax.annotation.Nullable Boolean secureAccessAllowPortForwading) {
  ...
  public GatewayCreateProducerNativeK8S secureAccessBastionIssuer(@javax.annotation.Nullable String secureAccessBastionIssuer) {
  ...
  public GatewayCreateProducerNativeK8S secureAccessCertificateIssuer(@javax.annotation.Nullable String secureAccessCertificateIssuer) {
  ...
  public GatewayCreateProducerNativeK8S secureAccessClusterEndpoint(@javax.annotation.Nullable String secureAccessClusterEndpoint) {
  ...
  public GatewayCreateProducerNativeK8S secureAccessDashboardUrl(@javax.annotation.Nullable String secureAccessDashboardUrl) {
  ...
  public GatewayCreateProducerNativeK8S secureAccessDelay(@javax.annotation.Nullable Long secureAccessDelay) {
  ...
  public GatewayCreateProducerNativeK8S secureAccessEnable(@javax.annotation.Nullable String secureAccessEnable) {
  ...
  public GatewayCreateProducerNativeK8S secureAccessWeb(@javax.annotation.Nullable Boolean secureAccessWeb) {
  ...
  public GatewayCreateProducerNativeK8S secureAccessWebBrowsing(@javax.annotation.Nullable Boolean secureAccessWebBrowsing) {
  ...
  public GatewayCreateProducerNativeK8S secureAccessWebProxy(@javax.annotation.Nullable Boolean secureAccessWebProxy) {
  ...
  public GatewayCreateProducerNativeK8S tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public GatewayCreateProducerNativeK8S targetName(@javax.annotation.Nullable String targetName) {
  ...
  public GatewayCreateProducerNativeK8S token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public GatewayCreateProducerNativeK8S uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public GatewayCreateProducerNativeK8S useGwServiceAccount(@javax.annotation.Nullable Boolean useGwServiceAccount) {
  ...
  public GatewayCreateProducerNativeK8S userTtl(@javax.annotation.Nullable String userTtl) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.customUsernameTemplate, gatewayCreateProducerNativeK8S.customUsernameTemplate) &&
        Objects.equals(this.deleteProtection, gatewayCreateProducerNativeK8S.deleteProtection) &&
        Objects.equals(this.inputRule, gatewayCreateProducerNativeK8S.inputRule) &&
        Objects.equals(this.itemCustomFields, gatewayCreateProducerNativeK8S.itemCustomFields) &&
        ...
        Objects.equals(this.outputRule, gatewayCreateProducerNativeK8S.outputRule) &&
        ...
        Objects.equals(this.secureAccessCertificateIssuer, gatewayCreateProducerNativeK8S.secureAccessCertificateIssuer) &&
        ...
        Objects.equals(this.secureAccessDelay, gatewayCreateProducerNativeK8S.secureAccessDelay) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to GatewayCreateProducerNativeK8S
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GatewayCreateProducerNativeK8S.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GatewayCreateProducerNativeK8S is not found in the empty JSON string", GatewayCreateProducerNativeK8S.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GatewayCreateProducerNativeK8S.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GatewayCreateProducerNativeK8S` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GatewayCreateProducerNativeK8S.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GatewayCreateProducerNativeK8S.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GatewayCreateProducerNativeK8S' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GatewayCreateProducerNativeK8S> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GatewayCreateProducerNativeK8S.class));

       return (TypeAdapter<T>) new TypeAdapter<GatewayCreateProducerNativeK8S>() {
           @Override
           public void write(JsonWriter out, GatewayCreateProducerNativeK8S value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GatewayCreateProducerNativeK8S read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GatewayCreateProducerNativeK8S given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GatewayCreateProducerNativeK8S
   * @throws IOException if the JSON string is invalid with respect to GatewayCreateProducerNativeK8S
   */
  public static GatewayCreateProducerNativeK8S fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GatewayCreateProducerNativeK8S.class);
  }

  /**
   * Convert an instance of GatewayCreateProducerNativeK8S to an JSON string
   *
   * @return JSON string
   */
