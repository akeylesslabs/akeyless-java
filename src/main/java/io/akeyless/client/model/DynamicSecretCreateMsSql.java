...
public class DynamicSecretCreateMsSql {
  ...
  public DynamicSecretCreateMsSql customUsernameTemplate(@javax.annotation.Nullable String customUsernameTemplate) {
  ...
  public DynamicSecretCreateMsSql itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public DynamicSecretCreateMsSql putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public DynamicSecretCreateMsSql mssqlAllowedDbNames(@javax.annotation.Nullable String mssqlAllowedDbNames) {
  ...
  public DynamicSecretCreateMsSql secureAccessDbName(@javax.annotation.Nullable String secureAccessDbName) {
  ...
  public DynamicSecretCreateMsSql useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public DynamicSecretCreateMsSql useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public DynamicSecretCreateMsSql useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public DynamicSecretCreateMsSql useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.customUsernameTemplate, dynamicSecretCreateMsSql.customUsernameTemplate) &&
        ...
        Objects.equals(this.secureAccessDbName, dynamicSecretCreateMsSql.secureAccessDbName) &&
        ...
        Objects.equals(this.useCapitalLetters, dynamicSecretCreateMsSql.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, dynamicSecretCreateMsSql.useLowerLetters) &&
        Objects.equals(this.useNumbers, dynamicSecretCreateMsSql.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, dynamicSecretCreateMsSql.useSpecialCharacters) &&
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("custom-username-template", "delete_protection", "description", "input-rule", "item-custom-fields", "json", "mssql-allowed-db-names", "mssql-create-statements", "mssql-dbname", "mssql-host", "mssql-password", "mssql-port", "mssql-revocation-statements", "mssql-username", "name", "output-rule", "password-length", "producer-encryption-key-name", "secure-access-bastion-issuer", "secure-access-certificate-issuer", "secure-access-db-name", "secure-access-db-schema", "secure-access-delay", "secure-access-enable", "secure-access-host", "secure-access-web", "tags", "target-name", "token", "uid-token", "use-capital-letters", "use-lower-letters", "use-numbers", "use-special-characters", "user-ttl"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicSecretCreateMsSql.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicSecretCreateMsSql is not found in the empty JSON string", DynamicSecretCreateMsSql.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicSecretCreateMsSql.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DynamicSecretCreateMsSql` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("mssql-allowed-db-names") != null && !jsonObj.get("mssql-allowed-db-names").isJsonNull()) && !jsonObj.get("mssql-allowed-db-names").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `mssql-allowed-db-names` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mssql-allowed-db-names").toString()));
      }
      if ((jsonObj.get("mssql-create-statements") != null && !jsonObj.get("mssql-create-statements").isJsonNull()) && !jsonObj.get("mssql-create-statements").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `mssql-create-statements` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mssql-create-statements").toString()));
      }
      if ((jsonObj.get("mssql-dbname") != null && !jsonObj.get("mssql-dbname").isJsonNull()) && !jsonObj.get("mssql-dbname").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `mssql-dbname` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mssql-dbname").toString()));
      }
      if ((jsonObj.get("mssql-host") != null && !jsonObj.get("mssql-host").isJsonNull()) && !jsonObj.get("mssql-host").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `mssql-host` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mssql-host").toString()));
      }
      if ((jsonObj.get("mssql-password") != null && !jsonObj.get("mssql-password").isJsonNull()) && !jsonObj.get("mssql-password").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `mssql-password` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mssql-password").toString()));
      }
      if ((jsonObj.get("mssql-port") != null && !jsonObj.get("mssql-port").isJsonNull()) && !jsonObj.get("mssql-port").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `mssql-port` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mssql-port").toString()));
      }
      if ((jsonObj.get("mssql-revocation-statements") != null && !jsonObj.get("mssql-revocation-statements").isJsonNull()) && !jsonObj.get("mssql-revocation-statements").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `mssql-revocation-statements` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mssql-revocation-statements").toString()));
      }
      if ((jsonObj.get("mssql-username") != null && !jsonObj.get("mssql-username").isJsonNull()) && !jsonObj.get("mssql-username").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `mssql-username` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mssql-username").toString()));
      }
