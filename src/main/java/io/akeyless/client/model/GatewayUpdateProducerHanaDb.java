...
public class GatewayUpdateProducerHanaDb {
  ...
  public GatewayUpdateProducerHanaDb customUsernameTemplate(@javax.annotation.Nullable String customUsernameTemplate) {
  ...
  public GatewayUpdateProducerHanaDb deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public GatewayUpdateProducerHanaDb hanaDbname(@javax.annotation.Nullable String hanaDbname) {
  ...
  public GatewayUpdateProducerHanaDb hanadbCreateStatements(@javax.annotation.Nullable String hanadbCreateStatements) {
  ...
  public GatewayUpdateProducerHanaDb hanadbHost(@javax.annotation.Nullable String hanadbHost) {
  ...
  public GatewayUpdateProducerHanaDb hanadbPassword(@javax.annotation.Nullable String hanadbPassword) {
  ...
  public GatewayUpdateProducerHanaDb hanadbPort(@javax.annotation.Nullable String hanadbPort) {
  ...
  public GatewayUpdateProducerHanaDb hanadbRevocationStatements(@javax.annotation.Nullable String hanadbRevocationStatements) {
  ...
  public GatewayUpdateProducerHanaDb hanadbUsername(@javax.annotation.Nullable String hanadbUsername) {
  ...
  public GatewayUpdateProducerHanaDb inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public GatewayUpdateProducerHanaDb addInputRuleItem(String inputRuleItem) {
  ...
  public GatewayUpdateProducerHanaDb itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public GatewayUpdateProducerHanaDb putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public GatewayUpdateProducerHanaDb json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public GatewayUpdateProducerHanaDb name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public GatewayUpdateProducerHanaDb newName(@javax.annotation.Nullable String newName) {
  ...
  public GatewayUpdateProducerHanaDb outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public GatewayUpdateProducerHanaDb addOutputRuleItem(String outputRuleItem) {
  ...
  public GatewayUpdateProducerHanaDb passwordLength(@javax.annotation.Nullable String passwordLength) {
  ...
  public GatewayUpdateProducerHanaDb producerEncryptionKeyName(@javax.annotation.Nullable String producerEncryptionKeyName) {
  ...
  public GatewayUpdateProducerHanaDb secureAccessBastionIssuer(@javax.annotation.Nullable String secureAccessBastionIssuer) {
  ...
  public GatewayUpdateProducerHanaDb secureAccessCertificateIssuer(@javax.annotation.Nullable String secureAccessCertificateIssuer) {
  ...
  public GatewayUpdateProducerHanaDb secureAccessDbName(@javax.annotation.Nullable String secureAccessDbName) {
  ...
  public GatewayUpdateProducerHanaDb secureAccessDbSchema(@javax.annotation.Nullable String secureAccessDbSchema) {
  ...
  public GatewayUpdateProducerHanaDb secureAccessEnable(@javax.annotation.Nullable String secureAccessEnable) {
  ...
  public GatewayUpdateProducerHanaDb secureAccessHost(@javax.annotation.Nullable List<String> secureAccessHost) {
  ...
  public GatewayUpdateProducerHanaDb secureAccessWeb(@javax.annotation.Nullable Boolean secureAccessWeb) {
  ...
  public GatewayUpdateProducerHanaDb tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public GatewayUpdateProducerHanaDb targetName(@javax.annotation.Nullable String targetName) {
  ...
  public GatewayUpdateProducerHanaDb token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public GatewayUpdateProducerHanaDb uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public GatewayUpdateProducerHanaDb useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public GatewayUpdateProducerHanaDb useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public GatewayUpdateProducerHanaDb useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public GatewayUpdateProducerHanaDb useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public GatewayUpdateProducerHanaDb userTtl(@javax.annotation.Nullable String userTtl) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.customUsernameTemplate, gatewayUpdateProducerHanaDb.customUsernameTemplate) &&
        Objects.equals(this.deleteProtection, gatewayUpdateProducerHanaDb.deleteProtection) &&
        ...
        Objects.equals(this.inputRule, gatewayUpdateProducerHanaDb.inputRule) &&
        Objects.equals(this.itemCustomFields, gatewayUpdateProducerHanaDb.itemCustomFields) &&
        ...
        Objects.equals(this.outputRule, gatewayUpdateProducerHanaDb.outputRule) &&
        Objects.equals(this.passwordLength, gatewayUpdateProducerHanaDb.passwordLength) &&
        ...
        Objects.equals(this.secureAccessCertificateIssuer, gatewayUpdateProducerHanaDb.secureAccessCertificateIssuer) &&
        Objects.equals(this.secureAccessDbName, gatewayUpdateProducerHanaDb.secureAccessDbName) &&
        ...
        Objects.equals(this.useCapitalLetters, gatewayUpdateProducerHanaDb.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, gatewayUpdateProducerHanaDb.useLowerLetters) &&
        Objects.equals(this.useNumbers, gatewayUpdateProducerHanaDb.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, gatewayUpdateProducerHanaDb.useSpecialCharacters) &&
        Objects.equals(this.userTtl, gatewayUpdateProducerHanaDb.userTtl);
  }

  @Override
  public int hashCode() {
    return Objects.hash(customUsernameTemplate, deleteProtection, hanaDbname, hanadbCreateStatements, hanadbHost, hanadbPassword, hanadbPort, hanadbRevocationStatements, hanadbUsername, inputRule, itemCustomFields, json, name, newName, outputRule, passwordLength, producerEncryptionKeyName, secureAccessBastionIssuer, secureAccessCertificateIssuer, secureAccessDbName, secureAccessDbSchema, secureAccessEnable, secureAccessHost, secureAccessWeb, tags, targetName, token, uidToken, useCapitalLetters, useLowerLetters, useNumbers, useSpecialCharacters, userTtl);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GatewayUpdateProducerHanaDb
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GatewayUpdateProducerHanaDb.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GatewayUpdateProducerHanaDb is not found in the empty JSON string", GatewayUpdateProducerHanaDb.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GatewayUpdateProducerHanaDb.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GatewayUpdateProducerHanaDb` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GatewayUpdateProducerHanaDb.openapiRequiredFields) {
      ...
      if ((jsonObj.get("hana-dbname") != null && !jsonObj.get("hana-dbname").isJsonNull()) && !jsonObj.get("hana-dbname").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `hana-dbname` to be a primitive type in the JSON string but got `%s`", jsonObj.get("hana-dbname").toString()));
      }
      if ((jsonObj.get("hanadb-create-statements") != null && !jsonObj.get("hanadb-create-statements").isJsonNull()) && !jsonObj.get("hanadb-create-statements").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `hanadb-create-statements` to be a primitive type in the JSON string but got `%s`", jsonObj.get("hanadb-create-statements").toString()));
      }
      if ((jsonObj.get("hanadb-host") != null && !jsonObj.get("hanadb-host").isJsonNull()) && !jsonObj.get("hanadb-host").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `hanadb-host` to be a primitive type in the JSON string but got `%s`", jsonObj.get("hanadb-host").toString()));
      }
      if ((jsonObj.get("hanadb-password") != null && !jsonObj.get("hanadb-password").isJsonNull()) && !jsonObj.get("hanadb-password").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `hanadb-password` to be a primitive type in the JSON string but got `%s`", jsonObj.get("hanadb-password").toString()));
      }
      if ((jsonObj.get("hanadb-port") != null && !jsonObj.get("hanadb-port").isJsonNull()) && !jsonObj.get("hanadb-port").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `hanadb-port` to be a primitive type in the JSON string but got `%s`", jsonObj.get("hanadb-port").toString()));
      }
      if ((jsonObj.get("hanadb-revocation-statements") != null && !jsonObj.get("hanadb-revocation-statements").isJsonNull()) && !jsonObj.get("hanadb-revocation-statements").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `hanadb-revocation-statements` to be a primitive type in the JSON string but got `%s`", jsonObj.get("hanadb-revocation-statements").toString()));
      }
      if ((jsonObj.get("hanadb-username") != null && !jsonObj.get("hanadb-username").isJsonNull()) && !jsonObj.get("hanadb-username").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `hanadb-username` to be a primitive type in the JSON string but got `%s`", jsonObj.get("hanadb-username").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GatewayUpdateProducerHanaDb.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GatewayUpdateProducerHanaDb' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GatewayUpdateProducerHanaDb> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GatewayUpdateProducerHanaDb.class));

       return (TypeAdapter<T>) new TypeAdapter<GatewayUpdateProducerHanaDb>() {
           @Override
           public void write(JsonWriter out, GatewayUpdateProducerHanaDb value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GatewayUpdateProducerHanaDb read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GatewayUpdateProducerHanaDb given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GatewayUpdateProducerHanaDb
   * @throws IOException if the JSON string is invalid with respect to GatewayUpdateProducerHanaDb
   */
  public static GatewayUpdateProducerHanaDb fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GatewayUpdateProducerHanaDb.class);
  }

  /**
   * Convert an instance of GatewayUpdateProducerHanaDb to an JSON string
   *
   * @return JSON string
   */
