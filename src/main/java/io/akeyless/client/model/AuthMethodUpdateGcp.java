...
public class AuthMethodUpdateGcp {
  ...
  public AuthMethodUpdateGcp() {
  }

  public AuthMethodUpdateGcp accessExpires(@javax.annotation.Nullable Long accessExpires) {
  ...
  public AuthMethodUpdateGcp allowedClientType(@javax.annotation.Nullable List<String> allowedClientType) {
    this.allowedClientType = allowedClientType;
    return this;
  }

  public AuthMethodUpdateGcp addAllowedClientTypeItem(String allowedClientTypeItem) {
  ...
  public AuthMethodUpdateGcp audience(@javax.annotation.Nonnull String audience) {
  ...
  public AuthMethodUpdateGcp auditLogsClaims(@javax.annotation.Nullable List<String> auditLogsClaims) {
    this.auditLogsClaims = auditLogsClaims;
    return this;
  }

  public AuthMethodUpdateGcp addAuditLogsClaimsItem(String auditLogsClaimsItem) {
  ...
  public AuthMethodUpdateGcp boundIps(@javax.annotation.Nullable List<String> boundIps) {
    this.boundIps = boundIps;
    return this;
  }

  public AuthMethodUpdateGcp addBoundIpsItem(String boundIpsItem) {
  ...
  public AuthMethodUpdateGcp boundLabels(@javax.annotation.Nullable List<String> boundLabels) {
    this.boundLabels = boundLabels;
    return this;
  }

  public AuthMethodUpdateGcp addBoundLabelsItem(String boundLabelsItem) {
  ...
  public AuthMethodUpdateGcp boundProjects(@javax.annotation.Nullable List<String> boundProjects) {
    this.boundProjects = boundProjects;
    return this;
  }

  public AuthMethodUpdateGcp addBoundProjectsItem(String boundProjectsItem) {
  ...
  public AuthMethodUpdateGcp boundRegions(@javax.annotation.Nullable List<String> boundRegions) {
    this.boundRegions = boundRegions;
    return this;
  }

  public AuthMethodUpdateGcp addBoundRegionsItem(String boundRegionsItem) {
  ...
  public AuthMethodUpdateGcp boundServiceAccounts(@javax.annotation.Nullable List<String> boundServiceAccounts) {
    this.boundServiceAccounts = boundServiceAccounts;
    return this;
  }

  public AuthMethodUpdateGcp addBoundServiceAccountsItem(String boundServiceAccountsItem) {
  ...
  public AuthMethodUpdateGcp boundZones(@javax.annotation.Nullable List<String> boundZones) {
    this.boundZones = boundZones;
    return this;
  }

  public AuthMethodUpdateGcp addBoundZonesItem(String boundZonesItem) {
  ...
  public AuthMethodUpdateGcp deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public AuthMethodUpdateGcp description(@javax.annotation.Nullable String description) {
  ...
  public AuthMethodUpdateGcp expirationEventIn(@javax.annotation.Nullable List<String> expirationEventIn) {
    this.expirationEventIn = expirationEventIn;
    return this;
  }

  public AuthMethodUpdateGcp addExpirationEventInItem(String expirationEventInItem) {
  ...
  public AuthMethodUpdateGcp forceSubClaims(@javax.annotation.Nullable Boolean forceSubClaims) {
  ...
  public AuthMethodUpdateGcp gwBoundIps(@javax.annotation.Nullable List<String> gwBoundIps) {
    this.gwBoundIps = gwBoundIps;
    return this;
  }

  public AuthMethodUpdateGcp addGwBoundIpsItem(String gwBoundIpsItem) {
  ...
  public AuthMethodUpdateGcp json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public AuthMethodUpdateGcp jwtTtl(@javax.annotation.Nullable Long jwtTtl) {
    this.jwtTtl = jwtTtl;
    return this;
  }
  ...
  public AuthMethodUpdateGcp name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public AuthMethodUpdateGcp newName(@javax.annotation.Nullable String newName) {
  ...
  public AuthMethodUpdateGcp productType(@javax.annotation.Nullable List<String> productType) {
    this.productType = productType;
    return this;
  }

  public AuthMethodUpdateGcp addProductTypeItem(String productTypeItem) {
  ...
  public AuthMethodUpdateGcp serviceAccountCredsData(@javax.annotation.Nullable String serviceAccountCredsData) {
  ...
  public AuthMethodUpdateGcp token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public AuthMethodUpdateGcp type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public AuthMethodUpdateGcp uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public AuthMethodUpdateGcp uniqueIdentifier(@javax.annotation.Nullable String uniqueIdentifier) {
  ...
  public boolean equals(Object o) {
    ...
    AuthMethodUpdateGcp authMethodUpdateGcp = (AuthMethodUpdateGcp) o;
    return Objects.equals(this.accessExpires, authMethodUpdateGcp.accessExpires) &&
        Objects.equals(this.allowedClientType, authMethodUpdateGcp.allowedClientType) &&
        Objects.equals(this.audience, authMethodUpdateGcp.audience) &&
        Objects.equals(this.auditLogsClaims, authMethodUpdateGcp.auditLogsClaims) &&
        Objects.equals(this.boundIps, authMethodUpdateGcp.boundIps) &&
        Objects.equals(this.boundLabels, authMethodUpdateGcp.boundLabels) &&
        Objects.equals(this.boundProjects, authMethodUpdateGcp.boundProjects) &&
        Objects.equals(this.boundRegions, authMethodUpdateGcp.boundRegions) &&
        Objects.equals(this.boundServiceAccounts, authMethodUpdateGcp.boundServiceAccounts) &&
        Objects.equals(this.boundZones, authMethodUpdateGcp.boundZones) &&
        Objects.equals(this.deleteProtection, authMethodUpdateGcp.deleteProtection) &&
        Objects.equals(this.description, authMethodUpdateGcp.description) &&
        Objects.equals(this.expirationEventIn, authMethodUpdateGcp.expirationEventIn) &&
        Objects.equals(this.forceSubClaims, authMethodUpdateGcp.forceSubClaims) &&
        Objects.equals(this.gwBoundIps, authMethodUpdateGcp.gwBoundIps) &&
        Objects.equals(this.json, authMethodUpdateGcp.json) &&
        Objects.equals(this.jwtTtl, authMethodUpdateGcp.jwtTtl) &&
        Objects.equals(this.name, authMethodUpdateGcp.name) &&
        Objects.equals(this.newName, authMethodUpdateGcp.newName) &&
        Objects.equals(this.productType, authMethodUpdateGcp.productType) &&
        Objects.equals(this.serviceAccountCredsData, authMethodUpdateGcp.serviceAccountCredsData) &&
        Objects.equals(this.token, authMethodUpdateGcp.token) &&
        Objects.equals(this.type, authMethodUpdateGcp.type) &&
        Objects.equals(this.uidToken, authMethodUpdateGcp.uidToken) &&
        Objects.equals(this.uniqueIdentifier, authMethodUpdateGcp.uniqueIdentifier);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accessExpires, allowedClientType, audience, auditLogsClaims, boundIps, boundLabels, boundProjects, boundRegions, boundServiceAccounts, boundZones, deleteProtection, description, expirationEventIn, forceSubClaims, gwBoundIps, json, jwtTtl, name, newName, productType, serviceAccountCredsData, token, type, uidToken, uniqueIdentifier);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AuthMethodUpdateGcp {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("access-expires", "allowed-client-type", "audience", "audit-logs-claims", "bound-ips", "bound-labels", "bound-projects", "bound-regions", "bound-service-accounts", "bound-zones", "delete_protection", "description", "expiration-event-in", "force-sub-claims", "gw-bound-ips", "json", "jwt-ttl", "name", "new-name", "product-type", "service-account-creds-data", "token", "type", "uid-token", "unique-identifier"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("audience", "name", "type"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AuthMethodUpdateGcp
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthMethodUpdateGcp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AuthMethodUpdateGcp is not found in the empty JSON string", AuthMethodUpdateGcp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthMethodUpdateGcp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AuthMethodUpdateGcp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AuthMethodUpdateGcp.openapiRequiredFields) {
      ...
      if (jsonObj.get("bound-labels") != null && !jsonObj.get("bound-labels").isJsonNull() && !jsonObj.get("bound-labels").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `bound-labels` to be an array in the JSON string but got `%s`", jsonObj.get("bound-labels").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("bound-projects") != null && !jsonObj.get("bound-projects").isJsonNull() && !jsonObj.get("bound-projects").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `bound-projects` to be an array in the JSON string but got `%s`", jsonObj.get("bound-projects").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("bound-regions") != null && !jsonObj.get("bound-regions").isJsonNull() && !jsonObj.get("bound-regions").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `bound-regions` to be an array in the JSON string but got `%s`", jsonObj.get("bound-regions").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("bound-service-accounts") != null && !jsonObj.get("bound-service-accounts").isJsonNull() && !jsonObj.get("bound-service-accounts").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `bound-service-accounts` to be an array in the JSON string but got `%s`", jsonObj.get("bound-service-accounts").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("bound-zones") != null && !jsonObj.get("bound-zones").isJsonNull() && !jsonObj.get("bound-zones").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `bound-zones` to be an array in the JSON string but got `%s`", jsonObj.get("bound-zones").toString()));
      }
      ...
      if ((jsonObj.get("service-account-creds-data") != null && !jsonObj.get("service-account-creds-data").isJsonNull()) && !jsonObj.get("service-account-creds-data").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `service-account-creds-data` to be a primitive type in the JSON string but got `%s`", jsonObj.get("service-account-creds-data").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuthMethodUpdateGcp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuthMethodUpdateGcp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuthMethodUpdateGcp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuthMethodUpdateGcp.class));

       return (TypeAdapter<T>) new TypeAdapter<AuthMethodUpdateGcp>() {
           @Override
           public void write(JsonWriter out, AuthMethodUpdateGcp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AuthMethodUpdateGcp read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AuthMethodUpdateGcp given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AuthMethodUpdateGcp
   * @throws IOException if the JSON string is invalid with respect to AuthMethodUpdateGcp
   */
  public static AuthMethodUpdateGcp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuthMethodUpdateGcp.class);
  }

  /**
   * Convert an instance of AuthMethodUpdateGcp to an JSON string
   *
   * @return JSON string
   */
