...
public class TargetCreateRabbitMq {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("delete_protection", "description", "json", "key", "max-versions", "name", "rabbitmq-server-password", "rabbitmq-server-uri", "rabbitmq-server-user", "token", "uid-token"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TargetCreateRabbitMq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TargetCreateRabbitMq is not found in the empty JSON string", TargetCreateRabbitMq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TargetCreateRabbitMq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TargetCreateRabbitMq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
