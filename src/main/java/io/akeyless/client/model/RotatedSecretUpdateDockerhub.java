...
public class RotatedSecretUpdateDockerhub {
  ...
  public RotatedSecretUpdateDockerhub addTag(@javax.annotation.Nullable List<String> addTag) {
    this.addTag = addTag;
    return this;
  }
  ...
  public RotatedSecretUpdateDockerhub authenticationCredentials(@javax.annotation.Nullable String authenticationCredentials) {
  ...
  public RotatedSecretUpdateDockerhub autoRotate(@javax.annotation.Nullable String autoRotate) {
  ...
  public RotatedSecretUpdateDockerhub deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public RotatedSecretUpdateDockerhub description(@javax.annotation.Nullable String description) {
  ...
  public RotatedSecretUpdateDockerhub inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public RotatedSecretUpdateDockerhub addInputRuleItem(String inputRuleItem) {
  ...
  public RotatedSecretUpdateDockerhub itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public RotatedSecretUpdateDockerhub putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public RotatedSecretUpdateDockerhub json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public RotatedSecretUpdateDockerhub keepPrevVersion(@javax.annotation.Nullable String keepPrevVersion) {
  ...
  public RotatedSecretUpdateDockerhub key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public RotatedSecretUpdateDockerhub maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public RotatedSecretUpdateDockerhub name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public RotatedSecretUpdateDockerhub newName(@javax.annotation.Nullable String newName) {
  ...
  public RotatedSecretUpdateDockerhub outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public RotatedSecretUpdateDockerhub addOutputRuleItem(String outputRuleItem) {
  ...
  public RotatedSecretUpdateDockerhub passwordLength(@javax.annotation.Nullable String passwordLength) {
  ...
  public RotatedSecretUpdateDockerhub rmTag(@javax.annotation.Nullable List<String> rmTag) {
    this.rmTag = rmTag;
    return this;
  }
  ...
  public RotatedSecretUpdateDockerhub rotationEventIn(@javax.annotation.Nullable List<String> rotationEventIn) {
    this.rotationEventIn = rotationEventIn;
    return this;
  }

  public RotatedSecretUpdateDockerhub addRotationEventInItem(String rotationEventInItem) {
  ...
  public RotatedSecretUpdateDockerhub rotationHour(@javax.annotation.Nullable Integer rotationHour) {
  ...
  public RotatedSecretUpdateDockerhub rotationInterval(@javax.annotation.Nullable String rotationInterval) {
  ...
  public RotatedSecretUpdateDockerhub token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public RotatedSecretUpdateDockerhub uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public RotatedSecretUpdateDockerhub useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public RotatedSecretUpdateDockerhub useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public RotatedSecretUpdateDockerhub useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public RotatedSecretUpdateDockerhub useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.addTag, rotatedSecretUpdateDockerhub.addTag) &&
        ...
        Objects.equals(this.inputRule, rotatedSecretUpdateDockerhub.inputRule) &&
        Objects.equals(this.itemCustomFields, rotatedSecretUpdateDockerhub.itemCustomFields) &&
        ...
        Objects.equals(this.outputRule, rotatedSecretUpdateDockerhub.outputRule) &&
        ...
        Objects.equals(this.rotationEventIn, rotatedSecretUpdateDockerhub.rotationEventIn) &&
        ...
        Objects.equals(this.useCapitalLetters, rotatedSecretUpdateDockerhub.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, rotatedSecretUpdateDockerhub.useLowerLetters) &&
        Objects.equals(this.useNumbers, rotatedSecretUpdateDockerhub.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, rotatedSecretUpdateDockerhub.useSpecialCharacters);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RotatedSecretUpdateDockerhub
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RotatedSecretUpdateDockerhub.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RotatedSecretUpdateDockerhub is not found in the empty JSON string", RotatedSecretUpdateDockerhub.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RotatedSecretUpdateDockerhub.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RotatedSecretUpdateDockerhub` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RotatedSecretUpdateDockerhub.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RotatedSecretUpdateDockerhub.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RotatedSecretUpdateDockerhub' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RotatedSecretUpdateDockerhub> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RotatedSecretUpdateDockerhub.class));

       return (TypeAdapter<T>) new TypeAdapter<RotatedSecretUpdateDockerhub>() {
           @Override
           public void write(JsonWriter out, RotatedSecretUpdateDockerhub value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RotatedSecretUpdateDockerhub read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RotatedSecretUpdateDockerhub given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RotatedSecretUpdateDockerhub
   * @throws IOException if the JSON string is invalid with respect to RotatedSecretUpdateDockerhub
   */
  public static RotatedSecretUpdateDockerhub fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RotatedSecretUpdateDockerhub.class);
  }

  /**
   * Convert an instance of RotatedSecretUpdateDockerhub to an JSON string
   *
   * @return JSON string
   */
