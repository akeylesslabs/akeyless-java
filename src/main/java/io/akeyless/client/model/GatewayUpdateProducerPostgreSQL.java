...
public class GatewayUpdateProducerPostgreSQL {
  ...
  public GatewayUpdateProducerPostgreSQL creationStatements(@javax.annotation.Nullable String creationStatements) {
  ...
  public GatewayUpdateProducerPostgreSQL customUsernameTemplate(@javax.annotation.Nullable String customUsernameTemplate) {
  ...
  public GatewayUpdateProducerPostgreSQL deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public GatewayUpdateProducerPostgreSQL inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public GatewayUpdateProducerPostgreSQL addInputRuleItem(String inputRuleItem) {
  ...
  public GatewayUpdateProducerPostgreSQL itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public GatewayUpdateProducerPostgreSQL putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public GatewayUpdateProducerPostgreSQL json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public GatewayUpdateProducerPostgreSQL name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public GatewayUpdateProducerPostgreSQL newName(@javax.annotation.Nullable String newName) {
  ...
  public GatewayUpdateProducerPostgreSQL outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public GatewayUpdateProducerPostgreSQL addOutputRuleItem(String outputRuleItem) {
  ...
  public GatewayUpdateProducerPostgreSQL passwordLength(@javax.annotation.Nullable String passwordLength) {
  ...
  public GatewayUpdateProducerPostgreSQL postgresqlDbName(@javax.annotation.Nullable String postgresqlDbName) {
  ...
  public GatewayUpdateProducerPostgreSQL postgresqlHost(@javax.annotation.Nullable String postgresqlHost) {
  ...
  public GatewayUpdateProducerPostgreSQL postgresqlPassword(@javax.annotation.Nullable String postgresqlPassword) {
  ...
  public GatewayUpdateProducerPostgreSQL postgresqlPort(@javax.annotation.Nullable String postgresqlPort) {
  ...
  public GatewayUpdateProducerPostgreSQL postgresqlUsername(@javax.annotation.Nullable String postgresqlUsername) {
  ...
  public GatewayUpdateProducerPostgreSQL producerEncryptionKey(@javax.annotation.Nullable String producerEncryptionKey) {
  ...
  public GatewayUpdateProducerPostgreSQL revocationStatement(@javax.annotation.Nullable String revocationStatement) {
  ...
  public GatewayUpdateProducerPostgreSQL secureAccessBastionIssuer(@javax.annotation.Nullable String secureAccessBastionIssuer) {
  ...
  public GatewayUpdateProducerPostgreSQL secureAccessCertificateIssuer(@javax.annotation.Nullable String secureAccessCertificateIssuer) {
  ...
  public GatewayUpdateProducerPostgreSQL secureAccessDbName(@javax.annotation.Nullable String secureAccessDbName) {
  ...
  public GatewayUpdateProducerPostgreSQL secureAccessDbSchema(@javax.annotation.Nullable String secureAccessDbSchema) {
  ...
  public GatewayUpdateProducerPostgreSQL secureAccessDelay(@javax.annotation.Nullable Long secureAccessDelay) {
  ...
  public GatewayUpdateProducerPostgreSQL secureAccessEnable(@javax.annotation.Nullable String secureAccessEnable) {
  ...
  public GatewayUpdateProducerPostgreSQL secureAccessHost(@javax.annotation.Nullable List<String> secureAccessHost) {
  ...
  public GatewayUpdateProducerPostgreSQL secureAccessWeb(@javax.annotation.Nullable Boolean secureAccessWeb) {
  ...
  public GatewayUpdateProducerPostgreSQL ssl(@javax.annotation.Nullable Boolean ssl) {
    this.ssl = ssl;
    return this;
  }
  ...
  public GatewayUpdateProducerPostgreSQL tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public GatewayUpdateProducerPostgreSQL targetName(@javax.annotation.Nullable String targetName) {
  ...
  public GatewayUpdateProducerPostgreSQL token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public GatewayUpdateProducerPostgreSQL uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public GatewayUpdateProducerPostgreSQL useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public GatewayUpdateProducerPostgreSQL useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public GatewayUpdateProducerPostgreSQL useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public GatewayUpdateProducerPostgreSQL useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public GatewayUpdateProducerPostgreSQL userTtl(@javax.annotation.Nullable String userTtl) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.creationStatements, gatewayUpdateProducerPostgreSQL.creationStatements) &&
        Objects.equals(this.customUsernameTemplate, gatewayUpdateProducerPostgreSQL.customUsernameTemplate) &&
        Objects.equals(this.deleteProtection, gatewayUpdateProducerPostgreSQL.deleteProtection) &&
        Objects.equals(this.inputRule, gatewayUpdateProducerPostgreSQL.inputRule) &&
        Objects.equals(this.itemCustomFields, gatewayUpdateProducerPostgreSQL.itemCustomFields) &&
        ...
        Objects.equals(this.outputRule, gatewayUpdateProducerPostgreSQL.outputRule) &&
        ...
        Objects.equals(this.secureAccessCertificateIssuer, gatewayUpdateProducerPostgreSQL.secureAccessCertificateIssuer) &&
        Objects.equals(this.secureAccessDbName, gatewayUpdateProducerPostgreSQL.secureAccessDbName) &&
        Objects.equals(this.secureAccessDbSchema, gatewayUpdateProducerPostgreSQL.secureAccessDbSchema) &&
        Objects.equals(this.secureAccessDelay, gatewayUpdateProducerPostgreSQL.secureAccessDelay) &&
        ...
        Objects.equals(this.useCapitalLetters, gatewayUpdateProducerPostgreSQL.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, gatewayUpdateProducerPostgreSQL.useLowerLetters) &&
        Objects.equals(this.useNumbers, gatewayUpdateProducerPostgreSQL.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, gatewayUpdateProducerPostgreSQL.useSpecialCharacters) &&
        Objects.equals(this.userTtl, gatewayUpdateProducerPostgreSQL.userTtl);
  }

  @Override
  public int hashCode() {
    return Objects.hash(creationStatements, customUsernameTemplate, deleteProtection, inputRule, itemCustomFields, json, name, newName, outputRule, passwordLength, postgresqlDbName, postgresqlHost, postgresqlPassword, postgresqlPort, postgresqlUsername, producerEncryptionKey, revocationStatement, secureAccessBastionIssuer, secureAccessCertificateIssuer, secureAccessDbName, secureAccessDbSchema, secureAccessDelay, secureAccessEnable, secureAccessHost, secureAccessWeb, ssl, tags, targetName, token, uidToken, useCapitalLetters, useLowerLetters, useNumbers, useSpecialCharacters, userTtl);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("creation-statements", "custom-username-template", "delete_protection", "input-rule", "item-custom-fields", "json", "name", "new-name", "output-rule", "password-length", "postgresql-db-name", "postgresql-host", "postgresql-password", "postgresql-port", "postgresql-username", "producer-encryption-key", "revocation-statement", "secure-access-bastion-issuer", "secure-access-certificate-issuer", "secure-access-db-name", "secure-access-db-schema", "secure-access-delay", "secure-access-enable", "secure-access-host", "secure-access-web", "ssl", "tags", "target-name", "token", "uid-token", "use-capital-letters", "use-lower-letters", "use-numbers", "use-special-characters", "user-ttl"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to GatewayUpdateProducerPostgreSQL
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GatewayUpdateProducerPostgreSQL.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GatewayUpdateProducerPostgreSQL is not found in the empty JSON string", GatewayUpdateProducerPostgreSQL.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GatewayUpdateProducerPostgreSQL.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GatewayUpdateProducerPostgreSQL` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GatewayUpdateProducerPostgreSQL.openapiRequiredFields) {
      ...
      if ((jsonObj.get("creation-statements") != null && !jsonObj.get("creation-statements").isJsonNull()) && !jsonObj.get("creation-statements").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `creation-statements` to be a primitive type in the JSON string but got `%s`", jsonObj.get("creation-statements").toString()));
      }
      ...
      if ((jsonObj.get("postgresql-db-name") != null && !jsonObj.get("postgresql-db-name").isJsonNull()) && !jsonObj.get("postgresql-db-name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `postgresql-db-name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("postgresql-db-name").toString()));
      }
      if ((jsonObj.get("postgresql-host") != null && !jsonObj.get("postgresql-host").isJsonNull()) && !jsonObj.get("postgresql-host").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `postgresql-host` to be a primitive type in the JSON string but got `%s`", jsonObj.get("postgresql-host").toString()));
      }
      if ((jsonObj.get("postgresql-password") != null && !jsonObj.get("postgresql-password").isJsonNull()) && !jsonObj.get("postgresql-password").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `postgresql-password` to be a primitive type in the JSON string but got `%s`", jsonObj.get("postgresql-password").toString()));
      }
      if ((jsonObj.get("postgresql-port") != null && !jsonObj.get("postgresql-port").isJsonNull()) && !jsonObj.get("postgresql-port").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `postgresql-port` to be a primitive type in the JSON string but got `%s`", jsonObj.get("postgresql-port").toString()));
      }
      if ((jsonObj.get("postgresql-username") != null && !jsonObj.get("postgresql-username").isJsonNull()) && !jsonObj.get("postgresql-username").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `postgresql-username` to be a primitive type in the JSON string but got `%s`", jsonObj.get("postgresql-username").toString()));
      }
      if ((jsonObj.get("producer-encryption-key") != null && !jsonObj.get("producer-encryption-key").isJsonNull()) && !jsonObj.get("producer-encryption-key").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `producer-encryption-key` to be a primitive type in the JSON string but got `%s`", jsonObj.get("producer-encryption-key").toString()));
      }
      if ((jsonObj.get("revocation-statement") != null && !jsonObj.get("revocation-statement").isJsonNull()) && !jsonObj.get("revocation-statement").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `revocation-statement` to be a primitive type in the JSON string but got `%s`", jsonObj.get("revocation-statement").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GatewayUpdateProducerPostgreSQL.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GatewayUpdateProducerPostgreSQL' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GatewayUpdateProducerPostgreSQL> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GatewayUpdateProducerPostgreSQL.class));

       return (TypeAdapter<T>) new TypeAdapter<GatewayUpdateProducerPostgreSQL>() {
           @Override
           public void write(JsonWriter out, GatewayUpdateProducerPostgreSQL value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GatewayUpdateProducerPostgreSQL read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GatewayUpdateProducerPostgreSQL given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GatewayUpdateProducerPostgreSQL
   * @throws IOException if the JSON string is invalid with respect to GatewayUpdateProducerPostgreSQL
   */
  public static GatewayUpdateProducerPostgreSQL fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GatewayUpdateProducerPostgreSQL.class);
  }

  /**
   * Convert an instance of GatewayUpdateProducerPostgreSQL to an JSON string
   *
   * @return JSON string
   */
