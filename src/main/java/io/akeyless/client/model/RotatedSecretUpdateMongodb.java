...
public class RotatedSecretUpdateMongodb {
  ...
  public RotatedSecretUpdateMongodb() {
  }

  public RotatedSecretUpdateMongodb addTag(@javax.annotation.Nullable List<String> addTag) {
    this.addTag = addTag;
    return this;
  }

  public RotatedSecretUpdateMongodb addAddTagItem(String addTagItem) {
    if (this.addTag == null) {
  ...
  public RotatedSecretUpdateMongodb authenticationCredentials(@javax.annotation.Nullable String authenticationCredentials) {
  ...
  public RotatedSecretUpdateMongodb autoRotate(@javax.annotation.Nullable String autoRotate) {
  ...
  public RotatedSecretUpdateMongodb deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public RotatedSecretUpdateMongodb description(@javax.annotation.Nullable String description) {
  ...
  public RotatedSecretUpdateMongodb inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public RotatedSecretUpdateMongodb addInputRuleItem(String inputRuleItem) {
  ...
  public RotatedSecretUpdateMongodb itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public RotatedSecretUpdateMongodb putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public RotatedSecretUpdateMongodb json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public RotatedSecretUpdateMongodb keepPrevVersion(@javax.annotation.Nullable String keepPrevVersion) {
  ...
  public RotatedSecretUpdateMongodb key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public RotatedSecretUpdateMongodb lockDuringSraSession(@javax.annotation.Nullable String lockDuringSraSession) {
  ...
  public RotatedSecretUpdateMongodb maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public RotatedSecretUpdateMongodb name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public RotatedSecretUpdateMongodb newName(@javax.annotation.Nullable String newName) {
  ...
  public RotatedSecretUpdateMongodb outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public RotatedSecretUpdateMongodb addOutputRuleItem(String outputRuleItem) {
  ...
  public RotatedSecretUpdateMongodb passwordLength(@javax.annotation.Nullable String passwordLength) {
  ...
  public RotatedSecretUpdateMongodb rmTag(@javax.annotation.Nullable List<String> rmTag) {
    this.rmTag = rmTag;
    return this;
  }

  public RotatedSecretUpdateMongodb addRmTagItem(String rmTagItem) {
    if (this.rmTag == null) {
  ...
  public RotatedSecretUpdateMongodb rotateAfterDisconnect(@javax.annotation.Nullable String rotateAfterDisconnect) {
  ...
  public RotatedSecretUpdateMongodb rotatedPassword(@javax.annotation.Nullable String rotatedPassword) {
  ...
  public RotatedSecretUpdateMongodb rotatedUsername(@javax.annotation.Nullable String rotatedUsername) {
  ...
  public RotatedSecretUpdateMongodb rotationEventIn(@javax.annotation.Nullable List<String> rotationEventIn) {
    this.rotationEventIn = rotationEventIn;
    return this;
  }

  public RotatedSecretUpdateMongodb addRotationEventInItem(String rotationEventInItem) {
  ...
  public RotatedSecretUpdateMongodb rotationHour(@javax.annotation.Nullable Integer rotationHour) {
  ...
  public RotatedSecretUpdateMongodb rotationInterval(@javax.annotation.Nullable String rotationInterval) {
  ...
  public RotatedSecretUpdateMongodb secureAccessBastionIssuer(@javax.annotation.Nullable String secureAccessBastionIssuer) {
  ...
  public RotatedSecretUpdateMongodb secureAccessCertificateIssuer(@javax.annotation.Nullable String secureAccessCertificateIssuer) {
  ...
  public RotatedSecretUpdateMongodb secureAccessDbName(@javax.annotation.Nullable String secureAccessDbName) {
  ...
  public RotatedSecretUpdateMongodb secureAccessEnable(@javax.annotation.Nullable String secureAccessEnable) {
  ...
  public RotatedSecretUpdateMongodb secureAccessHost(@javax.annotation.Nullable List<String> secureAccessHost) {
    this.secureAccessHost = secureAccessHost;
    return this;
  }

  public RotatedSecretUpdateMongodb addSecureAccessHostItem(String secureAccessHostItem) {
  ...
  public RotatedSecretUpdateMongodb secureAccessWeb(@javax.annotation.Nullable Boolean secureAccessWeb) {
  ...
  public RotatedSecretUpdateMongodb token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public RotatedSecretUpdateMongodb uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public RotatedSecretUpdateMongodb useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public RotatedSecretUpdateMongodb useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public RotatedSecretUpdateMongodb useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public RotatedSecretUpdateMongodb useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    RotatedSecretUpdateMongodb rotatedSecretUpdateMongodb = (RotatedSecretUpdateMongodb) o;
    return Objects.equals(this.addTag, rotatedSecretUpdateMongodb.addTag) &&
        Objects.equals(this.authenticationCredentials, rotatedSecretUpdateMongodb.authenticationCredentials) &&
        Objects.equals(this.autoRotate, rotatedSecretUpdateMongodb.autoRotate) &&
        Objects.equals(this.deleteProtection, rotatedSecretUpdateMongodb.deleteProtection) &&
        Objects.equals(this.description, rotatedSecretUpdateMongodb.description) &&
        Objects.equals(this.inputRule, rotatedSecretUpdateMongodb.inputRule) &&
        Objects.equals(this.itemCustomFields, rotatedSecretUpdateMongodb.itemCustomFields) &&
        Objects.equals(this.json, rotatedSecretUpdateMongodb.json) &&
        Objects.equals(this.keepPrevVersion, rotatedSecretUpdateMongodb.keepPrevVersion) &&
        Objects.equals(this.key, rotatedSecretUpdateMongodb.key) &&
        Objects.equals(this.lockDuringSraSession, rotatedSecretUpdateMongodb.lockDuringSraSession) &&
        Objects.equals(this.maxVersions, rotatedSecretUpdateMongodb.maxVersions) &&
        Objects.equals(this.name, rotatedSecretUpdateMongodb.name) &&
        Objects.equals(this.newName, rotatedSecretUpdateMongodb.newName) &&
        Objects.equals(this.outputRule, rotatedSecretUpdateMongodb.outputRule) &&
        Objects.equals(this.passwordLength, rotatedSecretUpdateMongodb.passwordLength) &&
        Objects.equals(this.rmTag, rotatedSecretUpdateMongodb.rmTag) &&
        Objects.equals(this.rotateAfterDisconnect, rotatedSecretUpdateMongodb.rotateAfterDisconnect) &&
        Objects.equals(this.rotatedPassword, rotatedSecretUpdateMongodb.rotatedPassword) &&
        Objects.equals(this.rotatedUsername, rotatedSecretUpdateMongodb.rotatedUsername) &&
        Objects.equals(this.rotationEventIn, rotatedSecretUpdateMongodb.rotationEventIn) &&
        Objects.equals(this.rotationHour, rotatedSecretUpdateMongodb.rotationHour) &&
        Objects.equals(this.rotationInterval, rotatedSecretUpdateMongodb.rotationInterval) &&
        Objects.equals(this.secureAccessBastionIssuer, rotatedSecretUpdateMongodb.secureAccessBastionIssuer) &&
        Objects.equals(this.secureAccessCertificateIssuer, rotatedSecretUpdateMongodb.secureAccessCertificateIssuer) &&
        Objects.equals(this.secureAccessDbName, rotatedSecretUpdateMongodb.secureAccessDbName) &&
        Objects.equals(this.secureAccessEnable, rotatedSecretUpdateMongodb.secureAccessEnable) &&
        Objects.equals(this.secureAccessHost, rotatedSecretUpdateMongodb.secureAccessHost) &&
        Objects.equals(this.secureAccessWeb, rotatedSecretUpdateMongodb.secureAccessWeb) &&
        Objects.equals(this.token, rotatedSecretUpdateMongodb.token) &&
        Objects.equals(this.uidToken, rotatedSecretUpdateMongodb.uidToken) &&
        Objects.equals(this.useCapitalLetters, rotatedSecretUpdateMongodb.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, rotatedSecretUpdateMongodb.useLowerLetters) &&
        Objects.equals(this.useNumbers, rotatedSecretUpdateMongodb.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, rotatedSecretUpdateMongodb.useSpecialCharacters);
  }

  @Override
  public int hashCode() {
    return Objects.hash(addTag, authenticationCredentials, autoRotate, deleteProtection, description, inputRule, itemCustomFields, json, keepPrevVersion, key, lockDuringSraSession, maxVersions, name, newName, outputRule, passwordLength, rmTag, rotateAfterDisconnect, rotatedPassword, rotatedUsername, rotationEventIn, rotationHour, rotationInterval, secureAccessBastionIssuer, secureAccessCertificateIssuer, secureAccessDbName, secureAccessEnable, secureAccessHost, secureAccessWeb, token, uidToken, useCapitalLetters, useLowerLetters, useNumbers, useSpecialCharacters);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RotatedSecretUpdateMongodb {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("add-tag", "authentication-credentials", "auto-rotate", "delete_protection", "description", "input-rule", "item-custom-fields", "json", "keep-prev-version", "key", "lock-during-sra-session", "max-versions", "name", "new-name", "output-rule", "password-length", "rm-tag", "rotate-after-disconnect", "rotated-password", "rotated-username", "rotation-event-in", "rotation-hour", "rotation-interval", "secure-access-bastion-issuer", "secure-access-certificate-issuer", "secure-access-db-name", "secure-access-enable", "secure-access-host", "secure-access-web", "token", "uid-token", "use-capital-letters", "use-lower-letters", "use-numbers", "use-special-characters"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to RotatedSecretUpdateMongodb
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RotatedSecretUpdateMongodb.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RotatedSecretUpdateMongodb is not found in the empty JSON string", RotatedSecretUpdateMongodb.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RotatedSecretUpdateMongodb.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RotatedSecretUpdateMongodb` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RotatedSecretUpdateMongodb.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RotatedSecretUpdateMongodb.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RotatedSecretUpdateMongodb' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RotatedSecretUpdateMongodb> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RotatedSecretUpdateMongodb.class));

       return (TypeAdapter<T>) new TypeAdapter<RotatedSecretUpdateMongodb>() {
           @Override
           public void write(JsonWriter out, RotatedSecretUpdateMongodb value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RotatedSecretUpdateMongodb read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RotatedSecretUpdateMongodb given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RotatedSecretUpdateMongodb
   * @throws IOException if the JSON string is invalid with respect to RotatedSecretUpdateMongodb
   */
  public static RotatedSecretUpdateMongodb fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RotatedSecretUpdateMongodb.class);
  }

  /**
   * Convert an instance of RotatedSecretUpdateMongodb to an JSON string
   *
   * @return JSON string
   */
