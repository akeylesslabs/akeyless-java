...
public class DynamicSecretUpdateArtifactory {
  ...
  public DynamicSecretUpdateArtifactory artifactoryAdminName(@javax.annotation.Nullable String artifactoryAdminName) {
  ...
  public DynamicSecretUpdateArtifactory artifactoryAdminPwd(@javax.annotation.Nullable String artifactoryAdminPwd) {
  ...
  public DynamicSecretUpdateArtifactory artifactoryTokenAudience(@javax.annotation.Nonnull String artifactoryTokenAudience) {
  ...
  public DynamicSecretUpdateArtifactory artifactoryTokenScope(@javax.annotation.Nonnull String artifactoryTokenScope) {
  ...
  public DynamicSecretUpdateArtifactory baseUrl(@javax.annotation.Nullable String baseUrl) {
  ...
  public DynamicSecretUpdateArtifactory customUsernameTemplate(@javax.annotation.Nullable String customUsernameTemplate) {
  ...
  public DynamicSecretUpdateArtifactory deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public DynamicSecretUpdateArtifactory description(@javax.annotation.Nullable String description) {
  ...
  public DynamicSecretUpdateArtifactory inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public DynamicSecretUpdateArtifactory addInputRuleItem(String inputRuleItem) {
  ...
  public DynamicSecretUpdateArtifactory itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public DynamicSecretUpdateArtifactory putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public DynamicSecretUpdateArtifactory json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public DynamicSecretUpdateArtifactory name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public DynamicSecretUpdateArtifactory newName(@javax.annotation.Nullable String newName) {
  ...
  public DynamicSecretUpdateArtifactory outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public DynamicSecretUpdateArtifactory addOutputRuleItem(String outputRuleItem) {
  ...
  public DynamicSecretUpdateArtifactory producerEncryptionKeyName(@javax.annotation.Nullable String producerEncryptionKeyName) {
  ...
  public DynamicSecretUpdateArtifactory tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public DynamicSecretUpdateArtifactory targetName(@javax.annotation.Nullable String targetName) {
  ...
  public DynamicSecretUpdateArtifactory token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public DynamicSecretUpdateArtifactory uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public DynamicSecretUpdateArtifactory userTtl(@javax.annotation.Nullable String userTtl) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.artifactoryAdminName, dynamicSecretUpdateArtifactory.artifactoryAdminName) &&
        ...
        Objects.equals(this.customUsernameTemplate, dynamicSecretUpdateArtifactory.customUsernameTemplate) &&
        ...
        Objects.equals(this.inputRule, dynamicSecretUpdateArtifactory.inputRule) &&
        Objects.equals(this.itemCustomFields, dynamicSecretUpdateArtifactory.itemCustomFields) &&
        ...
        Objects.equals(this.outputRule, dynamicSecretUpdateArtifactory.outputRule) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(artifactoryAdminName, artifactoryAdminPwd, artifactoryTokenAudience, artifactoryTokenScope, baseUrl, customUsernameTemplate, deleteProtection, description, inputRule, itemCustomFields, json, name, newName, outputRule, producerEncryptionKeyName, tags, targetName, token, uidToken, userTtl);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DynamicSecretUpdateArtifactory
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicSecretUpdateArtifactory.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicSecretUpdateArtifactory is not found in the empty JSON string", DynamicSecretUpdateArtifactory.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicSecretUpdateArtifactory.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DynamicSecretUpdateArtifactory` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DynamicSecretUpdateArtifactory.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DynamicSecretUpdateArtifactory.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DynamicSecretUpdateArtifactory' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DynamicSecretUpdateArtifactory> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DynamicSecretUpdateArtifactory.class));

       return (TypeAdapter<T>) new TypeAdapter<DynamicSecretUpdateArtifactory>() {
           @Override
           public void write(JsonWriter out, DynamicSecretUpdateArtifactory value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DynamicSecretUpdateArtifactory read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DynamicSecretUpdateArtifactory given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DynamicSecretUpdateArtifactory
   * @throws IOException if the JSON string is invalid with respect to DynamicSecretUpdateArtifactory
   */
  public static DynamicSecretUpdateArtifactory fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DynamicSecretUpdateArtifactory.class);
  }

  /**
   * Convert an instance of DynamicSecretUpdateArtifactory to an JSON string
   *
   * @return JSON string
   */
