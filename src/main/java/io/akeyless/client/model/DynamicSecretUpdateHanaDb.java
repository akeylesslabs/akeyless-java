...
public class DynamicSecretUpdateHanaDb {
  ...
  public DynamicSecretUpdateHanaDb useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public DynamicSecretUpdateHanaDb useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public DynamicSecretUpdateHanaDb useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public DynamicSecretUpdateHanaDb useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.customUsernameTemplate, dynamicSecretUpdateHanaDb.customUsernameTemplate) &&
        ...
        Objects.equals(this.useCapitalLetters, dynamicSecretUpdateHanaDb.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, dynamicSecretUpdateHanaDb.useLowerLetters) &&
        Objects.equals(this.useNumbers, dynamicSecretUpdateHanaDb.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, dynamicSecretUpdateHanaDb.useSpecialCharacters) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicSecretUpdateHanaDb.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicSecretUpdateHanaDb is not found in the empty JSON string", DynamicSecretUpdateHanaDb.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicSecretUpdateHanaDb.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DynamicSecretUpdateHanaDb` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
