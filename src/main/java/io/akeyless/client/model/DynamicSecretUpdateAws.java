...
public class DynamicSecretUpdateAws {
  ...
  public DynamicSecretUpdateAws inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public DynamicSecretUpdateAws addInputRuleItem(String inputRuleItem) {
  ...
  public DynamicSecretUpdateAws itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public DynamicSecretUpdateAws putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public DynamicSecretUpdateAws outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public DynamicSecretUpdateAws addOutputRuleItem(String outputRuleItem) {
  ...
  public DynamicSecretUpdateAws useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public DynamicSecretUpdateAws useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public DynamicSecretUpdateAws useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public DynamicSecretUpdateAws useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessMode, dynamicSecretUpdateAws.accessMode) &&
        ...
        Objects.equals(this.inputRule, dynamicSecretUpdateAws.inputRule) &&
        Objects.equals(this.itemCustomFields, dynamicSecretUpdateAws.itemCustomFields) &&
        ...
        Objects.equals(this.outputRule, dynamicSecretUpdateAws.outputRule) &&
        ...
        Objects.equals(this.useCapitalLetters, dynamicSecretUpdateAws.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, dynamicSecretUpdateAws.useLowerLetters) &&
        Objects.equals(this.useNumbers, dynamicSecretUpdateAws.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, dynamicSecretUpdateAws.useSpecialCharacters) &&
        Objects.equals(this.userTtl, dynamicSecretUpdateAws.userTtl);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accessMode, adminRotationIntervalDays, awsAccessKeyId, awsAccessSecretKey, awsExternalId, awsRoleArns, awsUserConsoleAccess, awsUserGroups, awsUserPolicies, awsUserProgrammaticAccess, customUsernameTemplate, deleteProtection, description, enableAdminRotation, inputRule, itemCustomFields, json, name, newName, outputRule, passwordLength, producerEncryptionKeyName, region, secureAccessAwsAccountId, secureAccessAwsNativeCli, secureAccessBastionIssuer, secureAccessCertificateIssuer, secureAccessDelay, secureAccessEnable, secureAccessWeb, secureAccessWebBrowsing, secureAccessWebProxy, sessionTags, tags, targetName, token, transitiveTagKeys, uidToken, useCapitalLetters, useLowerLetters, useNumbers, useSpecialCharacters, userTtl);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("access-mode", "admin-rotation-interval-days", "aws-access-key-id", "aws-access-secret-key", "aws-external-id", "aws-role-arns", "aws-user-console-access", "aws-user-groups", "aws-user-policies", "aws-user-programmatic-access", "custom-username-template", "delete_protection", "description", "enable-admin-rotation", "input-rule", "item-custom-fields", "json", "name", "new-name", "output-rule", "password-length", "producer-encryption-key-name", "region", "secure-access-aws-account-id", "secure-access-aws-native-cli", "secure-access-bastion-issuer", "secure-access-certificate-issuer", "secure-access-delay", "secure-access-enable", "secure-access-web", "secure-access-web-browsing", "secure-access-web-proxy", "session-tags", "tags", "target-name", "token", "transitive-tag-keys", "uid-token", "use-capital-letters", "use-lower-letters", "use-numbers", "use-special-characters", "user-ttl"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicSecretUpdateAws.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicSecretUpdateAws is not found in the empty JSON string", DynamicSecretUpdateAws.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicSecretUpdateAws.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DynamicSecretUpdateAws` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("access-mode") != null && !jsonObj.get("access-mode").isJsonNull()) && !jsonObj.get("access-mode").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `access-mode` to be a primitive type in the JSON string but got `%s`", jsonObj.get("access-mode").toString()));
      }
      if ((jsonObj.get("aws-access-key-id") != null && !jsonObj.get("aws-access-key-id").isJsonNull()) && !jsonObj.get("aws-access-key-id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `aws-access-key-id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("aws-access-key-id").toString()));
      }
      if ((jsonObj.get("aws-access-secret-key") != null && !jsonObj.get("aws-access-secret-key").isJsonNull()) && !jsonObj.get("aws-access-secret-key").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `aws-access-secret-key` to be a primitive type in the JSON string but got `%s`", jsonObj.get("aws-access-secret-key").toString()));
      }
      if ((jsonObj.get("aws-external-id") != null && !jsonObj.get("aws-external-id").isJsonNull()) && !jsonObj.get("aws-external-id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `aws-external-id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("aws-external-id").toString()));
      }
      if ((jsonObj.get("aws-role-arns") != null && !jsonObj.get("aws-role-arns").isJsonNull()) && !jsonObj.get("aws-role-arns").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `aws-role-arns` to be a primitive type in the JSON string but got `%s`", jsonObj.get("aws-role-arns").toString()));
      }
      if ((jsonObj.get("aws-user-groups") != null && !jsonObj.get("aws-user-groups").isJsonNull()) && !jsonObj.get("aws-user-groups").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `aws-user-groups` to be a primitive type in the JSON string but got `%s`", jsonObj.get("aws-user-groups").toString()));
      }
      if ((jsonObj.get("aws-user-policies") != null && !jsonObj.get("aws-user-policies").isJsonNull()) && !jsonObj.get("aws-user-policies").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `aws-user-policies` to be a primitive type in the JSON string but got `%s`", jsonObj.get("aws-user-policies").toString()));
      }
      ...
      if ((jsonObj.get("session-tags") != null && !jsonObj.get("session-tags").isJsonNull()) && !jsonObj.get("session-tags").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `session-tags` to be a primitive type in the JSON string but got `%s`", jsonObj.get("session-tags").toString()));
      }
      // ensure the optional json data is an array if present
      ...
      if ((jsonObj.get("transitive-tag-keys") != null && !jsonObj.get("transitive-tag-keys").isJsonNull()) && !jsonObj.get("transitive-tag-keys").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `transitive-tag-keys` to be a primitive type in the JSON string but got `%s`", jsonObj.get("transitive-tag-keys").toString()));
      }
