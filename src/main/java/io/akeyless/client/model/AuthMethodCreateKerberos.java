...
public class AuthMethodCreateKerberos {
  ...
  public AuthMethodCreateKerberos accessExpires(@javax.annotation.Nullable Long accessExpires) {
  ...
  public AuthMethodCreateKerberos auditLogsClaims(@javax.annotation.Nullable List<String> auditLogsClaims) {
  ...
  public AuthMethodCreateKerberos bindDn(@javax.annotation.Nullable String bindDn) {
    this.bindDn = bindDn;
    return this;
  }
  ...
  public AuthMethodCreateKerberos bindDnPassword(@javax.annotation.Nullable String bindDnPassword) {
  ...
  public AuthMethodCreateKerberos boundIps(@javax.annotation.Nullable List<String> boundIps) {
  ...
  public AuthMethodCreateKerberos deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public AuthMethodCreateKerberos description(@javax.annotation.Nullable String description) {
  ...
  public AuthMethodCreateKerberos expirationEventIn(@javax.annotation.Nullable List<String> expirationEventIn) {
    this.expirationEventIn = expirationEventIn;
    return this;
  }

  public AuthMethodCreateKerberos addExpirationEventInItem(String expirationEventInItem) {
  ...
  public AuthMethodCreateKerberos forceSubClaims(@javax.annotation.Nullable Boolean forceSubClaims) {
  ...
  public AuthMethodCreateKerberos groupAttr(@javax.annotation.Nullable String groupAttr) {
  ...
  public AuthMethodCreateKerberos groupDn(@javax.annotation.Nullable String groupDn) {
  ...
  public AuthMethodCreateKerberos groupFilter(@javax.annotation.Nullable String groupFilter) {
  ...
  public AuthMethodCreateKerberos gwBoundIps(@javax.annotation.Nullable List<String> gwBoundIps) {
  ...
  public AuthMethodCreateKerberos json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public AuthMethodCreateKerberos jwtTtl(@javax.annotation.Nullable Long jwtTtl) {
    this.jwtTtl = jwtTtl;
    return this;
  }
  ...
  public AuthMethodCreateKerberos keytabFileData(@javax.annotation.Nullable String keytabFileData) {
  ...
  public AuthMethodCreateKerberos keytabFilePath(@javax.annotation.Nullable String keytabFilePath) {
  ...
  public AuthMethodCreateKerberos krb5ConfData(@javax.annotation.Nullable String krb5ConfData) {
  ...
  public AuthMethodCreateKerberos krb5ConfPath(@javax.annotation.Nullable String krb5ConfPath) {
  ...
  public AuthMethodCreateKerberos ldapAnonymousSearch(@javax.annotation.Nullable Boolean ldapAnonymousSearch) {
  ...
  public AuthMethodCreateKerberos ldapCaCert(@javax.annotation.Nullable String ldapCaCert) {
  ...
  public AuthMethodCreateKerberos ldapUrl(@javax.annotation.Nullable String ldapUrl) {
  ...
  public AuthMethodCreateKerberos name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public AuthMethodCreateKerberos productType(@javax.annotation.Nullable List<String> productType) {
  ...
  public AuthMethodCreateKerberos subclaimsDelimiters(@javax.annotation.Nullable List<String> subclaimsDelimiters) {
  ...
  public AuthMethodCreateKerberos token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public AuthMethodCreateKerberos uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public AuthMethodCreateKerberos uniqueIdentifier(@javax.annotation.Nullable String uniqueIdentifier) {
  ...
  public AuthMethodCreateKerberos userAttribute(@javax.annotation.Nullable String userAttribute) {
  ...
  public AuthMethodCreateKerberos userDn(@javax.annotation.Nullable String userDn) {
    this.userDn = userDn;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessExpires, authMethodCreateKerberos.accessExpires) &&
        ...
        Objects.equals(this.expirationEventIn, authMethodCreateKerberos.expirationEventIn) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to AuthMethodCreateKerberos
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthMethodCreateKerberos.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AuthMethodCreateKerberos is not found in the empty JSON string", AuthMethodCreateKerberos.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthMethodCreateKerberos.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AuthMethodCreateKerberos` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AuthMethodCreateKerberos.openapiRequiredFields) {
      ...
      if ((jsonObj.get("group-attr") != null && !jsonObj.get("group-attr").isJsonNull()) && !jsonObj.get("group-attr").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `group-attr` to be a primitive type in the JSON string but got `%s`", jsonObj.get("group-attr").toString()));
      }
      ...
      if ((jsonObj.get("group-filter") != null && !jsonObj.get("group-filter").isJsonNull()) && !jsonObj.get("group-filter").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `group-filter` to be a primitive type in the JSON string but got `%s`", jsonObj.get("group-filter").toString()));
      }
      // ensure the optional json data is an array if present
      ...
      if ((jsonObj.get("keytab-file-data") != null && !jsonObj.get("keytab-file-data").isJsonNull()) && !jsonObj.get("keytab-file-data").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `keytab-file-data` to be a primitive type in the JSON string but got `%s`", jsonObj.get("keytab-file-data").toString()));
      }
      if ((jsonObj.get("keytab-file-path") != null && !jsonObj.get("keytab-file-path").isJsonNull()) && !jsonObj.get("keytab-file-path").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `keytab-file-path` to be a primitive type in the JSON string but got `%s`", jsonObj.get("keytab-file-path").toString()));
      }
      if ((jsonObj.get("krb5-conf-data") != null && !jsonObj.get("krb5-conf-data").isJsonNull()) && !jsonObj.get("krb5-conf-data").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `krb5-conf-data` to be a primitive type in the JSON string but got `%s`", jsonObj.get("krb5-conf-data").toString()));
      }
      if ((jsonObj.get("krb5-conf-path") != null && !jsonObj.get("krb5-conf-path").isJsonNull()) && !jsonObj.get("krb5-conf-path").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `krb5-conf-path` to be a primitive type in the JSON string but got `%s`", jsonObj.get("krb5-conf-path").toString()));
      }
      ...
      if (jsonObj.get("subclaims-delimiters") != null && !jsonObj.get("subclaims-delimiters").isJsonNull() && !jsonObj.get("subclaims-delimiters").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `subclaims-delimiters` to be an array in the JSON string but got `%s`", jsonObj.get("subclaims-delimiters").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuthMethodCreateKerberos.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuthMethodCreateKerberos' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuthMethodCreateKerberos> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuthMethodCreateKerberos.class));

       return (TypeAdapter<T>) new TypeAdapter<AuthMethodCreateKerberos>() {
           @Override
           public void write(JsonWriter out, AuthMethodCreateKerberos value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AuthMethodCreateKerberos read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AuthMethodCreateKerberos given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AuthMethodCreateKerberos
   * @throws IOException if the JSON string is invalid with respect to AuthMethodCreateKerberos
   */
  public static AuthMethodCreateKerberos fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuthMethodCreateKerberos.class);
  }

  /**
   * Convert an instance of AuthMethodCreateKerberos to an JSON string
   *
   * @return JSON string
   */
