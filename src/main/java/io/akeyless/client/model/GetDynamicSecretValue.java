...
public class GetDynamicSecretValue {
  ...
  public GetDynamicSecretValue dbname(@javax.annotation.Nullable String dbname) {
    this.dbname = dbname;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.args, getDynamicSecretValue.args) &&
        Objects.equals(this.dbname, getDynamicSecretValue.dbname) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetDynamicSecretValue.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetDynamicSecretValue is not found in the empty JSON string", GetDynamicSecretValue.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetDynamicSecretValue.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetDynamicSecretValue` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
