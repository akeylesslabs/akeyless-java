...
public class GatewayCreateProducerAzure {
  ...
  public GatewayCreateProducerAzure appObjId(@javax.annotation.Nullable String appObjId) {
  ...
  public GatewayCreateProducerAzure azureAdministrativeUnit(@javax.annotation.Nullable String azureAdministrativeUnit) {
  ...
  public GatewayCreateProducerAzure azureClientId(@javax.annotation.Nullable String azureClientId) {
  ...
  public GatewayCreateProducerAzure azureClientSecret(@javax.annotation.Nullable String azureClientSecret) {
  ...
  public GatewayCreateProducerAzure azureTenantId(@javax.annotation.Nullable String azureTenantId) {
  ...
  public GatewayCreateProducerAzure customUsernameTemplate(@javax.annotation.Nullable String customUsernameTemplate) {
  ...
  public GatewayCreateProducerAzure deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public GatewayCreateProducerAzure fixedUserClaimKeyname(@javax.annotation.Nullable String fixedUserClaimKeyname) {
  ...
  public GatewayCreateProducerAzure fixedUserOnly(@javax.annotation.Nullable Boolean fixedUserOnly) {
  ...
  public GatewayCreateProducerAzure inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public GatewayCreateProducerAzure addInputRuleItem(String inputRuleItem) {
  ...
  public GatewayCreateProducerAzure itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public GatewayCreateProducerAzure putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public GatewayCreateProducerAzure json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public GatewayCreateProducerAzure name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public GatewayCreateProducerAzure outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public GatewayCreateProducerAzure addOutputRuleItem(String outputRuleItem) {
  ...
  public GatewayCreateProducerAzure passwordLength(@javax.annotation.Nullable String passwordLength) {
  ...
  public GatewayCreateProducerAzure producerEncryptionKeyName(@javax.annotation.Nullable String producerEncryptionKeyName) {
  ...
  public GatewayCreateProducerAzure secureAccessEnable(@javax.annotation.Nullable String secureAccessEnable) {
  ...
  public GatewayCreateProducerAzure secureAccessUrl(@javax.annotation.Nullable String secureAccessUrl) {
  ...
  public GatewayCreateProducerAzure secureAccessWeb(@javax.annotation.Nullable Boolean secureAccessWeb) {
  ...
  public GatewayCreateProducerAzure secureAccessWebBrowsing(@javax.annotation.Nullable Boolean secureAccessWebBrowsing) {
  ...
  public GatewayCreateProducerAzure secureAccessWebProxy(@javax.annotation.Nullable Boolean secureAccessWebProxy) {
  ...
  public GatewayCreateProducerAzure tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }

  public GatewayCreateProducerAzure addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public GatewayCreateProducerAzure targetName(@javax.annotation.Nullable String targetName) {
  ...
  public GatewayCreateProducerAzure token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public GatewayCreateProducerAzure uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public GatewayCreateProducerAzure useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public GatewayCreateProducerAzure useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public GatewayCreateProducerAzure useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public GatewayCreateProducerAzure useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public GatewayCreateProducerAzure userGroupObjId(@javax.annotation.Nullable String userGroupObjId) {
  ...
  public GatewayCreateProducerAzure userPortalAccess(@javax.annotation.Nullable Boolean userPortalAccess) {
  ...
  public GatewayCreateProducerAzure userPrincipalName(@javax.annotation.Nullable String userPrincipalName) {
  ...
  public GatewayCreateProducerAzure userProgrammaticAccess(@javax.annotation.Nullable Boolean userProgrammaticAccess) {
  ...
  public GatewayCreateProducerAzure userRoleTemplateId(@javax.annotation.Nullable String userRoleTemplateId) {
  ...
  public GatewayCreateProducerAzure userTtl(@javax.annotation.Nullable String userTtl) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.appObjId, gatewayCreateProducerAzure.appObjId) &&
        Objects.equals(this.azureAdministrativeUnit, gatewayCreateProducerAzure.azureAdministrativeUnit) &&
        ...
        Objects.equals(this.customUsernameTemplate, gatewayCreateProducerAzure.customUsernameTemplate) &&
        ...
        Objects.equals(this.inputRule, gatewayCreateProducerAzure.inputRule) &&
        Objects.equals(this.itemCustomFields, gatewayCreateProducerAzure.itemCustomFields) &&
        Objects.equals(this.json, gatewayCreateProducerAzure.json) &&
        Objects.equals(this.name, gatewayCreateProducerAzure.name) &&
        Objects.equals(this.outputRule, gatewayCreateProducerAzure.outputRule) &&
        Objects.equals(this.passwordLength, gatewayCreateProducerAzure.passwordLength) &&
        ...
        Objects.equals(this.secureAccessUrl, gatewayCreateProducerAzure.secureAccessUrl) &&
        ...
        Objects.equals(this.useCapitalLetters, gatewayCreateProducerAzure.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, gatewayCreateProducerAzure.useLowerLetters) &&
        Objects.equals(this.useNumbers, gatewayCreateProducerAzure.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, gatewayCreateProducerAzure.useSpecialCharacters) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to GatewayCreateProducerAzure
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GatewayCreateProducerAzure.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GatewayCreateProducerAzure is not found in the empty JSON string", GatewayCreateProducerAzure.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GatewayCreateProducerAzure.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GatewayCreateProducerAzure` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GatewayCreateProducerAzure.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GatewayCreateProducerAzure.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GatewayCreateProducerAzure' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GatewayCreateProducerAzure> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GatewayCreateProducerAzure.class));

       return (TypeAdapter<T>) new TypeAdapter<GatewayCreateProducerAzure>() {
           @Override
           public void write(JsonWriter out, GatewayCreateProducerAzure value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GatewayCreateProducerAzure read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GatewayCreateProducerAzure given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GatewayCreateProducerAzure
   * @throws IOException if the JSON string is invalid with respect to GatewayCreateProducerAzure
   */
  public static GatewayCreateProducerAzure fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GatewayCreateProducerAzure.class);
  }

  /**
   * Convert an instance of GatewayCreateProducerAzure to an JSON string
   *
   * @return JSON string
   */
