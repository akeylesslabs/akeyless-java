...
public class KMIPClientListResponse {
  ...
  private List<KMIPClient> clients = null;

  public KMIPClientListResponse() { 
  }

  public KMIPClientListResponse clients(List<KMIPClient> clients) {
  ...
  public KMIPClientListResponse addClientsItem(KMIPClient clientsItem) {
    if (this.clients == null) {
      this.clients = new ArrayList<KMIPClient>();
    }
  ...
  **/
  ...
  public void setClients(List<KMIPClient> clients) {
    this.clients = clients;
  }
