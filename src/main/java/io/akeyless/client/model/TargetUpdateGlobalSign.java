...
public class TargetUpdateGlobalSign {
  ...
  public TargetUpdateGlobalSign contactEmail(@javax.annotation.Nonnull String contactEmail) {
  ...
  public TargetUpdateGlobalSign contactFirstName(@javax.annotation.Nonnull String contactFirstName) {
  ...
  public TargetUpdateGlobalSign contactLastName(@javax.annotation.Nonnull String contactLastName) {
  ...
  public TargetUpdateGlobalSign contactPhone(@javax.annotation.Nonnull String contactPhone) {
  ...
  public TargetUpdateGlobalSign deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public TargetUpdateGlobalSign description(@javax.annotation.Nullable String description) {
  ...
  public TargetUpdateGlobalSign json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public TargetUpdateGlobalSign keepPrevVersion(@javax.annotation.Nullable String keepPrevVersion) {
  ...
  public TargetUpdateGlobalSign key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public TargetUpdateGlobalSign maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public TargetUpdateGlobalSign name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public TargetUpdateGlobalSign newName(@javax.annotation.Nullable String newName) {
  ...
  public TargetUpdateGlobalSign password(@javax.annotation.Nonnull String password) {
  ...
  public TargetUpdateGlobalSign profileId(@javax.annotation.Nonnull String profileId) {
  ...
  public TargetUpdateGlobalSign timeout(@javax.annotation.Nullable String timeout) {
  ...
  public TargetUpdateGlobalSign token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public TargetUpdateGlobalSign uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public TargetUpdateGlobalSign username(@javax.annotation.Nonnull String username) {
  ...
  public boolean equals(Object o) {
    ...
    TargetUpdateGlobalSign targetUpdateGlobalSign = (TargetUpdateGlobalSign) o;
    return Objects.equals(this.contactEmail, targetUpdateGlobalSign.contactEmail) &&
        Objects.equals(this.contactFirstName, targetUpdateGlobalSign.contactFirstName) &&
        Objects.equals(this.contactLastName, targetUpdateGlobalSign.contactLastName) &&
        Objects.equals(this.contactPhone, targetUpdateGlobalSign.contactPhone) &&
        Objects.equals(this.deleteProtection, targetUpdateGlobalSign.deleteProtection) &&
        Objects.equals(this.description, targetUpdateGlobalSign.description) &&
        Objects.equals(this.json, targetUpdateGlobalSign.json) &&
        Objects.equals(this.keepPrevVersion, targetUpdateGlobalSign.keepPrevVersion) &&
        Objects.equals(this.key, targetUpdateGlobalSign.key) &&
        Objects.equals(this.maxVersions, targetUpdateGlobalSign.maxVersions) &&
        Objects.equals(this.name, targetUpdateGlobalSign.name) &&
        Objects.equals(this.newName, targetUpdateGlobalSign.newName) &&
        Objects.equals(this.password, targetUpdateGlobalSign.password) &&
        Objects.equals(this.profileId, targetUpdateGlobalSign.profileId) &&
        Objects.equals(this.timeout, targetUpdateGlobalSign.timeout) &&
        Objects.equals(this.token, targetUpdateGlobalSign.token) &&
        Objects.equals(this.uidToken, targetUpdateGlobalSign.uidToken) &&
        Objects.equals(this.username, targetUpdateGlobalSign.username);
  }

  @Override
  public int hashCode() {
    return Objects.hash(contactEmail, contactFirstName, contactLastName, contactPhone, deleteProtection, description, json, keepPrevVersion, key, maxVersions, name, newName, password, profileId, timeout, token, uidToken, username);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TargetUpdateGlobalSign {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("contact-email", "contact-first-name", "contact-last-name", "contact-phone", "delete_protection", "description", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "password", "profile-id", "timeout", "token", "uid-token", "username"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to TargetUpdateGlobalSign
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TargetUpdateGlobalSign.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TargetUpdateGlobalSign is not found in the empty JSON string", TargetUpdateGlobalSign.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TargetUpdateGlobalSign.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TargetUpdateGlobalSign` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TargetUpdateGlobalSign.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TargetUpdateGlobalSign.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TargetUpdateGlobalSign' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TargetUpdateGlobalSign> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TargetUpdateGlobalSign.class));

       return (TypeAdapter<T>) new TypeAdapter<TargetUpdateGlobalSign>() {
           @Override
           public void write(JsonWriter out, TargetUpdateGlobalSign value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TargetUpdateGlobalSign read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TargetUpdateGlobalSign given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TargetUpdateGlobalSign
   * @throws IOException if the JSON string is invalid with respect to TargetUpdateGlobalSign
   */
  public static TargetUpdateGlobalSign fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TargetUpdateGlobalSign.class);
  }

  /**
   * Convert an instance of TargetUpdateGlobalSign to an JSON string
   *
   * @return JSON string
   */
