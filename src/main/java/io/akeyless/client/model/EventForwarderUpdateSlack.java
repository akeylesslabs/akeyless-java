...
public class EventForwarderUpdateSlack {
  ...
  public EventForwarderUpdateSlack authMethodsEventSourceLocations(@javax.annotation.Nullable List<String> authMethodsEventSourceLocations) {
  ...
  public EventForwarderUpdateSlack description(@javax.annotation.Nullable String description) {
  ...
  public EventForwarderUpdateSlack enable(@javax.annotation.Nullable String enable) {
    this.enable = enable;
    return this;
  }
  ...
  public EventForwarderUpdateSlack eventTypes(@javax.annotation.Nullable List<String> eventTypes) {
  ...
  public EventForwarderUpdateSlack gatewaysEventSourceLocations(@javax.annotation.Nonnull List<String> gatewaysEventSourceLocations) {
  ...
  public EventForwarderUpdateSlack itemsEventSourceLocations(@javax.annotation.Nullable List<String> itemsEventSourceLocations) {
  ...
  public EventForwarderUpdateSlack json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public EventForwarderUpdateSlack keepPrevVersion(@javax.annotation.Nullable String keepPrevVersion) {
  ...
  public EventForwarderUpdateSlack key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public EventForwarderUpdateSlack name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public EventForwarderUpdateSlack newName(@javax.annotation.Nullable String newName) {
  ...
  public EventForwarderUpdateSlack targetsEventSourceLocations(@javax.annotation.Nullable List<String> targetsEventSourceLocations) {
  ...
  public EventForwarderUpdateSlack token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public EventForwarderUpdateSlack uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public EventForwarderUpdateSlack url(@javax.annotation.Nonnull String url) {
    this.url = url;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("auth-methods-event-source-locations", "description", "enable", "event-types", "gateways-event-source-locations", "items-event-source-locations", "json", "keep-prev-version", "key", "name", "new-name", "targets-event-source-locations", "token", "uid-token", "url"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("gateways-event-source-locations", "name", "url"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EventForwarderUpdateSlack
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventForwarderUpdateSlack.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EventForwarderUpdateSlack is not found in the empty JSON string", EventForwarderUpdateSlack.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EventForwarderUpdateSlack.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EventForwarderUpdateSlack` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EventForwarderUpdateSlack.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventForwarderUpdateSlack.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventForwarderUpdateSlack' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventForwarderUpdateSlack> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventForwarderUpdateSlack.class));

       return (TypeAdapter<T>) new TypeAdapter<EventForwarderUpdateSlack>() {
           @Override
           public void write(JsonWriter out, EventForwarderUpdateSlack value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EventForwarderUpdateSlack read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EventForwarderUpdateSlack given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EventForwarderUpdateSlack
   * @throws IOException if the JSON string is invalid with respect to EventForwarderUpdateSlack
   */
  public static EventForwarderUpdateSlack fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EventForwarderUpdateSlack.class);
  }

  /**
   * Convert an instance of EventForwarderUpdateSlack to an JSON string
   *
   * @return JSON string
   */
