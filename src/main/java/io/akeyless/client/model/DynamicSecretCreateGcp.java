...
public class DynamicSecretCreateGcp {
  ...
  public DynamicSecretCreateGcp inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public DynamicSecretCreateGcp addInputRuleItem(String inputRuleItem) {
  ...
  public DynamicSecretCreateGcp outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public DynamicSecretCreateGcp addOutputRuleItem(String outputRuleItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessType, dynamicSecretCreateGcp.accessType) &&
        ...
        Objects.equals(this.inputRule, dynamicSecretCreateGcp.inputRule) &&
        ...
        Objects.equals(this.outputRule, dynamicSecretCreateGcp.outputRule) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicSecretCreateGcp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicSecretCreateGcp is not found in the empty JSON string", DynamicSecretCreateGcp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicSecretCreateGcp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DynamicSecretCreateGcp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
