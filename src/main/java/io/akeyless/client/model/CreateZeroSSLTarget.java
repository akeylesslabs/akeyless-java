...
public class CreateZeroSSLTarget {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("api-key", "comment", "description", "imap-fqdn", "imap-password", "imap-port", "imap-target-email", "imap-username", "json", "key", "max-versions", "name", "timeout", "token", "uid-token"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateZeroSSLTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateZeroSSLTarget is not found in the empty JSON string", CreateZeroSSLTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateZeroSSLTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateZeroSSLTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
