...
public class AuthMethodUpdateOIDC {
  ...
  public AuthMethodUpdateOIDC accessExpires(@javax.annotation.Nullable Long accessExpires) {
  ...
  public AuthMethodUpdateOIDC allowedClientType(@javax.annotation.Nullable List<String> allowedClientType) {
    this.allowedClientType = allowedClientType;
    return this;
  }

  public AuthMethodUpdateOIDC addAllowedClientTypeItem(String allowedClientTypeItem) {
  ...
  public AuthMethodUpdateOIDC allowedRedirectUri(@javax.annotation.Nullable List<String> allowedRedirectUri) {
    this.allowedRedirectUri = allowedRedirectUri;
    return this;
  }

  public AuthMethodUpdateOIDC addAllowedRedirectUriItem(String allowedRedirectUriItem) {
  ...
  public AuthMethodUpdateOIDC audience(@javax.annotation.Nullable String audience) {
  ...
  public AuthMethodUpdateOIDC auditLogsClaims(@javax.annotation.Nullable List<String> auditLogsClaims) {
    this.auditLogsClaims = auditLogsClaims;
    return this;
  }

  public AuthMethodUpdateOIDC addAuditLogsClaimsItem(String auditLogsClaimsItem) {
  ...
  public AuthMethodUpdateOIDC boundIps(@javax.annotation.Nullable List<String> boundIps) {
    this.boundIps = boundIps;
    return this;
  }

  public AuthMethodUpdateOIDC addBoundIpsItem(String boundIpsItem) {
  ...
  public AuthMethodUpdateOIDC clientId(@javax.annotation.Nullable String clientId) {
  ...
  public AuthMethodUpdateOIDC clientSecret(@javax.annotation.Nullable String clientSecret) {
  ...
  public AuthMethodUpdateOIDC deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public AuthMethodUpdateOIDC description(@javax.annotation.Nullable String description) {
  ...
  public AuthMethodUpdateOIDC expirationEventIn(@javax.annotation.Nullable List<String> expirationEventIn) {
    this.expirationEventIn = expirationEventIn;
    return this;
  }

  public AuthMethodUpdateOIDC addExpirationEventInItem(String expirationEventInItem) {
  ...
  public AuthMethodUpdateOIDC forceSubClaims(@javax.annotation.Nullable Boolean forceSubClaims) {
  ...
  public AuthMethodUpdateOIDC gwBoundIps(@javax.annotation.Nullable List<String> gwBoundIps) {
    this.gwBoundIps = gwBoundIps;
    return this;
  }

  public AuthMethodUpdateOIDC addGwBoundIpsItem(String gwBoundIpsItem) {
  ...
  public AuthMethodUpdateOIDC issuer(@javax.annotation.Nullable String issuer) {
    this.issuer = issuer;
    return this;
  }
  ...
  public AuthMethodUpdateOIDC json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public AuthMethodUpdateOIDC jwtTtl(@javax.annotation.Nullable Long jwtTtl) {
    this.jwtTtl = jwtTtl;
    return this;
  }
  ...
  public AuthMethodUpdateOIDC name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public AuthMethodUpdateOIDC newName(@javax.annotation.Nullable String newName) {
  ...
  public AuthMethodUpdateOIDC productType(@javax.annotation.Nullable List<String> productType) {
    this.productType = productType;
    return this;
  }

  public AuthMethodUpdateOIDC addProductTypeItem(String productTypeItem) {
  ...
  public AuthMethodUpdateOIDC requiredScopes(@javax.annotation.Nullable List<String> requiredScopes) {
    this.requiredScopes = requiredScopes;
    return this;
  }

  public AuthMethodUpdateOIDC addRequiredScopesItem(String requiredScopesItem) {
  ...
  public AuthMethodUpdateOIDC requiredScopesPrefix(@javax.annotation.Nullable String requiredScopesPrefix) {
  ...
  public AuthMethodUpdateOIDC subclaimsDelimiters(@javax.annotation.Nullable List<String> subclaimsDelimiters) {
    this.subclaimsDelimiters = subclaimsDelimiters;
    return this;
  }

  public AuthMethodUpdateOIDC addSubclaimsDelimitersItem(String subclaimsDelimitersItem) {
  ...
  public AuthMethodUpdateOIDC token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public AuthMethodUpdateOIDC uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public AuthMethodUpdateOIDC uniqueIdentifier(@javax.annotation.Nonnull String uniqueIdentifier) {
  ...
  public boolean equals(Object o) {
    ...
    AuthMethodUpdateOIDC authMethodUpdateOIDC = (AuthMethodUpdateOIDC) o;
    return Objects.equals(this.accessExpires, authMethodUpdateOIDC.accessExpires) &&
        Objects.equals(this.allowedClientType, authMethodUpdateOIDC.allowedClientType) &&
        Objects.equals(this.allowedRedirectUri, authMethodUpdateOIDC.allowedRedirectUri) &&
        Objects.equals(this.audience, authMethodUpdateOIDC.audience) &&
        Objects.equals(this.auditLogsClaims, authMethodUpdateOIDC.auditLogsClaims) &&
        ...
        Objects.equals(this.expirationEventIn, authMethodUpdateOIDC.expirationEventIn) &&
        ...
        Objects.equals(this.issuer, authMethodUpdateOIDC.issuer) &&
        Objects.equals(this.json, authMethodUpdateOIDC.json) &&
        Objects.equals(this.jwtTtl, authMethodUpdateOIDC.jwtTtl) &&
        Objects.equals(this.name, authMethodUpdateOIDC.name) &&
        Objects.equals(this.newName, authMethodUpdateOIDC.newName) &&
        Objects.equals(this.productType, authMethodUpdateOIDC.productType) &&
        Objects.equals(this.requiredScopes, authMethodUpdateOIDC.requiredScopes) &&
        Objects.equals(this.requiredScopesPrefix, authMethodUpdateOIDC.requiredScopesPrefix) &&
        Objects.equals(this.subclaimsDelimiters, authMethodUpdateOIDC.subclaimsDelimiters) &&
        Objects.equals(this.token, authMethodUpdateOIDC.token) &&
        Objects.equals(this.uidToken, authMethodUpdateOIDC.uidToken) &&
        Objects.equals(this.uniqueIdentifier, authMethodUpdateOIDC.uniqueIdentifier);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accessExpires, allowedClientType, allowedRedirectUri, audience, auditLogsClaims, boundIps, clientId, clientSecret, deleteProtection, description, expirationEventIn, forceSubClaims, gwBoundIps, issuer, json, jwtTtl, name, newName, productType, requiredScopes, requiredScopesPrefix, subclaimsDelimiters, token, uidToken, uniqueIdentifier);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AuthMethodUpdateOIDC
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthMethodUpdateOIDC.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AuthMethodUpdateOIDC is not found in the empty JSON string", AuthMethodUpdateOIDC.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthMethodUpdateOIDC.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AuthMethodUpdateOIDC` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AuthMethodUpdateOIDC.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuthMethodUpdateOIDC.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuthMethodUpdateOIDC' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuthMethodUpdateOIDC> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuthMethodUpdateOIDC.class));

       return (TypeAdapter<T>) new TypeAdapter<AuthMethodUpdateOIDC>() {
           @Override
           public void write(JsonWriter out, AuthMethodUpdateOIDC value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AuthMethodUpdateOIDC read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AuthMethodUpdateOIDC given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AuthMethodUpdateOIDC
   * @throws IOException if the JSON string is invalid with respect to AuthMethodUpdateOIDC
   */
  public static AuthMethodUpdateOIDC fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuthMethodUpdateOIDC.class);
  }

  /**
   * Convert an instance of AuthMethodUpdateOIDC to an JSON string
   *
   * @return JSON string
   */
