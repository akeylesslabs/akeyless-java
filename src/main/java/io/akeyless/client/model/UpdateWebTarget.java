...
public class UpdateWebTarget {
  ...
  public UpdateWebTarget comment(@javax.annotation.Nullable String comment) {
  ...
  public UpdateWebTarget description(@javax.annotation.Nullable String description) {
  ...
  public UpdateWebTarget json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public UpdateWebTarget keepPrevVersion(@javax.annotation.Nullable String keepPrevVersion) {
  ...
  public UpdateWebTarget key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public UpdateWebTarget maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public UpdateWebTarget name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateWebTarget newName(@javax.annotation.Nullable String newName) {
  ...
  public UpdateWebTarget token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public UpdateWebTarget uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public UpdateWebTarget updateVersion(@javax.annotation.Nullable Boolean updateVersion) {
  ...
  public UpdateWebTarget url(@javax.annotation.Nullable String url) {
    this.url = url;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("comment", "description", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "token", "uid-token", "update-version", "url"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateWebTarget
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateWebTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateWebTarget is not found in the empty JSON string", UpdateWebTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateWebTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateWebTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateWebTarget.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateWebTarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateWebTarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateWebTarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateWebTarget.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateWebTarget>() {
           @Override
           public void write(JsonWriter out, UpdateWebTarget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateWebTarget read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateWebTarget given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateWebTarget
   * @throws IOException if the JSON string is invalid with respect to UpdateWebTarget
   */
  public static UpdateWebTarget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateWebTarget.class);
  }

  /**
   * Convert an instance of UpdateWebTarget to an JSON string
   *
   * @return JSON string
   */
