...
public class ProvisionCertificate {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("display-id", "item-id", "json", "name", "token", "uid-token"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ProvisionCertificate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ProvisionCertificate is not found in the empty JSON string", ProvisionCertificate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ProvisionCertificate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ProvisionCertificate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
