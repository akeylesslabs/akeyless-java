 ...
 */
@ApiModel(description = "authMethodList is a command that returns a list of auth methods")
...
public class AuthMethodList {
  ...
  public AuthMethodList filter(String filter) {
  ...
  **/
  ...
  public AuthMethodList json(Boolean json) {
  ...
  **/
  ...
  public AuthMethodList paginationToken(String paginationToken) {
  ...
  **/
  ...
  public AuthMethodList token(String token) {
  ...
  **/
  ...
  public AuthMethodList type(List<String> type) {
  ...
  **/
  ...
  public AuthMethodList uidToken(String uidToken) {
