...
public class TargetUpdateWindows {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("certificate", "connection-type", "delete_protection", "description", "domain", "hostname", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "parent-target-name", "password", "port", "token", "uid-token", "use-tls", "username"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TargetUpdateWindows.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TargetUpdateWindows is not found in the empty JSON string", TargetUpdateWindows.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TargetUpdateWindows.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TargetUpdateWindows` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
