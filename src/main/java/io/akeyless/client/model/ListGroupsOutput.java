...
public class ListGroupsOutput {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("groups", "next_page"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListGroupsOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ListGroupsOutput is not found in the empty JSON string", ListGroupsOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListGroupsOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ListGroupsOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
