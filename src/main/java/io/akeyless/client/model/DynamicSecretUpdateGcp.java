 ...
 */
@ApiModel(description = "dynamicSecretUpdateGcp is a command that updates a GCP dynamic secret")
...
public class DynamicSecretUpdateGcp {
  ...
  public DynamicSecretUpdateGcp deleteProtection(String deleteProtection) {
  ...
  **/
  ...
  public DynamicSecretUpdateGcp description(String description) {
  ...
  **/
  ...
  public DynamicSecretUpdateGcp gcpCredType(String gcpCredType) {
  ...
  **/
  ...
  public DynamicSecretUpdateGcp gcpKey(String gcpKey) {
  ...
  **/
  ...
  public DynamicSecretUpdateGcp gcpKeyAlgo(String gcpKeyAlgo) {
  ...
  **/
  ...
  public DynamicSecretUpdateGcp gcpSaEmail(String gcpSaEmail) {
  ...
  **/
  ...
  public DynamicSecretUpdateGcp gcpTokenScopes(String gcpTokenScopes) {
  ...
  **/
  ...
  public DynamicSecretUpdateGcp json(Boolean json) {
  ...
  **/
  ...
  public DynamicSecretUpdateGcp name(String name) {
  ...
  **/
  ...
  public DynamicSecretUpdateGcp newName(String newName) {
  ...
  **/
  ...
  public DynamicSecretUpdateGcp producerEncryptionKeyName(String producerEncryptionKeyName) {
  ...
  **/
  ...
  public DynamicSecretUpdateGcp roleBinding(String roleBinding) {
  ...
  **/
  ...
  public DynamicSecretUpdateGcp serviceAccountType(String serviceAccountType) {
  ...
  **/
  ...
  public DynamicSecretUpdateGcp tags(List<String> tags) {
  ...
  **/
  ...
  public DynamicSecretUpdateGcp targetName(String targetName) {
  ...
  **/
  ...
  public DynamicSecretUpdateGcp token(String token) {
  ...
  **/
  ...
  public DynamicSecretUpdateGcp uidToken(String uidToken) {
  ...
  **/
  ...
  public DynamicSecretUpdateGcp userTtl(String userTtl) {
