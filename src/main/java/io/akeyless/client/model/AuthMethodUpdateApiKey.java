...
public class AuthMethodUpdateApiKey {
  ...
  public AuthMethodUpdateApiKey() {
  }

  public AuthMethodUpdateApiKey accessExpires(@javax.annotation.Nullable Long accessExpires) {
  ...
  public AuthMethodUpdateApiKey allowedClientType(@javax.annotation.Nullable List<String> allowedClientType) {
    this.allowedClientType = allowedClientType;
    return this;
  }

  public AuthMethodUpdateApiKey addAllowedClientTypeItem(String allowedClientTypeItem) {
  ...
  public AuthMethodUpdateApiKey auditLogsClaims(@javax.annotation.Nullable List<String> auditLogsClaims) {
    this.auditLogsClaims = auditLogsClaims;
    return this;
  }

  public AuthMethodUpdateApiKey addAuditLogsClaimsItem(String auditLogsClaimsItem) {
  ...
  public AuthMethodUpdateApiKey boundIps(@javax.annotation.Nullable List<String> boundIps) {
    this.boundIps = boundIps;
    return this;
  }

  public AuthMethodUpdateApiKey addBoundIpsItem(String boundIpsItem) {
  ...
  public AuthMethodUpdateApiKey deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public AuthMethodUpdateApiKey description(@javax.annotation.Nullable String description) {
  ...
  public AuthMethodUpdateApiKey expirationEventIn(@javax.annotation.Nullable List<String> expirationEventIn) {
    this.expirationEventIn = expirationEventIn;
    return this;
  }

  public AuthMethodUpdateApiKey addExpirationEventInItem(String expirationEventInItem) {
  ...
  public AuthMethodUpdateApiKey forceSubClaims(@javax.annotation.Nullable Boolean forceSubClaims) {
  ...
  public AuthMethodUpdateApiKey gwBoundIps(@javax.annotation.Nullable List<String> gwBoundIps) {
    this.gwBoundIps = gwBoundIps;
    return this;
  }

  public AuthMethodUpdateApiKey addGwBoundIpsItem(String gwBoundIpsItem) {
  ...
  public AuthMethodUpdateApiKey json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public AuthMethodUpdateApiKey jwtTtl(@javax.annotation.Nullable Long jwtTtl) {
    this.jwtTtl = jwtTtl;
    return this;
  }
  ...
  public AuthMethodUpdateApiKey name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public AuthMethodUpdateApiKey newName(@javax.annotation.Nullable String newName) {
  ...
  public AuthMethodUpdateApiKey productType(@javax.annotation.Nullable List<String> productType) {
    this.productType = productType;
    return this;
  }

  public AuthMethodUpdateApiKey addProductTypeItem(String productTypeItem) {
  ...
  public AuthMethodUpdateApiKey token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public AuthMethodUpdateApiKey uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public boolean equals(Object o) {
    ...
    AuthMethodUpdateApiKey authMethodUpdateApiKey = (AuthMethodUpdateApiKey) o;
    return Objects.equals(this.accessExpires, authMethodUpdateApiKey.accessExpires) &&
        Objects.equals(this.allowedClientType, authMethodUpdateApiKey.allowedClientType) &&
        Objects.equals(this.auditLogsClaims, authMethodUpdateApiKey.auditLogsClaims) &&
        Objects.equals(this.boundIps, authMethodUpdateApiKey.boundIps) &&
        Objects.equals(this.deleteProtection, authMethodUpdateApiKey.deleteProtection) &&
        Objects.equals(this.description, authMethodUpdateApiKey.description) &&
        Objects.equals(this.expirationEventIn, authMethodUpdateApiKey.expirationEventIn) &&
        Objects.equals(this.forceSubClaims, authMethodUpdateApiKey.forceSubClaims) &&
        Objects.equals(this.gwBoundIps, authMethodUpdateApiKey.gwBoundIps) &&
        Objects.equals(this.json, authMethodUpdateApiKey.json) &&
        Objects.equals(this.jwtTtl, authMethodUpdateApiKey.jwtTtl) &&
        Objects.equals(this.name, authMethodUpdateApiKey.name) &&
        Objects.equals(this.newName, authMethodUpdateApiKey.newName) &&
        Objects.equals(this.productType, authMethodUpdateApiKey.productType) &&
        Objects.equals(this.token, authMethodUpdateApiKey.token) &&
        Objects.equals(this.uidToken, authMethodUpdateApiKey.uidToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accessExpires, allowedClientType, auditLogsClaims, boundIps, deleteProtection, description, expirationEventIn, forceSubClaims, gwBoundIps, json, jwtTtl, name, newName, productType, token, uidToken);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AuthMethodUpdateApiKey {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("access-expires", "allowed-client-type", "audit-logs-claims", "bound-ips", "delete_protection", "description", "expiration-event-in", "force-sub-claims", "gw-bound-ips", "json", "jwt-ttl", "name", "new-name", "product-type", "token", "uid-token"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to AuthMethodUpdateApiKey
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthMethodUpdateApiKey.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AuthMethodUpdateApiKey is not found in the empty JSON string", AuthMethodUpdateApiKey.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthMethodUpdateApiKey.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AuthMethodUpdateApiKey` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AuthMethodUpdateApiKey.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuthMethodUpdateApiKey.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuthMethodUpdateApiKey' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuthMethodUpdateApiKey> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuthMethodUpdateApiKey.class));

       return (TypeAdapter<T>) new TypeAdapter<AuthMethodUpdateApiKey>() {
           @Override
           public void write(JsonWriter out, AuthMethodUpdateApiKey value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AuthMethodUpdateApiKey read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AuthMethodUpdateApiKey given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AuthMethodUpdateApiKey
   * @throws IOException if the JSON string is invalid with respect to AuthMethodUpdateApiKey
   */
  public static AuthMethodUpdateApiKey fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuthMethodUpdateApiKey.class);
  }

  /**
   * Convert an instance of AuthMethodUpdateApiKey to an JSON string
   *
   * @return JSON string
   */
