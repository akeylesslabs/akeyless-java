...
public class PathRule {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("assigners", "capabilities", "cb", "is_limit_access", "item_id", "number_of_access_used", "number_of_allowed_access", "path", "start_time", "ttl", "type"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PathRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in PathRule is not found in the empty JSON string", PathRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PathRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `PathRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
