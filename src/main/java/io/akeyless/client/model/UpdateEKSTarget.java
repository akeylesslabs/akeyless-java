...
public class UpdateEKSTarget {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("comment", "description", "eks-access-key-id", "eks-cluster-ca-cert", "eks-cluster-endpoint", "eks-cluster-name", "eks-region", "eks-secret-access-key", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "token", "uid-token", "update-version", "use-gw-cloud-identity"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateEKSTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateEKSTarget is not found in the empty JSON string", UpdateEKSTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateEKSTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateEKSTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
