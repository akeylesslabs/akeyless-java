...
public class AuthMethodUpdateUniversalIdentity {
  ...
  public AuthMethodUpdateUniversalIdentity() {
  }

  public AuthMethodUpdateUniversalIdentity accessExpires(@javax.annotation.Nullable Long accessExpires) {
  ...
  public AuthMethodUpdateUniversalIdentity allowedClientType(@javax.annotation.Nullable List<String> allowedClientType) {
    this.allowedClientType = allowedClientType;
    return this;
  }

  public AuthMethodUpdateUniversalIdentity addAllowedClientTypeItem(String allowedClientTypeItem) {
  ...
  public AuthMethodUpdateUniversalIdentity auditLogsClaims(@javax.annotation.Nullable List<String> auditLogsClaims) {
    this.auditLogsClaims = auditLogsClaims;
    return this;
  }

  public AuthMethodUpdateUniversalIdentity addAuditLogsClaimsItem(String auditLogsClaimsItem) {
  ...
  public AuthMethodUpdateUniversalIdentity boundIps(@javax.annotation.Nullable List<String> boundIps) {
    this.boundIps = boundIps;
    return this;
  }

  public AuthMethodUpdateUniversalIdentity addBoundIpsItem(String boundIpsItem) {
  ...
  public AuthMethodUpdateUniversalIdentity childTtlLimit(@javax.annotation.Nullable Integer childTtlLimit) {
  ...
  public AuthMethodUpdateUniversalIdentity deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public AuthMethodUpdateUniversalIdentity denyInheritance(@javax.annotation.Nullable Boolean denyInheritance) {
  ...
  public AuthMethodUpdateUniversalIdentity denyRotate(@javax.annotation.Nullable Boolean denyRotate) {
  ...
  public AuthMethodUpdateUniversalIdentity description(@javax.annotation.Nullable String description) {
  ...
  public AuthMethodUpdateUniversalIdentity expirationEventIn(@javax.annotation.Nullable List<String> expirationEventIn) {
    this.expirationEventIn = expirationEventIn;
    return this;
  }

  public AuthMethodUpdateUniversalIdentity addExpirationEventInItem(String expirationEventInItem) {
  ...
  public AuthMethodUpdateUniversalIdentity forceSubClaims(@javax.annotation.Nullable Boolean forceSubClaims) {
  ...
  public AuthMethodUpdateUniversalIdentity gwBoundIps(@javax.annotation.Nullable List<String> gwBoundIps) {
    this.gwBoundIps = gwBoundIps;
    return this;
  }

  public AuthMethodUpdateUniversalIdentity addGwBoundIpsItem(String gwBoundIpsItem) {
  ...
  public AuthMethodUpdateUniversalIdentity json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public AuthMethodUpdateUniversalIdentity jwtTtl(@javax.annotation.Nullable Long jwtTtl) {
    this.jwtTtl = jwtTtl;
    return this;
  }
  ...
  public AuthMethodUpdateUniversalIdentity name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public AuthMethodUpdateUniversalIdentity newName(@javax.annotation.Nullable String newName) {
  ...
  public AuthMethodUpdateUniversalIdentity productType(@javax.annotation.Nullable List<String> productType) {
    this.productType = productType;
    return this;
  }

  public AuthMethodUpdateUniversalIdentity addProductTypeItem(String productTypeItem) {
  ...
  public AuthMethodUpdateUniversalIdentity token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public AuthMethodUpdateUniversalIdentity treeLength(@javax.annotation.Nullable Integer treeLength) {
  ...
  public AuthMethodUpdateUniversalIdentity ttl(@javax.annotation.Nullable Integer ttl) {
    this.ttl = ttl;
    return this;
  }
  ...
  public AuthMethodUpdateUniversalIdentity uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public boolean equals(Object o) {
    ...
    AuthMethodUpdateUniversalIdentity authMethodUpdateUniversalIdentity = (AuthMethodUpdateUniversalIdentity) o;
    return Objects.equals(this.accessExpires, authMethodUpdateUniversalIdentity.accessExpires) &&
        Objects.equals(this.allowedClientType, authMethodUpdateUniversalIdentity.allowedClientType) &&
        Objects.equals(this.auditLogsClaims, authMethodUpdateUniversalIdentity.auditLogsClaims) &&
        Objects.equals(this.boundIps, authMethodUpdateUniversalIdentity.boundIps) &&
        Objects.equals(this.childTtlLimit, authMethodUpdateUniversalIdentity.childTtlLimit) &&
        Objects.equals(this.deleteProtection, authMethodUpdateUniversalIdentity.deleteProtection) &&
        Objects.equals(this.denyInheritance, authMethodUpdateUniversalIdentity.denyInheritance) &&
        Objects.equals(this.denyRotate, authMethodUpdateUniversalIdentity.denyRotate) &&
        Objects.equals(this.description, authMethodUpdateUniversalIdentity.description) &&
        Objects.equals(this.expirationEventIn, authMethodUpdateUniversalIdentity.expirationEventIn) &&
        Objects.equals(this.forceSubClaims, authMethodUpdateUniversalIdentity.forceSubClaims) &&
        Objects.equals(this.gwBoundIps, authMethodUpdateUniversalIdentity.gwBoundIps) &&
        Objects.equals(this.json, authMethodUpdateUniversalIdentity.json) &&
        Objects.equals(this.jwtTtl, authMethodUpdateUniversalIdentity.jwtTtl) &&
        Objects.equals(this.name, authMethodUpdateUniversalIdentity.name) &&
        Objects.equals(this.newName, authMethodUpdateUniversalIdentity.newName) &&
        Objects.equals(this.productType, authMethodUpdateUniversalIdentity.productType) &&
        Objects.equals(this.token, authMethodUpdateUniversalIdentity.token) &&
        Objects.equals(this.treeLength, authMethodUpdateUniversalIdentity.treeLength) &&
        Objects.equals(this.ttl, authMethodUpdateUniversalIdentity.ttl) &&
        Objects.equals(this.uidToken, authMethodUpdateUniversalIdentity.uidToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accessExpires, allowedClientType, auditLogsClaims, boundIps, childTtlLimit, deleteProtection, denyInheritance, denyRotate, description, expirationEventIn, forceSubClaims, gwBoundIps, json, jwtTtl, name, newName, productType, token, treeLength, ttl, uidToken);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("access-expires", "allowed-client-type", "audit-logs-claims", "bound-ips", "child-ttl-limit", "delete_protection", "deny-inheritance", "deny-rotate", "description", "expiration-event-in", "force-sub-claims", "gw-bound-ips", "json", "jwt-ttl", "name", "new-name", "product-type", "token", "tree-length", "ttl", "uid-token"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to AuthMethodUpdateUniversalIdentity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthMethodUpdateUniversalIdentity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AuthMethodUpdateUniversalIdentity is not found in the empty JSON string", AuthMethodUpdateUniversalIdentity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthMethodUpdateUniversalIdentity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AuthMethodUpdateUniversalIdentity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AuthMethodUpdateUniversalIdentity.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuthMethodUpdateUniversalIdentity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuthMethodUpdateUniversalIdentity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuthMethodUpdateUniversalIdentity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuthMethodUpdateUniversalIdentity.class));

       return (TypeAdapter<T>) new TypeAdapter<AuthMethodUpdateUniversalIdentity>() {
           @Override
           public void write(JsonWriter out, AuthMethodUpdateUniversalIdentity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AuthMethodUpdateUniversalIdentity read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AuthMethodUpdateUniversalIdentity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AuthMethodUpdateUniversalIdentity
   * @throws IOException if the JSON string is invalid with respect to AuthMethodUpdateUniversalIdentity
   */
  public static AuthMethodUpdateUniversalIdentity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuthMethodUpdateUniversalIdentity.class);
  }

  /**
   * Convert an instance of AuthMethodUpdateUniversalIdentity to an JSON string
   *
   * @return JSON string
   */
