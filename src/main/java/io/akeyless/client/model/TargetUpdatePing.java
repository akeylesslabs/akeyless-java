...
public class TargetUpdatePing {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("administrative-port", "authorization-port", "delete_protection", "description", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "password", "ping-url", "privileged-user", "token", "uid-token"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TargetUpdatePing.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TargetUpdatePing is not found in the empty JSON string", TargetUpdatePing.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TargetUpdatePing.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TargetUpdatePing` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
