...
public class UpdateAzureTarget {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("azure-cloud", "client-id", "client-secret", "comment", "connection-type", "description", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "resource-group-name", "resource-name", "subscription-id", "tenant-id", "token", "uid-token", "update-version", "use-gw-cloud-identity"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateAzureTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateAzureTarget is not found in the empty JSON string", UpdateAzureTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateAzureTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateAzureTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
