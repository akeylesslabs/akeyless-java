...
public class CreateGlobalSignTarget {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(comment, contactEmail, contactFirstName, contactLastName, contactPhone, description, json, key, name, password, profileId, timeout, token, uidToken, username);
  }
