...
public class CreateGlobalSignTarget {
  ...
  public CreateGlobalSignTarget() {
  }

  public CreateGlobalSignTarget comment(@javax.annotation.Nullable String comment) {
  ...
  public CreateGlobalSignTarget contactEmail(@javax.annotation.Nonnull String contactEmail) {
  ...
  public CreateGlobalSignTarget contactFirstName(@javax.annotation.Nonnull String contactFirstName) {
  ...
  public CreateGlobalSignTarget contactLastName(@javax.annotation.Nonnull String contactLastName) {
  ...
  public CreateGlobalSignTarget contactPhone(@javax.annotation.Nonnull String contactPhone) {
  ...
  public CreateGlobalSignTarget description(@javax.annotation.Nullable String description) {
  ...
  public CreateGlobalSignTarget json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public CreateGlobalSignTarget key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public CreateGlobalSignTarget maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public CreateGlobalSignTarget name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateGlobalSignTarget password(@javax.annotation.Nonnull String password) {
  ...
  public CreateGlobalSignTarget profileId(@javax.annotation.Nonnull String profileId) {
  ...
  public CreateGlobalSignTarget timeout(@javax.annotation.Nullable String timeout) {
  ...
  public CreateGlobalSignTarget token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public CreateGlobalSignTarget uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public CreateGlobalSignTarget username(@javax.annotation.Nonnull String username) {
  ...
  public boolean equals(Object o) {
    ...
    CreateGlobalSignTarget createGlobalSignTarget = (CreateGlobalSignTarget) o;
    return Objects.equals(this.comment, createGlobalSignTarget.comment) &&
        Objects.equals(this.contactEmail, createGlobalSignTarget.contactEmail) &&
        Objects.equals(this.contactFirstName, createGlobalSignTarget.contactFirstName) &&
        Objects.equals(this.contactLastName, createGlobalSignTarget.contactLastName) &&
        Objects.equals(this.contactPhone, createGlobalSignTarget.contactPhone) &&
        Objects.equals(this.description, createGlobalSignTarget.description) &&
        Objects.equals(this.json, createGlobalSignTarget.json) &&
        Objects.equals(this.key, createGlobalSignTarget.key) &&
        Objects.equals(this.maxVersions, createGlobalSignTarget.maxVersions) &&
        Objects.equals(this.name, createGlobalSignTarget.name) &&
        Objects.equals(this.password, createGlobalSignTarget.password) &&
        Objects.equals(this.profileId, createGlobalSignTarget.profileId) &&
        Objects.equals(this.timeout, createGlobalSignTarget.timeout) &&
        Objects.equals(this.token, createGlobalSignTarget.token) &&
        Objects.equals(this.uidToken, createGlobalSignTarget.uidToken) &&
        Objects.equals(this.username, createGlobalSignTarget.username);
  }

  @Override
  public int hashCode() {
    return Objects.hash(comment, contactEmail, contactFirstName, contactLastName, contactPhone, description, json, key, maxVersions, name, password, profileId, timeout, token, uidToken, username);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateGlobalSignTarget
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateGlobalSignTarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateGlobalSignTarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateGlobalSignTarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateGlobalSignTarget.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateGlobalSignTarget>() {
           @Override
           public void write(JsonWriter out, CreateGlobalSignTarget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateGlobalSignTarget read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateGlobalSignTarget given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateGlobalSignTarget
   * @throws IOException if the JSON string is invalid with respect to CreateGlobalSignTarget
   */
  public static CreateGlobalSignTarget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateGlobalSignTarget.class);
  }

  /**
   * Convert an instance of CreateGlobalSignTarget to an JSON string
   *
   * @return JSON string
   */
