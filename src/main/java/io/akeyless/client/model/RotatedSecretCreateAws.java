...
public class RotatedSecretCreateAws {
  ...
  public RotatedSecretCreateAws apiId(@javax.annotation.Nullable String apiId) {
    this.apiId = apiId;
    return this;
  }
  ...
  public RotatedSecretCreateAws apiKey(@javax.annotation.Nullable String apiKey) {
    this.apiKey = apiKey;
    return this;
  }
  ...
  public RotatedSecretCreateAws authenticationCredentials(@javax.annotation.Nullable String authenticationCredentials) {
  ...
  public RotatedSecretCreateAws autoRotate(@javax.annotation.Nullable String autoRotate) {
  ...
  public RotatedSecretCreateAws awsRegion(@javax.annotation.Nullable String awsRegion) {
  ...
  public RotatedSecretCreateAws deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public RotatedSecretCreateAws description(@javax.annotation.Nullable String description) {
  ...
  public RotatedSecretCreateAws graceRotation(@javax.annotation.Nullable String graceRotation) {
  ...
  public RotatedSecretCreateAws graceRotationHour(@javax.annotation.Nullable Integer graceRotationHour) {
  ...
  public RotatedSecretCreateAws graceRotationInterval(@javax.annotation.Nullable String graceRotationInterval) {
  ...
  public RotatedSecretCreateAws graceRotationTiming(@javax.annotation.Nullable String graceRotationTiming) {
  ...
  public RotatedSecretCreateAws inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public RotatedSecretCreateAws addInputRuleItem(String inputRuleItem) {
  ...
  public RotatedSecretCreateAws itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public RotatedSecretCreateAws putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public RotatedSecretCreateAws json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public RotatedSecretCreateAws key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public RotatedSecretCreateAws lockDuringSraSession(@javax.annotation.Nullable String lockDuringSraSession) {
  ...
  public RotatedSecretCreateAws maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public RotatedSecretCreateAws name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public RotatedSecretCreateAws outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public RotatedSecretCreateAws addOutputRuleItem(String outputRuleItem) {
  ...
  public RotatedSecretCreateAws passwordLength(@javax.annotation.Nullable String passwordLength) {
  ...
  public RotatedSecretCreateAws rotateAfterDisconnect(@javax.annotation.Nullable String rotateAfterDisconnect) {
  ...
  public RotatedSecretCreateAws rotationEventIn(@javax.annotation.Nullable List<String> rotationEventIn) {
  ...
  public RotatedSecretCreateAws rotationHour(@javax.annotation.Nullable Integer rotationHour) {
  ...
  public RotatedSecretCreateAws rotationInterval(@javax.annotation.Nullable String rotationInterval) {
  ...
  public RotatedSecretCreateAws rotatorType(@javax.annotation.Nonnull String rotatorType) {
  ...
  public RotatedSecretCreateAws secureAccessAwsAccountId(@javax.annotation.Nullable String secureAccessAwsAccountId) {
  ...
  public RotatedSecretCreateAws secureAccessAwsNativeCli(@javax.annotation.Nullable Boolean secureAccessAwsNativeCli) {
  ...
  public RotatedSecretCreateAws secureAccessBastionIssuer(@javax.annotation.Nullable String secureAccessBastionIssuer) {
  ...
  public RotatedSecretCreateAws secureAccessCertificateIssuer(@javax.annotation.Nullable String secureAccessCertificateIssuer) {
  ...
  public RotatedSecretCreateAws secureAccessEnable(@javax.annotation.Nullable String secureAccessEnable) {
  ...
  public RotatedSecretCreateAws tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public RotatedSecretCreateAws targetName(@javax.annotation.Nonnull String targetName) {
  ...
  public RotatedSecretCreateAws token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public RotatedSecretCreateAws uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public RotatedSecretCreateAws useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public RotatedSecretCreateAws useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public RotatedSecretCreateAws useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public RotatedSecretCreateAws useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.apiId, rotatedSecretCreateAws.apiId) &&
        ...
        Objects.equals(this.graceRotationHour, rotatedSecretCreateAws.graceRotationHour) &&
        Objects.equals(this.graceRotationInterval, rotatedSecretCreateAws.graceRotationInterval) &&
        Objects.equals(this.graceRotationTiming, rotatedSecretCreateAws.graceRotationTiming) &&
        Objects.equals(this.inputRule, rotatedSecretCreateAws.inputRule) &&
        Objects.equals(this.itemCustomFields, rotatedSecretCreateAws.itemCustomFields) &&
        Objects.equals(this.json, rotatedSecretCreateAws.json) &&
        Objects.equals(this.key, rotatedSecretCreateAws.key) &&
        Objects.equals(this.lockDuringSraSession, rotatedSecretCreateAws.lockDuringSraSession) &&
        Objects.equals(this.maxVersions, rotatedSecretCreateAws.maxVersions) &&
        Objects.equals(this.name, rotatedSecretCreateAws.name) &&
        Objects.equals(this.outputRule, rotatedSecretCreateAws.outputRule) &&
        ...
        Objects.equals(this.secureAccessCertificateIssuer, rotatedSecretCreateAws.secureAccessCertificateIssuer) &&
        ...
        Objects.equals(this.useCapitalLetters, rotatedSecretCreateAws.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, rotatedSecretCreateAws.useLowerLetters) &&
        Objects.equals(this.useNumbers, rotatedSecretCreateAws.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, rotatedSecretCreateAws.useSpecialCharacters);
  }

  @Override
  public int hashCode() {
    return Objects.hash(apiId, apiKey, authenticationCredentials, autoRotate, awsRegion, deleteProtection, description, graceRotation, graceRotationHour, graceRotationInterval, graceRotationTiming, inputRule, itemCustomFields, json, key, lockDuringSraSession, maxVersions, name, outputRule, passwordLength, rotateAfterDisconnect, rotationEventIn, rotationHour, rotationInterval, rotatorType, secureAccessAwsAccountId, secureAccessAwsNativeCli, secureAccessBastionIssuer, secureAccessCertificateIssuer, secureAccessEnable, tags, targetName, token, uidToken, useCapitalLetters, useLowerLetters, useNumbers, useSpecialCharacters);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("api-id", "api-key", "authentication-credentials", "auto-rotate", "aws-region", "delete_protection", "description", "grace-rotation", "grace-rotation-hour", "grace-rotation-interval", "grace-rotation-timing", "input-rule", "item-custom-fields", "json", "key", "lock-during-sra-session", "max-versions", "name", "output-rule", "password-length", "rotate-after-disconnect", "rotation-event-in", "rotation-hour", "rotation-interval", "rotator-type", "secure-access-aws-account-id", "secure-access-aws-native-cli", "secure-access-bastion-issuer", "secure-access-certificate-issuer", "secure-access-enable", "tags", "target-name", "token", "uid-token", "use-capital-letters", "use-lower-letters", "use-numbers", "use-special-characters"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to RotatedSecretCreateAws
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RotatedSecretCreateAws.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RotatedSecretCreateAws is not found in the empty JSON string", RotatedSecretCreateAws.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RotatedSecretCreateAws.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RotatedSecretCreateAws` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RotatedSecretCreateAws.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RotatedSecretCreateAws.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RotatedSecretCreateAws' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RotatedSecretCreateAws> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RotatedSecretCreateAws.class));

       return (TypeAdapter<T>) new TypeAdapter<RotatedSecretCreateAws>() {
           @Override
           public void write(JsonWriter out, RotatedSecretCreateAws value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RotatedSecretCreateAws read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RotatedSecretCreateAws given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RotatedSecretCreateAws
   * @throws IOException if the JSON string is invalid with respect to RotatedSecretCreateAws
   */
  public static RotatedSecretCreateAws fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RotatedSecretCreateAws.class);
  }

  /**
   * Convert an instance of RotatedSecretCreateAws to an JSON string
   *
   * @return JSON string
   */
