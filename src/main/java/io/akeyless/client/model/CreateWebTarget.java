 ...
 */
@ApiModel(description = "createWebTarget is a command that creates a new target. [Deprecated: Use target-create-web command]")
...
public class CreateWebTarget {
  ...
  **/
  ...
  public CreateWebTarget maxVersions(String maxVersions) {
