...
public class Target {
  ...
  public Target credentialsLess(@javax.annotation.Nullable Boolean credentialsLess) {
  ...
  public void setCredentialsLess(@javax.annotation.Nullable Boolean credentialsLess) {
    this.credentialsLess = credentialsLess;
  }
  ...
  static {
    ...
    openapiFields.add("credentials_less");
