 ...
 */
@ApiModel(description = "gwUpdateRemoteAccessSessionLogsAwsS3 is a command that updates session log forwarding config (aws-s3 target)")
...
public class GwUpdateRemoteAccessSessionLogsAwsS3 {
  ...
  public GwUpdateRemoteAccessSessionLogsAwsS3 accessId(String accessId) {
  ...
  **/
  ...
  public GwUpdateRemoteAccessSessionLogsAwsS3 accessKey(String accessKey) {
  ...
  **/
  ...
  public GwUpdateRemoteAccessSessionLogsAwsS3 authType(String authType) {
  ...
  **/
  ...
  public GwUpdateRemoteAccessSessionLogsAwsS3 bucketName(String bucketName) {
  ...
  **/
  ...
  public GwUpdateRemoteAccessSessionLogsAwsS3 enable(String enable) {
  ...
  **/
  ...
  public GwUpdateRemoteAccessSessionLogsAwsS3 json(Boolean json) {
  ...
  **/
  ...
  public GwUpdateRemoteAccessSessionLogsAwsS3 logFolder(String logFolder) {
  ...
  **/
  ...
  public GwUpdateRemoteAccessSessionLogsAwsS3 outputFormat(String outputFormat) {
  ...
  **/
  ...
  public GwUpdateRemoteAccessSessionLogsAwsS3 pullInterval(String pullInterval) {
  ...
  **/
  ...
  public GwUpdateRemoteAccessSessionLogsAwsS3 region(String region) {
  ...
  **/
  ...
  public GwUpdateRemoteAccessSessionLogsAwsS3 roleArn(String roleArn) {
  ...
  **/
  ...
  public GwUpdateRemoteAccessSessionLogsAwsS3 token(String token) {
  ...
  **/
  ...
  public GwUpdateRemoteAccessSessionLogsAwsS3 uidToken(String uidToken) {
