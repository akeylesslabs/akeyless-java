...
public class DynamicSecretCreateGoogleWorkspace {
  ...
  public DynamicSecretCreateGoogleWorkspace inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public DynamicSecretCreateGoogleWorkspace addInputRuleItem(String inputRuleItem) {
  ...
  public DynamicSecretCreateGoogleWorkspace itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public DynamicSecretCreateGoogleWorkspace putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public DynamicSecretCreateGoogleWorkspace outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public DynamicSecretCreateGoogleWorkspace addOutputRuleItem(String outputRuleItem) {
  ...
  public DynamicSecretCreateGoogleWorkspace secureAccessDelay(@javax.annotation.Nullable Long secureAccessDelay) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessMode, dynamicSecretCreateGoogleWorkspace.accessMode) &&
        ...
        Objects.equals(this.inputRule, dynamicSecretCreateGoogleWorkspace.inputRule) &&
        Objects.equals(this.itemCustomFields, dynamicSecretCreateGoogleWorkspace.itemCustomFields) &&
        ...
        Objects.equals(this.outputRule, dynamicSecretCreateGoogleWorkspace.outputRule) &&
        ...
        Objects.equals(this.secureAccessDelay, dynamicSecretCreateGoogleWorkspace.secureAccessDelay) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicSecretCreateGoogleWorkspace.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicSecretCreateGoogleWorkspace is not found in the empty JSON string", DynamicSecretCreateGoogleWorkspace.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicSecretCreateGoogleWorkspace.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DynamicSecretCreateGoogleWorkspace` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
