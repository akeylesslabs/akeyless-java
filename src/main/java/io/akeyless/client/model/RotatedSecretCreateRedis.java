...
public class RotatedSecretCreateRedis {
  ...
  public RotatedSecretCreateRedis inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public RotatedSecretCreateRedis addInputRuleItem(String inputRuleItem) {
  ...
  public RotatedSecretCreateRedis outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public RotatedSecretCreateRedis addOutputRuleItem(String outputRuleItem) {
  ...
  public RotatedSecretCreateRedis useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public RotatedSecretCreateRedis useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public RotatedSecretCreateRedis useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public RotatedSecretCreateRedis useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authenticationCredentials, rotatedSecretCreateRedis.authenticationCredentials) &&
        ...
        Objects.equals(this.inputRule, rotatedSecretCreateRedis.inputRule) &&
        ...
        Objects.equals(this.outputRule, rotatedSecretCreateRedis.outputRule) &&
        ...
        Objects.equals(this.useCapitalLetters, rotatedSecretCreateRedis.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, rotatedSecretCreateRedis.useLowerLetters) &&
        Objects.equals(this.useNumbers, rotatedSecretCreateRedis.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, rotatedSecretCreateRedis.useSpecialCharacters);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RotatedSecretCreateRedis.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RotatedSecretCreateRedis is not found in the empty JSON string", RotatedSecretCreateRedis.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RotatedSecretCreateRedis.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RotatedSecretCreateRedis` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
