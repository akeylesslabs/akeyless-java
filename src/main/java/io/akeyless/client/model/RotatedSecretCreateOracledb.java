...
public class RotatedSecretCreateOracledb {
  ...
  public RotatedSecretCreateOracledb inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public RotatedSecretCreateOracledb addInputRuleItem(String inputRuleItem) {
  ...
  public RotatedSecretCreateOracledb outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public RotatedSecretCreateOracledb addOutputRuleItem(String outputRuleItem) {
  ...
  public RotatedSecretCreateOracledb useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public RotatedSecretCreateOracledb useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public RotatedSecretCreateOracledb useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public RotatedSecretCreateOracledb useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authenticationCredentials, rotatedSecretCreateOracledb.authenticationCredentials) &&
        ...
        Objects.equals(this.inputRule, rotatedSecretCreateOracledb.inputRule) &&
        ...
        Objects.equals(this.outputRule, rotatedSecretCreateOracledb.outputRule) &&
        ...
        Objects.equals(this.useCapitalLetters, rotatedSecretCreateOracledb.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, rotatedSecretCreateOracledb.useLowerLetters) &&
        Objects.equals(this.useNumbers, rotatedSecretCreateOracledb.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, rotatedSecretCreateOracledb.useSpecialCharacters);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authenticationCredentials, autoRotate, deleteProtection, description, inputRule, itemCustomFields, json, key, lockDuringSraSession, maxVersions, name, outputRule, passwordLength, rotateAfterDisconnect, rotatedPassword, rotatedUsername, rotationEventIn, rotationHour, rotationInterval, rotatorType, secureAccessDbName, secureAccessEnable, secureAccessHost, secureAccessWeb, tags, targetName, token, uidToken, useCapitalLetters, useLowerLetters, useNumbers, useSpecialCharacters);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RotatedSecretCreateOracledb.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RotatedSecretCreateOracledb is not found in the empty JSON string", RotatedSecretCreateOracledb.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RotatedSecretCreateOracledb.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RotatedSecretCreateOracledb` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
