 ...
 */
@ApiModel(description = "uscList is a command that lists the secrets of a Universal Secrets Connector")
...
public class UscList {
  ...
  public UscList json(Boolean json) {
  ...
  **/
  ...
  public UscList token(String token) {
  ...
  **/
  ...
  public UscList uidToken(String uidToken) {
  ...
  **/
  ...
  public UscList uscName(String uscName) {
