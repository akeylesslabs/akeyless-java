...
public class AuthMethodUpdateSAML {
  ...
  public AuthMethodUpdateSAML allowedClientType(@javax.annotation.Nullable List<String> allowedClientType) {
    this.allowedClientType = allowedClientType;
    return this;
  }

  public AuthMethodUpdateSAML addAllowedClientTypeItem(String allowedClientTypeItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessExpires, authMethodUpdateSAML.accessExpires) &&
        Objects.equals(this.allowedClientType, authMethodUpdateSAML.allowedClientType) &&
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("access-expires", "allowed-client-type", "allowed-redirect-uri", "audit-logs-claims", "bound-ips", "delete_protection", "description", "expiration-event-in", "force-sub-claims", "gw-bound-ips", "idp-metadata-url", "idp-metadata-xml-data", "json", "jwt-ttl", "name", "new-name", "product-type", "subclaims-delimiters", "token", "uid-token", "unique-identifier"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthMethodUpdateSAML.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AuthMethodUpdateSAML is not found in the empty JSON string", AuthMethodUpdateSAML.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthMethodUpdateSAML.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AuthMethodUpdateSAML` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("idp-metadata-url") != null && !jsonObj.get("idp-metadata-url").isJsonNull()) && !jsonObj.get("idp-metadata-url").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `idp-metadata-url` to be a primitive type in the JSON string but got `%s`", jsonObj.get("idp-metadata-url").toString()));
      }
      if ((jsonObj.get("idp-metadata-xml-data") != null && !jsonObj.get("idp-metadata-xml-data").isJsonNull()) && !jsonObj.get("idp-metadata-xml-data").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `idp-metadata-xml-data` to be a primitive type in the JSON string but got `%s`", jsonObj.get("idp-metadata-xml-data").toString()));
      }
