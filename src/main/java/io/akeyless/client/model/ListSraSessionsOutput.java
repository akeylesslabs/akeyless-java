...
public class ListSraSessionsOutput {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("allowed_gateways", "next_page", "sessions"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListSraSessionsOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ListSraSessionsOutput is not found in the empty JSON string", ListSraSessionsOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListSraSessionsOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ListSraSessionsOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("allowed_gateways") != null && !jsonObj.get("allowed_gateways").isJsonNull()) {
        ...
        if (jsonArrayallowedGateways != null) {
          ...
          if (!jsonObj.get("allowed_gateways").isJsonArray()) {
            throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `allowed_gateways` to be an array in the JSON string but got `%s`", jsonObj.get("allowed_gateways").toString()));
          }
