...
public class UpdateAuthMethodLDAP {
  ...
  public UpdateAuthMethodLDAP() {
  }

  public UpdateAuthMethodLDAP accessExpires(@javax.annotation.Nullable Long accessExpires) {
  ...
  public UpdateAuthMethodLDAP auditLogsClaims(@javax.annotation.Nullable List<String> auditLogsClaims) {
    this.auditLogsClaims = auditLogsClaims;
    return this;
  }

  public UpdateAuthMethodLDAP addAuditLogsClaimsItem(String auditLogsClaimsItem) {
  ...
  public UpdateAuthMethodLDAP boundIps(@javax.annotation.Nullable List<String> boundIps) {
  ...
  public UpdateAuthMethodLDAP deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public UpdateAuthMethodLDAP description(@javax.annotation.Nullable String description) {
  ...
  public UpdateAuthMethodLDAP expirationEventIn(@javax.annotation.Nullable List<String> expirationEventIn) {
    this.expirationEventIn = expirationEventIn;
    return this;
  }

  public UpdateAuthMethodLDAP addExpirationEventInItem(String expirationEventInItem) {
  ...
  public UpdateAuthMethodLDAP forceSubClaims(@javax.annotation.Nullable Boolean forceSubClaims) {
  ...
  public UpdateAuthMethodLDAP genKey(@javax.annotation.Nullable String genKey) {
    this.genKey = genKey;
    return this;
  }
  ...
  public UpdateAuthMethodLDAP gwBoundIps(@javax.annotation.Nullable List<String> gwBoundIps) {
  ...
  public UpdateAuthMethodLDAP json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public UpdateAuthMethodLDAP jwtTtl(@javax.annotation.Nullable Long jwtTtl) {
    this.jwtTtl = jwtTtl;
    return this;
  }
  ...
  public UpdateAuthMethodLDAP name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateAuthMethodLDAP newName(@javax.annotation.Nullable String newName) {
  ...
  public UpdateAuthMethodLDAP productType(@javax.annotation.Nullable List<String> productType) {
  ...
  public UpdateAuthMethodLDAP publicKeyData(@javax.annotation.Nullable String publicKeyData) {
  ...
  public UpdateAuthMethodLDAP token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public UpdateAuthMethodLDAP uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public UpdateAuthMethodLDAP uniqueIdentifier(@javax.annotation.Nullable String uniqueIdentifier) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessExpires, updateAuthMethodLDAP.accessExpires) &&
        ...
        Objects.equals(this.expirationEventIn, updateAuthMethodLDAP.expirationEventIn) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateAuthMethodLDAP
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateAuthMethodLDAP.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateAuthMethodLDAP is not found in the empty JSON string", UpdateAuthMethodLDAP.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateAuthMethodLDAP.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateAuthMethodLDAP` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateAuthMethodLDAP.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateAuthMethodLDAP.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateAuthMethodLDAP' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateAuthMethodLDAP> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateAuthMethodLDAP.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateAuthMethodLDAP>() {
           @Override
           public void write(JsonWriter out, UpdateAuthMethodLDAP value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateAuthMethodLDAP read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateAuthMethodLDAP given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateAuthMethodLDAP
   * @throws IOException if the JSON string is invalid with respect to UpdateAuthMethodLDAP
   */
  public static UpdateAuthMethodLDAP fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateAuthMethodLDAP.class);
  }

  /**
   * Convert an instance of UpdateAuthMethodLDAP to an JSON string
   *
   * @return JSON string
   */
