...
public class AuthMethodCreateAzureAD {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("access-expires", "allowed-client-type", "audience", "audit-logs-claims", "bound-group-id", "bound-ips", "bound-providers", "bound-resource-id", "bound-resource-names", "bound-resource-types", "bound-rg-id", "bound-spid", "bound-sub-id", "bound-tenant-id", "delete_protection", "description", "expiration-event-in", "force-sub-claims", "gw-bound-ips", "issuer", "json", "jwks-uri", "jwt-ttl", "name", "product-type", "token", "uid-token", "unique-identifier"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("bound-tenant-id", "name"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthMethodCreateAzureAD.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AuthMethodCreateAzureAD is not found in the empty JSON string", AuthMethodCreateAzureAD.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthMethodCreateAzureAD.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AuthMethodCreateAzureAD` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("bound-group-id") != null && !jsonObj.get("bound-group-id").isJsonNull() && !jsonObj.get("bound-group-id").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `bound-group-id` to be an array in the JSON string but got `%s`", jsonObj.get("bound-group-id").toString()));
      }
      // ensure the optional json data is an array if present
      ...
      if (jsonObj.get("bound-providers") != null && !jsonObj.get("bound-providers").isJsonNull() && !jsonObj.get("bound-providers").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `bound-providers` to be an array in the JSON string but got `%s`", jsonObj.get("bound-providers").toString()));
      }
      // ensure the optional json data is an array if present
      ...
      if (jsonObj.get("bound-resource-names") != null && !jsonObj.get("bound-resource-names").isJsonNull() && !jsonObj.get("bound-resource-names").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `bound-resource-names` to be an array in the JSON string but got `%s`", jsonObj.get("bound-resource-names").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("bound-resource-types") != null && !jsonObj.get("bound-resource-types").isJsonNull() && !jsonObj.get("bound-resource-types").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `bound-resource-types` to be an array in the JSON string but got `%s`", jsonObj.get("bound-resource-types").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("bound-rg-id") != null && !jsonObj.get("bound-rg-id").isJsonNull() && !jsonObj.get("bound-rg-id").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `bound-rg-id` to be an array in the JSON string but got `%s`", jsonObj.get("bound-rg-id").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("bound-spid") != null && !jsonObj.get("bound-spid").isJsonNull() && !jsonObj.get("bound-spid").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `bound-spid` to be an array in the JSON string but got `%s`", jsonObj.get("bound-spid").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("bound-sub-id") != null && !jsonObj.get("bound-sub-id").isJsonNull() && !jsonObj.get("bound-sub-id").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `bound-sub-id` to be an array in the JSON string but got `%s`", jsonObj.get("bound-sub-id").toString()));
      }
      if (!jsonObj.get("bound-tenant-id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `bound-tenant-id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("bound-tenant-id").toString()));
      }
      ...
      if ((jsonObj.get("jwks-uri") != null && !jsonObj.get("jwks-uri").isJsonNull()) && !jsonObj.get("jwks-uri").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `jwks-uri` to be a primitive type in the JSON string but got `%s`", jsonObj.get("jwks-uri").toString()));
      }
