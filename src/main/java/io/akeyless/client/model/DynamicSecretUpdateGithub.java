...
public class DynamicSecretUpdateGithub {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("delete_protection", "description", "github-app-id", "github-app-private-key", "github-base-url", "input-rule", "installation-id", "installation-organization", "installation-repository", "item-custom-fields", "json", "name", "new-name", "output-rule", "tags", "target-name", "token", "token-permissions", "token-repositories", "token-ttl", "uid-token"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicSecretUpdateGithub.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicSecretUpdateGithub is not found in the empty JSON string", DynamicSecretUpdateGithub.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicSecretUpdateGithub.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DynamicSecretUpdateGithub` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
