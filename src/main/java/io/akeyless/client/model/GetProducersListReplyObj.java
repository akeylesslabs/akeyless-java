...
public class GetProducersListReplyObj {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("producers", "producers_errors"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetProducersListReplyObj.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetProducersListReplyObj is not found in the empty JSON string", GetProducersListReplyObj.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetProducersListReplyObj.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetProducersListReplyObj` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
