...
public class GatewayUpdateProducerNativeK8S {
  ...
  public GatewayUpdateProducerNativeK8S customUsernameTemplate(@javax.annotation.Nullable String customUsernameTemplate) {
  ...
  public GatewayUpdateProducerNativeK8S deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public GatewayUpdateProducerNativeK8S itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public GatewayUpdateProducerNativeK8S putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public GatewayUpdateProducerNativeK8S json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public GatewayUpdateProducerNativeK8S k8sAllowedNamespaces(@javax.annotation.Nullable String k8sAllowedNamespaces) {
  ...
  public GatewayUpdateProducerNativeK8S k8sClusterCaCert(@javax.annotation.Nullable String k8sClusterCaCert) {
  ...
  public GatewayUpdateProducerNativeK8S k8sClusterEndpoint(@javax.annotation.Nullable String k8sClusterEndpoint) {
  ...
  public GatewayUpdateProducerNativeK8S k8sClusterName(@javax.annotation.Nullable String k8sClusterName) {
  ...
  public GatewayUpdateProducerNativeK8S k8sClusterToken(@javax.annotation.Nullable String k8sClusterToken) {
  ...
  public GatewayUpdateProducerNativeK8S k8sNamespace(@javax.annotation.Nullable String k8sNamespace) {
  ...
  public GatewayUpdateProducerNativeK8S k8sPredefinedRoleName(@javax.annotation.Nullable String k8sPredefinedRoleName) {
  ...
  public GatewayUpdateProducerNativeK8S k8sPredefinedRoleType(@javax.annotation.Nullable String k8sPredefinedRoleType) {
  ...
  public GatewayUpdateProducerNativeK8S k8sRolebindingYamlData(@javax.annotation.Nullable String k8sRolebindingYamlData) {
  ...
  public GatewayUpdateProducerNativeK8S k8sRolebindingYamlDef(@javax.annotation.Nullable String k8sRolebindingYamlDef) {
  ...
  public GatewayUpdateProducerNativeK8S k8sServiceAccount(@javax.annotation.Nullable String k8sServiceAccount) {
  ...
  public GatewayUpdateProducerNativeK8S k8sServiceAccountType(@javax.annotation.Nullable String k8sServiceAccountType) {
  ...
  public GatewayUpdateProducerNativeK8S name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public GatewayUpdateProducerNativeK8S newName(@javax.annotation.Nullable String newName) {
  ...
  public GatewayUpdateProducerNativeK8S producerEncryptionKeyName(@javax.annotation.Nullable String producerEncryptionKeyName) {
  ...
  public GatewayUpdateProducerNativeK8S secureAccessAllowPortForwading(@javax.annotation.Nullable Boolean secureAccessAllowPortForwading) {
  ...
  public GatewayUpdateProducerNativeK8S secureAccessBastionIssuer(@javax.annotation.Nullable String secureAccessBastionIssuer) {
  ...
  public GatewayUpdateProducerNativeK8S secureAccessCertificateIssuer(@javax.annotation.Nullable String secureAccessCertificateIssuer) {
  ...
  public GatewayUpdateProducerNativeK8S secureAccessClusterEndpoint(@javax.annotation.Nullable String secureAccessClusterEndpoint) {
  ...
  public GatewayUpdateProducerNativeK8S secureAccessDashboardUrl(@javax.annotation.Nullable String secureAccessDashboardUrl) {
  ...
  public GatewayUpdateProducerNativeK8S secureAccessDelay(@javax.annotation.Nullable Long secureAccessDelay) {
  ...
  public GatewayUpdateProducerNativeK8S secureAccessEnable(@javax.annotation.Nullable String secureAccessEnable) {
  ...
  public GatewayUpdateProducerNativeK8S secureAccessWeb(@javax.annotation.Nullable Boolean secureAccessWeb) {
  ...
  public GatewayUpdateProducerNativeK8S secureAccessWebBrowsing(@javax.annotation.Nullable Boolean secureAccessWebBrowsing) {
  ...
  public GatewayUpdateProducerNativeK8S secureAccessWebProxy(@javax.annotation.Nullable Boolean secureAccessWebProxy) {
  ...
  public GatewayUpdateProducerNativeK8S tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public GatewayUpdateProducerNativeK8S targetName(@javax.annotation.Nullable String targetName) {
  ...
  public GatewayUpdateProducerNativeK8S token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public GatewayUpdateProducerNativeK8S uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public GatewayUpdateProducerNativeK8S useGwServiceAccount(@javax.annotation.Nullable Boolean useGwServiceAccount) {
  ...
  public GatewayUpdateProducerNativeK8S userTtl(@javax.annotation.Nullable String userTtl) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.customUsernameTemplate, gatewayUpdateProducerNativeK8S.customUsernameTemplate) &&
        ...
        Objects.equals(this.k8sRolebindingYamlData, gatewayUpdateProducerNativeK8S.k8sRolebindingYamlData) &&
        ...
        Objects.equals(this.secureAccessCertificateIssuer, gatewayUpdateProducerNativeK8S.secureAccessCertificateIssuer) &&
        ...
        Objects.equals(this.secureAccessDelay, gatewayUpdateProducerNativeK8S.secureAccessDelay) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to GatewayUpdateProducerNativeK8S
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GatewayUpdateProducerNativeK8S.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GatewayUpdateProducerNativeK8S is not found in the empty JSON string", GatewayUpdateProducerNativeK8S.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GatewayUpdateProducerNativeK8S.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GatewayUpdateProducerNativeK8S` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GatewayUpdateProducerNativeK8S.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GatewayUpdateProducerNativeK8S.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GatewayUpdateProducerNativeK8S' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GatewayUpdateProducerNativeK8S> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GatewayUpdateProducerNativeK8S.class));

       return (TypeAdapter<T>) new TypeAdapter<GatewayUpdateProducerNativeK8S>() {
           @Override
           public void write(JsonWriter out, GatewayUpdateProducerNativeK8S value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GatewayUpdateProducerNativeK8S read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GatewayUpdateProducerNativeK8S given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GatewayUpdateProducerNativeK8S
   * @throws IOException if the JSON string is invalid with respect to GatewayUpdateProducerNativeK8S
   */
  public static GatewayUpdateProducerNativeK8S fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GatewayUpdateProducerNativeK8S.class);
  }

  /**
   * Convert an instance of GatewayUpdateProducerNativeK8S to an JSON string
   *
   * @return JSON string
   */
