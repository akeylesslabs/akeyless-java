...
public class GatewayUpdateProducerMSSQL {
  ...
  public GatewayUpdateProducerMSSQL itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public GatewayUpdateProducerMSSQL putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public GatewayUpdateProducerMSSQL mssqlAllowedDbNames(@javax.annotation.Nullable String mssqlAllowedDbNames) {
  ...
  public GatewayUpdateProducerMSSQL useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public GatewayUpdateProducerMSSQL useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public GatewayUpdateProducerMSSQL useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public GatewayUpdateProducerMSSQL useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.customUsernameTemplate, gatewayUpdateProducerMSSQL.customUsernameTemplate) &&
        ...
        Objects.equals(this.useCapitalLetters, gatewayUpdateProducerMSSQL.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, gatewayUpdateProducerMSSQL.useLowerLetters) &&
        Objects.equals(this.useNumbers, gatewayUpdateProducerMSSQL.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, gatewayUpdateProducerMSSQL.useSpecialCharacters) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GatewayUpdateProducerMSSQL.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GatewayUpdateProducerMSSQL is not found in the empty JSON string", GatewayUpdateProducerMSSQL.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GatewayUpdateProducerMSSQL.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GatewayUpdateProducerMSSQL` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
