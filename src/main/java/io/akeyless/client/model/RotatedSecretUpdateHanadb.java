...
public class RotatedSecretUpdateHanadb {
  ...
  public RotatedSecretUpdateHanadb() {
  }

  public RotatedSecretUpdateHanadb addTag(@javax.annotation.Nullable List<String> addTag) {
    this.addTag = addTag;
    return this;
  }

  public RotatedSecretUpdateHanadb addAddTagItem(String addTagItem) {
    if (this.addTag == null) {
  ...
  public RotatedSecretUpdateHanadb authenticationCredentials(@javax.annotation.Nullable String authenticationCredentials) {
  ...
  public RotatedSecretUpdateHanadb autoRotate(@javax.annotation.Nullable String autoRotate) {
  ...
  public RotatedSecretUpdateHanadb deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public RotatedSecretUpdateHanadb description(@javax.annotation.Nullable String description) {
  ...
  public RotatedSecretUpdateHanadb putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public RotatedSecretUpdateHanadb json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public RotatedSecretUpdateHanadb keepPrevVersion(@javax.annotation.Nullable String keepPrevVersion) {
  ...
  public RotatedSecretUpdateHanadb key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public RotatedSecretUpdateHanadb maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public RotatedSecretUpdateHanadb name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public RotatedSecretUpdateHanadb newName(@javax.annotation.Nullable String newName) {
  ...
  public RotatedSecretUpdateHanadb passwordLength(@javax.annotation.Nullable String passwordLength) {
  ...
  public RotatedSecretUpdateHanadb rmTag(@javax.annotation.Nullable List<String> rmTag) {
    this.rmTag = rmTag;
    return this;
  }

  public RotatedSecretUpdateHanadb addRmTagItem(String rmTagItem) {
    if (this.rmTag == null) {
  ...
  public RotatedSecretUpdateHanadb rotatedPassword(@javax.annotation.Nullable String rotatedPassword) {
  ...
  public RotatedSecretUpdateHanadb rotatedUsername(@javax.annotation.Nullable String rotatedUsername) {
  ...
  public RotatedSecretUpdateHanadb rotationEventIn(@javax.annotation.Nullable List<String> rotationEventIn) {
    this.rotationEventIn = rotationEventIn;
    return this;
  }

  public RotatedSecretUpdateHanadb addRotationEventInItem(String rotationEventInItem) {
  ...
  public RotatedSecretUpdateHanadb rotationHour(@javax.annotation.Nullable Integer rotationHour) {
  ...
  public RotatedSecretUpdateHanadb rotationInterval(@javax.annotation.Nullable String rotationInterval) {
  ...
  public RotatedSecretUpdateHanadb token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public RotatedSecretUpdateHanadb uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public RotatedSecretUpdateHanadb useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public RotatedSecretUpdateHanadb useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public RotatedSecretUpdateHanadb useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public RotatedSecretUpdateHanadb useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    RotatedSecretUpdateHanadb rotatedSecretUpdateHanadb = (RotatedSecretUpdateHanadb) o;
    return Objects.equals(this.addTag, rotatedSecretUpdateHanadb.addTag) &&
        Objects.equals(this.authenticationCredentials, rotatedSecretUpdateHanadb.authenticationCredentials) &&
        ...
        Objects.equals(this.key, rotatedSecretUpdateHanadb.key) &&
        ...
        Objects.equals(this.rotatedUsername, rotatedSecretUpdateHanadb.rotatedUsername) &&
        Objects.equals(this.rotationEventIn, rotatedSecretUpdateHanadb.rotationEventIn) &&
        Objects.equals(this.rotationHour, rotatedSecretUpdateHanadb.rotationHour) &&
        Objects.equals(this.rotationInterval, rotatedSecretUpdateHanadb.rotationInterval) &&
        Objects.equals(this.token, rotatedSecretUpdateHanadb.token) &&
        Objects.equals(this.uidToken, rotatedSecretUpdateHanadb.uidToken) &&
        Objects.equals(this.useCapitalLetters, rotatedSecretUpdateHanadb.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, rotatedSecretUpdateHanadb.useLowerLetters) &&
        Objects.equals(this.useNumbers, rotatedSecretUpdateHanadb.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, rotatedSecretUpdateHanadb.useSpecialCharacters);
  }
  ...
  public String toString() {
    ...
    sb.append("class RotatedSecretUpdateHanadb {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RotatedSecretUpdateHanadb
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RotatedSecretUpdateHanadb.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RotatedSecretUpdateHanadb is not found in the empty JSON string", RotatedSecretUpdateHanadb.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RotatedSecretUpdateHanadb.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RotatedSecretUpdateHanadb` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RotatedSecretUpdateHanadb.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RotatedSecretUpdateHanadb.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RotatedSecretUpdateHanadb' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RotatedSecretUpdateHanadb> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RotatedSecretUpdateHanadb.class));

       return (TypeAdapter<T>) new TypeAdapter<RotatedSecretUpdateHanadb>() {
           @Override
           public void write(JsonWriter out, RotatedSecretUpdateHanadb value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RotatedSecretUpdateHanadb read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RotatedSecretUpdateHanadb given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RotatedSecretUpdateHanadb
   * @throws IOException if the JSON string is invalid with respect to RotatedSecretUpdateHanadb
   */
  public static RotatedSecretUpdateHanadb fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RotatedSecretUpdateHanadb.class);
  }

  /**
   * Convert an instance of RotatedSecretUpdateHanadb to an JSON string
   *
   * @return JSON string
   */
