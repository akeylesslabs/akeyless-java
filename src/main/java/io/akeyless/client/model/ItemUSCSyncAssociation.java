...
public class ItemUSCSyncAssociation {
  ...
  @javax.annotation.Nullable
  private RemoteSecretInfo attributes;
  ...
  public ItemUSCSyncAssociation attributes(@javax.annotation.Nullable RemoteSecretInfo attributes) {
   ...
   */
  @javax.annotation.Nullable
  public RemoteSecretInfo getAttributes() {
    return attributes;
  }

  public void setAttributes(@javax.annotation.Nullable RemoteSecretInfo attributes) {
    this.attributes = attributes;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("attributes") != null && !jsonObj.get("attributes").isJsonNull()) {
        RemoteSecretInfo.validateJsonElement(jsonObj.get("attributes"));
      }
