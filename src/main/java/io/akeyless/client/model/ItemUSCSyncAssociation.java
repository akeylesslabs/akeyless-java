...
public class ItemUSCSyncAssociation {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("assoc_id", "attributes", "delete_remote", "item_id", "item_name", "item_type"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ItemUSCSyncAssociation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ItemUSCSyncAssociation is not found in the empty JSON string", ItemUSCSyncAssociation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ItemUSCSyncAssociation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ItemUSCSyncAssociation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
