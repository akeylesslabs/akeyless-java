...
public class RotatedSecretCreateOpenAI {
  ...
  public RotatedSecretCreateOpenAI() {
  }

  public RotatedSecretCreateOpenAI apiKey(@javax.annotation.Nullable String apiKey) {
    this.apiKey = apiKey;
    return this;
  }
  ...
  public RotatedSecretCreateOpenAI apiKeyId(@javax.annotation.Nullable String apiKeyId) {
  ...
  public RotatedSecretCreateOpenAI authenticationCredentials(@javax.annotation.Nullable String authenticationCredentials) {
  ...
  public RotatedSecretCreateOpenAI autoRotate(@javax.annotation.Nullable String autoRotate) {
  ...
  public RotatedSecretCreateOpenAI deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public RotatedSecretCreateOpenAI description(@javax.annotation.Nullable String description) {
  ...
  public RotatedSecretCreateOpenAI inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public RotatedSecretCreateOpenAI addInputRuleItem(String inputRuleItem) {
  ...
  public RotatedSecretCreateOpenAI itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public RotatedSecretCreateOpenAI putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public RotatedSecretCreateOpenAI json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public RotatedSecretCreateOpenAI key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public RotatedSecretCreateOpenAI maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public RotatedSecretCreateOpenAI name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public RotatedSecretCreateOpenAI outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public RotatedSecretCreateOpenAI addOutputRuleItem(String outputRuleItem) {
  ...
  public RotatedSecretCreateOpenAI passwordLength(@javax.annotation.Nullable String passwordLength) {
  ...
  public RotatedSecretCreateOpenAI rotationEventIn(@javax.annotation.Nullable List<String> rotationEventIn) {
    this.rotationEventIn = rotationEventIn;
    return this;
  }

  public RotatedSecretCreateOpenAI addRotationEventInItem(String rotationEventInItem) {
  ...
  public RotatedSecretCreateOpenAI rotationHour(@javax.annotation.Nullable Integer rotationHour) {
  ...
  public RotatedSecretCreateOpenAI rotationInterval(@javax.annotation.Nullable String rotationInterval) {
  ...
  public RotatedSecretCreateOpenAI rotatorType(@javax.annotation.Nonnull String rotatorType) {
  ...
  public RotatedSecretCreateOpenAI tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }

  public RotatedSecretCreateOpenAI addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public RotatedSecretCreateOpenAI targetName(@javax.annotation.Nonnull String targetName) {
  ...
  public RotatedSecretCreateOpenAI token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public RotatedSecretCreateOpenAI uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public RotatedSecretCreateOpenAI useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public RotatedSecretCreateOpenAI useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public RotatedSecretCreateOpenAI useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public RotatedSecretCreateOpenAI useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    RotatedSecretCreateOpenAI rotatedSecretCreateOpenAI = (RotatedSecretCreateOpenAI) o;
    return Objects.equals(this.apiKey, rotatedSecretCreateOpenAI.apiKey) &&
        Objects.equals(this.apiKeyId, rotatedSecretCreateOpenAI.apiKeyId) &&
        Objects.equals(this.authenticationCredentials, rotatedSecretCreateOpenAI.authenticationCredentials) &&
        Objects.equals(this.autoRotate, rotatedSecretCreateOpenAI.autoRotate) &&
        Objects.equals(this.deleteProtection, rotatedSecretCreateOpenAI.deleteProtection) &&
        Objects.equals(this.description, rotatedSecretCreateOpenAI.description) &&
        Objects.equals(this.inputRule, rotatedSecretCreateOpenAI.inputRule) &&
        Objects.equals(this.itemCustomFields, rotatedSecretCreateOpenAI.itemCustomFields) &&
        Objects.equals(this.json, rotatedSecretCreateOpenAI.json) &&
        Objects.equals(this.key, rotatedSecretCreateOpenAI.key) &&
        Objects.equals(this.maxVersions, rotatedSecretCreateOpenAI.maxVersions) &&
        Objects.equals(this.name, rotatedSecretCreateOpenAI.name) &&
        Objects.equals(this.outputRule, rotatedSecretCreateOpenAI.outputRule) &&
        Objects.equals(this.passwordLength, rotatedSecretCreateOpenAI.passwordLength) &&
        Objects.equals(this.rotationEventIn, rotatedSecretCreateOpenAI.rotationEventIn) &&
        Objects.equals(this.rotationHour, rotatedSecretCreateOpenAI.rotationHour) &&
        Objects.equals(this.rotationInterval, rotatedSecretCreateOpenAI.rotationInterval) &&
        Objects.equals(this.rotatorType, rotatedSecretCreateOpenAI.rotatorType) &&
        Objects.equals(this.tags, rotatedSecretCreateOpenAI.tags) &&
        Objects.equals(this.targetName, rotatedSecretCreateOpenAI.targetName) &&
        Objects.equals(this.token, rotatedSecretCreateOpenAI.token) &&
        Objects.equals(this.uidToken, rotatedSecretCreateOpenAI.uidToken) &&
        Objects.equals(this.useCapitalLetters, rotatedSecretCreateOpenAI.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, rotatedSecretCreateOpenAI.useLowerLetters) &&
        Objects.equals(this.useNumbers, rotatedSecretCreateOpenAI.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, rotatedSecretCreateOpenAI.useSpecialCharacters);
  }

  @Override
  public int hashCode() {
    return Objects.hash(apiKey, apiKeyId, authenticationCredentials, autoRotate, deleteProtection, description, inputRule, itemCustomFields, json, key, maxVersions, name, outputRule, passwordLength, rotationEventIn, rotationHour, rotationInterval, rotatorType, tags, targetName, token, uidToken, useCapitalLetters, useLowerLetters, useNumbers, useSpecialCharacters);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RotatedSecretCreateOpenAI {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RotatedSecretCreateOpenAI
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RotatedSecretCreateOpenAI.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RotatedSecretCreateOpenAI is not found in the empty JSON string", RotatedSecretCreateOpenAI.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RotatedSecretCreateOpenAI.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RotatedSecretCreateOpenAI` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RotatedSecretCreateOpenAI.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RotatedSecretCreateOpenAI.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RotatedSecretCreateOpenAI' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RotatedSecretCreateOpenAI> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RotatedSecretCreateOpenAI.class));

       return (TypeAdapter<T>) new TypeAdapter<RotatedSecretCreateOpenAI>() {
           @Override
           public void write(JsonWriter out, RotatedSecretCreateOpenAI value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RotatedSecretCreateOpenAI read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RotatedSecretCreateOpenAI given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RotatedSecretCreateOpenAI
   * @throws IOException if the JSON string is invalid with respect to RotatedSecretCreateOpenAI
   */
  public static RotatedSecretCreateOpenAI fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RotatedSecretCreateOpenAI.class);
  }

  /**
   * Convert an instance of RotatedSecretCreateOpenAI to an JSON string
   *
   * @return JSON string
   */
