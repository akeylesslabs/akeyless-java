...
public class GatewayCreateProducerRedis {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(aclRules, customUsernameTemplate, deleteProtection, host, json, name, password, passwordLength, port, producerEncryptionKeyName, ssl, sslCertificate, tags, targetName, token, uidToken, userTtl, username);
  }
