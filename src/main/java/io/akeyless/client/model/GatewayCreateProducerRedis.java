...
public class GatewayCreateProducerRedis {
  ...
  public GatewayCreateProducerRedis customUsernameTemplate(@javax.annotation.Nullable String customUsernameTemplate) {
  ...
  public GatewayCreateProducerRedis putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public GatewayCreateProducerRedis useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public GatewayCreateProducerRedis useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public GatewayCreateProducerRedis useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public GatewayCreateProducerRedis useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.aclRules, gatewayCreateProducerRedis.aclRules) &&
        ...
        Objects.equals(this.useCapitalLetters, gatewayCreateProducerRedis.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, gatewayCreateProducerRedis.useLowerLetters) &&
        Objects.equals(this.useNumbers, gatewayCreateProducerRedis.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, gatewayCreateProducerRedis.useSpecialCharacters) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GatewayCreateProducerRedis.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GatewayCreateProducerRedis is not found in the empty JSON string", GatewayCreateProducerRedis.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GatewayCreateProducerRedis.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GatewayCreateProducerRedis` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
