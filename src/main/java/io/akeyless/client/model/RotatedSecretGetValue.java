...
public class RotatedSecretGetValue {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("host", "ignore-cache", "json", "name", "token", "uid-token", "version"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RotatedSecretGetValue.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RotatedSecretGetValue is not found in the empty JSON string", RotatedSecretGetValue.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RotatedSecretGetValue.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RotatedSecretGetValue` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
