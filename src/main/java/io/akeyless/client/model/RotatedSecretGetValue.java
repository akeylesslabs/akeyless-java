...
public class RotatedSecretGetValue {
  ...
  public RotatedSecretGetValue host(String host) {
  ...
  **/
  ...
  public RotatedSecretGetValue ignoreCache(String ignoreCache) {
  ...
  **/
  ...
  public RotatedSecretGetValue json(Boolean json) {
  ...
  **/
  ...
  public RotatedSecretGetValue name(String name) {
  ...
  **/
  ...
  public RotatedSecretGetValue token(String token) {
  ...
  **/
  ...
  public RotatedSecretGetValue uidToken(String uidToken) {
  ...
  **/
  ...
  public RotatedSecretGetValue version(Integer version) {
