...
public class RotatedSecretUpdateCustom {
  ...
  public RotatedSecretUpdateCustom addTag(@javax.annotation.Nullable List<String> addTag) {
    this.addTag = addTag;
    return this;
  }
  ...
  public RotatedSecretUpdateCustom authenticationCredentials(@javax.annotation.Nullable String authenticationCredentials) {
  ...
  public RotatedSecretUpdateCustom autoRotate(@javax.annotation.Nullable String autoRotate) {
  ...
  public RotatedSecretUpdateCustom customPayload(@javax.annotation.Nullable String customPayload) {
  ...
  public RotatedSecretUpdateCustom deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public RotatedSecretUpdateCustom description(@javax.annotation.Nullable String description) {
  ...
  public RotatedSecretUpdateCustom enablePasswordPolicy(@javax.annotation.Nullable String enablePasswordPolicy) {
  ...
  public RotatedSecretUpdateCustom inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public RotatedSecretUpdateCustom addInputRuleItem(String inputRuleItem) {
  ...
  public RotatedSecretUpdateCustom itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public RotatedSecretUpdateCustom putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public RotatedSecretUpdateCustom json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public RotatedSecretUpdateCustom keepPrevVersion(@javax.annotation.Nullable String keepPrevVersion) {
  ...
  public RotatedSecretUpdateCustom key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public RotatedSecretUpdateCustom lockDuringSraSession(@javax.annotation.Nullable String lockDuringSraSession) {
  ...
  public RotatedSecretUpdateCustom maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public RotatedSecretUpdateCustom name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public RotatedSecretUpdateCustom newName(@javax.annotation.Nullable String newName) {
  ...
  public RotatedSecretUpdateCustom outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public RotatedSecretUpdateCustom addOutputRuleItem(String outputRuleItem) {
  ...
  public RotatedSecretUpdateCustom passwordLength(@javax.annotation.Nullable String passwordLength) {
  ...
  public RotatedSecretUpdateCustom rmTag(@javax.annotation.Nullable List<String> rmTag) {
    this.rmTag = rmTag;
    return this;
  }
  ...
  public RotatedSecretUpdateCustom rotateAfterDisconnect(@javax.annotation.Nullable String rotateAfterDisconnect) {
  ...
  public RotatedSecretUpdateCustom rotationEventIn(@javax.annotation.Nullable List<String> rotationEventIn) {
    this.rotationEventIn = rotationEventIn;
    return this;
  }

  public RotatedSecretUpdateCustom addRotationEventInItem(String rotationEventInItem) {
  ...
  public RotatedSecretUpdateCustom rotationHour(@javax.annotation.Nullable Integer rotationHour) {
  ...
  public RotatedSecretUpdateCustom rotationInterval(@javax.annotation.Nullable String rotationInterval) {
  ...
  public RotatedSecretUpdateCustom secureAccessAllowExternalUser(@javax.annotation.Nullable Boolean secureAccessAllowExternalUser) {
  ...
  public RotatedSecretUpdateCustom secureAccessBastionIssuer(@javax.annotation.Nullable String secureAccessBastionIssuer) {
  ...
  public RotatedSecretUpdateCustom secureAccessCertificateIssuer(@javax.annotation.Nullable String secureAccessCertificateIssuer) {
  ...
  public RotatedSecretUpdateCustom secureAccessEnable(@javax.annotation.Nullable String secureAccessEnable) {
  ...
  public RotatedSecretUpdateCustom secureAccessHost(@javax.annotation.Nullable List<String> secureAccessHost) {
  ...
  public RotatedSecretUpdateCustom secureAccessRdpDomain(@javax.annotation.Nullable String secureAccessRdpDomain) {
  ...
  public RotatedSecretUpdateCustom secureAccessRdpUser(@javax.annotation.Nullable String secureAccessRdpUser) {
  ...
  public RotatedSecretUpdateCustom secureAccessSshUser(@javax.annotation.Nullable String secureAccessSshUser) {
  ...
  public RotatedSecretUpdateCustom secureAccessUrl(@javax.annotation.Nullable String secureAccessUrl) {
  ...
  public RotatedSecretUpdateCustom secureAccessWeb(@javax.annotation.Nullable Boolean secureAccessWeb) {
  ...
  public RotatedSecretUpdateCustom secureAccessWebBrowsing(@javax.annotation.Nullable Boolean secureAccessWebBrowsing) {
  ...
  public RotatedSecretUpdateCustom secureAccessWebProxy(@javax.annotation.Nullable Boolean secureAccessWebProxy) {
  ...
  public RotatedSecretUpdateCustom timeoutSec(@javax.annotation.Nullable Long timeoutSec) {
  ...
  public RotatedSecretUpdateCustom token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public RotatedSecretUpdateCustom uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public RotatedSecretUpdateCustom useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public RotatedSecretUpdateCustom useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public RotatedSecretUpdateCustom useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public RotatedSecretUpdateCustom useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.addTag, rotatedSecretUpdateCustom.addTag) &&
        ...
        Objects.equals(this.enablePasswordPolicy, rotatedSecretUpdateCustom.enablePasswordPolicy) &&
        Objects.equals(this.inputRule, rotatedSecretUpdateCustom.inputRule) &&
        Objects.equals(this.itemCustomFields, rotatedSecretUpdateCustom.itemCustomFields) &&
        ...
        Objects.equals(this.lockDuringSraSession, rotatedSecretUpdateCustom.lockDuringSraSession) &&
        ...
        Objects.equals(this.outputRule, rotatedSecretUpdateCustom.outputRule) &&
        ...
        Objects.equals(this.rotationEventIn, rotatedSecretUpdateCustom.rotationEventIn) &&
        ...
        Objects.equals(this.secureAccessCertificateIssuer, rotatedSecretUpdateCustom.secureAccessCertificateIssuer) &&
        ...
        Objects.equals(this.timeoutSec, rotatedSecretUpdateCustom.timeoutSec) &&
        Objects.equals(this.token, rotatedSecretUpdateCustom.token) &&
        Objects.equals(this.uidToken, rotatedSecretUpdateCustom.uidToken) &&
        Objects.equals(this.useCapitalLetters, rotatedSecretUpdateCustom.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, rotatedSecretUpdateCustom.useLowerLetters) &&
        Objects.equals(this.useNumbers, rotatedSecretUpdateCustom.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, rotatedSecretUpdateCustom.useSpecialCharacters);
  }

  @Override
  public int hashCode() {
    return Objects.hash(addTag, authenticationCredentials, autoRotate, customPayload, deleteProtection, description, enablePasswordPolicy, inputRule, itemCustomFields, json, keepPrevVersion, key, lockDuringSraSession, maxVersions, name, newName, outputRule, passwordLength, rmTag, rotateAfterDisconnect, rotationEventIn, rotationHour, rotationInterval, secureAccessAllowExternalUser, secureAccessBastionIssuer, secureAccessCertificateIssuer, secureAccessEnable, secureAccessHost, secureAccessRdpDomain, secureAccessRdpUser, secureAccessSshUser, secureAccessUrl, secureAccessWeb, secureAccessWebBrowsing, secureAccessWebProxy, timeoutSec, token, uidToken, useCapitalLetters, useLowerLetters, useNumbers, useSpecialCharacters);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("add-tag", "authentication-credentials", "auto-rotate", "custom-payload", "delete_protection", "description", "enable-password-policy", "input-rule", "item-custom-fields", "json", "keep-prev-version", "key", "lock-during-sra-session", "max-versions", "name", "new-name", "output-rule", "password-length", "rm-tag", "rotate-after-disconnect", "rotation-event-in", "rotation-hour", "rotation-interval", "secure-access-allow-external-user", "secure-access-bastion-issuer", "secure-access-certificate-issuer", "secure-access-enable", "secure-access-host", "secure-access-rdp-domain", "secure-access-rdp-user", "secure-access-ssh-user", "secure-access-url", "secure-access-web", "secure-access-web-browsing", "secure-access-web-proxy", "timeout-sec", "token", "uid-token", "use-capital-letters", "use-lower-letters", "use-numbers", "use-special-characters"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to RotatedSecretUpdateCustom
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RotatedSecretUpdateCustom.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RotatedSecretUpdateCustom is not found in the empty JSON string", RotatedSecretUpdateCustom.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RotatedSecretUpdateCustom.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RotatedSecretUpdateCustom` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RotatedSecretUpdateCustom.openapiRequiredFields) {
      ...
      if ((jsonObj.get("enable-password-policy") != null && !jsonObj.get("enable-password-policy").isJsonNull()) && !jsonObj.get("enable-password-policy").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `enable-password-policy` to be a primitive type in the JSON string but got `%s`", jsonObj.get("enable-password-policy").toString()));
      }
      // ensure the optional json data is an array if present
      ...
      if ((jsonObj.get("secure-access-ssh-user") != null && !jsonObj.get("secure-access-ssh-user").isJsonNull()) && !jsonObj.get("secure-access-ssh-user").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `secure-access-ssh-user` to be a primitive type in the JSON string but got `%s`", jsonObj.get("secure-access-ssh-user").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RotatedSecretUpdateCustom.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RotatedSecretUpdateCustom' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RotatedSecretUpdateCustom> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RotatedSecretUpdateCustom.class));

       return (TypeAdapter<T>) new TypeAdapter<RotatedSecretUpdateCustom>() {
           @Override
           public void write(JsonWriter out, RotatedSecretUpdateCustom value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RotatedSecretUpdateCustom read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RotatedSecretUpdateCustom given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RotatedSecretUpdateCustom
   * @throws IOException if the JSON string is invalid with respect to RotatedSecretUpdateCustom
   */
  public static RotatedSecretUpdateCustom fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RotatedSecretUpdateCustom.class);
  }

  /**
   * Convert an instance of RotatedSecretUpdateCustom to an JSON string
   *
   * @return JSON string
   */
