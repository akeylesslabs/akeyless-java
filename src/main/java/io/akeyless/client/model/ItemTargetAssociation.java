...
public class ItemTargetAssociation {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("assoc_id", "attributes", "target_id", "target_name", "target_type"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ItemTargetAssociation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ItemTargetAssociation is not found in the empty JSON string", ItemTargetAssociation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ItemTargetAssociation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ItemTargetAssociation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
