...
public class GatewayCreateProducerDockerhub {
  ...
  public GatewayCreateProducerDockerhub deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public GatewayCreateProducerDockerhub dockerhubPassword(@javax.annotation.Nullable String dockerhubPassword) {
  ...
  public GatewayCreateProducerDockerhub dockerhubTokenScopes(@javax.annotation.Nullable String dockerhubTokenScopes) {
  ...
  public GatewayCreateProducerDockerhub dockerhubUsername(@javax.annotation.Nullable String dockerhubUsername) {
  ...
  public GatewayCreateProducerDockerhub inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public GatewayCreateProducerDockerhub addInputRuleItem(String inputRuleItem) {
  ...
  public GatewayCreateProducerDockerhub json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public GatewayCreateProducerDockerhub name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public GatewayCreateProducerDockerhub outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public GatewayCreateProducerDockerhub addOutputRuleItem(String outputRuleItem) {
  ...
  public GatewayCreateProducerDockerhub producerEncryptionKeyName(@javax.annotation.Nullable String producerEncryptionKeyName) {
  ...
  public GatewayCreateProducerDockerhub tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public GatewayCreateProducerDockerhub targetName(@javax.annotation.Nullable String targetName) {
  ...
  public GatewayCreateProducerDockerhub token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public GatewayCreateProducerDockerhub uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public GatewayCreateProducerDockerhub userTtl(@javax.annotation.Nullable String userTtl) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.deleteProtection, gatewayCreateProducerDockerhub.deleteProtection) &&
        ...
        Objects.equals(this.inputRule, gatewayCreateProducerDockerhub.inputRule) &&
        ...
        Objects.equals(this.outputRule, gatewayCreateProducerDockerhub.outputRule) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(deleteProtection, dockerhubPassword, dockerhubTokenScopes, dockerhubUsername, inputRule, itemCustomFields, json, name, outputRule, producerEncryptionKeyName, tags, targetName, token, uidToken, userTtl);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("delete_protection", "dockerhub-password", "dockerhub-token-scopes", "dockerhub-username", "input-rule", "item-custom-fields", "json", "name", "output-rule", "producer-encryption-key-name", "tags", "target-name", "token", "uid-token", "user-ttl"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to GatewayCreateProducerDockerhub
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GatewayCreateProducerDockerhub.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GatewayCreateProducerDockerhub is not found in the empty JSON string", GatewayCreateProducerDockerhub.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GatewayCreateProducerDockerhub.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GatewayCreateProducerDockerhub` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GatewayCreateProducerDockerhub.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GatewayCreateProducerDockerhub.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GatewayCreateProducerDockerhub' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GatewayCreateProducerDockerhub> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GatewayCreateProducerDockerhub.class));

       return (TypeAdapter<T>) new TypeAdapter<GatewayCreateProducerDockerhub>() {
           @Override
           public void write(JsonWriter out, GatewayCreateProducerDockerhub value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GatewayCreateProducerDockerhub read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GatewayCreateProducerDockerhub given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GatewayCreateProducerDockerhub
   * @throws IOException if the JSON string is invalid with respect to GatewayCreateProducerDockerhub
   */
  public static GatewayCreateProducerDockerhub fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GatewayCreateProducerDockerhub.class);
  }

  /**
   * Convert an instance of GatewayCreateProducerDockerhub to an JSON string
   *
   * @return JSON string
   */
