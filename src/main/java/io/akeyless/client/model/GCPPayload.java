...
public class GCPPayload {
  ...
  public GCPPayload gcpCredentialsJson(@javax.annotation.Nullable String gcpCredentialsJson) {
  ...
  public void setGcpCredentialsJson(@javax.annotation.Nullable String gcpCredentialsJson) {
    this.gcpCredentialsJson = gcpCredentialsJson;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GCPPayload
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GCPPayload.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GCPPayload' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GCPPayload> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GCPPayload.class));

       return (TypeAdapter<T>) new TypeAdapter<GCPPayload>() {
           @Override
           public void write(JsonWriter out, GCPPayload value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GCPPayload read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GCPPayload given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GCPPayload
   * @throws IOException if the JSON string is invalid with respect to GCPPayload
   */
  public static GCPPayload fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GCPPayload.class);
  }

  /**
   * Convert an instance of GCPPayload to an JSON string
   *
   * @return JSON string
   */
