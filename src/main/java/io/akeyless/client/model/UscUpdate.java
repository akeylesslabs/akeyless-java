...
public class UscUpdate {
  ...
  public UscUpdate uscEncryptionKey(@javax.annotation.Nullable String uscEncryptionKey) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.binaryValue, uscUpdate.binaryValue) &&
        ...
        Objects.equals(this.uscEncryptionKey, uscUpdate.uscEncryptionKey) &&
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("binary-value", "description", "json", "namespace", "object-type", "pfx-password", "remote-secret-activation-date", "remote-secret-expires", "secret-id", "selected-repositories", "tags", "token", "uid-token", "usc-encryption-key", "usc-name", "value"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("secret-id", "usc-name", "value"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UscUpdate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UscUpdate is not found in the empty JSON string", UscUpdate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UscUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UscUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
