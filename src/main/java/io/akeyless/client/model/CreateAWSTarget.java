...
public class CreateAWSTarget {
  ...
  public CreateAWSTarget accessKey(@javax.annotation.Nonnull String accessKey) {
  ...
  public CreateAWSTarget accessKeyId(@javax.annotation.Nonnull String accessKeyId) {
  ...
  public CreateAWSTarget comment(@javax.annotation.Nullable String comment) {
  ...
  public CreateAWSTarget description(@javax.annotation.Nullable String description) {
  ...
  public CreateAWSTarget generateExternalId(@javax.annotation.Nullable Boolean generateExternalId) {
  ...
  public CreateAWSTarget json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public CreateAWSTarget key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public CreateAWSTarget maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public CreateAWSTarget name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateAWSTarget region(@javax.annotation.Nullable String region) {
    this.region = region;
    return this;
  }
  ...
  public CreateAWSTarget roleArn(@javax.annotation.Nullable String roleArn) {
  ...
  public CreateAWSTarget sessionToken(@javax.annotation.Nullable String sessionToken) {
  ...
  public CreateAWSTarget token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public CreateAWSTarget uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public CreateAWSTarget useGwCloudIdentity(@javax.annotation.Nullable Boolean useGwCloudIdentity) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessKey, createAWSTarget.accessKey) &&
        ...
        Objects.equals(this.generateExternalId, createAWSTarget.generateExternalId) &&
        ...
        Objects.equals(this.roleArn, createAWSTarget.roleArn) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessKey, accessKeyId, comment, description, generateExternalId, json, key, maxVersions, name, region, roleArn, sessionToken, token, uidToken, useGwCloudIdentity);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("access-key", "access-key-id", "comment", "description", "generate-external-id", "json", "key", "max-versions", "name", "region", "role-arn", "session-token", "token", "uid-token", "use-gw-cloud-identity"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateAWSTarget
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateAWSTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateAWSTarget is not found in the empty JSON string", CreateAWSTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateAWSTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateAWSTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateAWSTarget.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateAWSTarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateAWSTarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateAWSTarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateAWSTarget.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateAWSTarget>() {
           @Override
           public void write(JsonWriter out, CreateAWSTarget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateAWSTarget read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateAWSTarget given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateAWSTarget
   * @throws IOException if the JSON string is invalid with respect to CreateAWSTarget
   */
  public static CreateAWSTarget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAWSTarget.class);
  }

  /**
   * Convert an instance of CreateAWSTarget to an JSON string
   *
   * @return JSON string
   */
