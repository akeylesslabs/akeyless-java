...
public class TargetUpdateAzure {
  ...
  public TargetUpdateAzure connectionType(@javax.annotation.Nullable String connectionType) {
  ...
  public TargetUpdateAzure deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.azureCloud, targetUpdateAzure.azureCloud) &&
        ...
        Objects.equals(this.deleteProtection, targetUpdateAzure.deleteProtection) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(azureCloud, clientId, clientSecret, connectionType, deleteProtection, description, json, keepPrevVersion, key, maxVersions, name, newName, resourceGroupName, resourceName, subscriptionId, tenantId, token, uidToken, useGwCloudIdentity);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("azure-cloud", "client-id", "client-secret", "connection-type", "delete_protection", "description", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "resource-group-name", "resource-name", "subscription-id", "tenant-id", "token", "uid-token", "use-gw-cloud-identity"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TargetUpdateAzure.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TargetUpdateAzure is not found in the empty JSON string", TargetUpdateAzure.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TargetUpdateAzure.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TargetUpdateAzure` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
