...
public class AuthMethodCreateGcp {
  ...
  public AuthMethodCreateGcp() {
  }

  public AuthMethodCreateGcp accessExpires(@javax.annotation.Nullable Long accessExpires) {
  ...
  public AuthMethodCreateGcp allowedClientType(@javax.annotation.Nullable List<String> allowedClientType) {
    this.allowedClientType = allowedClientType;
    return this;
  }

  public AuthMethodCreateGcp addAllowedClientTypeItem(String allowedClientTypeItem) {
  ...
  public AuthMethodCreateGcp audience(@javax.annotation.Nonnull String audience) {
  ...
  public AuthMethodCreateGcp auditLogsClaims(@javax.annotation.Nullable List<String> auditLogsClaims) {
    this.auditLogsClaims = auditLogsClaims;
    return this;
  }

  public AuthMethodCreateGcp addAuditLogsClaimsItem(String auditLogsClaimsItem) {
  ...
  public AuthMethodCreateGcp boundIps(@javax.annotation.Nullable List<String> boundIps) {
    this.boundIps = boundIps;
    return this;
  }

  public AuthMethodCreateGcp addBoundIpsItem(String boundIpsItem) {
  ...
  public AuthMethodCreateGcp boundLabels(@javax.annotation.Nullable List<String> boundLabels) {
    this.boundLabels = boundLabels;
    return this;
  }

  public AuthMethodCreateGcp addBoundLabelsItem(String boundLabelsItem) {
  ...
  public AuthMethodCreateGcp boundProjects(@javax.annotation.Nullable List<String> boundProjects) {
    this.boundProjects = boundProjects;
    return this;
  }

  public AuthMethodCreateGcp addBoundProjectsItem(String boundProjectsItem) {
  ...
  public AuthMethodCreateGcp boundRegions(@javax.annotation.Nullable List<String> boundRegions) {
    this.boundRegions = boundRegions;
    return this;
  }

  public AuthMethodCreateGcp addBoundRegionsItem(String boundRegionsItem) {
  ...
  public AuthMethodCreateGcp boundServiceAccounts(@javax.annotation.Nullable List<String> boundServiceAccounts) {
    this.boundServiceAccounts = boundServiceAccounts;
    return this;
  }

  public AuthMethodCreateGcp addBoundServiceAccountsItem(String boundServiceAccountsItem) {
  ...
  public AuthMethodCreateGcp boundZones(@javax.annotation.Nullable List<String> boundZones) {
    this.boundZones = boundZones;
    return this;
  }

  public AuthMethodCreateGcp addBoundZonesItem(String boundZonesItem) {
  ...
  public AuthMethodCreateGcp deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public AuthMethodCreateGcp description(@javax.annotation.Nullable String description) {
  ...
  public AuthMethodCreateGcp expirationEventIn(@javax.annotation.Nullable List<String> expirationEventIn) {
    this.expirationEventIn = expirationEventIn;
    return this;
  }

  public AuthMethodCreateGcp addExpirationEventInItem(String expirationEventInItem) {
  ...
  public AuthMethodCreateGcp forceSubClaims(@javax.annotation.Nullable Boolean forceSubClaims) {
  ...
  public AuthMethodCreateGcp gwBoundIps(@javax.annotation.Nullable List<String> gwBoundIps) {
    this.gwBoundIps = gwBoundIps;
    return this;
  }

  public AuthMethodCreateGcp addGwBoundIpsItem(String gwBoundIpsItem) {
  ...
  public AuthMethodCreateGcp json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public AuthMethodCreateGcp jwtTtl(@javax.annotation.Nullable Long jwtTtl) {
    this.jwtTtl = jwtTtl;
    return this;
  }
  ...
  public AuthMethodCreateGcp name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public AuthMethodCreateGcp productType(@javax.annotation.Nullable List<String> productType) {
    this.productType = productType;
    return this;
  }

  public AuthMethodCreateGcp addProductTypeItem(String productTypeItem) {
  ...
  public AuthMethodCreateGcp serviceAccountCredsData(@javax.annotation.Nullable String serviceAccountCredsData) {
  ...
  public AuthMethodCreateGcp token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public AuthMethodCreateGcp type(@javax.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public AuthMethodCreateGcp uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public AuthMethodCreateGcp uniqueIdentifier(@javax.annotation.Nullable String uniqueIdentifier) {
  ...
  public boolean equals(Object o) {
    ...
    AuthMethodCreateGcp authMethodCreateGcp = (AuthMethodCreateGcp) o;
    return Objects.equals(this.accessExpires, authMethodCreateGcp.accessExpires) &&
        Objects.equals(this.allowedClientType, authMethodCreateGcp.allowedClientType) &&
        Objects.equals(this.audience, authMethodCreateGcp.audience) &&
        Objects.equals(this.auditLogsClaims, authMethodCreateGcp.auditLogsClaims) &&
        Objects.equals(this.boundIps, authMethodCreateGcp.boundIps) &&
        Objects.equals(this.boundLabels, authMethodCreateGcp.boundLabels) &&
        Objects.equals(this.boundProjects, authMethodCreateGcp.boundProjects) &&
        Objects.equals(this.boundRegions, authMethodCreateGcp.boundRegions) &&
        Objects.equals(this.boundServiceAccounts, authMethodCreateGcp.boundServiceAccounts) &&
        Objects.equals(this.boundZones, authMethodCreateGcp.boundZones) &&
        Objects.equals(this.deleteProtection, authMethodCreateGcp.deleteProtection) &&
        Objects.equals(this.description, authMethodCreateGcp.description) &&
        Objects.equals(this.expirationEventIn, authMethodCreateGcp.expirationEventIn) &&
        Objects.equals(this.forceSubClaims, authMethodCreateGcp.forceSubClaims) &&
        Objects.equals(this.gwBoundIps, authMethodCreateGcp.gwBoundIps) &&
        Objects.equals(this.json, authMethodCreateGcp.json) &&
        Objects.equals(this.jwtTtl, authMethodCreateGcp.jwtTtl) &&
        Objects.equals(this.name, authMethodCreateGcp.name) &&
        Objects.equals(this.productType, authMethodCreateGcp.productType) &&
        Objects.equals(this.serviceAccountCredsData, authMethodCreateGcp.serviceAccountCredsData) &&
        Objects.equals(this.token, authMethodCreateGcp.token) &&
        Objects.equals(this.type, authMethodCreateGcp.type) &&
        Objects.equals(this.uidToken, authMethodCreateGcp.uidToken) &&
        Objects.equals(this.uniqueIdentifier, authMethodCreateGcp.uniqueIdentifier);
  }
  ...
  public String toString() {
    ...
    sb.append("class AuthMethodCreateGcp {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AuthMethodCreateGcp
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthMethodCreateGcp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AuthMethodCreateGcp is not found in the empty JSON string", AuthMethodCreateGcp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthMethodCreateGcp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AuthMethodCreateGcp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AuthMethodCreateGcp.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuthMethodCreateGcp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuthMethodCreateGcp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuthMethodCreateGcp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuthMethodCreateGcp.class));

       return (TypeAdapter<T>) new TypeAdapter<AuthMethodCreateGcp>() {
           @Override
           public void write(JsonWriter out, AuthMethodCreateGcp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AuthMethodCreateGcp read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AuthMethodCreateGcp given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AuthMethodCreateGcp
   * @throws IOException if the JSON string is invalid with respect to AuthMethodCreateGcp
   */
  public static AuthMethodCreateGcp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuthMethodCreateGcp.class);
  }

  /**
   * Convert an instance of AuthMethodCreateGcp to an JSON string
   *
   * @return JSON string
   */
