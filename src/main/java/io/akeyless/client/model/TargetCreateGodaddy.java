...
public class TargetCreateGodaddy {
  ...
  public TargetCreateGodaddy() {
  }

  public TargetCreateGodaddy apiKey(@javax.annotation.Nonnull String apiKey) {
    this.apiKey = apiKey;
    return this;
  }
  ...
  public TargetCreateGodaddy customerId(@javax.annotation.Nullable String customerId) {
  ...
  public TargetCreateGodaddy description(@javax.annotation.Nullable String description) {
  ...
  public TargetCreateGodaddy imapFqdn(@javax.annotation.Nonnull String imapFqdn) {
  ...
  public TargetCreateGodaddy imapPassword(@javax.annotation.Nonnull String imapPassword) {
  ...
  public TargetCreateGodaddy imapPort(@javax.annotation.Nullable String imapPort) {
  ...
  public TargetCreateGodaddy imapUsername(@javax.annotation.Nonnull String imapUsername) {
  ...
  public TargetCreateGodaddy json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public TargetCreateGodaddy key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public TargetCreateGodaddy maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public TargetCreateGodaddy name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public TargetCreateGodaddy secret(@javax.annotation.Nonnull String secret) {
    this.secret = secret;
    return this;
  }
  ...
  public TargetCreateGodaddy timeout(@javax.annotation.Nullable String timeout) {
  ...
  public TargetCreateGodaddy token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public TargetCreateGodaddy uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.apiKey, targetCreateGodaddy.apiKey) &&
        ...
        Objects.equals(this.imapPort, targetCreateGodaddy.imapPort) &&
        Objects.equals(this.imapUsername, targetCreateGodaddy.imapUsername) &&
        Objects.equals(this.json, targetCreateGodaddy.json) &&
        Objects.equals(this.key, targetCreateGodaddy.key) &&
        Objects.equals(this.maxVersions, targetCreateGodaddy.maxVersions) &&
        Objects.equals(this.name, targetCreateGodaddy.name) &&
        Objects.equals(this.secret, targetCreateGodaddy.secret) &&
        Objects.equals(this.timeout, targetCreateGodaddy.timeout) &&
        Objects.equals(this.token, targetCreateGodaddy.token) &&
        Objects.equals(this.uidToken, targetCreateGodaddy.uidToken);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("api-key", "customer_id", "delete_protection", "description", "imap-fqdn", "imap-password", "imap-port", "imap-username", "json", "key", "max-versions", "name", "secret", "timeout", "token", "uid-token"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to TargetCreateGodaddy
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TargetCreateGodaddy.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TargetCreateGodaddy is not found in the empty JSON string", TargetCreateGodaddy.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TargetCreateGodaddy.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TargetCreateGodaddy` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TargetCreateGodaddy.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TargetCreateGodaddy.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TargetCreateGodaddy' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TargetCreateGodaddy> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TargetCreateGodaddy.class));

       return (TypeAdapter<T>) new TypeAdapter<TargetCreateGodaddy>() {
           @Override
           public void write(JsonWriter out, TargetCreateGodaddy value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TargetCreateGodaddy read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TargetCreateGodaddy given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TargetCreateGodaddy
   * @throws IOException if the JSON string is invalid with respect to TargetCreateGodaddy
   */
  public static TargetCreateGodaddy fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TargetCreateGodaddy.class);
  }

  /**
   * Convert an instance of TargetCreateGodaddy to an JSON string
   *
   * @return JSON string
   */
