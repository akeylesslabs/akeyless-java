...
public class UpdateAuthMethodCert {
  ...
  public UpdateAuthMethodCert allowedClientType(@javax.annotation.Nullable List<String> allowedClientType) {
    this.allowedClientType = allowedClientType;
    return this;
  }

  public UpdateAuthMethodCert addAllowedClientTypeItem(String allowedClientTypeItem) {
  ...
  public UpdateAuthMethodCert requireCrlDp(@javax.annotation.Nullable Boolean requireCrlDp) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessExpires, updateAuthMethodCert.accessExpires) &&
        Objects.equals(this.allowedClientType, updateAuthMethodCert.allowedClientType) &&
        ...
        Objects.equals(this.requireCrlDp, updateAuthMethodCert.requireCrlDp) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateAuthMethodCert.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateAuthMethodCert is not found in the empty JSON string", UpdateAuthMethodCert.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateAuthMethodCert.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateAuthMethodCert` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
