...
public class Role {
  ...
  public Role roleId(@javax.annotation.Nullable Long roleId) {
    this.roleId = roleId;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessDate, accessDateDisplay, clientPermissions, comment, creationDate, deleteProtection, modificationDate, roleAuthMethodsAssoc, roleId, roleName, rules);
  }
