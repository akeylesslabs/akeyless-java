...
public class CreateGithubTarget {
  ...
  public CreateGithubTarget comment(@javax.annotation.Nullable String comment) {
  ...
  public CreateGithubTarget description(@javax.annotation.Nullable String description) {
  ...
  public CreateGithubTarget githubAppId(@javax.annotation.Nullable Long githubAppId) {
  ...
  public CreateGithubTarget githubAppPrivateKey(@javax.annotation.Nullable String githubAppPrivateKey) {
  ...
  public CreateGithubTarget githubBaseUrl(@javax.annotation.Nullable String githubBaseUrl) {
  ...
  public CreateGithubTarget json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public CreateGithubTarget key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public CreateGithubTarget maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public CreateGithubTarget name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateGithubTarget token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public CreateGithubTarget uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.comment, createGithubTarget.comment) &&
        ...
        Objects.equals(this.maxVersions, createGithubTarget.maxVersions) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(comment, description, githubAppId, githubAppPrivateKey, githubBaseUrl, json, key, maxVersions, name, token, uidToken);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("comment", "description", "github-app-id", "github-app-private-key", "github-base-url", "json", "key", "max-versions", "name", "token", "uid-token"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateGithubTarget
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateGithubTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateGithubTarget is not found in the empty JSON string", CreateGithubTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateGithubTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateGithubTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateGithubTarget.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateGithubTarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateGithubTarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateGithubTarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateGithubTarget.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateGithubTarget>() {
           @Override
           public void write(JsonWriter out, CreateGithubTarget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateGithubTarget read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateGithubTarget given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateGithubTarget
   * @throws IOException if the JSON string is invalid with respect to CreateGithubTarget
   */
  public static CreateGithubTarget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateGithubTarget.class);
  }

  /**
   * Convert an instance of CreateGithubTarget to an JSON string
   *
   * @return JSON string
   */
