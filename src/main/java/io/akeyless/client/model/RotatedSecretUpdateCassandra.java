...
public class RotatedSecretUpdateCassandra {
  ...
  public RotatedSecretUpdateCassandra() {
  }

  public RotatedSecretUpdateCassandra addTag(@javax.annotation.Nullable List<String> addTag) {
    this.addTag = addTag;
    return this;
  }

  public RotatedSecretUpdateCassandra addAddTagItem(String addTagItem) {
    if (this.addTag == null) {
  ...
  public RotatedSecretUpdateCassandra authenticationCredentials(@javax.annotation.Nullable String authenticationCredentials) {
  ...
  public RotatedSecretUpdateCassandra autoRotate(@javax.annotation.Nullable String autoRotate) {
  ...
  public RotatedSecretUpdateCassandra deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public RotatedSecretUpdateCassandra description(@javax.annotation.Nullable String description) {
  ...
  public RotatedSecretUpdateCassandra inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public RotatedSecretUpdateCassandra addInputRuleItem(String inputRuleItem) {
  ...
  public RotatedSecretUpdateCassandra itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public RotatedSecretUpdateCassandra putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public RotatedSecretUpdateCassandra json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public RotatedSecretUpdateCassandra keepPrevVersion(@javax.annotation.Nullable String keepPrevVersion) {
  ...
  public RotatedSecretUpdateCassandra key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public RotatedSecretUpdateCassandra maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public RotatedSecretUpdateCassandra name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public RotatedSecretUpdateCassandra newName(@javax.annotation.Nullable String newName) {
  ...
  public RotatedSecretUpdateCassandra outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public RotatedSecretUpdateCassandra addOutputRuleItem(String outputRuleItem) {
  ...
  public RotatedSecretUpdateCassandra passwordLength(@javax.annotation.Nullable String passwordLength) {
  ...
  public RotatedSecretUpdateCassandra rmTag(@javax.annotation.Nullable List<String> rmTag) {
    this.rmTag = rmTag;
    return this;
  }

  public RotatedSecretUpdateCassandra addRmTagItem(String rmTagItem) {
    if (this.rmTag == null) {
  ...
  public RotatedSecretUpdateCassandra rotatedPassword(@javax.annotation.Nullable String rotatedPassword) {
  ...
  public RotatedSecretUpdateCassandra rotatedUsername(@javax.annotation.Nullable String rotatedUsername) {
  ...
  public RotatedSecretUpdateCassandra rotationEventIn(@javax.annotation.Nullable List<String> rotationEventIn) {
  ...
  public RotatedSecretUpdateCassandra rotationHour(@javax.annotation.Nullable Integer rotationHour) {
  ...
  public RotatedSecretUpdateCassandra rotationInterval(@javax.annotation.Nullable String rotationInterval) {
  ...
  public RotatedSecretUpdateCassandra token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public RotatedSecretUpdateCassandra uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public RotatedSecretUpdateCassandra useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public RotatedSecretUpdateCassandra useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public RotatedSecretUpdateCassandra useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public RotatedSecretUpdateCassandra useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    RotatedSecretUpdateCassandra rotatedSecretUpdateCassandra = (RotatedSecretUpdateCassandra) o;
    return Objects.equals(this.addTag, rotatedSecretUpdateCassandra.addTag) &&
        Objects.equals(this.authenticationCredentials, rotatedSecretUpdateCassandra.authenticationCredentials) &&
        Objects.equals(this.autoRotate, rotatedSecretUpdateCassandra.autoRotate) &&
        Objects.equals(this.deleteProtection, rotatedSecretUpdateCassandra.deleteProtection) &&
        Objects.equals(this.description, rotatedSecretUpdateCassandra.description) &&
        Objects.equals(this.inputRule, rotatedSecretUpdateCassandra.inputRule) &&
        Objects.equals(this.itemCustomFields, rotatedSecretUpdateCassandra.itemCustomFields) &&
        Objects.equals(this.json, rotatedSecretUpdateCassandra.json) &&
        Objects.equals(this.keepPrevVersion, rotatedSecretUpdateCassandra.keepPrevVersion) &&
        Objects.equals(this.key, rotatedSecretUpdateCassandra.key) &&
        Objects.equals(this.maxVersions, rotatedSecretUpdateCassandra.maxVersions) &&
        Objects.equals(this.name, rotatedSecretUpdateCassandra.name) &&
        Objects.equals(this.newName, rotatedSecretUpdateCassandra.newName) &&
        Objects.equals(this.outputRule, rotatedSecretUpdateCassandra.outputRule) &&
        Objects.equals(this.passwordLength, rotatedSecretUpdateCassandra.passwordLength) &&
        ...
        Objects.equals(this.uidToken, rotatedSecretUpdateCassandra.uidToken) &&
        Objects.equals(this.useCapitalLetters, rotatedSecretUpdateCassandra.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, rotatedSecretUpdateCassandra.useLowerLetters) &&
        Objects.equals(this.useNumbers, rotatedSecretUpdateCassandra.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, rotatedSecretUpdateCassandra.useSpecialCharacters);
  }

  @Override
  public int hashCode() {
    return Objects.hash(addTag, authenticationCredentials, autoRotate, deleteProtection, description, inputRule, itemCustomFields, json, keepPrevVersion, key, maxVersions, name, newName, outputRule, passwordLength, rmTag, rotatedPassword, rotatedUsername, rotationEventIn, rotationHour, rotationInterval, token, uidToken, useCapitalLetters, useLowerLetters, useNumbers, useSpecialCharacters);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RotatedSecretUpdateCassandra
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RotatedSecretUpdateCassandra.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RotatedSecretUpdateCassandra is not found in the empty JSON string", RotatedSecretUpdateCassandra.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RotatedSecretUpdateCassandra.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RotatedSecretUpdateCassandra` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RotatedSecretUpdateCassandra.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RotatedSecretUpdateCassandra.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RotatedSecretUpdateCassandra' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RotatedSecretUpdateCassandra> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RotatedSecretUpdateCassandra.class));

       return (TypeAdapter<T>) new TypeAdapter<RotatedSecretUpdateCassandra>() {
           @Override
           public void write(JsonWriter out, RotatedSecretUpdateCassandra value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RotatedSecretUpdateCassandra read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RotatedSecretUpdateCassandra given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RotatedSecretUpdateCassandra
   * @throws IOException if the JSON string is invalid with respect to RotatedSecretUpdateCassandra
   */
  public static RotatedSecretUpdateCassandra fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RotatedSecretUpdateCassandra.class);
  }

  /**
   * Convert an instance of RotatedSecretUpdateCassandra to an JSON string
   *
   * @return JSON string
   */
