...
public class RotatedSecretUpdateAzure {
  ...
  public static final String SERIALIZED_NAME_EXPLICITLY_SET_SA = "explicitly-set-sa";
  @SerializedName(SERIALIZED_NAME_EXPLICITLY_SET_SA)
  @javax.annotation.Nullable
  private String explicitlySetSa = "false";
  ...
  public RotatedSecretUpdateAzure explicitlySetSa(@javax.annotation.Nullable String explicitlySetSa) {
   ...
   * @return explicitlySetSa
   */
  @javax.annotation.Nullable
  public String getExplicitlySetSa() {
    return explicitlySetSa;
  }

  public void setExplicitlySetSa(@javax.annotation.Nullable String explicitlySetSa) {
    this.explicitlySetSa = explicitlySetSa;
  }


  public RotatedSecretUpdateAzure graceRotation(@javax.annotation.Nullable String graceRotation) {
  ...
  public RotatedSecretUpdateAzure graceRotationHour(@javax.annotation.Nullable Integer graceRotationHour) {
  ...
  public RotatedSecretUpdateAzure graceRotationInterval(@javax.annotation.Nullable String graceRotationInterval) {
  ...
  public RotatedSecretUpdateAzure inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public RotatedSecretUpdateAzure addInputRuleItem(String inputRuleItem) {
  ...
  public RotatedSecretUpdateAzure itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public RotatedSecretUpdateAzure putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public RotatedSecretUpdateAzure outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public RotatedSecretUpdateAzure addOutputRuleItem(String outputRuleItem) {
  ...
  public RotatedSecretUpdateAzure password(@javax.annotation.Nullable String password) {
  ...
  public RotatedSecretUpdateAzure resourceGroupName(@javax.annotation.Nullable String resourceGroupName) {
  ...
  public RotatedSecretUpdateAzure resourceName(@javax.annotation.Nullable String resourceName) {
  ...
  public RotatedSecretUpdateAzure useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public RotatedSecretUpdateAzure useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public RotatedSecretUpdateAzure useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public RotatedSecretUpdateAzure useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.addTag, rotatedSecretUpdateAzure.addTag) &&
        ...
        Objects.equals(this.explicitlySetSa, rotatedSecretUpdateAzure.explicitlySetSa) &&
        ...
        Objects.equals(this.inputRule, rotatedSecretUpdateAzure.inputRule) &&
        ...
        Objects.equals(this.outputRule, rotatedSecretUpdateAzure.outputRule) &&
        Objects.equals(this.password, rotatedSecretUpdateAzure.password) &&
        Objects.equals(this.passwordLength, rotatedSecretUpdateAzure.passwordLength) &&
        Objects.equals(this.resourceGroupName, rotatedSecretUpdateAzure.resourceGroupName) &&
        Objects.equals(this.resourceName, rotatedSecretUpdateAzure.resourceName) &&
        ...
        Objects.equals(this.useCapitalLetters, rotatedSecretUpdateAzure.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, rotatedSecretUpdateAzure.useLowerLetters) &&
        Objects.equals(this.useNumbers, rotatedSecretUpdateAzure.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, rotatedSecretUpdateAzure.useSpecialCharacters) &&
        Objects.equals(this.username, rotatedSecretUpdateAzure.username);
  }

  @Override
  public int hashCode() {
    return Objects.hash(addTag, apiId, apiKey, applicationId, authenticationCredentials, autoRotate, deleteProtection, description, explicitlySetSa, graceRotation, graceRotationHour, graceRotationInterval, graceRotationTiming, inputRule, itemCustomFields, json, keepPrevVersion, key, lockDuringSraSession, maxVersions, name, newName, outputRule, password, passwordLength, resourceGroupName, resourceName, rmTag, rotateAfterDisconnect, rotationEventIn, rotationHour, rotationInterval, secureAccessDisableConcurrentConnections, secureAccessEnable, secureAccessUrl, secureAccessWeb, secureAccessWebBrowsing, secureAccessWebProxy, storageAccountKeyName, token, uidToken, useCapitalLetters, useLowerLetters, useNumbers, useSpecialCharacters, username);
  }
  ...
  public String toString() {
    ...
    sb.append("    explicitlySetSa: ").append(toIndentedString(explicitlySetSa)).append("\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("add-tag", "api-id", "api-key", "application-id", "authentication-credentials", "auto-rotate", "delete_protection", "description", "explicitly-set-sa", "grace-rotation", "grace-rotation-hour", "grace-rotation-interval", "grace-rotation-timing", "input-rule", "item-custom-fields", "json", "keep-prev-version", "key", "lock-during-sra-session", "max-versions", "name", "new-name", "output-rule", "password", "password-length", "resource-group-name", "resource-name", "rm-tag", "rotate-after-disconnect", "rotation-event-in", "rotation-hour", "rotation-interval", "secure-access-disable-concurrent-connections", "secure-access-enable", "secure-access-url", "secure-access-web", "secure-access-web-browsing", "secure-access-web-proxy", "storage-account-key-name", "token", "uid-token", "use-capital-letters", "use-lower-letters", "use-numbers", "use-special-characters", "username"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RotatedSecretUpdateAzure.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RotatedSecretUpdateAzure is not found in the empty JSON string", RotatedSecretUpdateAzure.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RotatedSecretUpdateAzure.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RotatedSecretUpdateAzure` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("explicitly-set-sa") != null && !jsonObj.get("explicitly-set-sa").isJsonNull()) && !jsonObj.get("explicitly-set-sa").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `explicitly-set-sa` to be a primitive type in the JSON string but got `%s`", jsonObj.get("explicitly-set-sa").toString()));
      }
      ...
      if ((jsonObj.get("grace-rotation-interval") != null && !jsonObj.get("grace-rotation-interval").isJsonNull()) && !jsonObj.get("grace-rotation-interval").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `grace-rotation-interval` to be a primitive type in the JSON string but got `%s`", jsonObj.get("grace-rotation-interval").toString()));
      }
      if ((jsonObj.get("grace-rotation-timing") != null && !jsonObj.get("grace-rotation-timing").isJsonNull()) && !jsonObj.get("grace-rotation-timing").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `grace-rotation-timing` to be a primitive type in the JSON string but got `%s`", jsonObj.get("grace-rotation-timing").toString()));
      }
      // ensure the optional json data is an array if present
      ...
      if ((jsonObj.get("resource-group-name") != null && !jsonObj.get("resource-group-name").isJsonNull()) && !jsonObj.get("resource-group-name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `resource-group-name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("resource-group-name").toString()));
      }
      if ((jsonObj.get("resource-name") != null && !jsonObj.get("resource-name").isJsonNull()) && !jsonObj.get("resource-name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `resource-name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("resource-name").toString()));
      }
      // ensure the optional json data is an array if present
