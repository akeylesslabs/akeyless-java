...
public class GatewayCreateProducerPostgreSQL {
  ...
  public GatewayCreateProducerPostgreSQL inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public GatewayCreateProducerPostgreSQL addInputRuleItem(String inputRuleItem) {
  ...
  public GatewayCreateProducerPostgreSQL itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public GatewayCreateProducerPostgreSQL putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public GatewayCreateProducerPostgreSQL outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public GatewayCreateProducerPostgreSQL addOutputRuleItem(String outputRuleItem) {
  ...
  public GatewayCreateProducerPostgreSQL useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public GatewayCreateProducerPostgreSQL useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public GatewayCreateProducerPostgreSQL useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public GatewayCreateProducerPostgreSQL useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.creationStatements, gatewayCreateProducerPostgreSQL.creationStatements) &&
        ...
        Objects.equals(this.inputRule, gatewayCreateProducerPostgreSQL.inputRule) &&
        Objects.equals(this.itemCustomFields, gatewayCreateProducerPostgreSQL.itemCustomFields) &&
        ...
        Objects.equals(this.outputRule, gatewayCreateProducerPostgreSQL.outputRule) &&
        ...
        Objects.equals(this.useCapitalLetters, gatewayCreateProducerPostgreSQL.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, gatewayCreateProducerPostgreSQL.useLowerLetters) &&
        Objects.equals(this.useNumbers, gatewayCreateProducerPostgreSQL.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, gatewayCreateProducerPostgreSQL.useSpecialCharacters) &&
        Objects.equals(this.userTtl, gatewayCreateProducerPostgreSQL.userTtl);
  }

  @Override
  public int hashCode() {
    return Objects.hash(creationStatements, customUsernameTemplate, deleteProtection, inputRule, itemCustomFields, json, name, outputRule, passwordLength, postgresqlDbName, postgresqlHost, postgresqlPassword, postgresqlPort, postgresqlUsername, producerEncryptionKey, revocationStatement, secureAccessBastionIssuer, secureAccessCertificateIssuer, secureAccessDbName, secureAccessDbSchema, secureAccessDelay, secureAccessEnable, secureAccessHost, secureAccessWeb, ssl, tags, targetName, token, uidToken, useCapitalLetters, useLowerLetters, useNumbers, useSpecialCharacters, userTtl);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GatewayCreateProducerPostgreSQL.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GatewayCreateProducerPostgreSQL is not found in the empty JSON string", GatewayCreateProducerPostgreSQL.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GatewayCreateProducerPostgreSQL.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GatewayCreateProducerPostgreSQL` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
