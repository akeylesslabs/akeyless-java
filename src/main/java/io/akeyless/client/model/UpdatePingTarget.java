...
public class UpdatePingTarget {
  ...
  public UpdatePingTarget() {
  }

  public UpdatePingTarget administrativePort(@javax.annotation.Nullable String administrativePort) {
  ...
  public UpdatePingTarget authorizationPort(@javax.annotation.Nullable String authorizationPort) {
  ...
  public UpdatePingTarget comment(@javax.annotation.Nullable String comment) {
  ...
  public UpdatePingTarget description(@javax.annotation.Nullable String description) {
  ...
  public UpdatePingTarget json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public UpdatePingTarget keepPrevVersion(@javax.annotation.Nullable String keepPrevVersion) {
  ...
  public UpdatePingTarget key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public UpdatePingTarget maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public UpdatePingTarget name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdatePingTarget newName(@javax.annotation.Nullable String newName) {
  ...
  public UpdatePingTarget password(@javax.annotation.Nullable String password) {
  ...
  public UpdatePingTarget pingUrl(@javax.annotation.Nullable String pingUrl) {
  ...
  public UpdatePingTarget privilegedUser(@javax.annotation.Nullable String privilegedUser) {
  ...
  public UpdatePingTarget token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public UpdatePingTarget uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public UpdatePingTarget updateVersion(@javax.annotation.Nullable Boolean updateVersion) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.administrativePort, updatePingTarget.administrativePort) &&
        ...
        Objects.equals(this.maxVersions, updatePingTarget.maxVersions) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(administrativePort, authorizationPort, comment, description, json, keepPrevVersion, key, maxVersions, name, newName, password, pingUrl, privilegedUser, token, uidToken, updateVersion);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("administrative-port", "authorization-port", "comment", "description", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "password", "ping-url", "privileged-user", "token", "uid-token", "update-version"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdatePingTarget
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePingTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdatePingTarget is not found in the empty JSON string", UpdatePingTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePingTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdatePingTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdatePingTarget.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdatePingTarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdatePingTarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdatePingTarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdatePingTarget.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdatePingTarget>() {
           @Override
           public void write(JsonWriter out, UpdatePingTarget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdatePingTarget read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdatePingTarget given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdatePingTarget
   * @throws IOException if the JSON string is invalid with respect to UpdatePingTarget
   */
  public static UpdatePingTarget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdatePingTarget.class);
  }

  /**
   * Convert an instance of UpdatePingTarget to an JSON string
   *
   * @return JSON string
   */
