...
public class Detokenize {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("ciphertext", "json", "token", "tokenizer-name", "tweak", "uid-token"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("ciphertext", "tokenizer-name"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Detokenize.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Detokenize is not found in the empty JSON string", Detokenize.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Detokenize.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Detokenize` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
