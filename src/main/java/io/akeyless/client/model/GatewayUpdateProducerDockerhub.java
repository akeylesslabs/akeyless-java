...
public class GatewayUpdateProducerDockerhub {
  ...
  public GatewayUpdateProducerDockerhub inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public GatewayUpdateProducerDockerhub addInputRuleItem(String inputRuleItem) {
  ...
  public GatewayUpdateProducerDockerhub itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public GatewayUpdateProducerDockerhub putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public GatewayUpdateProducerDockerhub outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public GatewayUpdateProducerDockerhub addOutputRuleItem(String outputRuleItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.deleteProtection, gatewayUpdateProducerDockerhub.deleteProtection) &&
        ...
        Objects.equals(this.inputRule, gatewayUpdateProducerDockerhub.inputRule) &&
        Objects.equals(this.itemCustomFields, gatewayUpdateProducerDockerhub.itemCustomFields) &&
        ...
        Objects.equals(this.outputRule, gatewayUpdateProducerDockerhub.outputRule) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(deleteProtection, dockerhubPassword, dockerhubTokenScopes, dockerhubUsername, inputRule, itemCustomFields, json, name, newName, outputRule, producerEncryptionKeyName, tags, targetName, token, uidToken, userTtl);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("delete_protection", "dockerhub-password", "dockerhub-token-scopes", "dockerhub-username", "input-rule", "item-custom-fields", "json", "name", "new-name", "output-rule", "producer-encryption-key-name", "tags", "target-name", "token", "uid-token", "user-ttl"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GatewayUpdateProducerDockerhub.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GatewayUpdateProducerDockerhub is not found in the empty JSON string", GatewayUpdateProducerDockerhub.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GatewayUpdateProducerDockerhub.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GatewayUpdateProducerDockerhub` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
