...
public class DescribeItem {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("accessibility", "bastion-details", "der-certificate-format", "display-id", "gateway-details", "item-custom-fields-details", "item-id", "json", "name", "services-details", "show-versions", "token", "uid-token"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DescribeItem is not found in the empty JSON string", DescribeItem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DescribeItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
