 ...
 */
@ApiModel(description = "dynamicSecretCreateChef is a command that creates chef dynamic secret")
...
public class DynamicSecretCreateChef {
  ...
  public DynamicSecretCreateChef chefOrgs(String chefOrgs) {
  ...
  **/
  ...
  public DynamicSecretCreateChef chefServerKey(String chefServerKey) {
  ...
  **/
  ...
  public DynamicSecretCreateChef chefServerUrl(String chefServerUrl) {
  ...
  **/
  ...
  public DynamicSecretCreateChef chefServerUsername(String chefServerUsername) {
  ...
  **/
  ...
  public DynamicSecretCreateChef deleteProtection(String deleteProtection) {
  ...
  **/
  ...
  public DynamicSecretCreateChef description(String description) {
  ...
  **/
  ...
  public DynamicSecretCreateChef json(Boolean json) {
  ...
  **/
  ...
  public DynamicSecretCreateChef name(String name) {
  ...
  **/
  ...
  public DynamicSecretCreateChef passwordLength(String passwordLength) {
  ...
  **/
  ...
  public DynamicSecretCreateChef producerEncryptionKeyName(String producerEncryptionKeyName) {
  ...
  **/
  ...
  public DynamicSecretCreateChef skipSsl(Boolean skipSsl) {
  ...
  **/
  ...
  public DynamicSecretCreateChef tags(List<String> tags) {
  ...
  **/
  ...
  public DynamicSecretCreateChef targetName(String targetName) {
  ...
  **/
  ...
  public DynamicSecretCreateChef token(String token) {
  ...
  **/
  ...
  public DynamicSecretCreateChef uidToken(String uidToken) {
  ...
  **/
  ...
  public DynamicSecretCreateChef userTtl(String userTtl) {
