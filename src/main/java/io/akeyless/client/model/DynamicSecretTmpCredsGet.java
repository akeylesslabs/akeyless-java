...
public class DynamicSecretTmpCredsGet {
  ...
  public DynamicSecretTmpCredsGet name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public DynamicSecretTmpCredsGet token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public DynamicSecretTmpCredsGet uidToken(@javax.annotation.Nullable String uidToken) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to DynamicSecretTmpCredsGet
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicSecretTmpCredsGet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicSecretTmpCredsGet is not found in the empty JSON string", DynamicSecretTmpCredsGet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicSecretTmpCredsGet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DynamicSecretTmpCredsGet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DynamicSecretTmpCredsGet.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DynamicSecretTmpCredsGet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DynamicSecretTmpCredsGet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DynamicSecretTmpCredsGet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DynamicSecretTmpCredsGet.class));

       return (TypeAdapter<T>) new TypeAdapter<DynamicSecretTmpCredsGet>() {
           @Override
           public void write(JsonWriter out, DynamicSecretTmpCredsGet value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DynamicSecretTmpCredsGet read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DynamicSecretTmpCredsGet given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DynamicSecretTmpCredsGet
   * @throws IOException if the JSON string is invalid with respect to DynamicSecretTmpCredsGet
   */
  public static DynamicSecretTmpCredsGet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DynamicSecretTmpCredsGet.class);
  }

  /**
   * Convert an instance of DynamicSecretTmpCredsGet to an JSON string
   *
   * @return JSON string
   */
