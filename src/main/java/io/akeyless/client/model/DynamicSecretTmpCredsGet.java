 ...
 */
@ApiModel(description = "dynamicSecretTmpCredsGet is a command that returns dynamic secret temp creds")
...
public class DynamicSecretTmpCredsGet {
  ...
  public DynamicSecretTmpCredsGet json(Boolean json) {
  ...
  **/
  ...
  public DynamicSecretTmpCredsGet name(String name) {
  ...
  **/
  ...
  public DynamicSecretTmpCredsGet token(String token) {
  ...
  **/
  ...
  public DynamicSecretTmpCredsGet uidToken(String uidToken) {
