...
public class RotatedSecretUpdateSplunk {
  ...
  public RotatedSecretUpdateSplunk inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public RotatedSecretUpdateSplunk addInputRuleItem(String inputRuleItem) {
  ...
  public RotatedSecretUpdateSplunk outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public RotatedSecretUpdateSplunk addOutputRuleItem(String outputRuleItem) {
  ...
  public RotatedSecretUpdateSplunk useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public RotatedSecretUpdateSplunk useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public RotatedSecretUpdateSplunk useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public RotatedSecretUpdateSplunk useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.addTag, rotatedSecretUpdateSplunk.addTag) &&
        ...
        Objects.equals(this.inputRule, rotatedSecretUpdateSplunk.inputRule) &&
        ...
        Objects.equals(this.outputRule, rotatedSecretUpdateSplunk.outputRule) &&
        ...
        Objects.equals(this.useCapitalLetters, rotatedSecretUpdateSplunk.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, rotatedSecretUpdateSplunk.useLowerLetters) &&
        Objects.equals(this.useNumbers, rotatedSecretUpdateSplunk.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, rotatedSecretUpdateSplunk.useSpecialCharacters);
  }

  @Override
  public int hashCode() {
    return Objects.hash(addTag, audience, authenticationCredentials, autoRotate, deleteProtection, description, expirationDate, hecToken, inputRule, itemCustomFields, json, keepPrevVersion, key, maxVersions, name, newName, outputRule, passwordLength, rmTag, rotationEventIn, rotationHour, rotationInterval, splunkToken, token, tokenOwner, uidToken, useCapitalLetters, useLowerLetters, useNumbers, useSpecialCharacters);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("add-tag", "audience", "authentication-credentials", "auto-rotate", "delete_protection", "description", "expiration-date", "hec-token", "input-rule", "item-custom-fields", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "output-rule", "password-length", "rm-tag", "rotation-event-in", "rotation-hour", "rotation-interval", "splunk-token", "token", "token-owner", "uid-token", "use-capital-letters", "use-lower-letters", "use-numbers", "use-special-characters"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RotatedSecretUpdateSplunk.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RotatedSecretUpdateSplunk is not found in the empty JSON string", RotatedSecretUpdateSplunk.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RotatedSecretUpdateSplunk.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RotatedSecretUpdateSplunk` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("expiration-date") != null && !jsonObj.get("expiration-date").isJsonNull()) && !jsonObj.get("expiration-date").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `expiration-date` to be a primitive type in the JSON string but got `%s`", jsonObj.get("expiration-date").toString()));
      }
      if ((jsonObj.get("hec-token") != null && !jsonObj.get("hec-token").isJsonNull()) && !jsonObj.get("hec-token").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `hec-token` to be a primitive type in the JSON string but got `%s`", jsonObj.get("hec-token").toString()));
      }
      // ensure the optional json data is an array if present
      ...
      if ((jsonObj.get("token-owner") != null && !jsonObj.get("token-owner").isJsonNull()) && !jsonObj.get("token-owner").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `token-owner` to be a primitive type in the JSON string but got `%s`", jsonObj.get("token-owner").toString()));
      }
