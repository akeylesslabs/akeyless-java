...
public class Group {
  ...
  public Group accountId(@javax.annotation.Nullable String accountId) {
  ...
  public Group creationDate(@javax.annotation.Nullable OffsetDateTime creationDate) {
  ...
  public Group groupAlias(@javax.annotation.Nullable String groupAlias) {
  ...
  public Group groupName(@javax.annotation.Nullable String groupName) {
  ...
  public Group isSubclaimsWithOperator(@javax.annotation.Nullable Boolean isSubclaimsWithOperator) {
  ...
  public Group modificationDate(@javax.annotation.Nullable OffsetDateTime modificationDate) {
  ...
  public Group userAssignments(@javax.annotation.Nullable List<AccessPermissionAssignment> userAssignments) {
