...
public class DynamicSecretUpdateOracleDb {
  ...
  public DynamicSecretUpdateOracleDb inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public DynamicSecretUpdateOracleDb addInputRuleItem(String inputRuleItem) {
  ...
  public DynamicSecretUpdateOracleDb itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public DynamicSecretUpdateOracleDb putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public DynamicSecretUpdateOracleDb outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public DynamicSecretUpdateOracleDb addOutputRuleItem(String outputRuleItem) {
  ...
  public DynamicSecretUpdateOracleDb useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public DynamicSecretUpdateOracleDb useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public DynamicSecretUpdateOracleDb useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public DynamicSecretUpdateOracleDb useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.customUsernameTemplate, dynamicSecretUpdateOracleDb.customUsernameTemplate) &&
        ...
        Objects.equals(this.inputRule, dynamicSecretUpdateOracleDb.inputRule) &&
        Objects.equals(this.itemCustomFields, dynamicSecretUpdateOracleDb.itemCustomFields) &&
        ...
        Objects.equals(this.outputRule, dynamicSecretUpdateOracleDb.outputRule) &&
        ...
        Objects.equals(this.useCapitalLetters, dynamicSecretUpdateOracleDb.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, dynamicSecretUpdateOracleDb.useLowerLetters) &&
        Objects.equals(this.useNumbers, dynamicSecretUpdateOracleDb.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, dynamicSecretUpdateOracleDb.useSpecialCharacters) &&
        Objects.equals(this.userTtl, dynamicSecretUpdateOracleDb.userTtl);
  }

  @Override
  public int hashCode() {
    return Objects.hash(customUsernameTemplate, dbServerCertificates, dbServerName, deleteProtection, description, inputRule, itemCustomFields, json, name, newName, oracleHost, oraclePassword, oraclePort, oracleRevocationStatements, oracleScreationStatements, oracleServiceName, oracleUsername, outputRule, passwordLength, producerEncryptionKeyName, secureAccessBastionIssuer, secureAccessCertificateIssuer, secureAccessEnable, secureAccessHost, secureAccessWeb, tags, targetName, token, uidToken, useCapitalLetters, useLowerLetters, useNumbers, useSpecialCharacters, userTtl);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("custom-username-template", "db-server-certificates", "db-server-name", "delete_protection", "description", "input-rule", "item-custom-fields", "json", "name", "new-name", "oracle-host", "oracle-password", "oracle-port", "oracle-revocation-statements", "oracle-screation-statements", "oracle-service-name", "oracle-username", "output-rule", "password-length", "producer-encryption-key-name", "secure-access-bastion-issuer", "secure-access-certificate-issuer", "secure-access-enable", "secure-access-host", "secure-access-web", "tags", "target-name", "token", "uid-token", "use-capital-letters", "use-lower-letters", "use-numbers", "use-special-characters", "user-ttl"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicSecretUpdateOracleDb.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicSecretUpdateOracleDb is not found in the empty JSON string", DynamicSecretUpdateOracleDb.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicSecretUpdateOracleDb.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DynamicSecretUpdateOracleDb` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("oracle-host") != null && !jsonObj.get("oracle-host").isJsonNull()) && !jsonObj.get("oracle-host").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `oracle-host` to be a primitive type in the JSON string but got `%s`", jsonObj.get("oracle-host").toString()));
      }
      if ((jsonObj.get("oracle-password") != null && !jsonObj.get("oracle-password").isJsonNull()) && !jsonObj.get("oracle-password").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `oracle-password` to be a primitive type in the JSON string but got `%s`", jsonObj.get("oracle-password").toString()));
      }
      if ((jsonObj.get("oracle-port") != null && !jsonObj.get("oracle-port").isJsonNull()) && !jsonObj.get("oracle-port").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `oracle-port` to be a primitive type in the JSON string but got `%s`", jsonObj.get("oracle-port").toString()));
      }
      if ((jsonObj.get("oracle-revocation-statements") != null && !jsonObj.get("oracle-revocation-statements").isJsonNull()) && !jsonObj.get("oracle-revocation-statements").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `oracle-revocation-statements` to be a primitive type in the JSON string but got `%s`", jsonObj.get("oracle-revocation-statements").toString()));
      }
      if ((jsonObj.get("oracle-screation-statements") != null && !jsonObj.get("oracle-screation-statements").isJsonNull()) && !jsonObj.get("oracle-screation-statements").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `oracle-screation-statements` to be a primitive type in the JSON string but got `%s`", jsonObj.get("oracle-screation-statements").toString()));
      }
      ...
      if ((jsonObj.get("oracle-username") != null && !jsonObj.get("oracle-username").isJsonNull()) && !jsonObj.get("oracle-username").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `oracle-username` to be a primitive type in the JSON string but got `%s`", jsonObj.get("oracle-username").toString()));
      }
      // ensure the optional json data is an array if present
