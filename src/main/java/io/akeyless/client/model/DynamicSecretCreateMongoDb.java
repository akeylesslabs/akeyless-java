...
public class DynamicSecretCreateMongoDb {
  ...
  public DynamicSecretCreateMongoDb inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public DynamicSecretCreateMongoDb addInputRuleItem(String inputRuleItem) {
  ...
  public DynamicSecretCreateMongoDb outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public DynamicSecretCreateMongoDb addOutputRuleItem(String outputRuleItem) {
  ...
  public DynamicSecretCreateMongoDb useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public DynamicSecretCreateMongoDb useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public DynamicSecretCreateMongoDb useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public DynamicSecretCreateMongoDb useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.customUsernameTemplate, dynamicSecretCreateMongoDb.customUsernameTemplate) &&
        ...
        Objects.equals(this.inputRule, dynamicSecretCreateMongoDb.inputRule) &&
        ...
        Objects.equals(this.outputRule, dynamicSecretCreateMongoDb.outputRule) &&
        ...
        Objects.equals(this.useCapitalLetters, dynamicSecretCreateMongoDb.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, dynamicSecretCreateMongoDb.useLowerLetters) &&
        Objects.equals(this.useNumbers, dynamicSecretCreateMongoDb.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, dynamicSecretCreateMongoDb.useSpecialCharacters) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicSecretCreateMongoDb.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicSecretCreateMongoDb is not found in the empty JSON string", DynamicSecretCreateMongoDb.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicSecretCreateMongoDb.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DynamicSecretCreateMongoDb` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
