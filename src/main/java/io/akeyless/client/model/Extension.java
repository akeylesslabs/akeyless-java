...
public class Extension {
  ...
  public Extension critical(@javax.annotation.Nullable Boolean critical) {
  ...
  public Extension value(@javax.annotation.Nullable String value) {
    this.value = value;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("Critical", "Name", "Value"));
