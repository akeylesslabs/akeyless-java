...
public class GatewayUpdateProducerArtifactory {
  ...
  public GatewayUpdateProducerArtifactory artifactoryAdminName(@javax.annotation.Nullable String artifactoryAdminName) {
  ...
  public GatewayUpdateProducerArtifactory artifactoryAdminPwd(@javax.annotation.Nullable String artifactoryAdminPwd) {
  ...
  public GatewayUpdateProducerArtifactory artifactoryTokenAudience(@javax.annotation.Nonnull String artifactoryTokenAudience) {
  ...
  public GatewayUpdateProducerArtifactory artifactoryTokenScope(@javax.annotation.Nonnull String artifactoryTokenScope) {
  ...
  public GatewayUpdateProducerArtifactory baseUrl(@javax.annotation.Nullable String baseUrl) {
  ...
  public GatewayUpdateProducerArtifactory customUsernameTemplate(@javax.annotation.Nullable String customUsernameTemplate) {
  ...
  public GatewayUpdateProducerArtifactory deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public GatewayUpdateProducerArtifactory inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public GatewayUpdateProducerArtifactory addInputRuleItem(String inputRuleItem) {
  ...
  public GatewayUpdateProducerArtifactory itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public GatewayUpdateProducerArtifactory putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public GatewayUpdateProducerArtifactory json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public GatewayUpdateProducerArtifactory name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public GatewayUpdateProducerArtifactory newName(@javax.annotation.Nullable String newName) {
  ...
  public GatewayUpdateProducerArtifactory outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public GatewayUpdateProducerArtifactory addOutputRuleItem(String outputRuleItem) {
  ...
  public GatewayUpdateProducerArtifactory producerEncryptionKeyName(@javax.annotation.Nullable String producerEncryptionKeyName) {
  ...
  public GatewayUpdateProducerArtifactory tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public GatewayUpdateProducerArtifactory targetName(@javax.annotation.Nullable String targetName) {
  ...
  public GatewayUpdateProducerArtifactory token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public GatewayUpdateProducerArtifactory uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public GatewayUpdateProducerArtifactory userTtl(@javax.annotation.Nullable String userTtl) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.artifactoryAdminName, gatewayUpdateProducerArtifactory.artifactoryAdminName) &&
        ...
        Objects.equals(this.customUsernameTemplate, gatewayUpdateProducerArtifactory.customUsernameTemplate) &&
        Objects.equals(this.deleteProtection, gatewayUpdateProducerArtifactory.deleteProtection) &&
        Objects.equals(this.inputRule, gatewayUpdateProducerArtifactory.inputRule) &&
        Objects.equals(this.itemCustomFields, gatewayUpdateProducerArtifactory.itemCustomFields) &&
        ...
        Objects.equals(this.outputRule, gatewayUpdateProducerArtifactory.outputRule) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(artifactoryAdminName, artifactoryAdminPwd, artifactoryTokenAudience, artifactoryTokenScope, baseUrl, customUsernameTemplate, deleteProtection, inputRule, itemCustomFields, json, name, newName, outputRule, producerEncryptionKeyName, tags, targetName, token, uidToken, userTtl);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GatewayUpdateProducerArtifactory
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GatewayUpdateProducerArtifactory.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GatewayUpdateProducerArtifactory is not found in the empty JSON string", GatewayUpdateProducerArtifactory.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GatewayUpdateProducerArtifactory.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GatewayUpdateProducerArtifactory` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GatewayUpdateProducerArtifactory.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GatewayUpdateProducerArtifactory.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GatewayUpdateProducerArtifactory' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GatewayUpdateProducerArtifactory> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GatewayUpdateProducerArtifactory.class));

       return (TypeAdapter<T>) new TypeAdapter<GatewayUpdateProducerArtifactory>() {
           @Override
           public void write(JsonWriter out, GatewayUpdateProducerArtifactory value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GatewayUpdateProducerArtifactory read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GatewayUpdateProducerArtifactory given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GatewayUpdateProducerArtifactory
   * @throws IOException if the JSON string is invalid with respect to GatewayUpdateProducerArtifactory
   */
  public static GatewayUpdateProducerArtifactory fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GatewayUpdateProducerArtifactory.class);
  }

  /**
   * Convert an instance of GatewayUpdateProducerArtifactory to an JSON string
   *
   * @return JSON string
   */
