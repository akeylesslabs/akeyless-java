...
public class GatewayUpdateProducerOracleDb {
  ...
  public GatewayUpdateProducerOracleDb customUsernameTemplate(@javax.annotation.Nullable String customUsernameTemplate) {
  ...
  public GatewayUpdateProducerOracleDb dbServerCertificates(@javax.annotation.Nullable String dbServerCertificates) {
  ...
  public GatewayUpdateProducerOracleDb dbServerName(@javax.annotation.Nullable String dbServerName) {
  ...
  public GatewayUpdateProducerOracleDb deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public GatewayUpdateProducerOracleDb inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public GatewayUpdateProducerOracleDb addInputRuleItem(String inputRuleItem) {
  ...
  public GatewayUpdateProducerOracleDb itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public GatewayUpdateProducerOracleDb putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public GatewayUpdateProducerOracleDb json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public GatewayUpdateProducerOracleDb name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public GatewayUpdateProducerOracleDb newName(@javax.annotation.Nullable String newName) {
  ...
  public GatewayUpdateProducerOracleDb oracleHost(@javax.annotation.Nullable String oracleHost) {
  ...
  public GatewayUpdateProducerOracleDb oraclePassword(@javax.annotation.Nullable String oraclePassword) {
  ...
  public GatewayUpdateProducerOracleDb oraclePort(@javax.annotation.Nullable String oraclePort) {
  ...
  public GatewayUpdateProducerOracleDb oracleRevocationStatements(@javax.annotation.Nullable String oracleRevocationStatements) {
  ...
  public GatewayUpdateProducerOracleDb oracleScreationStatements(@javax.annotation.Nullable String oracleScreationStatements) {
  ...
  public GatewayUpdateProducerOracleDb oracleServiceName(@javax.annotation.Nullable String oracleServiceName) {
  ...
  public GatewayUpdateProducerOracleDb oracleUsername(@javax.annotation.Nullable String oracleUsername) {
  ...
  public GatewayUpdateProducerOracleDb outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public GatewayUpdateProducerOracleDb addOutputRuleItem(String outputRuleItem) {
  ...
  public GatewayUpdateProducerOracleDb passwordLength(@javax.annotation.Nullable String passwordLength) {
  ...
  public GatewayUpdateProducerOracleDb producerEncryptionKeyName(@javax.annotation.Nullable String producerEncryptionKeyName) {
  ...
  public GatewayUpdateProducerOracleDb secureAccessBastionIssuer(@javax.annotation.Nullable String secureAccessBastionIssuer) {
  ...
  public GatewayUpdateProducerOracleDb secureAccessCertificateIssuer(@javax.annotation.Nullable String secureAccessCertificateIssuer) {
  ...
  public GatewayUpdateProducerOracleDb secureAccessEnable(@javax.annotation.Nullable String secureAccessEnable) {
  ...
  public GatewayUpdateProducerOracleDb secureAccessHost(@javax.annotation.Nullable List<String> secureAccessHost) {
  ...
  public GatewayUpdateProducerOracleDb secureAccessWeb(@javax.annotation.Nullable Boolean secureAccessWeb) {
  ...
  public GatewayUpdateProducerOracleDb tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public GatewayUpdateProducerOracleDb targetName(@javax.annotation.Nullable String targetName) {
  ...
  public GatewayUpdateProducerOracleDb token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public GatewayUpdateProducerOracleDb uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public GatewayUpdateProducerOracleDb useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public GatewayUpdateProducerOracleDb useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public GatewayUpdateProducerOracleDb useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public GatewayUpdateProducerOracleDb useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public GatewayUpdateProducerOracleDb userTtl(@javax.annotation.Nullable String userTtl) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.customUsernameTemplate, gatewayUpdateProducerOracleDb.customUsernameTemplate) &&
        Objects.equals(this.dbServerCertificates, gatewayUpdateProducerOracleDb.dbServerCertificates) &&
        ...
        Objects.equals(this.inputRule, gatewayUpdateProducerOracleDb.inputRule) &&
        Objects.equals(this.itemCustomFields, gatewayUpdateProducerOracleDb.itemCustomFields) &&
        ...
        Objects.equals(this.outputRule, gatewayUpdateProducerOracleDb.outputRule) &&
        Objects.equals(this.passwordLength, gatewayUpdateProducerOracleDb.passwordLength) &&
        ...
        Objects.equals(this.secureAccessCertificateIssuer, gatewayUpdateProducerOracleDb.secureAccessCertificateIssuer) &&
        ...
        Objects.equals(this.useCapitalLetters, gatewayUpdateProducerOracleDb.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, gatewayUpdateProducerOracleDb.useLowerLetters) &&
        Objects.equals(this.useNumbers, gatewayUpdateProducerOracleDb.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, gatewayUpdateProducerOracleDb.useSpecialCharacters) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to GatewayUpdateProducerOracleDb
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GatewayUpdateProducerOracleDb.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GatewayUpdateProducerOracleDb is not found in the empty JSON string", GatewayUpdateProducerOracleDb.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GatewayUpdateProducerOracleDb.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GatewayUpdateProducerOracleDb` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GatewayUpdateProducerOracleDb.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GatewayUpdateProducerOracleDb.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GatewayUpdateProducerOracleDb' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GatewayUpdateProducerOracleDb> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GatewayUpdateProducerOracleDb.class));

       return (TypeAdapter<T>) new TypeAdapter<GatewayUpdateProducerOracleDb>() {
           @Override
           public void write(JsonWriter out, GatewayUpdateProducerOracleDb value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GatewayUpdateProducerOracleDb read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GatewayUpdateProducerOracleDb given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GatewayUpdateProducerOracleDb
   * @throws IOException if the JSON string is invalid with respect to GatewayUpdateProducerOracleDb
   */
  public static GatewayUpdateProducerOracleDb fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GatewayUpdateProducerOracleDb.class);
  }

  /**
   * Convert an instance of GatewayUpdateProducerOracleDb to an JSON string
   *
   * @return JSON string
   */
