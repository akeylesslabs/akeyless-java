...
public class RenewCertificate {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("cert-issuer-name", "generate-key", "item-id", "json", "name", "token", "uid-token"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RenewCertificate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RenewCertificate is not found in the empty JSON string", RenewCertificate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RenewCertificate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RenewCertificate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
