...
public class AuthMethodUpdateLdap {
  ...
  public AuthMethodUpdateLdap accessExpires(@javax.annotation.Nullable Long accessExpires) {
  ...
  public AuthMethodUpdateLdap allowedClientType(@javax.annotation.Nullable List<String> allowedClientType) {
    this.allowedClientType = allowedClientType;
    return this;
  }

  public AuthMethodUpdateLdap addAllowedClientTypeItem(String allowedClientTypeItem) {
  ...
  public AuthMethodUpdateLdap auditLogsClaims(@javax.annotation.Nullable List<String> auditLogsClaims) {
    this.auditLogsClaims = auditLogsClaims;
    return this;
  }

  public AuthMethodUpdateLdap addAuditLogsClaimsItem(String auditLogsClaimsItem) {
  ...
  public AuthMethodUpdateLdap boundIps(@javax.annotation.Nullable List<String> boundIps) {
    this.boundIps = boundIps;
    return this;
  }

  public AuthMethodUpdateLdap addBoundIpsItem(String boundIpsItem) {
  ...
  public AuthMethodUpdateLdap deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public AuthMethodUpdateLdap description(@javax.annotation.Nullable String description) {
  ...
  public AuthMethodUpdateLdap expirationEventIn(@javax.annotation.Nullable List<String> expirationEventIn) {
    this.expirationEventIn = expirationEventIn;
    return this;
  }

  public AuthMethodUpdateLdap addExpirationEventInItem(String expirationEventInItem) {
  ...
  public AuthMethodUpdateLdap forceSubClaims(@javax.annotation.Nullable Boolean forceSubClaims) {
  ...
  public AuthMethodUpdateLdap genKey(@javax.annotation.Nullable String genKey) {
    this.genKey = genKey;
    return this;
  }
  ...
  public AuthMethodUpdateLdap gwBoundIps(@javax.annotation.Nullable List<String> gwBoundIps) {
    this.gwBoundIps = gwBoundIps;
    return this;
  }

  public AuthMethodUpdateLdap addGwBoundIpsItem(String gwBoundIpsItem) {
  ...
  public AuthMethodUpdateLdap json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public AuthMethodUpdateLdap jwtTtl(@javax.annotation.Nullable Long jwtTtl) {
    this.jwtTtl = jwtTtl;
    return this;
  }
  ...
  public AuthMethodUpdateLdap name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public AuthMethodUpdateLdap newName(@javax.annotation.Nullable String newName) {
  ...
  public AuthMethodUpdateLdap productType(@javax.annotation.Nullable List<String> productType) {
    this.productType = productType;
    return this;
  }

  public AuthMethodUpdateLdap addProductTypeItem(String productTypeItem) {
  ...
  public AuthMethodUpdateLdap publicKeyData(@javax.annotation.Nullable String publicKeyData) {
  ...
  public AuthMethodUpdateLdap token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public AuthMethodUpdateLdap uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public AuthMethodUpdateLdap uniqueIdentifier(@javax.annotation.Nullable String uniqueIdentifier) {
  ...
  public boolean equals(Object o) {
    ...
    AuthMethodUpdateLdap authMethodUpdateLdap = (AuthMethodUpdateLdap) o;
    return Objects.equals(this.accessExpires, authMethodUpdateLdap.accessExpires) &&
        Objects.equals(this.allowedClientType, authMethodUpdateLdap.allowedClientType) &&
        Objects.equals(this.auditLogsClaims, authMethodUpdateLdap.auditLogsClaims) &&
        Objects.equals(this.boundIps, authMethodUpdateLdap.boundIps) &&
        Objects.equals(this.deleteProtection, authMethodUpdateLdap.deleteProtection) &&
        Objects.equals(this.description, authMethodUpdateLdap.description) &&
        Objects.equals(this.expirationEventIn, authMethodUpdateLdap.expirationEventIn) &&
        Objects.equals(this.forceSubClaims, authMethodUpdateLdap.forceSubClaims) &&
        Objects.equals(this.genKey, authMethodUpdateLdap.genKey) &&
        Objects.equals(this.gwBoundIps, authMethodUpdateLdap.gwBoundIps) &&
        Objects.equals(this.json, authMethodUpdateLdap.json) &&
        Objects.equals(this.jwtTtl, authMethodUpdateLdap.jwtTtl) &&
        Objects.equals(this.name, authMethodUpdateLdap.name) &&
        Objects.equals(this.newName, authMethodUpdateLdap.newName) &&
        Objects.equals(this.productType, authMethodUpdateLdap.productType) &&
        Objects.equals(this.publicKeyData, authMethodUpdateLdap.publicKeyData) &&
        Objects.equals(this.token, authMethodUpdateLdap.token) &&
        Objects.equals(this.uidToken, authMethodUpdateLdap.uidToken) &&
        Objects.equals(this.uniqueIdentifier, authMethodUpdateLdap.uniqueIdentifier);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("access-expires", "allowed-client-type", "audit-logs-claims", "bound-ips", "delete_protection", "description", "expiration-event-in", "force-sub-claims", "gen-key", "gw-bound-ips", "json", "jwt-ttl", "name", "new-name", "product-type", "public-key-data", "token", "uid-token", "unique-identifier"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to AuthMethodUpdateLdap
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthMethodUpdateLdap.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AuthMethodUpdateLdap is not found in the empty JSON string", AuthMethodUpdateLdap.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthMethodUpdateLdap.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AuthMethodUpdateLdap` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AuthMethodUpdateLdap.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuthMethodUpdateLdap.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuthMethodUpdateLdap' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuthMethodUpdateLdap> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuthMethodUpdateLdap.class));

       return (TypeAdapter<T>) new TypeAdapter<AuthMethodUpdateLdap>() {
           @Override
           public void write(JsonWriter out, AuthMethodUpdateLdap value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AuthMethodUpdateLdap read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AuthMethodUpdateLdap given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AuthMethodUpdateLdap
   * @throws IOException if the JSON string is invalid with respect to AuthMethodUpdateLdap
   */
  public static AuthMethodUpdateLdap fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuthMethodUpdateLdap.class);
  }

  /**
   * Convert an instance of AuthMethodUpdateLdap to an JSON string
   *
   * @return JSON string
   */
