...
public class EventForwarderCreateSlack {
  ...
  public EventForwarderCreateSlack authMethodsEventSourceLocations(@javax.annotation.Nullable List<String> authMethodsEventSourceLocations) {
  ...
  public EventForwarderCreateSlack description(@javax.annotation.Nullable String description) {
  ...
  public EventForwarderCreateSlack eventTypes(@javax.annotation.Nullable List<String> eventTypes) {
  ...
  public EventForwarderCreateSlack every(@javax.annotation.Nullable String every) {
    this.every = every;
    return this;
  }
  ...
  public EventForwarderCreateSlack gatewaysEventSourceLocations(@javax.annotation.Nonnull List<String> gatewaysEventSourceLocations) {
  ...
  public EventForwarderCreateSlack itemsEventSourceLocations(@javax.annotation.Nullable List<String> itemsEventSourceLocations) {
  ...
  public EventForwarderCreateSlack json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public EventForwarderCreateSlack key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public EventForwarderCreateSlack name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public EventForwarderCreateSlack runnerType(@javax.annotation.Nonnull String runnerType) {
  ...
  public EventForwarderCreateSlack targetsEventSourceLocations(@javax.annotation.Nullable List<String> targetsEventSourceLocations) {
  ...
  public EventForwarderCreateSlack token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public EventForwarderCreateSlack uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public EventForwarderCreateSlack url(@javax.annotation.Nonnull String url) {
    this.url = url;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to EventForwarderCreateSlack
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventForwarderCreateSlack.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EventForwarderCreateSlack is not found in the empty JSON string", EventForwarderCreateSlack.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EventForwarderCreateSlack.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EventForwarderCreateSlack` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EventForwarderCreateSlack.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventForwarderCreateSlack.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventForwarderCreateSlack' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventForwarderCreateSlack> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventForwarderCreateSlack.class));

       return (TypeAdapter<T>) new TypeAdapter<EventForwarderCreateSlack>() {
           @Override
           public void write(JsonWriter out, EventForwarderCreateSlack value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EventForwarderCreateSlack read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EventForwarderCreateSlack given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EventForwarderCreateSlack
   * @throws IOException if the JSON string is invalid with respect to EventForwarderCreateSlack
   */
  public static EventForwarderCreateSlack fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EventForwarderCreateSlack.class);
  }

  /**
   * Convert an instance of EventForwarderCreateSlack to an JSON string
   *
   * @return JSON string
   */
