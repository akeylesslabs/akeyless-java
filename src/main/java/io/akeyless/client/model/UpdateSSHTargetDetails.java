...
public class UpdateSSHTargetDetails {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("host", "json", "keep-prev-version", "name", "new-version", "port", "private-key", "private-key-password", "protection_key", "ssh-password", "ssh-username", "token", "uid-token"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateSSHTargetDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateSSHTargetDetails is not found in the empty JSON string", UpdateSSHTargetDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateSSHTargetDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateSSHTargetDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
