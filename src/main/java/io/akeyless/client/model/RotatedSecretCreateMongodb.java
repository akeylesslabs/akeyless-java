...
public class RotatedSecretCreateMongodb {
  ...
  public RotatedSecretCreateMongodb authenticationCredentials(String authenticationCredentials) {
  ...
  **/
  ...
  public RotatedSecretCreateMongodb autoRotate(String autoRotate) {
  ...
  **/
  ...
  public RotatedSecretCreateMongodb deleteProtection(String deleteProtection) {
  ...
  **/
  ...
  public RotatedSecretCreateMongodb description(String description) {
  ...
  **/
  ...
  public RotatedSecretCreateMongodb json(Boolean json) {
  ...
  **/
  ...
  public RotatedSecretCreateMongodb key(String key) {
  ...
  **/
  ...
  public RotatedSecretCreateMongodb name(String name) {
  ...
  **/
  ...
  public RotatedSecretCreateMongodb passwordLength(String passwordLength) {
  ...
  **/
  ...
  public RotatedSecretCreateMongodb rotateAfterDisconnect(String rotateAfterDisconnect) {
  ...
  **/
  ...
  public RotatedSecretCreateMongodb rotatedPassword(String rotatedPassword) {
  ...
  **/
  ...
  public RotatedSecretCreateMongodb rotatedUsername(String rotatedUsername) {
  ...
  **/
  ...
  public RotatedSecretCreateMongodb rotationEventIn(List<String> rotationEventIn) {
  ...
  **/
  ...
  public RotatedSecretCreateMongodb rotationHour(Integer rotationHour) {
  ...
  **/
  ...
  public RotatedSecretCreateMongodb rotationInterval(String rotationInterval) {
  ...
  **/
  ...
  public RotatedSecretCreateMongodb rotatorType(String rotatorType) {
  ...
  **/
  ...
  public RotatedSecretCreateMongodb secureAccessBastionIssuer(String secureAccessBastionIssuer) {
  ...
  **/
  ...
  public RotatedSecretCreateMongodb secureAccessDbName(String secureAccessDbName) {
  ...
  **/
  ...
  public RotatedSecretCreateMongodb secureAccessEnable(String secureAccessEnable) {
  ...
  **/
  ...
  public RotatedSecretCreateMongodb secureAccessHost(List<String> secureAccessHost) {
  ...
  **/
  ...
  public RotatedSecretCreateMongodb secureAccessWeb(Boolean secureAccessWeb) {
  ...
  **/
  ...
  public RotatedSecretCreateMongodb tags(List<String> tags) {
  ...
  **/
  ...
  public RotatedSecretCreateMongodb targetName(String targetName) {
  ...
  **/
  ...
  public RotatedSecretCreateMongodb token(String token) {
  ...
  **/
  ...
  public RotatedSecretCreateMongodb uidToken(String uidToken) {
