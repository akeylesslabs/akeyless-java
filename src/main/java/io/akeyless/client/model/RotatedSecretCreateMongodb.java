...
public class RotatedSecretCreateMongodb {
  ...
  public RotatedSecretCreateMongodb() {
  }

  public RotatedSecretCreateMongodb authenticationCredentials(@javax.annotation.Nullable String authenticationCredentials) {
  ...
  public RotatedSecretCreateMongodb autoRotate(@javax.annotation.Nullable String autoRotate) {
  ...
  public RotatedSecretCreateMongodb deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public RotatedSecretCreateMongodb description(@javax.annotation.Nullable String description) {
  ...
  public RotatedSecretCreateMongodb inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public RotatedSecretCreateMongodb addInputRuleItem(String inputRuleItem) {
  ...
  public RotatedSecretCreateMongodb itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public RotatedSecretCreateMongodb putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public RotatedSecretCreateMongodb json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public RotatedSecretCreateMongodb key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public RotatedSecretCreateMongodb lockDuringSraSession(@javax.annotation.Nullable String lockDuringSraSession) {
  ...
  public RotatedSecretCreateMongodb maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public RotatedSecretCreateMongodb name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public RotatedSecretCreateMongodb outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public RotatedSecretCreateMongodb addOutputRuleItem(String outputRuleItem) {
  ...
  public RotatedSecretCreateMongodb passwordLength(@javax.annotation.Nullable String passwordLength) {
  ...
  public RotatedSecretCreateMongodb rotateAfterDisconnect(@javax.annotation.Nullable String rotateAfterDisconnect) {
  ...
  public RotatedSecretCreateMongodb rotatedPassword(@javax.annotation.Nullable String rotatedPassword) {
  ...
  public RotatedSecretCreateMongodb rotatedUsername(@javax.annotation.Nullable String rotatedUsername) {
  ...
  public RotatedSecretCreateMongodb rotationEventIn(@javax.annotation.Nullable List<String> rotationEventIn) {
    this.rotationEventIn = rotationEventIn;
    return this;
  }

  public RotatedSecretCreateMongodb addRotationEventInItem(String rotationEventInItem) {
  ...
  public RotatedSecretCreateMongodb rotationHour(@javax.annotation.Nullable Integer rotationHour) {
  ...
  public RotatedSecretCreateMongodb rotationInterval(@javax.annotation.Nullable String rotationInterval) {
  ...
  public RotatedSecretCreateMongodb rotatorType(@javax.annotation.Nonnull String rotatorType) {
  ...
  public RotatedSecretCreateMongodb secureAccessBastionIssuer(@javax.annotation.Nullable String secureAccessBastionIssuer) {
  ...
  public RotatedSecretCreateMongodb secureAccessCertificateIssuer(@javax.annotation.Nullable String secureAccessCertificateIssuer) {
  ...
  public RotatedSecretCreateMongodb secureAccessDbName(@javax.annotation.Nullable String secureAccessDbName) {
  ...
  public RotatedSecretCreateMongodb secureAccessEnable(@javax.annotation.Nullable String secureAccessEnable) {
  ...
  public RotatedSecretCreateMongodb secureAccessHost(@javax.annotation.Nullable List<String> secureAccessHost) {
    this.secureAccessHost = secureAccessHost;
    return this;
  }

  public RotatedSecretCreateMongodb addSecureAccessHostItem(String secureAccessHostItem) {
  ...
  public RotatedSecretCreateMongodb secureAccessWeb(@javax.annotation.Nullable Boolean secureAccessWeb) {
  ...
  public RotatedSecretCreateMongodb tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }

  public RotatedSecretCreateMongodb addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public RotatedSecretCreateMongodb targetName(@javax.annotation.Nonnull String targetName) {
  ...
  public RotatedSecretCreateMongodb token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public RotatedSecretCreateMongodb uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public RotatedSecretCreateMongodb useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public RotatedSecretCreateMongodb useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public RotatedSecretCreateMongodb useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public RotatedSecretCreateMongodb useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    RotatedSecretCreateMongodb rotatedSecretCreateMongodb = (RotatedSecretCreateMongodb) o;
    return Objects.equals(this.authenticationCredentials, rotatedSecretCreateMongodb.authenticationCredentials) &&
        Objects.equals(this.autoRotate, rotatedSecretCreateMongodb.autoRotate) &&
        Objects.equals(this.deleteProtection, rotatedSecretCreateMongodb.deleteProtection) &&
        Objects.equals(this.description, rotatedSecretCreateMongodb.description) &&
        Objects.equals(this.inputRule, rotatedSecretCreateMongodb.inputRule) &&
        Objects.equals(this.itemCustomFields, rotatedSecretCreateMongodb.itemCustomFields) &&
        Objects.equals(this.json, rotatedSecretCreateMongodb.json) &&
        Objects.equals(this.key, rotatedSecretCreateMongodb.key) &&
        Objects.equals(this.lockDuringSraSession, rotatedSecretCreateMongodb.lockDuringSraSession) &&
        ...
        Objects.equals(this.outputRule, rotatedSecretCreateMongodb.outputRule) &&
        ...
        Objects.equals(this.rotatedPassword, rotatedSecretCreateMongodb.rotatedPassword) &&
        Objects.equals(this.rotatedUsername, rotatedSecretCreateMongodb.rotatedUsername) &&
        Objects.equals(this.rotationEventIn, rotatedSecretCreateMongodb.rotationEventIn) &&
        Objects.equals(this.rotationHour, rotatedSecretCreateMongodb.rotationHour) &&
        Objects.equals(this.rotationInterval, rotatedSecretCreateMongodb.rotationInterval) &&
        Objects.equals(this.rotatorType, rotatedSecretCreateMongodb.rotatorType) &&
        Objects.equals(this.secureAccessBastionIssuer, rotatedSecretCreateMongodb.secureAccessBastionIssuer) &&
        Objects.equals(this.secureAccessCertificateIssuer, rotatedSecretCreateMongodb.secureAccessCertificateIssuer) &&
        Objects.equals(this.secureAccessDbName, rotatedSecretCreateMongodb.secureAccessDbName) &&
        Objects.equals(this.secureAccessEnable, rotatedSecretCreateMongodb.secureAccessEnable) &&
        Objects.equals(this.secureAccessHost, rotatedSecretCreateMongodb.secureAccessHost) &&
        Objects.equals(this.secureAccessWeb, rotatedSecretCreateMongodb.secureAccessWeb) &&
        Objects.equals(this.tags, rotatedSecretCreateMongodb.tags) &&
        Objects.equals(this.targetName, rotatedSecretCreateMongodb.targetName) &&
        Objects.equals(this.token, rotatedSecretCreateMongodb.token) &&
        Objects.equals(this.uidToken, rotatedSecretCreateMongodb.uidToken) &&
        Objects.equals(this.useCapitalLetters, rotatedSecretCreateMongodb.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, rotatedSecretCreateMongodb.useLowerLetters) &&
        Objects.equals(this.useNumbers, rotatedSecretCreateMongodb.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, rotatedSecretCreateMongodb.useSpecialCharacters);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authenticationCredentials, autoRotate, deleteProtection, description, inputRule, itemCustomFields, json, key, lockDuringSraSession, maxVersions, name, outputRule, passwordLength, rotateAfterDisconnect, rotatedPassword, rotatedUsername, rotationEventIn, rotationHour, rotationInterval, rotatorType, secureAccessBastionIssuer, secureAccessCertificateIssuer, secureAccessDbName, secureAccessEnable, secureAccessHost, secureAccessWeb, tags, targetName, token, uidToken, useCapitalLetters, useLowerLetters, useNumbers, useSpecialCharacters);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RotatedSecretCreateMongodb {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RotatedSecretCreateMongodb
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RotatedSecretCreateMongodb.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RotatedSecretCreateMongodb is not found in the empty JSON string", RotatedSecretCreateMongodb.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RotatedSecretCreateMongodb.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RotatedSecretCreateMongodb` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RotatedSecretCreateMongodb.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RotatedSecretCreateMongodb.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RotatedSecretCreateMongodb' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RotatedSecretCreateMongodb> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RotatedSecretCreateMongodb.class));

       return (TypeAdapter<T>) new TypeAdapter<RotatedSecretCreateMongodb>() {
           @Override
           public void write(JsonWriter out, RotatedSecretCreateMongodb value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RotatedSecretCreateMongodb read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RotatedSecretCreateMongodb given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RotatedSecretCreateMongodb
   * @throws IOException if the JSON string is invalid with respect to RotatedSecretCreateMongodb
   */
  public static RotatedSecretCreateMongodb fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RotatedSecretCreateMongodb.class);
  }

  /**
   * Convert an instance of RotatedSecretCreateMongodb to an JSON string
   *
   * @return JSON string
   */
