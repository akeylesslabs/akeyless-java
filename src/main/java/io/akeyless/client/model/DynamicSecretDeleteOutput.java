...
public class DynamicSecretDeleteOutput {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("dynamic_secret_name"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicSecretDeleteOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicSecretDeleteOutput is not found in the empty JSON string", DynamicSecretDeleteOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicSecretDeleteOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DynamicSecretDeleteOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
