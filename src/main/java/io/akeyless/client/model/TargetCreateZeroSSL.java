...
public class TargetCreateZeroSSL {
  ...
  public TargetCreateZeroSSL() {
  }

  public TargetCreateZeroSSL apiKey(@javax.annotation.Nonnull String apiKey) {
    this.apiKey = apiKey;
    return this;
  }
  ...
  public TargetCreateZeroSSL description(@javax.annotation.Nullable String description) {
  ...
  public TargetCreateZeroSSL imapFqdn(@javax.annotation.Nonnull String imapFqdn) {
  ...
  public TargetCreateZeroSSL imapPassword(@javax.annotation.Nonnull String imapPassword) {
  ...
  public TargetCreateZeroSSL imapPort(@javax.annotation.Nullable String imapPort) {
  ...
  public TargetCreateZeroSSL imapTargetEmail(@javax.annotation.Nullable String imapTargetEmail) {
  ...
  public TargetCreateZeroSSL imapUsername(@javax.annotation.Nonnull String imapUsername) {
  ...
  public TargetCreateZeroSSL json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public TargetCreateZeroSSL key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public TargetCreateZeroSSL maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public TargetCreateZeroSSL name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public TargetCreateZeroSSL timeout(@javax.annotation.Nullable String timeout) {
  ...
  public TargetCreateZeroSSL token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public TargetCreateZeroSSL uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.apiKey, targetCreateZeroSSL.apiKey) &&
        ...
        Objects.equals(this.imapPort, targetCreateZeroSSL.imapPort) &&
        Objects.equals(this.imapTargetEmail, targetCreateZeroSSL.imapTargetEmail) &&
        Objects.equals(this.imapUsername, targetCreateZeroSSL.imapUsername) &&
        Objects.equals(this.json, targetCreateZeroSSL.json) &&
        Objects.equals(this.key, targetCreateZeroSSL.key) &&
        Objects.equals(this.maxVersions, targetCreateZeroSSL.maxVersions) &&
        Objects.equals(this.name, targetCreateZeroSSL.name) &&
        Objects.equals(this.timeout, targetCreateZeroSSL.timeout) &&
        Objects.equals(this.token, targetCreateZeroSSL.token) &&
        Objects.equals(this.uidToken, targetCreateZeroSSL.uidToken);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("api-key", "delete_protection", "description", "imap-fqdn", "imap-password", "imap-port", "imap-target-email", "imap-username", "json", "key", "max-versions", "name", "timeout", "token", "uid-token"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("api-key", "imap-fqdn", "imap-password", "imap-username", "name"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TargetCreateZeroSSL
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TargetCreateZeroSSL.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TargetCreateZeroSSL is not found in the empty JSON string", TargetCreateZeroSSL.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TargetCreateZeroSSL.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TargetCreateZeroSSL` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TargetCreateZeroSSL.openapiRequiredFields) {
      ...
      if ((jsonObj.get("imap-target-email") != null && !jsonObj.get("imap-target-email").isJsonNull()) && !jsonObj.get("imap-target-email").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `imap-target-email` to be a primitive type in the JSON string but got `%s`", jsonObj.get("imap-target-email").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TargetCreateZeroSSL.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TargetCreateZeroSSL' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TargetCreateZeroSSL> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TargetCreateZeroSSL.class));

       return (TypeAdapter<T>) new TypeAdapter<TargetCreateZeroSSL>() {
           @Override
           public void write(JsonWriter out, TargetCreateZeroSSL value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TargetCreateZeroSSL read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TargetCreateZeroSSL given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TargetCreateZeroSSL
   * @throws IOException if the JSON string is invalid with respect to TargetCreateZeroSSL
   */
  public static TargetCreateZeroSSL fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TargetCreateZeroSSL.class);
  }

  /**
   * Convert an instance of TargetCreateZeroSSL to an JSON string
   *
   * @return JSON string
   */
