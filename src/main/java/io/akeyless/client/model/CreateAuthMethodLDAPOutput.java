...
public class CreateAuthMethodLDAPOutput {
  ...
  public CreateAuthMethodLDAPOutput accessId(@javax.annotation.Nullable String accessId) {
  ...
  public CreateAuthMethodLDAPOutput prvKey(@javax.annotation.Nullable String prvKey) {
    this.prvKey = prvKey;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateAuthMethodLDAPOutput
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateAuthMethodLDAPOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateAuthMethodLDAPOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateAuthMethodLDAPOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateAuthMethodLDAPOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateAuthMethodLDAPOutput>() {
           @Override
           public void write(JsonWriter out, CreateAuthMethodLDAPOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateAuthMethodLDAPOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateAuthMethodLDAPOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateAuthMethodLDAPOutput
   * @throws IOException if the JSON string is invalid with respect to CreateAuthMethodLDAPOutput
   */
  public static CreateAuthMethodLDAPOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAuthMethodLDAPOutput.class);
  }

  /**
   * Convert an instance of CreateAuthMethodLDAPOutput to an JSON string
   *
   * @return JSON string
   */
