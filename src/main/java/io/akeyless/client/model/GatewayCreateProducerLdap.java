...
public class GatewayCreateProducerLdap {
  ...
  public GatewayCreateProducerLdap providerType(@javax.annotation.Nullable String providerType) {
  ...
  public GatewayCreateProducerLdap bindDn(@javax.annotation.Nullable String bindDn) {
    this.bindDn = bindDn;
    return this;
  }
  ...
  public GatewayCreateProducerLdap bindDnPassword(@javax.annotation.Nullable String bindDnPassword) {
  ...
  public GatewayCreateProducerLdap customUsernameTemplate(@javax.annotation.Nullable String customUsernameTemplate) {
  ...
  public GatewayCreateProducerLdap deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public GatewayCreateProducerLdap externalUsername(@javax.annotation.Nullable String externalUsername) {
  ...
  public GatewayCreateProducerLdap fixedUserClaimKeyname(@javax.annotation.Nullable String fixedUserClaimKeyname) {
  ...
  public GatewayCreateProducerLdap groupDn(@javax.annotation.Nullable String groupDn) {
  ...
  public GatewayCreateProducerLdap hostProvider(@javax.annotation.Nullable String hostProvider) {
  ...
  public GatewayCreateProducerLdap inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public GatewayCreateProducerLdap addInputRuleItem(String inputRuleItem) {
  ...
  public GatewayCreateProducerLdap itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public GatewayCreateProducerLdap putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public GatewayCreateProducerLdap json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public GatewayCreateProducerLdap ldapCaCert(@javax.annotation.Nullable String ldapCaCert) {
  ...
  public GatewayCreateProducerLdap ldapUrl(@javax.annotation.Nullable String ldapUrl) {
  ...
  public GatewayCreateProducerLdap name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public GatewayCreateProducerLdap outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public GatewayCreateProducerLdap addOutputRuleItem(String outputRuleItem) {
  ...
  public GatewayCreateProducerLdap passwordLength(@javax.annotation.Nullable String passwordLength) {
  ...
  public GatewayCreateProducerLdap producerEncryptionKeyName(@javax.annotation.Nullable String producerEncryptionKeyName) {
  ...
  public GatewayCreateProducerLdap secureAccessEnable(@javax.annotation.Nullable String secureAccessEnable) {
  ...
  public GatewayCreateProducerLdap secureAccessHost(@javax.annotation.Nullable List<String> secureAccessHost) {
  ...
  public GatewayCreateProducerLdap secureAccessRdGatewayServer(@javax.annotation.Nullable String secureAccessRdGatewayServer) {
  ...
  public GatewayCreateProducerLdap secureAccessRdpDomain(@javax.annotation.Nullable String secureAccessRdpDomain) {
  ...
  public GatewayCreateProducerLdap tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public GatewayCreateProducerLdap target(@javax.annotation.Nullable List<String> target) {
    this.target = target;
    return this;
  }
  ...
  public GatewayCreateProducerLdap targetName(@javax.annotation.Nullable String targetName) {
  ...
  public GatewayCreateProducerLdap token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public GatewayCreateProducerLdap tokenExpiration(@javax.annotation.Nullable String tokenExpiration) {
  ...
  public GatewayCreateProducerLdap uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public GatewayCreateProducerLdap useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public GatewayCreateProducerLdap useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public GatewayCreateProducerLdap useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public GatewayCreateProducerLdap useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public GatewayCreateProducerLdap userAttribute(@javax.annotation.Nullable String userAttribute) {
  ...
  public GatewayCreateProducerLdap userDn(@javax.annotation.Nullable String userDn) {
    this.userDn = userDn;
    return this;
  }
  ...
  public GatewayCreateProducerLdap userTtl(@javax.annotation.Nullable String userTtl) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.providerType, gatewayCreateProducerLdap.providerType) &&
        ...
        Objects.equals(this.customUsernameTemplate, gatewayCreateProducerLdap.customUsernameTemplate) &&
        ...
        Objects.equals(this.fixedUserClaimKeyname, gatewayCreateProducerLdap.fixedUserClaimKeyname) &&
        ...
        Objects.equals(this.inputRule, gatewayCreateProducerLdap.inputRule) &&
        Objects.equals(this.itemCustomFields, gatewayCreateProducerLdap.itemCustomFields) &&
        ...
        Objects.equals(this.outputRule, gatewayCreateProducerLdap.outputRule) &&
        ...
        Objects.equals(this.useCapitalLetters, gatewayCreateProducerLdap.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, gatewayCreateProducerLdap.useLowerLetters) &&
        Objects.equals(this.useNumbers, gatewayCreateProducerLdap.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, gatewayCreateProducerLdap.useSpecialCharacters) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to GatewayCreateProducerLdap
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GatewayCreateProducerLdap.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GatewayCreateProducerLdap is not found in the empty JSON string", GatewayCreateProducerLdap.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GatewayCreateProducerLdap.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GatewayCreateProducerLdap` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GatewayCreateProducerLdap.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GatewayCreateProducerLdap.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GatewayCreateProducerLdap' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GatewayCreateProducerLdap> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GatewayCreateProducerLdap.class));

       return (TypeAdapter<T>) new TypeAdapter<GatewayCreateProducerLdap>() {
           @Override
           public void write(JsonWriter out, GatewayCreateProducerLdap value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GatewayCreateProducerLdap read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GatewayCreateProducerLdap given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GatewayCreateProducerLdap
   * @throws IOException if the JSON string is invalid with respect to GatewayCreateProducerLdap
   */
  public static GatewayCreateProducerLdap fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GatewayCreateProducerLdap.class);
  }

  /**
   * Convert an instance of GatewayCreateProducerLdap to an JSON string
   *
   * @return JSON string
   */
