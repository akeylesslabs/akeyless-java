...
public class TargetCreateDB {
  ...
  public TargetCreateDB() {
  }

  public TargetCreateDB azureClientId(@javax.annotation.Nullable String azureClientId) {
  ...
  public TargetCreateDB azureClientSecret(@javax.annotation.Nullable String azureClientSecret) {
  ...
  public TargetCreateDB azureTenantId(@javax.annotation.Nullable String azureTenantId) {
  ...
  public TargetCreateDB clientCertificate(@javax.annotation.Nullable String clientCertificate) {
  ...
  public TargetCreateDB clientKeyPassphrase(@javax.annotation.Nullable String clientKeyPassphrase) {
  ...
  public TargetCreateDB clientPrivateKey(@javax.annotation.Nullable String clientPrivateKey) {
  ...
  public TargetCreateDB cloudServiceProvider(@javax.annotation.Nullable String cloudServiceProvider) {
  ...
  public TargetCreateDB clusterMode(@javax.annotation.Nullable Boolean clusterMode) {
  ...
  public TargetCreateDB comment(@javax.annotation.Nullable String comment) {
  ...
  public TargetCreateDB connectionType(@javax.annotation.Nonnull String connectionType) {
  ...
  public TargetCreateDB dbName(@javax.annotation.Nullable String dbName) {
    this.dbName = dbName;
    return this;
  }
  ...
  public TargetCreateDB dbServerCertificates(@javax.annotation.Nullable String dbServerCertificates) {
  ...
  public TargetCreateDB dbServerName(@javax.annotation.Nullable String dbServerName) {
  ...
  public TargetCreateDB dbType(@javax.annotation.Nonnull String dbType) {
    this.dbType = dbType;
    return this;
  }
  ...
  public TargetCreateDB description(@javax.annotation.Nullable String description) {
  ...
  public TargetCreateDB enableMtls(@javax.annotation.Nullable Boolean enableMtls) {
  ...
  public TargetCreateDB host(@javax.annotation.Nullable String host) {
    this.host = host;
    return this;
  }
  ...
  public TargetCreateDB json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public TargetCreateDB key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public TargetCreateDB maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public TargetCreateDB mongodbAtlas(@javax.annotation.Nullable Boolean mongodbAtlas) {
  ...
  public TargetCreateDB mongodbAtlasApiPrivateKey(@javax.annotation.Nullable String mongodbAtlasApiPrivateKey) {
  ...
  public TargetCreateDB mongodbAtlasApiPublicKey(@javax.annotation.Nullable String mongodbAtlasApiPublicKey) {
  ...
  public TargetCreateDB mongodbAtlasProjectId(@javax.annotation.Nullable String mongodbAtlasProjectId) {
  ...
  public TargetCreateDB mongodbDefaultAuthDb(@javax.annotation.Nullable String mongodbDefaultAuthDb) {
  ...
  public TargetCreateDB mongodbUriOptions(@javax.annotation.Nullable String mongodbUriOptions) {
  ...
  public TargetCreateDB name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public TargetCreateDB oracleServiceName(@javax.annotation.Nullable String oracleServiceName) {
  ...
  public TargetCreateDB oracleWalletLoginType(@javax.annotation.Nullable String oracleWalletLoginType) {
  ...
  public TargetCreateDB oracleWalletP12FileData(@javax.annotation.Nullable String oracleWalletP12FileData) {
  ...
  public TargetCreateDB oracleWalletSsoFileData(@javax.annotation.Nullable String oracleWalletSsoFileData) {
  ...
  public TargetCreateDB parentTargetName(@javax.annotation.Nullable String parentTargetName) {
  ...
  public TargetCreateDB port(@javax.annotation.Nullable String port) {
    this.port = port;
    return this;
  }
  ...
  public TargetCreateDB pwd(@javax.annotation.Nullable String pwd) {
    this.pwd = pwd;
    return this;
  }
  ...
  public TargetCreateDB snowflakeAccount(@javax.annotation.Nullable String snowflakeAccount) {
  ...
  public TargetCreateDB snowflakeApiPrivateKey(@javax.annotation.Nullable String snowflakeApiPrivateKey) {
  ...
  public TargetCreateDB snowflakeApiPrivateKeyPassword(@javax.annotation.Nullable String snowflakeApiPrivateKeyPassword) {
  ...
  public TargetCreateDB ssl(@javax.annotation.Nullable Boolean ssl) {
    this.ssl = ssl;
    return this;
  }
  ...
  public TargetCreateDB sslCertificate(@javax.annotation.Nullable String sslCertificate) {
  ...
  public TargetCreateDB token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public TargetCreateDB uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public TargetCreateDB userName(@javax.annotation.Nullable String userName) {
  ...
  public boolean equals(Object o) {
    ...
    TargetCreateDB targetCreateDB = (TargetCreateDB) o;
    return Objects.equals(this.azureClientId, targetCreateDB.azureClientId) &&
        Objects.equals(this.azureClientSecret, targetCreateDB.azureClientSecret) &&
        Objects.equals(this.azureTenantId, targetCreateDB.azureTenantId) &&
        Objects.equals(this.clientCertificate, targetCreateDB.clientCertificate) &&
        Objects.equals(this.clientKeyPassphrase, targetCreateDB.clientKeyPassphrase) &&
        Objects.equals(this.clientPrivateKey, targetCreateDB.clientPrivateKey) &&
        Objects.equals(this.cloudServiceProvider, targetCreateDB.cloudServiceProvider) &&
        Objects.equals(this.clusterMode, targetCreateDB.clusterMode) &&
        Objects.equals(this.comment, targetCreateDB.comment) &&
        Objects.equals(this.connectionType, targetCreateDB.connectionType) &&
        Objects.equals(this.dbName, targetCreateDB.dbName) &&
        ...
        Objects.equals(this.enableMtls, targetCreateDB.enableMtls) &&
        Objects.equals(this.host, targetCreateDB.host) &&
        Objects.equals(this.json, targetCreateDB.json) &&
        Objects.equals(this.key, targetCreateDB.key) &&
        Objects.equals(this.maxVersions, targetCreateDB.maxVersions) &&
        Objects.equals(this.mongodbAtlas, targetCreateDB.mongodbAtlas) &&
        Objects.equals(this.mongodbAtlasApiPrivateKey, targetCreateDB.mongodbAtlasApiPrivateKey) &&
        Objects.equals(this.mongodbAtlasApiPublicKey, targetCreateDB.mongodbAtlasApiPublicKey) &&
        Objects.equals(this.mongodbAtlasProjectId, targetCreateDB.mongodbAtlasProjectId) &&
        Objects.equals(this.mongodbDefaultAuthDb, targetCreateDB.mongodbDefaultAuthDb) &&
        Objects.equals(this.mongodbUriOptions, targetCreateDB.mongodbUriOptions) &&
        Objects.equals(this.name, targetCreateDB.name) &&
        Objects.equals(this.oracleServiceName, targetCreateDB.oracleServiceName) &&
        Objects.equals(this.oracleWalletLoginType, targetCreateDB.oracleWalletLoginType) &&
        Objects.equals(this.oracleWalletP12FileData, targetCreateDB.oracleWalletP12FileData) &&
        Objects.equals(this.oracleWalletSsoFileData, targetCreateDB.oracleWalletSsoFileData) &&
        Objects.equals(this.parentTargetName, targetCreateDB.parentTargetName) &&
        Objects.equals(this.port, targetCreateDB.port) &&
        Objects.equals(this.pwd, targetCreateDB.pwd) &&
        Objects.equals(this.snowflakeAccount, targetCreateDB.snowflakeAccount) &&
        Objects.equals(this.snowflakeApiPrivateKey, targetCreateDB.snowflakeApiPrivateKey) &&
        Objects.equals(this.snowflakeApiPrivateKeyPassword, targetCreateDB.snowflakeApiPrivateKeyPassword) &&
        Objects.equals(this.ssl, targetCreateDB.ssl) &&
        Objects.equals(this.sslCertificate, targetCreateDB.sslCertificate) &&
        Objects.equals(this.token, targetCreateDB.token) &&
        Objects.equals(this.uidToken, targetCreateDB.uidToken) &&
        Objects.equals(this.userName, targetCreateDB.userName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(azureClientId, azureClientSecret, azureTenantId, clientCertificate, clientKeyPassphrase, clientPrivateKey, cloudServiceProvider, clusterMode, comment, connectionType, dbName, dbServerCertificates, dbServerName, dbType, deleteProtection, description, enableMtls, host, json, key, maxVersions, mongodbAtlas, mongodbAtlasApiPrivateKey, mongodbAtlasApiPublicKey, mongodbAtlasProjectId, mongodbDefaultAuthDb, mongodbUriOptions, name, oracleServiceName, oracleWalletLoginType, oracleWalletP12FileData, oracleWalletSsoFileData, parentTargetName, port, pwd, snowflakeAccount, snowflakeApiPrivateKey, snowflakeApiPrivateKeyPassword, ssl, sslCertificate, token, uidToken, userName);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("azure-client-id", "azure-client-secret", "azure-tenant-id", "client-certificate", "client-key-passphrase", "client-private-key", "cloud-service-provider", "cluster-mode", "comment", "connection-type", "db-name", "db-server-certificates", "db-server-name", "db-type", "delete_protection", "description", "enable-mtls", "host", "json", "key", "max-versions", "mongodb-atlas", "mongodb-atlas-api-private-key", "mongodb-atlas-api-public-key", "mongodb-atlas-project-id", "mongodb-default-auth-db", "mongodb-uri-options", "name", "oracle-service-name", "oracle-wallet-login-type", "oracle-wallet-p12-file-data", "oracle-wallet-sso-file-data", "parent-target-name", "port", "pwd", "snowflake-account", "snowflake-api-private-key", "snowflake-api-private-key-password", "ssl", "ssl-certificate", "token", "uid-token", "user-name"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("connection-type", "db-type", "name"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TargetCreateDB
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TargetCreateDB.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TargetCreateDB is not found in the empty JSON string", TargetCreateDB.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TargetCreateDB.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TargetCreateDB` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TargetCreateDB.openapiRequiredFields) {
      ...
      if ((jsonObj.get("client-certificate") != null && !jsonObj.get("client-certificate").isJsonNull()) && !jsonObj.get("client-certificate").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `client-certificate` to be a primitive type in the JSON string but got `%s`", jsonObj.get("client-certificate").toString()));
      }
      if ((jsonObj.get("client-key-passphrase") != null && !jsonObj.get("client-key-passphrase").isJsonNull()) && !jsonObj.get("client-key-passphrase").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `client-key-passphrase` to be a primitive type in the JSON string but got `%s`", jsonObj.get("client-key-passphrase").toString()));
      }
      if ((jsonObj.get("client-private-key") != null && !jsonObj.get("client-private-key").isJsonNull()) && !jsonObj.get("client-private-key").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `client-private-key` to be a primitive type in the JSON string but got `%s`", jsonObj.get("client-private-key").toString()));
      }
      if ((jsonObj.get("cloud-service-provider") != null && !jsonObj.get("cloud-service-provider").isJsonNull()) && !jsonObj.get("cloud-service-provider").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `cloud-service-provider` to be a primitive type in the JSON string but got `%s`", jsonObj.get("cloud-service-provider").toString()));
      }
      ...
      if (!jsonObj.get("connection-type").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `connection-type` to be a primitive type in the JSON string but got `%s`", jsonObj.get("connection-type").toString()));
      }
      ...
      if ((jsonObj.get("db-server-certificates") != null && !jsonObj.get("db-server-certificates").isJsonNull()) && !jsonObj.get("db-server-certificates").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `db-server-certificates` to be a primitive type in the JSON string but got `%s`", jsonObj.get("db-server-certificates").toString()));
      }
      if ((jsonObj.get("db-server-name") != null && !jsonObj.get("db-server-name").isJsonNull()) && !jsonObj.get("db-server-name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `db-server-name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("db-server-name").toString()));
      }
      ...
      if ((jsonObj.get("mongodb-atlas-api-private-key") != null && !jsonObj.get("mongodb-atlas-api-private-key").isJsonNull()) && !jsonObj.get("mongodb-atlas-api-private-key").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `mongodb-atlas-api-private-key` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mongodb-atlas-api-private-key").toString()));
      }
      if ((jsonObj.get("mongodb-atlas-api-public-key") != null && !jsonObj.get("mongodb-atlas-api-public-key").isJsonNull()) && !jsonObj.get("mongodb-atlas-api-public-key").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `mongodb-atlas-api-public-key` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mongodb-atlas-api-public-key").toString()));
      }
      if ((jsonObj.get("mongodb-atlas-project-id") != null && !jsonObj.get("mongodb-atlas-project-id").isJsonNull()) && !jsonObj.get("mongodb-atlas-project-id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `mongodb-atlas-project-id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mongodb-atlas-project-id").toString()));
      }
      if ((jsonObj.get("mongodb-default-auth-db") != null && !jsonObj.get("mongodb-default-auth-db").isJsonNull()) && !jsonObj.get("mongodb-default-auth-db").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `mongodb-default-auth-db` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mongodb-default-auth-db").toString()));
      }
      if ((jsonObj.get("mongodb-uri-options") != null && !jsonObj.get("mongodb-uri-options").isJsonNull()) && !jsonObj.get("mongodb-uri-options").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `mongodb-uri-options` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mongodb-uri-options").toString()));
      }
      ...
      if ((jsonObj.get("oracle-service-name") != null && !jsonObj.get("oracle-service-name").isJsonNull()) && !jsonObj.get("oracle-service-name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `oracle-service-name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("oracle-service-name").toString()));
      }
      if ((jsonObj.get("oracle-wallet-login-type") != null && !jsonObj.get("oracle-wallet-login-type").isJsonNull()) && !jsonObj.get("oracle-wallet-login-type").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `oracle-wallet-login-type` to be a primitive type in the JSON string but got `%s`", jsonObj.get("oracle-wallet-login-type").toString()));
      }
      if ((jsonObj.get("oracle-wallet-p12-file-data") != null && !jsonObj.get("oracle-wallet-p12-file-data").isJsonNull()) && !jsonObj.get("oracle-wallet-p12-file-data").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `oracle-wallet-p12-file-data` to be a primitive type in the JSON string but got `%s`", jsonObj.get("oracle-wallet-p12-file-data").toString()));
      }
      if ((jsonObj.get("oracle-wallet-sso-file-data") != null && !jsonObj.get("oracle-wallet-sso-file-data").isJsonNull()) && !jsonObj.get("oracle-wallet-sso-file-data").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `oracle-wallet-sso-file-data` to be a primitive type in the JSON string but got `%s`", jsonObj.get("oracle-wallet-sso-file-data").toString()));
      }
      if ((jsonObj.get("parent-target-name") != null && !jsonObj.get("parent-target-name").isJsonNull()) && !jsonObj.get("parent-target-name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `parent-target-name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("parent-target-name").toString()));
      }
      ...
      if ((jsonObj.get("snowflake-account") != null && !jsonObj.get("snowflake-account").isJsonNull()) && !jsonObj.get("snowflake-account").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `snowflake-account` to be a primitive type in the JSON string but got `%s`", jsonObj.get("snowflake-account").toString()));
      }
      if ((jsonObj.get("snowflake-api-private-key") != null && !jsonObj.get("snowflake-api-private-key").isJsonNull()) && !jsonObj.get("snowflake-api-private-key").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `snowflake-api-private-key` to be a primitive type in the JSON string but got `%s`", jsonObj.get("snowflake-api-private-key").toString()));
      }
      if ((jsonObj.get("snowflake-api-private-key-password") != null && !jsonObj.get("snowflake-api-private-key-password").isJsonNull()) && !jsonObj.get("snowflake-api-private-key-password").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `snowflake-api-private-key-password` to be a primitive type in the JSON string but got `%s`", jsonObj.get("snowflake-api-private-key-password").toString()));
      }
      if ((jsonObj.get("ssl-certificate") != null && !jsonObj.get("ssl-certificate").isJsonNull()) && !jsonObj.get("ssl-certificate").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `ssl-certificate` to be a primitive type in the JSON string but got `%s`", jsonObj.get("ssl-certificate").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TargetCreateDB.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TargetCreateDB' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TargetCreateDB> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TargetCreateDB.class));

       return (TypeAdapter<T>) new TypeAdapter<TargetCreateDB>() {
           @Override
           public void write(JsonWriter out, TargetCreateDB value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TargetCreateDB read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TargetCreateDB given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TargetCreateDB
   * @throws IOException if the JSON string is invalid with respect to TargetCreateDB
   */
  public static TargetCreateDB fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TargetCreateDB.class);
  }

  /**
   * Convert an instance of TargetCreateDB to an JSON string
   *
   * @return JSON string
   */
