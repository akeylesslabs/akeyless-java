...
public class GwUpdateRemoteAccessSessionLogsAzureAnalytics {
  ...
  public GwUpdateRemoteAccessSessionLogsAzureAnalytics enableBatch(@javax.annotation.Nullable String enableBatch) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.enable, gwUpdateRemoteAccessSessionLogsAzureAnalytics.enable) &&
        Objects.equals(this.enableBatch, gwUpdateRemoteAccessSessionLogsAzureAnalytics.enableBatch) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GwUpdateRemoteAccessSessionLogsAzureAnalytics.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GwUpdateRemoteAccessSessionLogsAzureAnalytics is not found in the empty JSON string", GwUpdateRemoteAccessSessionLogsAzureAnalytics.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GwUpdateRemoteAccessSessionLogsAzureAnalytics.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GwUpdateRemoteAccessSessionLogsAzureAnalytics` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
