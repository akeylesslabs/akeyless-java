...
public class GatewayCreateProducerCassandra {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(cassandraCreationStatements, cassandraHosts, cassandraPassword, cassandraPort, cassandraUsername, customUsernameTemplate, deleteProtection, itemCustomFields, json, name, passwordLength, producerEncryptionKeyName, ssl, sslCertificate, tags, targetName, token, uidToken, userTtl);
  }
