...
public class RotatedSecretCreateWindows {
  ...
  public RotatedSecretCreateWindows inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public RotatedSecretCreateWindows addInputRuleItem(String inputRuleItem) {
  ...
  public RotatedSecretCreateWindows itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public RotatedSecretCreateWindows putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public RotatedSecretCreateWindows lockDuringSraSession(@javax.annotation.Nullable String lockDuringSraSession) {
  ...
  public RotatedSecretCreateWindows outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public RotatedSecretCreateWindows addOutputRuleItem(String outputRuleItem) {
  ...
  public RotatedSecretCreateWindows secureAccessBastionIssuer(@javax.annotation.Nullable String secureAccessBastionIssuer) {
  ...
  public RotatedSecretCreateWindows secureAccessCertificateIssuer(@javax.annotation.Nullable String secureAccessCertificateIssuer) {
  ...
  public RotatedSecretCreateWindows useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public RotatedSecretCreateWindows useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public RotatedSecretCreateWindows useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public RotatedSecretCreateWindows useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authenticationCredentials, rotatedSecretCreateWindows.authenticationCredentials) &&
        ...
        Objects.equals(this.inputRule, rotatedSecretCreateWindows.inputRule) &&
        Objects.equals(this.itemCustomFields, rotatedSecretCreateWindows.itemCustomFields) &&
        Objects.equals(this.json, rotatedSecretCreateWindows.json) &&
        Objects.equals(this.key, rotatedSecretCreateWindows.key) &&
        Objects.equals(this.lockDuringSraSession, rotatedSecretCreateWindows.lockDuringSraSession) &&
        ...
        Objects.equals(this.outputRule, rotatedSecretCreateWindows.outputRule) &&
        ...
        Objects.equals(this.secureAccessBastionIssuer, rotatedSecretCreateWindows.secureAccessBastionIssuer) &&
        Objects.equals(this.secureAccessCertificateIssuer, rotatedSecretCreateWindows.secureAccessCertificateIssuer) &&
        ...
        Objects.equals(this.useCapitalLetters, rotatedSecretCreateWindows.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, rotatedSecretCreateWindows.useLowerLetters) &&
        Objects.equals(this.useNumbers, rotatedSecretCreateWindows.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, rotatedSecretCreateWindows.useSpecialCharacters);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authenticationCredentials, autoRotate, deleteProtection, description, inputRule, itemCustomFields, json, key, lockDuringSraSession, maxVersions, name, outputRule, passwordLength, rotateAfterDisconnect, rotatedPassword, rotatedUsername, rotationEventIn, rotationHour, rotationInterval, rotatorType, samePassword, secureAccessAllowExternalUser, secureAccessBastionIssuer, secureAccessCertificateIssuer, secureAccessEnable, secureAccessHost, secureAccessRdpDomain, secureAccessRdpUser, tags, targetName, token, uidToken, useCapitalLetters, useLowerLetters, useNumbers, useSpecialCharacters);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("authentication-credentials", "auto-rotate", "delete_protection", "description", "input-rule", "item-custom-fields", "json", "key", "lock-during-sra-session", "max-versions", "name", "output-rule", "password-length", "rotate-after-disconnect", "rotated-password", "rotated-username", "rotation-event-in", "rotation-hour", "rotation-interval", "rotator-type", "same-password", "secure-access-allow-external-user", "secure-access-bastion-issuer", "secure-access-certificate-issuer", "secure-access-enable", "secure-access-host", "secure-access-rdp-domain", "secure-access-rdp-user", "tags", "target-name", "token", "uid-token", "use-capital-letters", "use-lower-letters", "use-numbers", "use-special-characters"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RotatedSecretCreateWindows.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RotatedSecretCreateWindows is not found in the empty JSON string", RotatedSecretCreateWindows.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RotatedSecretCreateWindows.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RotatedSecretCreateWindows` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
