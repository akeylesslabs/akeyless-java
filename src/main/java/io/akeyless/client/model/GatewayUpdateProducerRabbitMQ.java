...
public class GatewayUpdateProducerRabbitMQ {
  ...
  public GatewayUpdateProducerRabbitMQ() {
  }

  public GatewayUpdateProducerRabbitMQ deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public GatewayUpdateProducerRabbitMQ inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public GatewayUpdateProducerRabbitMQ addInputRuleItem(String inputRuleItem) {
  ...
  public GatewayUpdateProducerRabbitMQ itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public GatewayUpdateProducerRabbitMQ putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public GatewayUpdateProducerRabbitMQ json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public GatewayUpdateProducerRabbitMQ name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public GatewayUpdateProducerRabbitMQ newName(@javax.annotation.Nullable String newName) {
  ...
  public GatewayUpdateProducerRabbitMQ outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public GatewayUpdateProducerRabbitMQ addOutputRuleItem(String outputRuleItem) {
  ...
  public GatewayUpdateProducerRabbitMQ passwordLength(@javax.annotation.Nullable String passwordLength) {
  ...
  public GatewayUpdateProducerRabbitMQ producerEncryptionKeyName(@javax.annotation.Nullable String producerEncryptionKeyName) {
  ...
  public GatewayUpdateProducerRabbitMQ rabbitmqAdminPwd(@javax.annotation.Nullable String rabbitmqAdminPwd) {
  ...
  public GatewayUpdateProducerRabbitMQ rabbitmqAdminUser(@javax.annotation.Nullable String rabbitmqAdminUser) {
  ...
  public GatewayUpdateProducerRabbitMQ rabbitmqServerUri(@javax.annotation.Nullable String rabbitmqServerUri) {
  ...
  public GatewayUpdateProducerRabbitMQ rabbitmqUserConfPermission(@javax.annotation.Nullable String rabbitmqUserConfPermission) {
  ...
  public GatewayUpdateProducerRabbitMQ rabbitmqUserReadPermission(@javax.annotation.Nullable String rabbitmqUserReadPermission) {
  ...
  public GatewayUpdateProducerRabbitMQ rabbitmqUserTags(@javax.annotation.Nullable String rabbitmqUserTags) {
  ...
  public GatewayUpdateProducerRabbitMQ rabbitmqUserVhost(@javax.annotation.Nullable String rabbitmqUserVhost) {
  ...
  public GatewayUpdateProducerRabbitMQ rabbitmqUserWritePermission(@javax.annotation.Nullable String rabbitmqUserWritePermission) {
  ...
  public GatewayUpdateProducerRabbitMQ secureAccessEnable(@javax.annotation.Nullable String secureAccessEnable) {
  ...
  public GatewayUpdateProducerRabbitMQ secureAccessUrl(@javax.annotation.Nullable String secureAccessUrl) {
  ...
  public GatewayUpdateProducerRabbitMQ secureAccessWeb(@javax.annotation.Nullable Boolean secureAccessWeb) {
  ...
  public GatewayUpdateProducerRabbitMQ secureAccessWebBrowsing(@javax.annotation.Nullable Boolean secureAccessWebBrowsing) {
  ...
  public GatewayUpdateProducerRabbitMQ secureAccessWebProxy(@javax.annotation.Nullable Boolean secureAccessWebProxy) {
  ...
  public GatewayUpdateProducerRabbitMQ tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public GatewayUpdateProducerRabbitMQ targetName(@javax.annotation.Nullable String targetName) {
  ...
  public GatewayUpdateProducerRabbitMQ token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public GatewayUpdateProducerRabbitMQ uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public GatewayUpdateProducerRabbitMQ useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public GatewayUpdateProducerRabbitMQ useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public GatewayUpdateProducerRabbitMQ useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public GatewayUpdateProducerRabbitMQ useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public GatewayUpdateProducerRabbitMQ userTtl(@javax.annotation.Nullable String userTtl) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.deleteProtection, gatewayUpdateProducerRabbitMQ.deleteProtection) &&
        Objects.equals(this.inputRule, gatewayUpdateProducerRabbitMQ.inputRule) &&
        Objects.equals(this.itemCustomFields, gatewayUpdateProducerRabbitMQ.itemCustomFields) &&
        ...
        Objects.equals(this.outputRule, gatewayUpdateProducerRabbitMQ.outputRule) &&
        ...
        Objects.equals(this.useCapitalLetters, gatewayUpdateProducerRabbitMQ.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, gatewayUpdateProducerRabbitMQ.useLowerLetters) &&
        Objects.equals(this.useNumbers, gatewayUpdateProducerRabbitMQ.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, gatewayUpdateProducerRabbitMQ.useSpecialCharacters) &&
        Objects.equals(this.userTtl, gatewayUpdateProducerRabbitMQ.userTtl);
  }

  @Override
  public int hashCode() {
    return Objects.hash(deleteProtection, inputRule, itemCustomFields, json, name, newName, outputRule, passwordLength, producerEncryptionKeyName, rabbitmqAdminPwd, rabbitmqAdminUser, rabbitmqServerUri, rabbitmqUserConfPermission, rabbitmqUserReadPermission, rabbitmqUserTags, rabbitmqUserVhost, rabbitmqUserWritePermission, secureAccessEnable, secureAccessUrl, secureAccessWeb, secureAccessWebBrowsing, secureAccessWebProxy, tags, targetName, token, uidToken, useCapitalLetters, useLowerLetters, useNumbers, useSpecialCharacters, userTtl);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GatewayUpdateProducerRabbitMQ
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GatewayUpdateProducerRabbitMQ.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GatewayUpdateProducerRabbitMQ is not found in the empty JSON string", GatewayUpdateProducerRabbitMQ.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GatewayUpdateProducerRabbitMQ.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GatewayUpdateProducerRabbitMQ` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GatewayUpdateProducerRabbitMQ.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GatewayUpdateProducerRabbitMQ.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GatewayUpdateProducerRabbitMQ' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GatewayUpdateProducerRabbitMQ> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GatewayUpdateProducerRabbitMQ.class));

       return (TypeAdapter<T>) new TypeAdapter<GatewayUpdateProducerRabbitMQ>() {
           @Override
           public void write(JsonWriter out, GatewayUpdateProducerRabbitMQ value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GatewayUpdateProducerRabbitMQ read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GatewayUpdateProducerRabbitMQ given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GatewayUpdateProducerRabbitMQ
   * @throws IOException if the JSON string is invalid with respect to GatewayUpdateProducerRabbitMQ
   */
  public static GatewayUpdateProducerRabbitMQ fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GatewayUpdateProducerRabbitMQ.class);
  }

  /**
   * Convert an instance of GatewayUpdateProducerRabbitMQ to an JSON string
   *
   * @return JSON string
   */
