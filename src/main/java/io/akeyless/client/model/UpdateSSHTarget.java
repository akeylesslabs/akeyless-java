 ...
 */
@ApiModel(description = "updateSSHTarget is a command that updates an existing target. [Deprecated: Use target-update-ssh command]")
...
public class UpdateSSHTarget {
  ...
  **/
  ...
  public UpdateSSHTarget json(Boolean json) {
