...
public class UpdateSSHTarget {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("description", "host", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "port", "private-key", "private-key-password", "ssh-password", "ssh-username", "token", "uid-token", "update-version"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateSSHTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateSSHTarget is not found in the empty JSON string", UpdateSSHTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateSSHTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateSSHTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
