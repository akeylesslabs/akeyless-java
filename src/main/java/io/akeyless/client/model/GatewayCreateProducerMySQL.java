...
public class GatewayCreateProducerMySQL {
  ...
  public GatewayCreateProducerMySQL customUsernameTemplate(@javax.annotation.Nullable String customUsernameTemplate) {
  ...
  public GatewayCreateProducerMySQL dbServerCertificates(@javax.annotation.Nullable String dbServerCertificates) {
  ...
  public GatewayCreateProducerMySQL dbServerName(@javax.annotation.Nullable String dbServerName) {
  ...
  public GatewayCreateProducerMySQL deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public GatewayCreateProducerMySQL inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public GatewayCreateProducerMySQL addInputRuleItem(String inputRuleItem) {
  ...
  public GatewayCreateProducerMySQL itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public GatewayCreateProducerMySQL putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public GatewayCreateProducerMySQL json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public GatewayCreateProducerMySQL mysqlDbname(@javax.annotation.Nullable String mysqlDbname) {
  ...
  public GatewayCreateProducerMySQL mysqlHost(@javax.annotation.Nullable String mysqlHost) {
  ...
  public GatewayCreateProducerMySQL mysqlPassword(@javax.annotation.Nullable String mysqlPassword) {
  ...
  public GatewayCreateProducerMySQL mysqlPort(@javax.annotation.Nullable String mysqlPort) {
  ...
  public GatewayCreateProducerMySQL mysqlRevocationStatements(@javax.annotation.Nullable String mysqlRevocationStatements) {
  ...
  public GatewayCreateProducerMySQL mysqlScreationStatements(@javax.annotation.Nullable String mysqlScreationStatements) {
  ...
  public GatewayCreateProducerMySQL mysqlUsername(@javax.annotation.Nullable String mysqlUsername) {
  ...
  public GatewayCreateProducerMySQL name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public GatewayCreateProducerMySQL outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public GatewayCreateProducerMySQL addOutputRuleItem(String outputRuleItem) {
  ...
  public GatewayCreateProducerMySQL passwordLength(@javax.annotation.Nullable String passwordLength) {
  ...
  public GatewayCreateProducerMySQL producerEncryptionKeyName(@javax.annotation.Nullable String producerEncryptionKeyName) {
  ...
  public GatewayCreateProducerMySQL secureAccessBastionIssuer(@javax.annotation.Nullable String secureAccessBastionIssuer) {
  ...
  public GatewayCreateProducerMySQL secureAccessCertificateIssuer(@javax.annotation.Nullable String secureAccessCertificateIssuer) {
  ...
  public GatewayCreateProducerMySQL secureAccessDbName(@javax.annotation.Nullable String secureAccessDbName) {
  ...
  public GatewayCreateProducerMySQL secureAccessDelay(@javax.annotation.Nullable Long secureAccessDelay) {
  ...
  public GatewayCreateProducerMySQL secureAccessEnable(@javax.annotation.Nullable String secureAccessEnable) {
  ...
  public GatewayCreateProducerMySQL secureAccessHost(@javax.annotation.Nullable List<String> secureAccessHost) {
  ...
  public GatewayCreateProducerMySQL secureAccessWeb(@javax.annotation.Nullable Boolean secureAccessWeb) {
  ...
  public GatewayCreateProducerMySQL ssl(@javax.annotation.Nullable Boolean ssl) {
    this.ssl = ssl;
    return this;
  }
  ...
  public GatewayCreateProducerMySQL sslCertificate(@javax.annotation.Nullable String sslCertificate) {
  ...
  public GatewayCreateProducerMySQL tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public GatewayCreateProducerMySQL targetName(@javax.annotation.Nullable String targetName) {
  ...
  public GatewayCreateProducerMySQL token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public GatewayCreateProducerMySQL uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public GatewayCreateProducerMySQL useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public GatewayCreateProducerMySQL useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public GatewayCreateProducerMySQL useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public GatewayCreateProducerMySQL useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public GatewayCreateProducerMySQL userTtl(@javax.annotation.Nullable String userTtl) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.customUsernameTemplate, gatewayCreateProducerMySQL.customUsernameTemplate) &&
        Objects.equals(this.dbServerCertificates, gatewayCreateProducerMySQL.dbServerCertificates) &&
        ...
        Objects.equals(this.inputRule, gatewayCreateProducerMySQL.inputRule) &&
        Objects.equals(this.itemCustomFields, gatewayCreateProducerMySQL.itemCustomFields) &&
        ...
        Objects.equals(this.mysqlRevocationStatements, gatewayCreateProducerMySQL.mysqlRevocationStatements) &&
        ...
        Objects.equals(this.outputRule, gatewayCreateProducerMySQL.outputRule) &&
        ...
        Objects.equals(this.secureAccessCertificateIssuer, gatewayCreateProducerMySQL.secureAccessCertificateIssuer) &&
        Objects.equals(this.secureAccessDbName, gatewayCreateProducerMySQL.secureAccessDbName) &&
        Objects.equals(this.secureAccessDelay, gatewayCreateProducerMySQL.secureAccessDelay) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to GatewayCreateProducerMySQL
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GatewayCreateProducerMySQL.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GatewayCreateProducerMySQL is not found in the empty JSON string", GatewayCreateProducerMySQL.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GatewayCreateProducerMySQL.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GatewayCreateProducerMySQL` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GatewayCreateProducerMySQL.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GatewayCreateProducerMySQL.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GatewayCreateProducerMySQL' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GatewayCreateProducerMySQL> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GatewayCreateProducerMySQL.class));

       return (TypeAdapter<T>) new TypeAdapter<GatewayCreateProducerMySQL>() {
           @Override
           public void write(JsonWriter out, GatewayCreateProducerMySQL value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GatewayCreateProducerMySQL read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GatewayCreateProducerMySQL given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GatewayCreateProducerMySQL
   * @throws IOException if the JSON string is invalid with respect to GatewayCreateProducerMySQL
   */
  public static GatewayCreateProducerMySQL fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GatewayCreateProducerMySQL.class);
  }

  /**
   * Convert an instance of GatewayCreateProducerMySQL to an JSON string
   *
   * @return JSON string
   */
