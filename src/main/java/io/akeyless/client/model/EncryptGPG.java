...
public class EncryptGPG {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("display-id", "input-format", "item-id", "json", "key-name", "plaintext", "token", "uid-token"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("key-name", "plaintext"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EncryptGPG.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EncryptGPG is not found in the empty JSON string", EncryptGPG.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EncryptGPG.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EncryptGPG` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
