...
public class CreateAuthMethodAzureAD {
  ...
  public CreateAuthMethodAzureAD accessExpires(@javax.annotation.Nullable Long accessExpires) {
  ...
  public CreateAuthMethodAzureAD allowedClientType(@javax.annotation.Nullable List<String> allowedClientType) {
    this.allowedClientType = allowedClientType;
    return this;
  }

  public CreateAuthMethodAzureAD addAllowedClientTypeItem(String allowedClientTypeItem) {
  ...
  public CreateAuthMethodAzureAD audience(@javax.annotation.Nullable String audience) {
  ...
  public CreateAuthMethodAzureAD auditLogsClaims(@javax.annotation.Nullable List<String> auditLogsClaims) {
  ...
  public CreateAuthMethodAzureAD boundGroupId(@javax.annotation.Nullable List<String> boundGroupId) {
    this.boundGroupId = boundGroupId;
    return this;
  }

  public CreateAuthMethodAzureAD addBoundGroupIdItem(String boundGroupIdItem) {
  ...
  public CreateAuthMethodAzureAD boundIps(@javax.annotation.Nullable List<String> boundIps) {
    this.boundIps = boundIps;
    return this;
  }

  public CreateAuthMethodAzureAD addBoundIpsItem(String boundIpsItem) {
  ...
  public CreateAuthMethodAzureAD boundProviders(@javax.annotation.Nullable List<String> boundProviders) {
    this.boundProviders = boundProviders;
    return this;
  }

  public CreateAuthMethodAzureAD addBoundProvidersItem(String boundProvidersItem) {
  ...
  public CreateAuthMethodAzureAD boundResourceId(@javax.annotation.Nullable List<String> boundResourceId) {
    this.boundResourceId = boundResourceId;
    return this;
  }

  public CreateAuthMethodAzureAD addBoundResourceIdItem(String boundResourceIdItem) {
  ...
  public CreateAuthMethodAzureAD boundResourceNames(@javax.annotation.Nullable List<String> boundResourceNames) {
    this.boundResourceNames = boundResourceNames;
    return this;
  }

  public CreateAuthMethodAzureAD addBoundResourceNamesItem(String boundResourceNamesItem) {
  ...
  public CreateAuthMethodAzureAD boundResourceTypes(@javax.annotation.Nullable List<String> boundResourceTypes) {
    this.boundResourceTypes = boundResourceTypes;
    return this;
  }

  public CreateAuthMethodAzureAD addBoundResourceTypesItem(String boundResourceTypesItem) {
  ...
  public CreateAuthMethodAzureAD boundRgId(@javax.annotation.Nullable List<String> boundRgId) {
    this.boundRgId = boundRgId;
    return this;
  }

  public CreateAuthMethodAzureAD addBoundRgIdItem(String boundRgIdItem) {
  ...
  public CreateAuthMethodAzureAD boundSpid(@javax.annotation.Nullable List<String> boundSpid) {
    this.boundSpid = boundSpid;
    return this;
  }

  public CreateAuthMethodAzureAD addBoundSpidItem(String boundSpidItem) {
  ...
  public CreateAuthMethodAzureAD boundSubId(@javax.annotation.Nullable List<String> boundSubId) {
    this.boundSubId = boundSubId;
    return this;
  }

  public CreateAuthMethodAzureAD addBoundSubIdItem(String boundSubIdItem) {
  ...
  public CreateAuthMethodAzureAD boundTenantId(@javax.annotation.Nonnull String boundTenantId) {
  ...
  public CreateAuthMethodAzureAD deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public CreateAuthMethodAzureAD description(@javax.annotation.Nullable String description) {
  ...
  public CreateAuthMethodAzureAD expirationEventIn(@javax.annotation.Nullable List<String> expirationEventIn) {
    this.expirationEventIn = expirationEventIn;
    return this;
  }

  public CreateAuthMethodAzureAD addExpirationEventInItem(String expirationEventInItem) {
  ...
  public CreateAuthMethodAzureAD forceSubClaims(@javax.annotation.Nullable Boolean forceSubClaims) {
  ...
  public CreateAuthMethodAzureAD gwBoundIps(@javax.annotation.Nullable List<String> gwBoundIps) {
  ...
  public CreateAuthMethodAzureAD issuer(@javax.annotation.Nullable String issuer) {
    this.issuer = issuer;
    return this;
  }
  ...
  public CreateAuthMethodAzureAD json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public CreateAuthMethodAzureAD jwksUri(@javax.annotation.Nullable String jwksUri) {
  ...
  public CreateAuthMethodAzureAD jwtTtl(@javax.annotation.Nullable Long jwtTtl) {
    this.jwtTtl = jwtTtl;
    return this;
  }
  ...
  public CreateAuthMethodAzureAD name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateAuthMethodAzureAD productType(@javax.annotation.Nullable List<String> productType) {
  ...
  public CreateAuthMethodAzureAD token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public CreateAuthMethodAzureAD uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public CreateAuthMethodAzureAD uniqueIdentifier(@javax.annotation.Nullable String uniqueIdentifier) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessExpires, createAuthMethodAzureAD.accessExpires) &&
        Objects.equals(this.allowedClientType, createAuthMethodAzureAD.allowedClientType) &&
        ...
        Objects.equals(this.boundResourceId, createAuthMethodAzureAD.boundResourceId) &&
        Objects.equals(this.boundResourceNames, createAuthMethodAzureAD.boundResourceNames) &&
        Objects.equals(this.boundResourceTypes, createAuthMethodAzureAD.boundResourceTypes) &&
        Objects.equals(this.boundRgId, createAuthMethodAzureAD.boundRgId) &&
        ...
        Objects.equals(this.expirationEventIn, createAuthMethodAzureAD.expirationEventIn) &&
        ...
        Objects.equals(this.json, createAuthMethodAzureAD.json) &&
        ...
        Objects.equals(this.uniqueIdentifier, createAuthMethodAzureAD.uniqueIdentifier);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateAuthMethodAzureAD
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateAuthMethodAzureAD.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateAuthMethodAzureAD is not found in the empty JSON string", CreateAuthMethodAzureAD.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateAuthMethodAzureAD.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateAuthMethodAzureAD` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateAuthMethodAzureAD.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateAuthMethodAzureAD.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateAuthMethodAzureAD' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateAuthMethodAzureAD> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateAuthMethodAzureAD.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateAuthMethodAzureAD>() {
           @Override
           public void write(JsonWriter out, CreateAuthMethodAzureAD value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateAuthMethodAzureAD read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateAuthMethodAzureAD given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateAuthMethodAzureAD
   * @throws IOException if the JSON string is invalid with respect to CreateAuthMethodAzureAD
   */
  public static CreateAuthMethodAzureAD fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAuthMethodAzureAD.class);
  }

  /**
   * Convert an instance of CreateAuthMethodAzureAD to an JSON string
   *
   * @return JSON string
   */
