...
public class DynamicSecretUpdateAzure {
  ...
  public DynamicSecretUpdateAzure inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public DynamicSecretUpdateAzure addInputRuleItem(String inputRuleItem) {
  ...
  public DynamicSecretUpdateAzure outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public DynamicSecretUpdateAzure addOutputRuleItem(String outputRuleItem) {
  ...
  public DynamicSecretUpdateAzure useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public DynamicSecretUpdateAzure useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public DynamicSecretUpdateAzure useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public DynamicSecretUpdateAzure useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.appObjId, dynamicSecretUpdateAzure.appObjId) &&
        ...
        Objects.equals(this.inputRule, dynamicSecretUpdateAzure.inputRule) &&
        ...
        Objects.equals(this.outputRule, dynamicSecretUpdateAzure.outputRule) &&
        ...
        Objects.equals(this.useCapitalLetters, dynamicSecretUpdateAzure.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, dynamicSecretUpdateAzure.useLowerLetters) &&
        Objects.equals(this.useNumbers, dynamicSecretUpdateAzure.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, dynamicSecretUpdateAzure.useSpecialCharacters) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicSecretUpdateAzure.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicSecretUpdateAzure is not found in the empty JSON string", DynamicSecretUpdateAzure.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicSecretUpdateAzure.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DynamicSecretUpdateAzure` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
