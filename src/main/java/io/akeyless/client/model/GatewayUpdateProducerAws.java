...
public class GatewayUpdateProducerAws {
  ...
  public GatewayUpdateProducerAws accessMode(@javax.annotation.Nullable String accessMode) {
  ...
  public GatewayUpdateProducerAws adminRotationIntervalDays(@javax.annotation.Nullable Long adminRotationIntervalDays) {
  ...
  public GatewayUpdateProducerAws awsAccessKeyId(@javax.annotation.Nullable String awsAccessKeyId) {
  ...
  public GatewayUpdateProducerAws awsAccessSecretKey(@javax.annotation.Nullable String awsAccessSecretKey) {
  ...
  public GatewayUpdateProducerAws awsExternalId(@javax.annotation.Nullable String awsExternalId) {
  ...
  public GatewayUpdateProducerAws awsRoleArns(@javax.annotation.Nullable String awsRoleArns) {
  ...
  public GatewayUpdateProducerAws awsUserConsoleAccess(@javax.annotation.Nullable Boolean awsUserConsoleAccess) {
  ...
  public GatewayUpdateProducerAws awsUserGroups(@javax.annotation.Nullable String awsUserGroups) {
  ...
  public GatewayUpdateProducerAws awsUserPolicies(@javax.annotation.Nullable String awsUserPolicies) {
  ...
  public GatewayUpdateProducerAws awsUserProgrammaticAccess(@javax.annotation.Nullable Boolean awsUserProgrammaticAccess) {
  ...
  public GatewayUpdateProducerAws customUsernameTemplate(@javax.annotation.Nullable String customUsernameTemplate) {
  ...
  public GatewayUpdateProducerAws deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public GatewayUpdateProducerAws enableAdminRotation(@javax.annotation.Nullable Boolean enableAdminRotation) {
  ...
  public GatewayUpdateProducerAws inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public GatewayUpdateProducerAws addInputRuleItem(String inputRuleItem) {
  ...
  public GatewayUpdateProducerAws itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public GatewayUpdateProducerAws putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public GatewayUpdateProducerAws json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public GatewayUpdateProducerAws name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public GatewayUpdateProducerAws newName(@javax.annotation.Nullable String newName) {
  ...
  public GatewayUpdateProducerAws outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public GatewayUpdateProducerAws addOutputRuleItem(String outputRuleItem) {
  ...
  public GatewayUpdateProducerAws passwordLength(@javax.annotation.Nullable String passwordLength) {
  ...
  public GatewayUpdateProducerAws producerEncryptionKeyName(@javax.annotation.Nullable String producerEncryptionKeyName) {
  ...
  public GatewayUpdateProducerAws region(@javax.annotation.Nullable String region) {
    this.region = region;
    return this;
  }
  ...
  public GatewayUpdateProducerAws secureAccessAwsAccountId(@javax.annotation.Nullable String secureAccessAwsAccountId) {
  ...
  public GatewayUpdateProducerAws secureAccessAwsNativeCli(@javax.annotation.Nullable Boolean secureAccessAwsNativeCli) {
  ...
  public GatewayUpdateProducerAws secureAccessBastionIssuer(@javax.annotation.Nullable String secureAccessBastionIssuer) {
  ...
  public GatewayUpdateProducerAws secureAccessCertificateIssuer(@javax.annotation.Nullable String secureAccessCertificateIssuer) {
  ...
  public GatewayUpdateProducerAws secureAccessDelay(@javax.annotation.Nullable Long secureAccessDelay) {
  ...
  public GatewayUpdateProducerAws secureAccessEnable(@javax.annotation.Nullable String secureAccessEnable) {
  ...
  public GatewayUpdateProducerAws secureAccessWeb(@javax.annotation.Nullable Boolean secureAccessWeb) {
  ...
  public GatewayUpdateProducerAws secureAccessWebBrowsing(@javax.annotation.Nullable Boolean secureAccessWebBrowsing) {
  ...
  public GatewayUpdateProducerAws secureAccessWebProxy(@javax.annotation.Nullable Boolean secureAccessWebProxy) {
  ...
  public GatewayUpdateProducerAws sessionTags(@javax.annotation.Nullable String sessionTags) {
  ...
  public GatewayUpdateProducerAws tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public GatewayUpdateProducerAws targetName(@javax.annotation.Nullable String targetName) {
  ...
  public GatewayUpdateProducerAws token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public GatewayUpdateProducerAws transitiveTagKeys(@javax.annotation.Nullable String transitiveTagKeys) {
  ...
  public GatewayUpdateProducerAws uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public GatewayUpdateProducerAws useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public GatewayUpdateProducerAws useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public GatewayUpdateProducerAws useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public GatewayUpdateProducerAws useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public GatewayUpdateProducerAws userTtl(@javax.annotation.Nullable String userTtl) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessMode, gatewayUpdateProducerAws.accessMode) &&
        ...
        Objects.equals(this.awsExternalId, gatewayUpdateProducerAws.awsExternalId) &&
        ...
        Objects.equals(this.customUsernameTemplate, gatewayUpdateProducerAws.customUsernameTemplate) &&
        ...
        Objects.equals(this.inputRule, gatewayUpdateProducerAws.inputRule) &&
        Objects.equals(this.itemCustomFields, gatewayUpdateProducerAws.itemCustomFields) &&
        ...
        Objects.equals(this.outputRule, gatewayUpdateProducerAws.outputRule) &&
        ...
        Objects.equals(this.secureAccessCertificateIssuer, gatewayUpdateProducerAws.secureAccessCertificateIssuer) &&
        Objects.equals(this.secureAccessDelay, gatewayUpdateProducerAws.secureAccessDelay) &&
        ...
        Objects.equals(this.sessionTags, gatewayUpdateProducerAws.sessionTags) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to GatewayUpdateProducerAws
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GatewayUpdateProducerAws.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GatewayUpdateProducerAws is not found in the empty JSON string", GatewayUpdateProducerAws.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GatewayUpdateProducerAws.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GatewayUpdateProducerAws` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GatewayUpdateProducerAws.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GatewayUpdateProducerAws.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GatewayUpdateProducerAws' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GatewayUpdateProducerAws> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GatewayUpdateProducerAws.class));

       return (TypeAdapter<T>) new TypeAdapter<GatewayUpdateProducerAws>() {
           @Override
           public void write(JsonWriter out, GatewayUpdateProducerAws value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GatewayUpdateProducerAws read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GatewayUpdateProducerAws given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GatewayUpdateProducerAws
   * @throws IOException if the JSON string is invalid with respect to GatewayUpdateProducerAws
   */
  public static GatewayUpdateProducerAws fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GatewayUpdateProducerAws.class);
  }

  /**
   * Convert an instance of GatewayUpdateProducerAws to an JSON string
   *
   * @return JSON string
   */
