...
public class GatewayUpdateProducerAws {
  ...
  **/
  ...
  public GatewayUpdateProducerAws sessionTags(String sessionTags) {
  ...
  **/
  ...
  public GatewayUpdateProducerAws transitiveTagKeys(String transitiveTagKeys) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessMode, adminRotationIntervalDays, awsAccessKeyId, awsAccessSecretKey, awsRoleArns, awsUserConsoleAccess, awsUserGroups, awsUserPolicies, awsUserProgrammaticAccess, deleteProtection, enableAdminRotation, json, name, newName, passwordLength, producerEncryptionKeyName, region, secureAccessAwsAccountId, secureAccessAwsNativeCli, secureAccessBastionIssuer, secureAccessEnable, secureAccessWeb, secureAccessWebBrowsing, secureAccessWebProxy, sessionTags, tags, targetName, token, transitiveTagKeys, uidToken, userTtl);
  }
