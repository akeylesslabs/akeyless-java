...
public class GatewayUpdateProducerRedis {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(aclRules, customUsernameTemplate, deleteProtection, host, inputRule, itemCustomFields, json, name, newName, outputRule, password, passwordLength, port, producerEncryptionKeyName, ssl, sslCertificate, tags, targetName, token, uidToken, userTtl, username);
  }
