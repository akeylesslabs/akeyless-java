...
public class GatewayUpdateProducerRedis {
  ...
  public GatewayUpdateProducerRedis customUsernameTemplate(@javax.annotation.Nullable String customUsernameTemplate) {
  ...
  public GatewayUpdateProducerRedis inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public GatewayUpdateProducerRedis addInputRuleItem(String inputRuleItem) {
  ...
  public GatewayUpdateProducerRedis outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public GatewayUpdateProducerRedis addOutputRuleItem(String outputRuleItem) {
  ...
  public GatewayUpdateProducerRedis useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public GatewayUpdateProducerRedis useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public GatewayUpdateProducerRedis useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public GatewayUpdateProducerRedis useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.aclRules, gatewayUpdateProducerRedis.aclRules) &&
        ...
        Objects.equals(this.inputRule, gatewayUpdateProducerRedis.inputRule) &&
        ...
        Objects.equals(this.outputRule, gatewayUpdateProducerRedis.outputRule) &&
        ...
        Objects.equals(this.useCapitalLetters, gatewayUpdateProducerRedis.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, gatewayUpdateProducerRedis.useLowerLetters) &&
        Objects.equals(this.useNumbers, gatewayUpdateProducerRedis.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, gatewayUpdateProducerRedis.useSpecialCharacters) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GatewayUpdateProducerRedis.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GatewayUpdateProducerRedis is not found in the empty JSON string", GatewayUpdateProducerRedis.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GatewayUpdateProducerRedis.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GatewayUpdateProducerRedis` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
