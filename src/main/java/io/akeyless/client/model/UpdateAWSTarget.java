...
public class UpdateAWSTarget {
  ...
  public UpdateAWSTarget generateExternalId(@javax.annotation.Nullable Boolean generateExternalId) {
  ...
  public UpdateAWSTarget roleArn(@javax.annotation.Nullable String roleArn) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessKey, updateAWSTarget.accessKey) &&
        ...
        Objects.equals(this.generateExternalId, updateAWSTarget.generateExternalId) &&
        ...
        Objects.equals(this.roleArn, updateAWSTarget.roleArn) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessKey, accessKeyId, comment, description, generateExternalId, json, keepPrevVersion, key, maxVersions, name, newName, region, roleArn, sessionToken, token, uidToken, updateVersion, useGwCloudIdentity);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("access-key", "access-key-id", "comment", "description", "generate-external-id", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "region", "role-arn", "session-token", "token", "uid-token", "update-version", "use-gw-cloud-identity"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("access-key", "access-key-id", "name"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateAWSTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateAWSTarget is not found in the empty JSON string", UpdateAWSTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateAWSTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateAWSTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("access-key-id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `access-key-id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("access-key-id").toString()));
      }
      ...
      if ((jsonObj.get("session-token") != null && !jsonObj.get("session-token").isJsonNull()) && !jsonObj.get("session-token").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `session-token` to be a primitive type in the JSON string but got `%s`", jsonObj.get("session-token").toString()));
      }
