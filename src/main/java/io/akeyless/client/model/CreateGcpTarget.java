...
public class CreateGcpTarget {
  ...
  public CreateGcpTarget comment(@javax.annotation.Nullable String comment) {
  ...
  public CreateGcpTarget description(@javax.annotation.Nullable String description) {
  ...
  public CreateGcpTarget gcpKey(@javax.annotation.Nullable String gcpKey) {
    this.gcpKey = gcpKey;
    return this;
  }
  ...
  public CreateGcpTarget json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public CreateGcpTarget key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public CreateGcpTarget maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public CreateGcpTarget name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateGcpTarget token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public CreateGcpTarget uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public CreateGcpTarget useGwCloudIdentity(@javax.annotation.Nullable Boolean useGwCloudIdentity) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("comment", "description", "gcp-key", "json", "key", "max-versions", "name", "token", "uid-token", "use-gw-cloud-identity"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateGcpTarget
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateGcpTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateGcpTarget is not found in the empty JSON string", CreateGcpTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateGcpTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateGcpTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateGcpTarget.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateGcpTarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateGcpTarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateGcpTarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateGcpTarget.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateGcpTarget>() {
           @Override
           public void write(JsonWriter out, CreateGcpTarget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateGcpTarget read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateGcpTarget given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateGcpTarget
   * @throws IOException if the JSON string is invalid with respect to CreateGcpTarget
   */
  public static CreateGcpTarget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateGcpTarget.class);
  }

  /**
   * Convert an instance of CreateGcpTarget to an JSON string
   *
   * @return JSON string
   */
