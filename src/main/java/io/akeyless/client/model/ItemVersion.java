...
public class ItemVersion {
  ...
  public ItemVersion accessId(@javax.annotation.Nullable String accessId) {
  ...
  public ItemVersion uniqueIdentifier(@javax.annotation.Nullable String uniqueIdentifier) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessDate, itemVersion.accessDate) &&
        ...
        Objects.equals(this.accessId, itemVersion.accessId) &&
        ...
        Objects.equals(this.uniqueIdentifier, itemVersion.uniqueIdentifier) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessDate, accessDateDisplay, accessId, certificateVersionInfo, creationDate, customerFragmentId, deletionDate, itemVersionState, modificationDate, protectionKeyName, uniqueIdentifier, version, withCustomerFragment);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("access_date", "access_date_display", "access_id", "certificate_version_info", "creation_date", "customer_fragment_id", "deletion_date", "item_version_state", "modification_date", "protection_key_name", "unique_identifier", "version", "with_customer_fragment"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ItemVersion.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ItemVersion is not found in the empty JSON string", ItemVersion.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ItemVersion.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ItemVersion` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
