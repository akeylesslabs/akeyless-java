...
public class DynamicSecretUpdatePostgreSql {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(creationStatements, customUsernameTemplate, deleteProtection, description, itemCustomFields, json, name, newName, passwordLength, postgresqlDbName, postgresqlHost, postgresqlPassword, postgresqlPort, postgresqlUsername, producerEncryptionKey, revocationStatement, secureAccessBastionIssuer, secureAccessCertificateIssuer, secureAccessDbName, secureAccessDbSchema, secureAccessDelay, secureAccessEnable, secureAccessHost, secureAccessWeb, ssl, tags, targetName, token, uidToken, userTtl);
  }
