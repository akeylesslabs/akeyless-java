...
public class GatewayCreateProducerCustom {
  ...
  public GatewayCreateProducerCustom adminRotationIntervalDays(@javax.annotation.Nullable Long adminRotationIntervalDays) {
  ...
  public GatewayCreateProducerCustom createSyncUrl(@javax.annotation.Nonnull String createSyncUrl) {
  ...
  public GatewayCreateProducerCustom deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public GatewayCreateProducerCustom enableAdminRotation(@javax.annotation.Nullable Boolean enableAdminRotation) {
  ...
  public GatewayCreateProducerCustom inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public GatewayCreateProducerCustom addInputRuleItem(String inputRuleItem) {
  ...
  public GatewayCreateProducerCustom itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public GatewayCreateProducerCustom putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public GatewayCreateProducerCustom json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public GatewayCreateProducerCustom name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public GatewayCreateProducerCustom outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public GatewayCreateProducerCustom addOutputRuleItem(String outputRuleItem) {
  ...
  public GatewayCreateProducerCustom payload(@javax.annotation.Nullable String payload) {
  ...
  public GatewayCreateProducerCustom producerEncryptionKeyName(@javax.annotation.Nullable String producerEncryptionKeyName) {
  ...
  public GatewayCreateProducerCustom revokeSyncUrl(@javax.annotation.Nonnull String revokeSyncUrl) {
  ...
  public GatewayCreateProducerCustom rotateSyncUrl(@javax.annotation.Nullable String rotateSyncUrl) {
  ...
  public GatewayCreateProducerCustom tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public GatewayCreateProducerCustom timeoutSec(@javax.annotation.Nullable Long timeoutSec) {
  ...
  public GatewayCreateProducerCustom token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public GatewayCreateProducerCustom uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public GatewayCreateProducerCustom userTtl(@javax.annotation.Nullable String userTtl) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.adminRotationIntervalDays, gatewayCreateProducerCustom.adminRotationIntervalDays) &&
        ...
        Objects.equals(this.inputRule, gatewayCreateProducerCustom.inputRule) &&
        Objects.equals(this.itemCustomFields, gatewayCreateProducerCustom.itemCustomFields) &&
        Objects.equals(this.json, gatewayCreateProducerCustom.json) &&
        Objects.equals(this.name, gatewayCreateProducerCustom.name) &&
        Objects.equals(this.outputRule, gatewayCreateProducerCustom.outputRule) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(adminRotationIntervalDays, createSyncUrl, deleteProtection, enableAdminRotation, inputRule, itemCustomFields, json, name, outputRule, payload, producerEncryptionKeyName, revokeSyncUrl, rotateSyncUrl, tags, timeoutSec, token, uidToken, userTtl);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("admin-rotation-interval-days", "create-sync-url", "delete_protection", "enable-admin-rotation", "input-rule", "item-custom-fields", "json", "name", "output-rule", "payload", "producer-encryption-key-name", "revoke-sync-url", "rotate-sync-url", "tags", "timeout-sec", "token", "uid-token", "user-ttl"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to GatewayCreateProducerCustom
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GatewayCreateProducerCustom.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GatewayCreateProducerCustom is not found in the empty JSON string", GatewayCreateProducerCustom.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GatewayCreateProducerCustom.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GatewayCreateProducerCustom` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GatewayCreateProducerCustom.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GatewayCreateProducerCustom.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GatewayCreateProducerCustom' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GatewayCreateProducerCustom> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GatewayCreateProducerCustom.class));

       return (TypeAdapter<T>) new TypeAdapter<GatewayCreateProducerCustom>() {
           @Override
           public void write(JsonWriter out, GatewayCreateProducerCustom value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GatewayCreateProducerCustom read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GatewayCreateProducerCustom given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GatewayCreateProducerCustom
   * @throws IOException if the JSON string is invalid with respect to GatewayCreateProducerCustom
   */
  public static GatewayCreateProducerCustom fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GatewayCreateProducerCustom.class);
  }

  /**
   * Convert an instance of GatewayCreateProducerCustom to an JSON string
   *
   * @return JSON string
   */
