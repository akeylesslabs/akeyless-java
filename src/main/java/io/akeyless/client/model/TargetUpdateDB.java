...
public class TargetUpdateDB {
  ...
  public TargetUpdateDB() {
  }

  public TargetUpdateDB azureClientId(@javax.annotation.Nullable String azureClientId) {
  ...
  public TargetUpdateDB azureClientSecret(@javax.annotation.Nullable String azureClientSecret) {
  ...
  public TargetUpdateDB azureTenantId(@javax.annotation.Nullable String azureTenantId) {
  ...
  public TargetUpdateDB clusterMode(@javax.annotation.Nullable Boolean clusterMode) {
  ...
  public TargetUpdateDB comment(@javax.annotation.Nullable String comment) {
  ...
  public TargetUpdateDB connectionType(@javax.annotation.Nonnull String connectionType) {
  ...
  public TargetUpdateDB dbName(@javax.annotation.Nullable String dbName) {
    this.dbName = dbName;
    return this;
  }
  ...
  public TargetUpdateDB dbServerCertificates(@javax.annotation.Nullable String dbServerCertificates) {
  ...
  public TargetUpdateDB dbServerName(@javax.annotation.Nullable String dbServerName) {
  ...
  public TargetUpdateDB dbType(@javax.annotation.Nonnull String dbType) {
    this.dbType = dbType;
    return this;
  }
  ...
  public TargetUpdateDB description(@javax.annotation.Nullable String description) {
  ...
  public TargetUpdateDB host(@javax.annotation.Nullable String host) {
    this.host = host;
    return this;
  }
  ...
  public TargetUpdateDB json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public TargetUpdateDB keepPrevVersion(@javax.annotation.Nullable String keepPrevVersion) {
  ...
  public TargetUpdateDB key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public TargetUpdateDB maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public TargetUpdateDB mongodbAtlas(@javax.annotation.Nullable Boolean mongodbAtlas) {
  ...
  public TargetUpdateDB mongodbAtlasApiPrivateKey(@javax.annotation.Nullable String mongodbAtlasApiPrivateKey) {
  ...
  public TargetUpdateDB mongodbAtlasApiPublicKey(@javax.annotation.Nullable String mongodbAtlasApiPublicKey) {
  ...
  public TargetUpdateDB mongodbAtlasProjectId(@javax.annotation.Nullable String mongodbAtlasProjectId) {
  ...
  public TargetUpdateDB mongodbDefaultAuthDb(@javax.annotation.Nullable String mongodbDefaultAuthDb) {
  ...
  public TargetUpdateDB mongodbUriOptions(@javax.annotation.Nullable String mongodbUriOptions) {
  ...
  public TargetUpdateDB name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public TargetUpdateDB newName(@javax.annotation.Nullable String newName) {
  ...
  public TargetUpdateDB oracleServiceName(@javax.annotation.Nullable String oracleServiceName) {
  ...
  public TargetUpdateDB oracleWalletLoginType(@javax.annotation.Nullable String oracleWalletLoginType) {
  ...
  public TargetUpdateDB oracleWalletP12FileData(@javax.annotation.Nullable String oracleWalletP12FileData) {
  ...
  public TargetUpdateDB oracleWalletSsoFileData(@javax.annotation.Nullable String oracleWalletSsoFileData) {
  ...
  public TargetUpdateDB parentTargetName(@javax.annotation.Nullable String parentTargetName) {
  ...
  public TargetUpdateDB port(@javax.annotation.Nullable String port) {
    this.port = port;
    return this;
  }
  ...
  public TargetUpdateDB pwd(@javax.annotation.Nullable String pwd) {
    this.pwd = pwd;
    return this;
  }
  ...
  public TargetUpdateDB snowflakeAccount(@javax.annotation.Nullable String snowflakeAccount) {
  ...
  public TargetUpdateDB snowflakeApiPrivateKey(@javax.annotation.Nullable String snowflakeApiPrivateKey) {
  ...
  public TargetUpdateDB snowflakeApiPrivateKeyPassword(@javax.annotation.Nullable String snowflakeApiPrivateKeyPassword) {
  ...
  public TargetUpdateDB ssl(@javax.annotation.Nullable Boolean ssl) {
    this.ssl = ssl;
    return this;
  }
  ...
  public TargetUpdateDB sslCertificate(@javax.annotation.Nullable String sslCertificate) {
  ...
  public TargetUpdateDB token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public TargetUpdateDB uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public TargetUpdateDB userName(@javax.annotation.Nullable String userName) {
  ...
  public boolean equals(Object o) {
    ...
    TargetUpdateDB targetUpdateDB = (TargetUpdateDB) o;
    return Objects.equals(this.azureClientId, targetUpdateDB.azureClientId) &&
        ...
        Objects.equals(this.connectionType, targetUpdateDB.connectionType) &&
        Objects.equals(this.dbName, targetUpdateDB.dbName) &&
        ...
        Objects.equals(this.key, targetUpdateDB.key) &&
        Objects.equals(this.maxVersions, targetUpdateDB.maxVersions) &&
        Objects.equals(this.mongodbAtlas, targetUpdateDB.mongodbAtlas) &&
        Objects.equals(this.mongodbAtlasApiPrivateKey, targetUpdateDB.mongodbAtlasApiPrivateKey) &&
        Objects.equals(this.mongodbAtlasApiPublicKey, targetUpdateDB.mongodbAtlasApiPublicKey) &&
        Objects.equals(this.mongodbAtlasProjectId, targetUpdateDB.mongodbAtlasProjectId) &&
        Objects.equals(this.mongodbDefaultAuthDb, targetUpdateDB.mongodbDefaultAuthDb) &&
        Objects.equals(this.mongodbUriOptions, targetUpdateDB.mongodbUriOptions) &&
        Objects.equals(this.name, targetUpdateDB.name) &&
        Objects.equals(this.newName, targetUpdateDB.newName) &&
        Objects.equals(this.oracleServiceName, targetUpdateDB.oracleServiceName) &&
        Objects.equals(this.oracleWalletLoginType, targetUpdateDB.oracleWalletLoginType) &&
        Objects.equals(this.oracleWalletP12FileData, targetUpdateDB.oracleWalletP12FileData) &&
        Objects.equals(this.oracleWalletSsoFileData, targetUpdateDB.oracleWalletSsoFileData) &&
        Objects.equals(this.parentTargetName, targetUpdateDB.parentTargetName) &&
        Objects.equals(this.port, targetUpdateDB.port) &&
        Objects.equals(this.pwd, targetUpdateDB.pwd) &&
        Objects.equals(this.snowflakeAccount, targetUpdateDB.snowflakeAccount) &&
        Objects.equals(this.snowflakeApiPrivateKey, targetUpdateDB.snowflakeApiPrivateKey) &&
        Objects.equals(this.snowflakeApiPrivateKeyPassword, targetUpdateDB.snowflakeApiPrivateKeyPassword) &&
        Objects.equals(this.ssl, targetUpdateDB.ssl) &&
        Objects.equals(this.sslCertificate, targetUpdateDB.sslCertificate) &&
        Objects.equals(this.token, targetUpdateDB.token) &&
        Objects.equals(this.uidToken, targetUpdateDB.uidToken) &&
        Objects.equals(this.userName, targetUpdateDB.userName);
  }
  ...
  public String toString() {
    ...
    sb.append("class TargetUpdateDB {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TargetUpdateDB
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TargetUpdateDB.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TargetUpdateDB is not found in the empty JSON string", TargetUpdateDB.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TargetUpdateDB.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TargetUpdateDB` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TargetUpdateDB.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TargetUpdateDB.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TargetUpdateDB' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TargetUpdateDB> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TargetUpdateDB.class));

       return (TypeAdapter<T>) new TypeAdapter<TargetUpdateDB>() {
           @Override
           public void write(JsonWriter out, TargetUpdateDB value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TargetUpdateDB read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TargetUpdateDB given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TargetUpdateDB
   * @throws IOException if the JSON string is invalid with respect to TargetUpdateDB
   */
  public static TargetUpdateDB fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TargetUpdateDB.class);
  }

  /**
   * Convert an instance of TargetUpdateDB to an JSON string
   *
   * @return JSON string
   */
