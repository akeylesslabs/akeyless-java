...
public class TargetUpdateDB {
  ...
  public TargetUpdateDB dbDefinedConnectionType(@javax.annotation.Nullable String dbDefinedConnectionType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dbDefinedConnectionType, targetUpdateDB.dbDefinedConnectionType) &&
        Objects.equals(this.azureClientId, targetUpdateDB.azureClientId) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TargetUpdateDB.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TargetUpdateDB is not found in the empty JSON string", TargetUpdateDB.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TargetUpdateDB.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TargetUpdateDB` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
