 ...
 */
@ApiModel(description = "targetDelete is a command that deletes a target")
...
public class TargetDelete {
  ...
  public TargetDelete forceDeletion(Boolean forceDeletion) {
  ...
  **/
  ...
  public TargetDelete json(Boolean json) {
  ...
  **/
  ...
  public TargetDelete name(String name) {
  ...
  **/
  ...
  public TargetDelete targetVersion(Integer targetVersion) {
  ...
  **/
  ...
  public TargetDelete token(String token) {
  ...
  **/
  ...
  public TargetDelete uidToken(String uidToken) {
