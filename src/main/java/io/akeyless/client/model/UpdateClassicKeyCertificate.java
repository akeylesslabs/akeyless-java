...
public class UpdateClassicKeyCertificate {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("cert-file-data", "certificate-format", "json", "name", "token", "uid-token"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateClassicKeyCertificate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateClassicKeyCertificate is not found in the empty JSON string", UpdateClassicKeyCertificate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateClassicKeyCertificate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateClassicKeyCertificate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
