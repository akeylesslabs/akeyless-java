...
public class DynamicSecretUpdateMsSql {
  ...
  public DynamicSecretUpdateMsSql inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public DynamicSecretUpdateMsSql addInputRuleItem(String inputRuleItem) {
  ...
  public DynamicSecretUpdateMsSql outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public DynamicSecretUpdateMsSql addOutputRuleItem(String outputRuleItem) {
  ...
  public DynamicSecretUpdateMsSql useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public DynamicSecretUpdateMsSql useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public DynamicSecretUpdateMsSql useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public DynamicSecretUpdateMsSql useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.customUsernameTemplate, dynamicSecretUpdateMsSql.customUsernameTemplate) &&
        ...
        Objects.equals(this.inputRule, dynamicSecretUpdateMsSql.inputRule) &&
        ...
        Objects.equals(this.outputRule, dynamicSecretUpdateMsSql.outputRule) &&
        ...
        Objects.equals(this.useCapitalLetters, dynamicSecretUpdateMsSql.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, dynamicSecretUpdateMsSql.useLowerLetters) &&
        Objects.equals(this.useNumbers, dynamicSecretUpdateMsSql.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, dynamicSecretUpdateMsSql.useSpecialCharacters) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicSecretUpdateMsSql.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicSecretUpdateMsSql is not found in the empty JSON string", DynamicSecretUpdateMsSql.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicSecretUpdateMsSql.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DynamicSecretUpdateMsSql` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
