...
public class DeleteRoleRuleOutput {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("deleted", "result"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteRoleRuleOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DeleteRoleRuleOutput is not found in the empty JSON string", DeleteRoleRuleOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteRoleRuleOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DeleteRoleRuleOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
