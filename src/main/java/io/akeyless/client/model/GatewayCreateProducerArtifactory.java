...
public class GatewayCreateProducerArtifactory {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(artifactoryAdminName, artifactoryAdminPwd, artifactoryTokenAudience, artifactoryTokenScope, baseUrl, customUsernameTemplate, deleteProtection, itemCustomFields, json, name, producerEncryptionKeyName, tags, targetName, token, uidToken, userTtl);
  }
