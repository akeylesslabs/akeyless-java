...
public class GatewayCreateProducerArtifactory {
  ...
  public GatewayCreateProducerArtifactory customUsernameTemplate(@javax.annotation.Nullable String customUsernameTemplate) {
  ...
  public GatewayCreateProducerArtifactory inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public GatewayCreateProducerArtifactory addInputRuleItem(String inputRuleItem) {
  ...
  public GatewayCreateProducerArtifactory itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public GatewayCreateProducerArtifactory putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public GatewayCreateProducerArtifactory outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public GatewayCreateProducerArtifactory addOutputRuleItem(String outputRuleItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.artifactoryAdminName, gatewayCreateProducerArtifactory.artifactoryAdminName) &&
        ...
        Objects.equals(this.customUsernameTemplate, gatewayCreateProducerArtifactory.customUsernameTemplate) &&
        Objects.equals(this.deleteProtection, gatewayCreateProducerArtifactory.deleteProtection) &&
        Objects.equals(this.inputRule, gatewayCreateProducerArtifactory.inputRule) &&
        Objects.equals(this.itemCustomFields, gatewayCreateProducerArtifactory.itemCustomFields) &&
        ...
        Objects.equals(this.outputRule, gatewayCreateProducerArtifactory.outputRule) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(artifactoryAdminName, artifactoryAdminPwd, artifactoryTokenAudience, artifactoryTokenScope, baseUrl, customUsernameTemplate, deleteProtection, inputRule, itemCustomFields, json, name, outputRule, producerEncryptionKeyName, tags, targetName, token, uidToken, userTtl);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GatewayCreateProducerArtifactory.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GatewayCreateProducerArtifactory is not found in the empty JSON string", GatewayCreateProducerArtifactory.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GatewayCreateProducerArtifactory.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GatewayCreateProducerArtifactory` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
