...
public class GatewayCreateProducerGcp {
  ...
  public GatewayCreateProducerGcp accessType(@javax.annotation.Nullable String accessType) {
  ...
  public GatewayCreateProducerGcp customUsernameTemplate(@javax.annotation.Nullable String customUsernameTemplate) {
  ...
  public GatewayCreateProducerGcp deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public GatewayCreateProducerGcp fixedUserClaimKeyname(@javax.annotation.Nullable String fixedUserClaimKeyname) {
  ...
  public GatewayCreateProducerGcp gcpCredType(@javax.annotation.Nullable String gcpCredType) {
  ...
  public GatewayCreateProducerGcp gcpKey(@javax.annotation.Nullable String gcpKey) {
    this.gcpKey = gcpKey;
    return this;
  }
  ...
  public GatewayCreateProducerGcp gcpKeyAlgo(@javax.annotation.Nullable String gcpKeyAlgo) {
  ...
  public GatewayCreateProducerGcp gcpTokenScopes(@javax.annotation.Nullable String gcpTokenScopes) {
  ...
  public GatewayCreateProducerGcp inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public GatewayCreateProducerGcp addInputRuleItem(String inputRuleItem) {
  ...
  public GatewayCreateProducerGcp json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public GatewayCreateProducerGcp name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public GatewayCreateProducerGcp outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public GatewayCreateProducerGcp addOutputRuleItem(String outputRuleItem) {
  ...
  public GatewayCreateProducerGcp producerEncryptionKeyName(@javax.annotation.Nullable String producerEncryptionKeyName) {
  ...
  public GatewayCreateProducerGcp roleBinding(@javax.annotation.Nullable String roleBinding) {
  ...
  public GatewayCreateProducerGcp roleNames(@javax.annotation.Nullable String roleNames) {
  ...
  public GatewayCreateProducerGcp secureAccessDelay(@javax.annotation.Nullable Long secureAccessDelay) {
  ...
  public GatewayCreateProducerGcp secureAccessEnable(@javax.annotation.Nullable String secureAccessEnable) {
  ...
  public GatewayCreateProducerGcp secureAccessUrl(@javax.annotation.Nullable String secureAccessUrl) {
  ...
  public GatewayCreateProducerGcp secureAccessWebBrowsing(@javax.annotation.Nullable Boolean secureAccessWebBrowsing) {
  ...
  public GatewayCreateProducerGcp secureAccessWebProxy(@javax.annotation.Nullable Boolean secureAccessWebProxy) {
  ...
  public GatewayCreateProducerGcp serviceAccountType(@javax.annotation.Nullable String serviceAccountType) {
  ...
  public GatewayCreateProducerGcp tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public GatewayCreateProducerGcp targetName(@javax.annotation.Nullable String targetName) {
  ...
  public GatewayCreateProducerGcp token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public GatewayCreateProducerGcp uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public GatewayCreateProducerGcp userTtl(@javax.annotation.Nullable String userTtl) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessType, gatewayCreateProducerGcp.accessType) &&
        Objects.equals(this.customUsernameTemplate, gatewayCreateProducerGcp.customUsernameTemplate) &&
        Objects.equals(this.deleteProtection, gatewayCreateProducerGcp.deleteProtection) &&
        Objects.equals(this.fixedUserClaimKeyname, gatewayCreateProducerGcp.fixedUserClaimKeyname) &&
        ...
        Objects.equals(this.inputRule, gatewayCreateProducerGcp.inputRule) &&
        ...
        Objects.equals(this.outputRule, gatewayCreateProducerGcp.outputRule) &&
        ...
        Objects.equals(this.roleNames, gatewayCreateProducerGcp.roleNames) &&
        Objects.equals(this.secureAccessDelay, gatewayCreateProducerGcp.secureAccessDelay) &&
        Objects.equals(this.secureAccessEnable, gatewayCreateProducerGcp.secureAccessEnable) &&
        Objects.equals(this.secureAccessUrl, gatewayCreateProducerGcp.secureAccessUrl) &&
        Objects.equals(this.secureAccessWebBrowsing, gatewayCreateProducerGcp.secureAccessWebBrowsing) &&
        Objects.equals(this.secureAccessWebProxy, gatewayCreateProducerGcp.secureAccessWebProxy) &&
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("access-type", "custom-username-template", "delete_protection", "fixed-user-claim-keyname", "gcp-cred-type", "gcp-key", "gcp-key-algo", "gcp-project-id", "gcp-sa-email", "gcp-token-scopes", "input-rule", "item-custom-fields", "json", "name", "output-rule", "producer-encryption-key-name", "role-binding", "role-names", "secure-access-delay", "secure-access-enable", "secure-access-url", "secure-access-web-browsing", "secure-access-web-proxy", "service-account-type", "tags", "target-name", "token", "uid-token", "user-ttl"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to GatewayCreateProducerGcp
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GatewayCreateProducerGcp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GatewayCreateProducerGcp is not found in the empty JSON string", GatewayCreateProducerGcp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GatewayCreateProducerGcp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GatewayCreateProducerGcp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GatewayCreateProducerGcp.openapiRequiredFields) {
      ...
      if ((jsonObj.get("access-type") != null && !jsonObj.get("access-type").isJsonNull()) && !jsonObj.get("access-type").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `access-type` to be a primitive type in the JSON string but got `%s`", jsonObj.get("access-type").toString()));
      }
      ...
      if ((jsonObj.get("gcp-cred-type") != null && !jsonObj.get("gcp-cred-type").isJsonNull()) && !jsonObj.get("gcp-cred-type").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `gcp-cred-type` to be a primitive type in the JSON string but got `%s`", jsonObj.get("gcp-cred-type").toString()));
      }
      ...
      if ((jsonObj.get("gcp-key-algo") != null && !jsonObj.get("gcp-key-algo").isJsonNull()) && !jsonObj.get("gcp-key-algo").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `gcp-key-algo` to be a primitive type in the JSON string but got `%s`", jsonObj.get("gcp-key-algo").toString()));
      }
      ...
      if ((jsonObj.get("gcp-sa-email") != null && !jsonObj.get("gcp-sa-email").isJsonNull()) && !jsonObj.get("gcp-sa-email").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `gcp-sa-email` to be a primitive type in the JSON string but got `%s`", jsonObj.get("gcp-sa-email").toString()));
      }
      if ((jsonObj.get("gcp-token-scopes") != null && !jsonObj.get("gcp-token-scopes").isJsonNull()) && !jsonObj.get("gcp-token-scopes").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `gcp-token-scopes` to be a primitive type in the JSON string but got `%s`", jsonObj.get("gcp-token-scopes").toString()));
      }
      ...
      if ((jsonObj.get("role-binding") != null && !jsonObj.get("role-binding").isJsonNull()) && !jsonObj.get("role-binding").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `role-binding` to be a primitive type in the JSON string but got `%s`", jsonObj.get("role-binding").toString()));
      }
      if ((jsonObj.get("role-names") != null && !jsonObj.get("role-names").isJsonNull()) && !jsonObj.get("role-names").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `role-names` to be a primitive type in the JSON string but got `%s`", jsonObj.get("role-names").toString()));
      }
      ...
      if ((jsonObj.get("service-account-type") != null && !jsonObj.get("service-account-type").isJsonNull()) && !jsonObj.get("service-account-type").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `service-account-type` to be a primitive type in the JSON string but got `%s`", jsonObj.get("service-account-type").toString()));
      }
      // ensure the optional json data is an array if present
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GatewayCreateProducerGcp.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GatewayCreateProducerGcp' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GatewayCreateProducerGcp> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GatewayCreateProducerGcp.class));

       return (TypeAdapter<T>) new TypeAdapter<GatewayCreateProducerGcp>() {
           @Override
           public void write(JsonWriter out, GatewayCreateProducerGcp value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GatewayCreateProducerGcp read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GatewayCreateProducerGcp given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GatewayCreateProducerGcp
   * @throws IOException if the JSON string is invalid with respect to GatewayCreateProducerGcp
   */
  public static GatewayCreateProducerGcp fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GatewayCreateProducerGcp.class);
  }

  /**
   * Convert an instance of GatewayCreateProducerGcp to an JSON string
   *
   * @return JSON string
   */
