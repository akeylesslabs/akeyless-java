...
public class VerifyDataWithClassicKey {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("data", "display-id", "hashed", "hashing-method", "json", "name", "signature", "token", "uid-token", "version"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("data", "name", "signature", "version"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VerifyDataWithClassicKey.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in VerifyDataWithClassicKey is not found in the empty JSON string", VerifyDataWithClassicKey.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VerifyDataWithClassicKey.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `VerifyDataWithClassicKey` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
