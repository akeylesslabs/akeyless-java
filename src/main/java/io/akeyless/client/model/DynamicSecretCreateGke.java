 ...
 */
@ApiModel(description = "dynamicSecretCreateGke is a command that creates gke dynamic secret")
...
public class DynamicSecretCreateGke {
  ...
  public DynamicSecretCreateGke deleteProtection(String deleteProtection) {
  ...
  **/
  ...
  public DynamicSecretCreateGke description(String description) {
  ...
  **/
  ...
  public DynamicSecretCreateGke gkeAccountKey(String gkeAccountKey) {
  ...
  **/
  ...
  public DynamicSecretCreateGke gkeClusterCert(String gkeClusterCert) {
  ...
  **/
  ...
  public DynamicSecretCreateGke gkeClusterEndpoint(String gkeClusterEndpoint) {
  ...
  **/
  ...
  public DynamicSecretCreateGke gkeClusterName(String gkeClusterName) {
  ...
  **/
  ...
  public DynamicSecretCreateGke gkeServiceAccountEmail(String gkeServiceAccountEmail) {
  ...
  **/
  ...
  public DynamicSecretCreateGke json(Boolean json) {
  ...
  **/
  ...
  public DynamicSecretCreateGke name(String name) {
  ...
  **/
  ...
  public DynamicSecretCreateGke producerEncryptionKeyName(String producerEncryptionKeyName) {
  ...
  **/
  ...
  public DynamicSecretCreateGke secureAccessAllowPortForwading(Boolean secureAccessAllowPortForwading) {
  ...
  **/
  ...
  public DynamicSecretCreateGke secureAccessBastionIssuer(String secureAccessBastionIssuer) {
  ...
  **/
  ...
  public DynamicSecretCreateGke secureAccessClusterEndpoint(String secureAccessClusterEndpoint) {
  ...
  **/
  ...
  public DynamicSecretCreateGke secureAccessEnable(String secureAccessEnable) {
  ...
  **/
  ...
  public DynamicSecretCreateGke secureAccessWeb(Boolean secureAccessWeb) {
  ...
  **/
  ...
  public DynamicSecretCreateGke tags(List<String> tags) {
  ...
  **/
  ...
  public DynamicSecretCreateGke targetName(String targetName) {
  ...
  **/
  ...
  public DynamicSecretCreateGke token(String token) {
  ...
  **/
  ...
  public DynamicSecretCreateGke uidToken(String uidToken) {
  ...
  **/
  ...
  public DynamicSecretCreateGke userTtl(String userTtl) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(deleteProtection, description, gkeAccountKey, gkeClusterCert, gkeClusterEndpoint, gkeClusterName, gkeServiceAccountEmail, json, name, producerEncryptionKeyName, secureAccessAllowPortForwading, secureAccessBastionIssuer, secureAccessClusterEndpoint, secureAccessEnable, secureAccessWeb, tags, targetName, token, uidToken, userTtl);
  }
