...
public class UpdateAuthMethod {
  ...
  public UpdateAuthMethod allowedClientType(@javax.annotation.Nullable List<String> allowedClientType) {
    this.allowedClientType = allowedClientType;
    return this;
  }

  public UpdateAuthMethod addAllowedClientTypeItem(String allowedClientTypeItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessExpires, updateAuthMethod.accessExpires) &&
        Objects.equals(this.allowedClientType, updateAuthMethod.allowedClientType) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateAuthMethod.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateAuthMethod is not found in the empty JSON string", UpdateAuthMethod.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateAuthMethod.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateAuthMethod` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
