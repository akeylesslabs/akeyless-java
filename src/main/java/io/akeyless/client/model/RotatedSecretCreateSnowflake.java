...
public class RotatedSecretCreateSnowflake {
  ...
  public RotatedSecretCreateSnowflake authenticationCredentials(String authenticationCredentials) {
  ...
  **/
  ...
  public RotatedSecretCreateSnowflake autoRotate(String autoRotate) {
  ...
  **/
  ...
  public RotatedSecretCreateSnowflake deleteProtection(String deleteProtection) {
  ...
  **/
  ...
  public RotatedSecretCreateSnowflake description(String description) {
  ...
  **/
  ...
  public RotatedSecretCreateSnowflake json(Boolean json) {
  ...
  **/
  ...
  public RotatedSecretCreateSnowflake key(String key) {
  ...
  **/
  ...
  public RotatedSecretCreateSnowflake maxVersions(String maxVersions) {
  ...
  **/
  ...
  public RotatedSecretCreateSnowflake name(String name) {
  ...
  **/
  ...
  public RotatedSecretCreateSnowflake passwordLength(String passwordLength) {
  ...
  **/
  ...
  public RotatedSecretCreateSnowflake rotatedPassword(String rotatedPassword) {
  ...
  **/
  ...
  public RotatedSecretCreateSnowflake rotatedUsername(String rotatedUsername) {
  ...
  **/
  ...
  public RotatedSecretCreateSnowflake rotationEventIn(List<String> rotationEventIn) {
  ...
  **/
  ...
  public RotatedSecretCreateSnowflake rotationHour(Integer rotationHour) {
  ...
  **/
  ...
  public RotatedSecretCreateSnowflake rotationInterval(String rotationInterval) {
  ...
  **/
  ...
  public RotatedSecretCreateSnowflake rotatorType(String rotatorType) {
  ...
  **/
  ...
  public RotatedSecretCreateSnowflake tags(List<String> tags) {
  ...
  **/
  ...
  public RotatedSecretCreateSnowflake targetName(String targetName) {
  ...
  **/
  ...
  public RotatedSecretCreateSnowflake token(String token) {
  ...
  **/
  ...
  public RotatedSecretCreateSnowflake uidToken(String uidToken) {
