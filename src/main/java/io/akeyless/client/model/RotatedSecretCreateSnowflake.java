...
public class RotatedSecretCreateSnowflake {
  ...
  static {
    ...
    openapiFields.add("private-key-file-name");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("private-key-file-name") != null && !jsonObj.get("private-key-file-name").isJsonNull()) && !jsonObj.get("private-key-file-name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `private-key-file-name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("private-key-file-name").toString()));
      }
