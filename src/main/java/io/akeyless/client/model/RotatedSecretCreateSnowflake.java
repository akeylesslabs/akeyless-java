...
public class RotatedSecretCreateSnowflake {
  ...
  public static final String SERIALIZED_NAME_PRIVATE_KEY_FILE_NAME = "private-key-file-name";
  @SerializedName(SERIALIZED_NAME_PRIVATE_KEY_FILE_NAME)
  @javax.annotation.Nullable
  ...
  public RotatedSecretCreateSnowflake inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public RotatedSecretCreateSnowflake addInputRuleItem(String inputRuleItem) {
  ...
  public RotatedSecretCreateSnowflake itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public RotatedSecretCreateSnowflake putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public RotatedSecretCreateSnowflake outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public RotatedSecretCreateSnowflake addOutputRuleItem(String outputRuleItem) {
  ...
  public RotatedSecretCreateSnowflake privateKey(@javax.annotation.Nullable String privateKey) {
  ...
  public RotatedSecretCreateSnowflake privateKeyFileName(@javax.annotation.Nullable String privateKeyFileName) {
  ...
  public RotatedSecretCreateSnowflake useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public RotatedSecretCreateSnowflake useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public RotatedSecretCreateSnowflake useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public RotatedSecretCreateSnowflake useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authenticationCredentials, rotatedSecretCreateSnowflake.authenticationCredentials) &&
        ...
        Objects.equals(this.inputRule, rotatedSecretCreateSnowflake.inputRule) &&
        Objects.equals(this.itemCustomFields, rotatedSecretCreateSnowflake.itemCustomFields) &&
        ...
        Objects.equals(this.outputRule, rotatedSecretCreateSnowflake.outputRule) &&
        Objects.equals(this.passwordLength, rotatedSecretCreateSnowflake.passwordLength) &&
        Objects.equals(this.privateKey, rotatedSecretCreateSnowflake.privateKey) &&
        Objects.equals(this.privateKeyFileName, rotatedSecretCreateSnowflake.privateKeyFileName) &&
        ...
        Objects.equals(this.useCapitalLetters, rotatedSecretCreateSnowflake.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, rotatedSecretCreateSnowflake.useLowerLetters) &&
        Objects.equals(this.useNumbers, rotatedSecretCreateSnowflake.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, rotatedSecretCreateSnowflake.useSpecialCharacters);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authenticationCredentials, autoRotate, deleteProtection, description, inputRule, itemCustomFields, json, key, maxVersions, name, outputRule, passwordLength, privateKey, privateKeyFileName, rotatedPassword, rotatedUsername, rotationEventIn, rotationHour, rotationInterval, rotatorType, tags, targetName, token, uidToken, useCapitalLetters, useLowerLetters, useNumbers, useSpecialCharacters);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("authentication-credentials", "auto-rotate", "delete_protection", "description", "input-rule", "item-custom-fields", "json", "key", "max-versions", "name", "output-rule", "password-length", "private-key", "private-key-file-name", "rotated-password", "rotated-username", "rotation-event-in", "rotation-hour", "rotation-interval", "rotator-type", "tags", "target-name", "token", "uid-token", "use-capital-letters", "use-lower-letters", "use-numbers", "use-special-characters"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RotatedSecretCreateSnowflake.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RotatedSecretCreateSnowflake is not found in the empty JSON string", RotatedSecretCreateSnowflake.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RotatedSecretCreateSnowflake.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RotatedSecretCreateSnowflake` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("private-key-file-name") != null && !jsonObj.get("private-key-file-name").isJsonNull()) && !jsonObj.get("private-key-file-name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `private-key-file-name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("private-key-file-name").toString()));
      }
