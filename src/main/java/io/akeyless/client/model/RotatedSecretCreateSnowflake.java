...
public class RotatedSecretCreateSnowflake {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(authenticationCredentials, autoRotate, deleteProtection, description, itemCustomFields, json, key, maxVersions, name, passwordLength, privateKey, privateKeyFileName, rotatedPassword, rotatedUsername, rotationEventIn, rotationHour, rotationInterval, rotatorType, tags, targetName, token, uidToken);
  }
