...
public class TargetCreateOpenAI {
  ...
  public TargetCreateOpenAI deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.apiKey, targetCreateOpenAI.apiKey) &&
        ...
        Objects.equals(this.deleteProtection, targetCreateOpenAI.deleteProtection) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(apiKey, apiKeyId, deleteProtection, description, json, key, maxVersions, model, name, openaiUrl, organizationId, token, uidToken);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("api-key", "api-key-id", "delete_protection", "description", "json", "key", "max-versions", "model", "name", "openai-url", "organization-id", "token", "uid-token"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TargetCreateOpenAI.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TargetCreateOpenAI is not found in the empty JSON string", TargetCreateOpenAI.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TargetCreateOpenAI.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TargetCreateOpenAI` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
