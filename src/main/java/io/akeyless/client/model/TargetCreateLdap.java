...
public class TargetCreateLdap {
  ...
  public TargetCreateLdap bindDn(@javax.annotation.Nonnull String bindDn) {
    this.bindDn = bindDn;
    return this;
  }
  ...
  public TargetCreateLdap bindDnPassword(@javax.annotation.Nonnull String bindDnPassword) {
  ...
  public TargetCreateLdap deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public TargetCreateLdap description(@javax.annotation.Nullable String description) {
  ...
  public TargetCreateLdap json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public TargetCreateLdap key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public TargetCreateLdap ldapCaCert(@javax.annotation.Nullable String ldapCaCert) {
  ...
  public TargetCreateLdap ldapUrl(@javax.annotation.Nonnull String ldapUrl) {
  ...
  public TargetCreateLdap maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public TargetCreateLdap name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public TargetCreateLdap serverType(@javax.annotation.Nullable String serverType) {
  ...
  public TargetCreateLdap token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public TargetCreateLdap tokenExpiration(@javax.annotation.Nullable String tokenExpiration) {
  ...
  public TargetCreateLdap uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bindDn, targetCreateLdap.bindDn) &&
        ...
        Objects.equals(this.deleteProtection, targetCreateLdap.deleteProtection) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(bindDn, bindDnPassword, deleteProtection, description, json, key, ldapCaCert, ldapUrl, maxVersions, name, serverType, token, tokenExpiration, uidToken);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("bind-dn", "bind-dn-password", "delete_protection", "description", "json", "key", "ldap-ca-cert", "ldap-url", "max-versions", "name", "server-type", "token", "token-expiration", "uid-token"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to TargetCreateLdap
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TargetCreateLdap.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TargetCreateLdap is not found in the empty JSON string", TargetCreateLdap.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TargetCreateLdap.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TargetCreateLdap` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TargetCreateLdap.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TargetCreateLdap.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TargetCreateLdap' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TargetCreateLdap> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TargetCreateLdap.class));

       return (TypeAdapter<T>) new TypeAdapter<TargetCreateLdap>() {
           @Override
           public void write(JsonWriter out, TargetCreateLdap value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TargetCreateLdap read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TargetCreateLdap given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TargetCreateLdap
   * @throws IOException if the JSON string is invalid with respect to TargetCreateLdap
   */
  public static TargetCreateLdap fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TargetCreateLdap.class);
  }

  /**
   * Convert an instance of TargetCreateLdap to an JSON string
   *
   * @return JSON string
   */
