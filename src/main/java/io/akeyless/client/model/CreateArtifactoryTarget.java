...
public class CreateArtifactoryTarget {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("artifactory-admin-name", "artifactory-admin-pwd", "base-url", "comment", "description", "json", "key", "max-versions", "name", "token", "uid-token"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateArtifactoryTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateArtifactoryTarget is not found in the empty JSON string", CreateArtifactoryTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateArtifactoryTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateArtifactoryTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
