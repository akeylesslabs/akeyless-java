...
public class UpdateGlobalSignAtlasTarget {
  ...
  public UpdateGlobalSignAtlasTarget apiKey(@javax.annotation.Nonnull String apiKey) {
    this.apiKey = apiKey;
    return this;
  }
  ...
  public UpdateGlobalSignAtlasTarget apiSecret(@javax.annotation.Nonnull String apiSecret) {
  ...
  public UpdateGlobalSignAtlasTarget comment(@javax.annotation.Nullable String comment) {
  ...
  public UpdateGlobalSignAtlasTarget description(@javax.annotation.Nullable String description) {
  ...
  public UpdateGlobalSignAtlasTarget json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public UpdateGlobalSignAtlasTarget keepPrevVersion(@javax.annotation.Nullable String keepPrevVersion) {
  ...
  public UpdateGlobalSignAtlasTarget key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public UpdateGlobalSignAtlasTarget maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public UpdateGlobalSignAtlasTarget mtlsCertDataBase64(@javax.annotation.Nullable String mtlsCertDataBase64) {
  ...
  public UpdateGlobalSignAtlasTarget mtlsKeyDataBase64(@javax.annotation.Nullable String mtlsKeyDataBase64) {
  ...
  public UpdateGlobalSignAtlasTarget name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateGlobalSignAtlasTarget newName(@javax.annotation.Nullable String newName) {
  ...
  public UpdateGlobalSignAtlasTarget timeout(@javax.annotation.Nullable String timeout) {
  ...
  public UpdateGlobalSignAtlasTarget token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public UpdateGlobalSignAtlasTarget uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public UpdateGlobalSignAtlasTarget updateVersion(@javax.annotation.Nullable Boolean updateVersion) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("api-key", "api-secret", "comment", "description", "json", "keep-prev-version", "key", "max-versions", "mtls-cert-data-base64", "mtls-key-data-base64", "name", "new-name", "timeout", "token", "uid-token", "update-version"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateGlobalSignAtlasTarget
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateGlobalSignAtlasTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateGlobalSignAtlasTarget is not found in the empty JSON string", UpdateGlobalSignAtlasTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateGlobalSignAtlasTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateGlobalSignAtlasTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateGlobalSignAtlasTarget.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateGlobalSignAtlasTarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateGlobalSignAtlasTarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateGlobalSignAtlasTarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateGlobalSignAtlasTarget.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateGlobalSignAtlasTarget>() {
           @Override
           public void write(JsonWriter out, UpdateGlobalSignAtlasTarget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateGlobalSignAtlasTarget read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateGlobalSignAtlasTarget given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateGlobalSignAtlasTarget
   * @throws IOException if the JSON string is invalid with respect to UpdateGlobalSignAtlasTarget
   */
  public static UpdateGlobalSignAtlasTarget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateGlobalSignAtlasTarget.class);
  }

  /**
   * Convert an instance of UpdateGlobalSignAtlasTarget to an JSON string
   *
   * @return JSON string
   */
