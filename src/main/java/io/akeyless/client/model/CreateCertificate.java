...
public class CreateCertificate {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("certificate-data", "delete_protection", "description", "expiration-event-in", "format", "item-custom-fields", "json", "key", "key-data", "metadata", "name", "tags", "token", "uid-token"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateCertificate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateCertificate is not found in the empty JSON string", CreateCertificate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateCertificate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateCertificate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
