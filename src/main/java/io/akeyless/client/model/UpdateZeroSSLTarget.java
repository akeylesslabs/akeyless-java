...
public class UpdateZeroSSLTarget {
  ...
  public UpdateZeroSSLTarget apiKey(@javax.annotation.Nonnull String apiKey) {
    this.apiKey = apiKey;
    return this;
  }
  ...
  public UpdateZeroSSLTarget comment(@javax.annotation.Nullable String comment) {
  ...
  public UpdateZeroSSLTarget description(@javax.annotation.Nullable String description) {
  ...
  public UpdateZeroSSLTarget imapFqdn(@javax.annotation.Nonnull String imapFqdn) {
  ...
  public UpdateZeroSSLTarget imapPassword(@javax.annotation.Nonnull String imapPassword) {
  ...
  public UpdateZeroSSLTarget imapPort(@javax.annotation.Nullable String imapPort) {
  ...
  public UpdateZeroSSLTarget imapTargetEmail(@javax.annotation.Nullable String imapTargetEmail) {
  ...
  public UpdateZeroSSLTarget imapUsername(@javax.annotation.Nonnull String imapUsername) {
  ...
  public UpdateZeroSSLTarget json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public UpdateZeroSSLTarget keepPrevVersion(@javax.annotation.Nullable String keepPrevVersion) {
  ...
  public UpdateZeroSSLTarget key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public UpdateZeroSSLTarget maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public UpdateZeroSSLTarget name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateZeroSSLTarget newName(@javax.annotation.Nullable String newName) {
  ...
  public UpdateZeroSSLTarget timeout(@javax.annotation.Nullable String timeout) {
  ...
  public UpdateZeroSSLTarget token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public UpdateZeroSSLTarget uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public UpdateZeroSSLTarget updateVersion(@javax.annotation.Nullable Boolean updateVersion) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("api-key", "comment", "description", "imap-fqdn", "imap-password", "imap-port", "imap-target-email", "imap-username", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "timeout", "token", "uid-token", "update-version"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateZeroSSLTarget
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateZeroSSLTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateZeroSSLTarget is not found in the empty JSON string", UpdateZeroSSLTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateZeroSSLTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateZeroSSLTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateZeroSSLTarget.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateZeroSSLTarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateZeroSSLTarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateZeroSSLTarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateZeroSSLTarget.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateZeroSSLTarget>() {
           @Override
           public void write(JsonWriter out, UpdateZeroSSLTarget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateZeroSSLTarget read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateZeroSSLTarget given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateZeroSSLTarget
   * @throws IOException if the JSON string is invalid with respect to UpdateZeroSSLTarget
   */
  public static UpdateZeroSSLTarget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateZeroSSLTarget.class);
  }

  /**
   * Convert an instance of UpdateZeroSSLTarget to an JSON string
   *
   * @return JSON string
   */
