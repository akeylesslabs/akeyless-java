...
public class UpdateLdapTargetDetails {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("bind-dn", "bind-dn-password", "json", "keep-prev-version", "key", "ldap-ca-cert", "ldap-url", "name", "new-version", "protection_key", "token", "token-expiration", "uid-token"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateLdapTargetDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateLdapTargetDetails is not found in the empty JSON string", UpdateLdapTargetDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateLdapTargetDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateLdapTargetDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
