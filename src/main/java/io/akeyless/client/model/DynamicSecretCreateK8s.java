...
public class DynamicSecretCreateK8s {
  ...
  public DynamicSecretCreateK8s customUsernameTemplate(@javax.annotation.Nullable String customUsernameTemplate) {
  ...
  public DynamicSecretCreateK8s deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public DynamicSecretCreateK8s description(@javax.annotation.Nullable String description) {
  ...
  public DynamicSecretCreateK8s itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public DynamicSecretCreateK8s putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public DynamicSecretCreateK8s json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public DynamicSecretCreateK8s k8sAllowedNamespaces(@javax.annotation.Nullable String k8sAllowedNamespaces) {
  ...
  public DynamicSecretCreateK8s k8sClusterCaCert(@javax.annotation.Nullable String k8sClusterCaCert) {
  ...
  public DynamicSecretCreateK8s k8sClusterEndpoint(@javax.annotation.Nullable String k8sClusterEndpoint) {
  ...
  public DynamicSecretCreateK8s k8sClusterName(@javax.annotation.Nullable String k8sClusterName) {
  ...
  public DynamicSecretCreateK8s k8sClusterToken(@javax.annotation.Nullable String k8sClusterToken) {
  ...
  public DynamicSecretCreateK8s k8sNamespace(@javax.annotation.Nullable String k8sNamespace) {
  ...
  public DynamicSecretCreateK8s k8sPredefinedRoleName(@javax.annotation.Nullable String k8sPredefinedRoleName) {
  ...
  public DynamicSecretCreateK8s k8sPredefinedRoleType(@javax.annotation.Nullable String k8sPredefinedRoleType) {
  ...
  public DynamicSecretCreateK8s k8sRolebindingYamlData(@javax.annotation.Nullable String k8sRolebindingYamlData) {
  ...
  public DynamicSecretCreateK8s k8sRolebindingYamlDef(@javax.annotation.Nullable String k8sRolebindingYamlDef) {
  ...
  public DynamicSecretCreateK8s k8sServiceAccount(@javax.annotation.Nullable String k8sServiceAccount) {
  ...
  public DynamicSecretCreateK8s k8sServiceAccountType(@javax.annotation.Nullable String k8sServiceAccountType) {
  ...
  public DynamicSecretCreateK8s name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public DynamicSecretCreateK8s producerEncryptionKeyName(@javax.annotation.Nullable String producerEncryptionKeyName) {
  ...
  public DynamicSecretCreateK8s secureAccessAllowPortForwading(@javax.annotation.Nullable Boolean secureAccessAllowPortForwading) {
  ...
  public DynamicSecretCreateK8s secureAccessBastionIssuer(@javax.annotation.Nullable String secureAccessBastionIssuer) {
  ...
  public DynamicSecretCreateK8s secureAccessCertificateIssuer(@javax.annotation.Nullable String secureAccessCertificateIssuer) {
  ...
  public DynamicSecretCreateK8s secureAccessClusterEndpoint(@javax.annotation.Nullable String secureAccessClusterEndpoint) {
  ...
  public DynamicSecretCreateK8s secureAccessDashboardUrl(@javax.annotation.Nullable String secureAccessDashboardUrl) {
  ...
  public DynamicSecretCreateK8s secureAccessDelay(@javax.annotation.Nullable Long secureAccessDelay) {
  ...
  public DynamicSecretCreateK8s secureAccessEnable(@javax.annotation.Nullable String secureAccessEnable) {
  ...
  public DynamicSecretCreateK8s secureAccessWeb(@javax.annotation.Nullable Boolean secureAccessWeb) {
  ...
  public DynamicSecretCreateK8s secureAccessWebBrowsing(@javax.annotation.Nullable Boolean secureAccessWebBrowsing) {
  ...
  public DynamicSecretCreateK8s secureAccessWebProxy(@javax.annotation.Nullable Boolean secureAccessWebProxy) {
  ...
  public DynamicSecretCreateK8s tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public DynamicSecretCreateK8s targetName(@javax.annotation.Nullable String targetName) {
  ...
  public DynamicSecretCreateK8s token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public DynamicSecretCreateK8s uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public DynamicSecretCreateK8s useGwServiceAccount(@javax.annotation.Nullable Boolean useGwServiceAccount) {
  ...
  public DynamicSecretCreateK8s userTtl(@javax.annotation.Nullable String userTtl) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.customUsernameTemplate, dynamicSecretCreateK8s.customUsernameTemplate) &&
        ...
        Objects.equals(this.k8sRolebindingYamlData, dynamicSecretCreateK8s.k8sRolebindingYamlData) &&
        ...
        Objects.equals(this.secureAccessCertificateIssuer, dynamicSecretCreateK8s.secureAccessCertificateIssuer) &&
        ...
        Objects.equals(this.secureAccessDelay, dynamicSecretCreateK8s.secureAccessDelay) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to DynamicSecretCreateK8s
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DynamicSecretCreateK8s.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DynamicSecretCreateK8s' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DynamicSecretCreateK8s> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DynamicSecretCreateK8s.class));

       return (TypeAdapter<T>) new TypeAdapter<DynamicSecretCreateK8s>() {
           @Override
           public void write(JsonWriter out, DynamicSecretCreateK8s value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DynamicSecretCreateK8s read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DynamicSecretCreateK8s given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DynamicSecretCreateK8s
   * @throws IOException if the JSON string is invalid with respect to DynamicSecretCreateK8s
   */
  public static DynamicSecretCreateK8s fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DynamicSecretCreateK8s.class);
  }

  /**
   * Convert an instance of DynamicSecretCreateK8s to an JSON string
   *
   * @return JSON string
   */
