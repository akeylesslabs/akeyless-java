...
public class DynamicSecretUpdateEks {
  ...
  public DynamicSecretUpdateEks() {
  }

  public DynamicSecretUpdateEks deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public DynamicSecretUpdateEks description(@javax.annotation.Nullable String description) {
  ...
  public DynamicSecretUpdateEks eksAccessKeyId(@javax.annotation.Nullable String eksAccessKeyId) {
  ...
  public DynamicSecretUpdateEks eksAssumeRole(@javax.annotation.Nullable String eksAssumeRole) {
  ...
  public DynamicSecretUpdateEks eksClusterCaCert(@javax.annotation.Nullable String eksClusterCaCert) {
  ...
  public DynamicSecretUpdateEks eksClusterEndpoint(@javax.annotation.Nullable String eksClusterEndpoint) {
  ...
  public DynamicSecretUpdateEks eksClusterName(@javax.annotation.Nullable String eksClusterName) {
  ...
  public DynamicSecretUpdateEks eksRegion(@javax.annotation.Nullable String eksRegion) {
  ...
  public DynamicSecretUpdateEks eksSecretAccessKey(@javax.annotation.Nullable String eksSecretAccessKey) {
  ...
  public DynamicSecretUpdateEks inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public DynamicSecretUpdateEks addInputRuleItem(String inputRuleItem) {
  ...
  public DynamicSecretUpdateEks itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public DynamicSecretUpdateEks putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public DynamicSecretUpdateEks json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public DynamicSecretUpdateEks name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public DynamicSecretUpdateEks newName(@javax.annotation.Nullable String newName) {
  ...
  public DynamicSecretUpdateEks outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public DynamicSecretUpdateEks addOutputRuleItem(String outputRuleItem) {
  ...
  public DynamicSecretUpdateEks producerEncryptionKeyName(@javax.annotation.Nullable String producerEncryptionKeyName) {
  ...
  public DynamicSecretUpdateEks secureAccessAllowPortForwading(@javax.annotation.Nullable Boolean secureAccessAllowPortForwading) {
  ...
  public DynamicSecretUpdateEks secureAccessBastionIssuer(@javax.annotation.Nullable String secureAccessBastionIssuer) {
  ...
  public DynamicSecretUpdateEks secureAccessCertificateIssuer(@javax.annotation.Nullable String secureAccessCertificateIssuer) {
  ...
  public DynamicSecretUpdateEks secureAccessClusterEndpoint(@javax.annotation.Nullable String secureAccessClusterEndpoint) {
  ...
  public DynamicSecretUpdateEks secureAccessDelay(@javax.annotation.Nullable Long secureAccessDelay) {
  ...
  public DynamicSecretUpdateEks secureAccessEnable(@javax.annotation.Nullable String secureAccessEnable) {
  ...
  public DynamicSecretUpdateEks secureAccessWeb(@javax.annotation.Nullable Boolean secureAccessWeb) {
  ...
  public DynamicSecretUpdateEks tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }

  public DynamicSecretUpdateEks addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public DynamicSecretUpdateEks targetName(@javax.annotation.Nullable String targetName) {
  ...
  public DynamicSecretUpdateEks token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public DynamicSecretUpdateEks uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public DynamicSecretUpdateEks userTtl(@javax.annotation.Nullable String userTtl) {
  ...
  public boolean equals(Object o) {
    ...
    DynamicSecretUpdateEks dynamicSecretUpdateEks = (DynamicSecretUpdateEks) o;
    return Objects.equals(this.deleteProtection, dynamicSecretUpdateEks.deleteProtection) &&
        Objects.equals(this.description, dynamicSecretUpdateEks.description) &&
        Objects.equals(this.eksAccessKeyId, dynamicSecretUpdateEks.eksAccessKeyId) &&
        Objects.equals(this.eksAssumeRole, dynamicSecretUpdateEks.eksAssumeRole) &&
        Objects.equals(this.eksClusterCaCert, dynamicSecretUpdateEks.eksClusterCaCert) &&
        Objects.equals(this.eksClusterEndpoint, dynamicSecretUpdateEks.eksClusterEndpoint) &&
        Objects.equals(this.eksClusterName, dynamicSecretUpdateEks.eksClusterName) &&
        Objects.equals(this.eksRegion, dynamicSecretUpdateEks.eksRegion) &&
        Objects.equals(this.eksSecretAccessKey, dynamicSecretUpdateEks.eksSecretAccessKey) &&
        Objects.equals(this.inputRule, dynamicSecretUpdateEks.inputRule) &&
        Objects.equals(this.itemCustomFields, dynamicSecretUpdateEks.itemCustomFields) &&
        Objects.equals(this.json, dynamicSecretUpdateEks.json) &&
        Objects.equals(this.name, dynamicSecretUpdateEks.name) &&
        Objects.equals(this.newName, dynamicSecretUpdateEks.newName) &&
        Objects.equals(this.outputRule, dynamicSecretUpdateEks.outputRule) &&
        Objects.equals(this.producerEncryptionKeyName, dynamicSecretUpdateEks.producerEncryptionKeyName) &&
        Objects.equals(this.secureAccessAllowPortForwading, dynamicSecretUpdateEks.secureAccessAllowPortForwading) &&
        Objects.equals(this.secureAccessBastionIssuer, dynamicSecretUpdateEks.secureAccessBastionIssuer) &&
        Objects.equals(this.secureAccessCertificateIssuer, dynamicSecretUpdateEks.secureAccessCertificateIssuer) &&
        Objects.equals(this.secureAccessClusterEndpoint, dynamicSecretUpdateEks.secureAccessClusterEndpoint) &&
        Objects.equals(this.secureAccessDelay, dynamicSecretUpdateEks.secureAccessDelay) &&
        Objects.equals(this.secureAccessEnable, dynamicSecretUpdateEks.secureAccessEnable) &&
        Objects.equals(this.secureAccessWeb, dynamicSecretUpdateEks.secureAccessWeb) &&
        Objects.equals(this.tags, dynamicSecretUpdateEks.tags) &&
        Objects.equals(this.targetName, dynamicSecretUpdateEks.targetName) &&
        Objects.equals(this.token, dynamicSecretUpdateEks.token) &&
        Objects.equals(this.uidToken, dynamicSecretUpdateEks.uidToken) &&
        Objects.equals(this.userTtl, dynamicSecretUpdateEks.userTtl);
  }

  @Override
  public int hashCode() {
    return Objects.hash(deleteProtection, description, eksAccessKeyId, eksAssumeRole, eksClusterCaCert, eksClusterEndpoint, eksClusterName, eksRegion, eksSecretAccessKey, inputRule, itemCustomFields, json, name, newName, outputRule, producerEncryptionKeyName, secureAccessAllowPortForwading, secureAccessBastionIssuer, secureAccessCertificateIssuer, secureAccessClusterEndpoint, secureAccessDelay, secureAccessEnable, secureAccessWeb, tags, targetName, token, uidToken, userTtl);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DynamicSecretUpdateEks {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DynamicSecretUpdateEks
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicSecretUpdateEks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicSecretUpdateEks is not found in the empty JSON string", DynamicSecretUpdateEks.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicSecretUpdateEks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DynamicSecretUpdateEks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DynamicSecretUpdateEks.openapiRequiredFields) {
      ...
      if ((jsonObj.get("eks-access-key-id") != null && !jsonObj.get("eks-access-key-id").isJsonNull()) && !jsonObj.get("eks-access-key-id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `eks-access-key-id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("eks-access-key-id").toString()));
      }
      if ((jsonObj.get("eks-assume-role") != null && !jsonObj.get("eks-assume-role").isJsonNull()) && !jsonObj.get("eks-assume-role").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `eks-assume-role` to be a primitive type in the JSON string but got `%s`", jsonObj.get("eks-assume-role").toString()));
      }
      if ((jsonObj.get("eks-cluster-ca-cert") != null && !jsonObj.get("eks-cluster-ca-cert").isJsonNull()) && !jsonObj.get("eks-cluster-ca-cert").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `eks-cluster-ca-cert` to be a primitive type in the JSON string but got `%s`", jsonObj.get("eks-cluster-ca-cert").toString()));
      }
      if ((jsonObj.get("eks-cluster-endpoint") != null && !jsonObj.get("eks-cluster-endpoint").isJsonNull()) && !jsonObj.get("eks-cluster-endpoint").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `eks-cluster-endpoint` to be a primitive type in the JSON string but got `%s`", jsonObj.get("eks-cluster-endpoint").toString()));
      }
      if ((jsonObj.get("eks-cluster-name") != null && !jsonObj.get("eks-cluster-name").isJsonNull()) && !jsonObj.get("eks-cluster-name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `eks-cluster-name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("eks-cluster-name").toString()));
      }
      if ((jsonObj.get("eks-region") != null && !jsonObj.get("eks-region").isJsonNull()) && !jsonObj.get("eks-region").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `eks-region` to be a primitive type in the JSON string but got `%s`", jsonObj.get("eks-region").toString()));
      }
      if ((jsonObj.get("eks-secret-access-key") != null && !jsonObj.get("eks-secret-access-key").isJsonNull()) && !jsonObj.get("eks-secret-access-key").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `eks-secret-access-key` to be a primitive type in the JSON string but got `%s`", jsonObj.get("eks-secret-access-key").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DynamicSecretUpdateEks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DynamicSecretUpdateEks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DynamicSecretUpdateEks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DynamicSecretUpdateEks.class));

       return (TypeAdapter<T>) new TypeAdapter<DynamicSecretUpdateEks>() {
           @Override
           public void write(JsonWriter out, DynamicSecretUpdateEks value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DynamicSecretUpdateEks read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DynamicSecretUpdateEks given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DynamicSecretUpdateEks
   * @throws IOException if the JSON string is invalid with respect to DynamicSecretUpdateEks
   */
  public static DynamicSecretUpdateEks fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DynamicSecretUpdateEks.class);
  }

  /**
   * Convert an instance of DynamicSecretUpdateEks to an JSON string
   *
   * @return JSON string
   */
