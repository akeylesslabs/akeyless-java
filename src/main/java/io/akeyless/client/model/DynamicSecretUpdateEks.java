 ...
 */
@ApiModel(description = "dynamicSecretUpdateEks is a command that updates eks dynamic secret")
...
public class DynamicSecretUpdateEks {
  ...
  public DynamicSecretUpdateEks deleteProtection(String deleteProtection) {
  ...
  **/
  ...
  public DynamicSecretUpdateEks description(String description) {
  ...
  **/
  ...
  public DynamicSecretUpdateEks eksAccessKeyId(String eksAccessKeyId) {
  ...
  **/
  ...
  public DynamicSecretUpdateEks eksAssumeRole(String eksAssumeRole) {
  ...
  **/
  ...
  public DynamicSecretUpdateEks eksClusterCaCert(String eksClusterCaCert) {
  ...
  **/
  ...
  public DynamicSecretUpdateEks eksClusterEndpoint(String eksClusterEndpoint) {
  ...
  **/
  ...
  public DynamicSecretUpdateEks eksClusterName(String eksClusterName) {
  ...
  **/
  ...
  public DynamicSecretUpdateEks eksRegion(String eksRegion) {
  ...
  **/
  ...
  public DynamicSecretUpdateEks eksSecretAccessKey(String eksSecretAccessKey) {
  ...
  **/
  ...
  public DynamicSecretUpdateEks json(Boolean json) {
  ...
  **/
  ...
  public DynamicSecretUpdateEks name(String name) {
  ...
  **/
  ...
  public DynamicSecretUpdateEks newName(String newName) {
  ...
  **/
  ...
  public DynamicSecretUpdateEks producerEncryptionKeyName(String producerEncryptionKeyName) {
  ...
  **/
  ...
  public DynamicSecretUpdateEks secureAccessAllowPortForwading(Boolean secureAccessAllowPortForwading) {
  ...
  **/
  ...
  public DynamicSecretUpdateEks secureAccessBastionIssuer(String secureAccessBastionIssuer) {
  ...
  **/
  ...
  public DynamicSecretUpdateEks secureAccessClusterEndpoint(String secureAccessClusterEndpoint) {
  ...
  **/
  ...
  public DynamicSecretUpdateEks secureAccessEnable(String secureAccessEnable) {
  ...
  **/
  ...
  public DynamicSecretUpdateEks secureAccessWeb(Boolean secureAccessWeb) {
  ...
  **/
  ...
  public DynamicSecretUpdateEks tags(List<String> tags) {
  ...
  **/
  ...
  public DynamicSecretUpdateEks targetName(String targetName) {
  ...
  **/
  ...
  public DynamicSecretUpdateEks token(String token) {
  ...
  **/
  ...
  public DynamicSecretUpdateEks uidToken(String uidToken) {
  ...
  **/
  ...
  public DynamicSecretUpdateEks userTtl(String userTtl) {
