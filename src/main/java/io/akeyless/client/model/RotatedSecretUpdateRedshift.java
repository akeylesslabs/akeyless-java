...
public class RotatedSecretUpdateRedshift {
  ...
  public RotatedSecretUpdateRedshift() {
  }

  public RotatedSecretUpdateRedshift addTag(@javax.annotation.Nullable List<String> addTag) {
    this.addTag = addTag;
    return this;
  }

  public RotatedSecretUpdateRedshift addAddTagItem(String addTagItem) {
    if (this.addTag == null) {
  ...
  public RotatedSecretUpdateRedshift authenticationCredentials(@javax.annotation.Nullable String authenticationCredentials) {
  ...
  public RotatedSecretUpdateRedshift autoRotate(@javax.annotation.Nullable String autoRotate) {
  ...
  public RotatedSecretUpdateRedshift deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public RotatedSecretUpdateRedshift description(@javax.annotation.Nullable String description) {
  ...
  public RotatedSecretUpdateRedshift inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public RotatedSecretUpdateRedshift addInputRuleItem(String inputRuleItem) {
  ...
  public RotatedSecretUpdateRedshift itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public RotatedSecretUpdateRedshift putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public RotatedSecretUpdateRedshift json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public RotatedSecretUpdateRedshift keepPrevVersion(@javax.annotation.Nullable String keepPrevVersion) {
  ...
  public RotatedSecretUpdateRedshift key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public RotatedSecretUpdateRedshift lockDuringSraSession(@javax.annotation.Nullable String lockDuringSraSession) {
  ...
  public RotatedSecretUpdateRedshift maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public RotatedSecretUpdateRedshift name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public RotatedSecretUpdateRedshift newName(@javax.annotation.Nullable String newName) {
  ...
  public RotatedSecretUpdateRedshift outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public RotatedSecretUpdateRedshift addOutputRuleItem(String outputRuleItem) {
  ...
  public RotatedSecretUpdateRedshift passwordLength(@javax.annotation.Nullable String passwordLength) {
  ...
  public RotatedSecretUpdateRedshift rmTag(@javax.annotation.Nullable List<String> rmTag) {
    this.rmTag = rmTag;
    return this;
  }

  public RotatedSecretUpdateRedshift addRmTagItem(String rmTagItem) {
    if (this.rmTag == null) {
  ...
  public RotatedSecretUpdateRedshift rotateAfterDisconnect(@javax.annotation.Nullable String rotateAfterDisconnect) {
  ...
  public RotatedSecretUpdateRedshift rotatedPassword(@javax.annotation.Nullable String rotatedPassword) {
  ...
  public RotatedSecretUpdateRedshift rotatedUsername(@javax.annotation.Nullable String rotatedUsername) {
  ...
  public RotatedSecretUpdateRedshift rotationEventIn(@javax.annotation.Nullable List<String> rotationEventIn) {
  ...
  public RotatedSecretUpdateRedshift rotationHour(@javax.annotation.Nullable Integer rotationHour) {
  ...
  public RotatedSecretUpdateRedshift rotationInterval(@javax.annotation.Nullable String rotationInterval) {
  ...
  public RotatedSecretUpdateRedshift secureAccessDbName(@javax.annotation.Nullable String secureAccessDbName) {
  ...
  public RotatedSecretUpdateRedshift secureAccessEnable(@javax.annotation.Nullable String secureAccessEnable) {
  ...
  public RotatedSecretUpdateRedshift secureAccessHost(@javax.annotation.Nullable List<String> secureAccessHost) {
    this.secureAccessHost = secureAccessHost;
    return this;
  }

  public RotatedSecretUpdateRedshift addSecureAccessHostItem(String secureAccessHostItem) {
  ...
  public RotatedSecretUpdateRedshift token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public RotatedSecretUpdateRedshift uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public RotatedSecretUpdateRedshift useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public RotatedSecretUpdateRedshift useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public RotatedSecretUpdateRedshift useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public RotatedSecretUpdateRedshift useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    RotatedSecretUpdateRedshift rotatedSecretUpdateRedshift = (RotatedSecretUpdateRedshift) o;
    return Objects.equals(this.addTag, rotatedSecretUpdateRedshift.addTag) &&
        Objects.equals(this.authenticationCredentials, rotatedSecretUpdateRedshift.authenticationCredentials) &&
        Objects.equals(this.autoRotate, rotatedSecretUpdateRedshift.autoRotate) &&
        Objects.equals(this.deleteProtection, rotatedSecretUpdateRedshift.deleteProtection) &&
        Objects.equals(this.description, rotatedSecretUpdateRedshift.description) &&
        Objects.equals(this.inputRule, rotatedSecretUpdateRedshift.inputRule) &&
        Objects.equals(this.itemCustomFields, rotatedSecretUpdateRedshift.itemCustomFields) &&
        ...
        Objects.equals(this.lockDuringSraSession, rotatedSecretUpdateRedshift.lockDuringSraSession) &&
        ...
        Objects.equals(this.outputRule, rotatedSecretUpdateRedshift.outputRule) &&
        Objects.equals(this.passwordLength, rotatedSecretUpdateRedshift.passwordLength) &&
        Objects.equals(this.rmTag, rotatedSecretUpdateRedshift.rmTag) &&
        ...
        Objects.equals(this.secureAccessEnable, rotatedSecretUpdateRedshift.secureAccessEnable) &&
        Objects.equals(this.secureAccessHost, rotatedSecretUpdateRedshift.secureAccessHost) &&
        Objects.equals(this.token, rotatedSecretUpdateRedshift.token) &&
        Objects.equals(this.uidToken, rotatedSecretUpdateRedshift.uidToken) &&
        Objects.equals(this.useCapitalLetters, rotatedSecretUpdateRedshift.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, rotatedSecretUpdateRedshift.useLowerLetters) &&
        Objects.equals(this.useNumbers, rotatedSecretUpdateRedshift.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, rotatedSecretUpdateRedshift.useSpecialCharacters);
  }

  @Override
  public int hashCode() {
    return Objects.hash(addTag, authenticationCredentials, autoRotate, deleteProtection, description, inputRule, itemCustomFields, json, keepPrevVersion, key, lockDuringSraSession, maxVersions, name, newName, outputRule, passwordLength, rmTag, rotateAfterDisconnect, rotatedPassword, rotatedUsername, rotationEventIn, rotationHour, rotationInterval, secureAccessDbName, secureAccessEnable, secureAccessHost, token, uidToken, useCapitalLetters, useLowerLetters, useNumbers, useSpecialCharacters);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RotatedSecretUpdateRedshift {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RotatedSecretUpdateRedshift
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RotatedSecretUpdateRedshift.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RotatedSecretUpdateRedshift is not found in the empty JSON string", RotatedSecretUpdateRedshift.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RotatedSecretUpdateRedshift.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RotatedSecretUpdateRedshift` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RotatedSecretUpdateRedshift.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RotatedSecretUpdateRedshift.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RotatedSecretUpdateRedshift' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RotatedSecretUpdateRedshift> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RotatedSecretUpdateRedshift.class));

       return (TypeAdapter<T>) new TypeAdapter<RotatedSecretUpdateRedshift>() {
           @Override
           public void write(JsonWriter out, RotatedSecretUpdateRedshift value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RotatedSecretUpdateRedshift read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RotatedSecretUpdateRedshift given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RotatedSecretUpdateRedshift
   * @throws IOException if the JSON string is invalid with respect to RotatedSecretUpdateRedshift
   */
  public static RotatedSecretUpdateRedshift fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RotatedSecretUpdateRedshift.class);
  }

  /**
   * Convert an instance of RotatedSecretUpdateRedshift to an JSON string
   *
   * @return JSON string
   */
