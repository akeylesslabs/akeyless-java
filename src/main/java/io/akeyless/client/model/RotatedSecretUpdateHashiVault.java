...
public class RotatedSecretUpdateHashiVault {
  ...
  public RotatedSecretUpdateHashiVault() {
  }

  public RotatedSecretUpdateHashiVault addTag(@javax.annotation.Nullable List<String> addTag) {
    this.addTag = addTag;
    return this;
  }

  public RotatedSecretUpdateHashiVault addAddTagItem(String addTagItem) {
    if (this.addTag == null) {
  ...
  public RotatedSecretUpdateHashiVault autoRotate(@javax.annotation.Nullable String autoRotate) {
  ...
  public RotatedSecretUpdateHashiVault deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public RotatedSecretUpdateHashiVault description(@javax.annotation.Nullable String description) {
  ...
  public RotatedSecretUpdateHashiVault inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public RotatedSecretUpdateHashiVault addInputRuleItem(String inputRuleItem) {
  ...
  public RotatedSecretUpdateHashiVault itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public RotatedSecretUpdateHashiVault putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public RotatedSecretUpdateHashiVault json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public RotatedSecretUpdateHashiVault keepPrevVersion(@javax.annotation.Nullable String keepPrevVersion) {
  ...
  public RotatedSecretUpdateHashiVault key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public RotatedSecretUpdateHashiVault maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public RotatedSecretUpdateHashiVault name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public RotatedSecretUpdateHashiVault newName(@javax.annotation.Nullable String newName) {
  ...
  public RotatedSecretUpdateHashiVault outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public RotatedSecretUpdateHashiVault addOutputRuleItem(String outputRuleItem) {
  ...
  public RotatedSecretUpdateHashiVault passwordLength(@javax.annotation.Nullable String passwordLength) {
  ...
  public RotatedSecretUpdateHashiVault rmTag(@javax.annotation.Nullable List<String> rmTag) {
    this.rmTag = rmTag;
    return this;
  }

  public RotatedSecretUpdateHashiVault addRmTagItem(String rmTagItem) {
    if (this.rmTag == null) {
  ...
  public RotatedSecretUpdateHashiVault rotationEventIn(@javax.annotation.Nullable List<String> rotationEventIn) {
    this.rotationEventIn = rotationEventIn;
    return this;
  }

  public RotatedSecretUpdateHashiVault addRotationEventInItem(String rotationEventInItem) {
  ...
  public RotatedSecretUpdateHashiVault rotationHour(@javax.annotation.Nullable Integer rotationHour) {
  ...
  public RotatedSecretUpdateHashiVault rotationInterval(@javax.annotation.Nullable String rotationInterval) {
  ...
  public RotatedSecretUpdateHashiVault token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public RotatedSecretUpdateHashiVault uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public RotatedSecretUpdateHashiVault useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public RotatedSecretUpdateHashiVault useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public RotatedSecretUpdateHashiVault useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public RotatedSecretUpdateHashiVault useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    RotatedSecretUpdateHashiVault rotatedSecretUpdateHashiVault = (RotatedSecretUpdateHashiVault) o;
    return Objects.equals(this.addTag, rotatedSecretUpdateHashiVault.addTag) &&
        Objects.equals(this.autoRotate, rotatedSecretUpdateHashiVault.autoRotate) &&
        Objects.equals(this.deleteProtection, rotatedSecretUpdateHashiVault.deleteProtection) &&
        Objects.equals(this.description, rotatedSecretUpdateHashiVault.description) &&
        Objects.equals(this.inputRule, rotatedSecretUpdateHashiVault.inputRule) &&
        Objects.equals(this.itemCustomFields, rotatedSecretUpdateHashiVault.itemCustomFields) &&
        Objects.equals(this.json, rotatedSecretUpdateHashiVault.json) &&
        Objects.equals(this.keepPrevVersion, rotatedSecretUpdateHashiVault.keepPrevVersion) &&
        Objects.equals(this.key, rotatedSecretUpdateHashiVault.key) &&
        Objects.equals(this.maxVersions, rotatedSecretUpdateHashiVault.maxVersions) &&
        Objects.equals(this.name, rotatedSecretUpdateHashiVault.name) &&
        Objects.equals(this.newName, rotatedSecretUpdateHashiVault.newName) &&
        Objects.equals(this.outputRule, rotatedSecretUpdateHashiVault.outputRule) &&
        Objects.equals(this.passwordLength, rotatedSecretUpdateHashiVault.passwordLength) &&
        Objects.equals(this.rmTag, rotatedSecretUpdateHashiVault.rmTag) &&
        Objects.equals(this.rotationEventIn, rotatedSecretUpdateHashiVault.rotationEventIn) &&
        Objects.equals(this.rotationHour, rotatedSecretUpdateHashiVault.rotationHour) &&
        Objects.equals(this.rotationInterval, rotatedSecretUpdateHashiVault.rotationInterval) &&
        Objects.equals(this.token, rotatedSecretUpdateHashiVault.token) &&
        Objects.equals(this.uidToken, rotatedSecretUpdateHashiVault.uidToken) &&
        Objects.equals(this.useCapitalLetters, rotatedSecretUpdateHashiVault.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, rotatedSecretUpdateHashiVault.useLowerLetters) &&
        Objects.equals(this.useNumbers, rotatedSecretUpdateHashiVault.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, rotatedSecretUpdateHashiVault.useSpecialCharacters);
  }

  @Override
  public int hashCode() {
    return Objects.hash(addTag, autoRotate, deleteProtection, description, inputRule, itemCustomFields, json, keepPrevVersion, key, maxVersions, name, newName, outputRule, passwordLength, rmTag, rotationEventIn, rotationHour, rotationInterval, token, uidToken, useCapitalLetters, useLowerLetters, useNumbers, useSpecialCharacters);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RotatedSecretUpdateHashiVault {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RotatedSecretUpdateHashiVault
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RotatedSecretUpdateHashiVault.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RotatedSecretUpdateHashiVault is not found in the empty JSON string", RotatedSecretUpdateHashiVault.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RotatedSecretUpdateHashiVault.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RotatedSecretUpdateHashiVault` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RotatedSecretUpdateHashiVault.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RotatedSecretUpdateHashiVault.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RotatedSecretUpdateHashiVault' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RotatedSecretUpdateHashiVault> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RotatedSecretUpdateHashiVault.class));

       return (TypeAdapter<T>) new TypeAdapter<RotatedSecretUpdateHashiVault>() {
           @Override
           public void write(JsonWriter out, RotatedSecretUpdateHashiVault value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RotatedSecretUpdateHashiVault read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RotatedSecretUpdateHashiVault given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RotatedSecretUpdateHashiVault
   * @throws IOException if the JSON string is invalid with respect to RotatedSecretUpdateHashiVault
   */
  public static RotatedSecretUpdateHashiVault fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RotatedSecretUpdateHashiVault.class);
  }

  /**
   * Convert an instance of RotatedSecretUpdateHashiVault to an JSON string
   *
   * @return JSON string
   */
