...
public class UpdateAuthMethodK8S {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessExpires, audience, boundIps, boundNamespaces, boundPodNames, boundSaNames, forceSubClaims, genKey, name, newName, password, publicKey, token, uidToken, username);
  }
