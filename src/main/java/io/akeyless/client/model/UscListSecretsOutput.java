...
public class UscListSecretsOutput {
  ...
  public UscListSecretsOutput warnings(@javax.annotation.Nullable List<String> warnings) {
    this.warnings = warnings;
    return this;
  }

  public UscListSecretsOutput addWarningsItem(String warningsItem) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UscListSecretsOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UscListSecretsOutput is not found in the empty JSON string", UscListSecretsOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UscListSecretsOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UscListSecretsOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
