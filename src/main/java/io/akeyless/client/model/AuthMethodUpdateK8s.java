...
public class AuthMethodUpdateK8s {
  ...
  public AuthMethodUpdateK8s() {
  }

  public AuthMethodUpdateK8s accessExpires(@javax.annotation.Nullable Long accessExpires) {
  ...
  public AuthMethodUpdateK8s audience(@javax.annotation.Nullable String audience) {
  ...
  public AuthMethodUpdateK8s auditLogsClaims(@javax.annotation.Nullable List<String> auditLogsClaims) {
    this.auditLogsClaims = auditLogsClaims;
    return this;
  }

  public AuthMethodUpdateK8s addAuditLogsClaimsItem(String auditLogsClaimsItem) {
  ...
  public AuthMethodUpdateK8s boundIps(@javax.annotation.Nullable List<String> boundIps) {
    this.boundIps = boundIps;
    return this;
  }

  public AuthMethodUpdateK8s addBoundIpsItem(String boundIpsItem) {
  ...
  public AuthMethodUpdateK8s boundNamespaces(@javax.annotation.Nullable List<String> boundNamespaces) {
    this.boundNamespaces = boundNamespaces;
    return this;
  }

  public AuthMethodUpdateK8s addBoundNamespacesItem(String boundNamespacesItem) {
  ...
  public AuthMethodUpdateK8s boundPodNames(@javax.annotation.Nullable List<String> boundPodNames) {
    this.boundPodNames = boundPodNames;
    return this;
  }

  public AuthMethodUpdateK8s addBoundPodNamesItem(String boundPodNamesItem) {
  ...
  public AuthMethodUpdateK8s boundSaNames(@javax.annotation.Nullable List<String> boundSaNames) {
    this.boundSaNames = boundSaNames;
    return this;
  }

  public AuthMethodUpdateK8s addBoundSaNamesItem(String boundSaNamesItem) {
  ...
  public AuthMethodUpdateK8s deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public AuthMethodUpdateK8s description(@javax.annotation.Nullable String description) {
  ...
  public AuthMethodUpdateK8s expirationEventIn(@javax.annotation.Nullable List<String> expirationEventIn) {
    this.expirationEventIn = expirationEventIn;
    return this;
  }

  public AuthMethodUpdateK8s addExpirationEventInItem(String expirationEventInItem) {
  ...
  public AuthMethodUpdateK8s forceSubClaims(@javax.annotation.Nullable Boolean forceSubClaims) {
  ...
  public AuthMethodUpdateK8s genKey(@javax.annotation.Nullable String genKey) {
    this.genKey = genKey;
    return this;
  }
  ...
  public AuthMethodUpdateK8s gwBoundIps(@javax.annotation.Nullable List<String> gwBoundIps) {
    this.gwBoundIps = gwBoundIps;
    return this;
  }

  public AuthMethodUpdateK8s addGwBoundIpsItem(String gwBoundIpsItem) {
  ...
  public AuthMethodUpdateK8s json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public AuthMethodUpdateK8s jwtTtl(@javax.annotation.Nullable Long jwtTtl) {
    this.jwtTtl = jwtTtl;
    return this;
  }
  ...
  public AuthMethodUpdateK8s name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public AuthMethodUpdateK8s newName(@javax.annotation.Nullable String newName) {
  ...
  public AuthMethodUpdateK8s productType(@javax.annotation.Nullable List<String> productType) {
    this.productType = productType;
    return this;
  }

  public AuthMethodUpdateK8s addProductTypeItem(String productTypeItem) {
  ...
  public AuthMethodUpdateK8s publicKey(@javax.annotation.Nullable String publicKey) {
  ...
  public AuthMethodUpdateK8s token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public AuthMethodUpdateK8s uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessExpires, authMethodUpdateK8s.accessExpires) &&
        ...
        Objects.equals(this.boundNamespaces, authMethodUpdateK8s.boundNamespaces) &&
        Objects.equals(this.boundPodNames, authMethodUpdateK8s.boundPodNames) &&
        Objects.equals(this.boundSaNames, authMethodUpdateK8s.boundSaNames) &&
        Objects.equals(this.deleteProtection, authMethodUpdateK8s.deleteProtection) &&
        Objects.equals(this.description, authMethodUpdateK8s.description) &&
        Objects.equals(this.expirationEventIn, authMethodUpdateK8s.expirationEventIn) &&
        Objects.equals(this.forceSubClaims, authMethodUpdateK8s.forceSubClaims) &&
        Objects.equals(this.genKey, authMethodUpdateK8s.genKey) &&
        Objects.equals(this.gwBoundIps, authMethodUpdateK8s.gwBoundIps) &&
        Objects.equals(this.json, authMethodUpdateK8s.json) &&
        Objects.equals(this.jwtTtl, authMethodUpdateK8s.jwtTtl) &&
        Objects.equals(this.name, authMethodUpdateK8s.name) &&
        Objects.equals(this.newName, authMethodUpdateK8s.newName) &&
        Objects.equals(this.productType, authMethodUpdateK8s.productType) &&
        Objects.equals(this.publicKey, authMethodUpdateK8s.publicKey) &&
        Objects.equals(this.token, authMethodUpdateK8s.token) &&
        Objects.equals(this.uidToken, authMethodUpdateK8s.uidToken);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("access-expires", "allowed-client-type", "audience", "audit-logs-claims", "bound-ips", "bound-namespaces", "bound-pod-names", "bound-sa-names", "delete_protection", "description", "expiration-event-in", "force-sub-claims", "gen-key", "gw-bound-ips", "json", "jwt-ttl", "name", "new-name", "product-type", "public-key", "token", "uid-token"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to AuthMethodUpdateK8s
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthMethodUpdateK8s.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AuthMethodUpdateK8s is not found in the empty JSON string", AuthMethodUpdateK8s.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthMethodUpdateK8s.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AuthMethodUpdateK8s` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AuthMethodUpdateK8s.openapiRequiredFields) {
      ...
      if (jsonObj.get("bound-namespaces") != null && !jsonObj.get("bound-namespaces").isJsonNull() && !jsonObj.get("bound-namespaces").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `bound-namespaces` to be an array in the JSON string but got `%s`", jsonObj.get("bound-namespaces").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("bound-pod-names") != null && !jsonObj.get("bound-pod-names").isJsonNull() && !jsonObj.get("bound-pod-names").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `bound-pod-names` to be an array in the JSON string but got `%s`", jsonObj.get("bound-pod-names").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("bound-sa-names") != null && !jsonObj.get("bound-sa-names").isJsonNull() && !jsonObj.get("bound-sa-names").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `bound-sa-names` to be an array in the JSON string but got `%s`", jsonObj.get("bound-sa-names").toString()));
      }
      ...
      if ((jsonObj.get("gen-key") != null && !jsonObj.get("gen-key").isJsonNull()) && !jsonObj.get("gen-key").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `gen-key` to be a primitive type in the JSON string but got `%s`", jsonObj.get("gen-key").toString()));
      }
      // ensure the optional json data is an array if present
      ...
      if ((jsonObj.get("public-key") != null && !jsonObj.get("public-key").isJsonNull()) && !jsonObj.get("public-key").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `public-key` to be a primitive type in the JSON string but got `%s`", jsonObj.get("public-key").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuthMethodUpdateK8s.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuthMethodUpdateK8s' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuthMethodUpdateK8s> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuthMethodUpdateK8s.class));

       return (TypeAdapter<T>) new TypeAdapter<AuthMethodUpdateK8s>() {
           @Override
           public void write(JsonWriter out, AuthMethodUpdateK8s value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AuthMethodUpdateK8s read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AuthMethodUpdateK8s given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AuthMethodUpdateK8s
   * @throws IOException if the JSON string is invalid with respect to AuthMethodUpdateK8s
   */
  public static AuthMethodUpdateK8s fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuthMethodUpdateK8s.class);
  }

  /**
   * Convert an instance of AuthMethodUpdateK8s to an JSON string
   *
   * @return JSON string
   */
