 ...
 */
@ApiModel(description = "authMethodUpdateK8s is a command that updates a new auth method that will be able to authenticate using K8S.")
...
public class AuthMethodUpdateK8s {
  ...
  public AuthMethodUpdateK8s accessExpires(Long accessExpires) {
  ...
  **/
  ...
  public AuthMethodUpdateK8s audience(String audience) {
  ...
  **/
  ...
  public AuthMethodUpdateK8s auditLogsClaims(List<String> auditLogsClaims) {
  ...
  **/
  ...
  public AuthMethodUpdateK8s boundIps(List<String> boundIps) {
  ...
  **/
  ...
  public AuthMethodUpdateK8s boundNamespaces(List<String> boundNamespaces) {
  ...
  **/
  ...
  public AuthMethodUpdateK8s boundPodNames(List<String> boundPodNames) {
  ...
  **/
  ...
  public AuthMethodUpdateK8s boundSaNames(List<String> boundSaNames) {
  ...
  **/
  ...
  public AuthMethodUpdateK8s deleteProtection(String deleteProtection) {
  ...
  **/
  ...
  public AuthMethodUpdateK8s description(String description) {
  ...
  **/
  ...
  public AuthMethodUpdateK8s forceSubClaims(Boolean forceSubClaims) {
  ...
  **/
  ...
  public AuthMethodUpdateK8s genKey(String genKey) {
  ...
  **/
  ...
  public AuthMethodUpdateK8s gwBoundIps(List<String> gwBoundIps) {
  ...
  **/
  ...
  public AuthMethodUpdateK8s json(Boolean json) {
  ...
  **/
  ...
  public AuthMethodUpdateK8s jwtTtl(Long jwtTtl) {
  ...
  **/
  ...
  public AuthMethodUpdateK8s name(String name) {
  ...
  **/
  ...
  public AuthMethodUpdateK8s newName(String newName) {
  ...
  **/
  ...
  public AuthMethodUpdateK8s productType(List<String> productType) {
  ...
  **/
  ...
  public AuthMethodUpdateK8s publicKey(String publicKey) {
  ...
  **/
  ...
  public AuthMethodUpdateK8s token(String token) {
  ...
  **/
  ...
  public AuthMethodUpdateK8s uidToken(String uidToken) {
