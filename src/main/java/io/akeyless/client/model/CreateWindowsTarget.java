...
public class CreateWindowsTarget {
  ...
  public CreateWindowsTarget connectionType(@javax.annotation.Nullable String connectionType) {
  ...
  public CreateWindowsTarget parentTargetName(@javax.annotation.Nullable String parentTargetName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.certificate, createWindowsTarget.certificate) &&
        Objects.equals(this.connectionType, createWindowsTarget.connectionType) &&
        ...
        Objects.equals(this.parentTargetName, createWindowsTarget.parentTargetName) &&
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("certificate", "connection-type", "description", "domain", "hostname", "json", "key", "max-versions", "name", "parent-target-name", "password", "port", "token", "uid-token", "use-tls", "username"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateWindowsTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateWindowsTarget is not found in the empty JSON string", CreateWindowsTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateWindowsTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateWindowsTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
