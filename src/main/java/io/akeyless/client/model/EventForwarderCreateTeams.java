...
public class EventForwarderCreateTeams {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("auth-methods-event-source-locations", "description", "event-types", "every", "gateways-event-source-locations", "items-event-source-locations", "json", "key", "name", "runner-type", "targets-event-source-locations", "token", "uid-token", "url"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("gateways-event-source-locations", "name", "runner-type", "url"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventForwarderCreateTeams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EventForwarderCreateTeams is not found in the empty JSON string", EventForwarderCreateTeams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EventForwarderCreateTeams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EventForwarderCreateTeams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
