...
public class UpdateRabbitMQTarget {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("comment", "description", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "rabbitmq-server-password", "rabbitmq-server-uri", "rabbitmq-server-user", "token", "uid-token", "update-version"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateRabbitMQTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateRabbitMQTarget is not found in the empty JSON string", UpdateRabbitMQTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateRabbitMQTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateRabbitMQTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
