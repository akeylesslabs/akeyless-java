...
public class TargetCreateAws {
  ...
  public TargetCreateAws generateExternalId(@javax.annotation.Nullable Boolean generateExternalId) {
  ...
  public TargetCreateAws roleArn(@javax.annotation.Nullable String roleArn) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessKey, targetCreateAws.accessKey) &&
        ...
        Objects.equals(this.roleArn, targetCreateAws.roleArn) &&
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("access-key", "access-key-id", "delete_protection", "description", "generate-external-id", "json", "key", "max-versions", "name", "region", "role-arn", "session-token", "token", "uid-token", "use-gw-cloud-identity"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TargetCreateAws.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TargetCreateAws is not found in the empty JSON string", TargetCreateAws.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TargetCreateAws.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TargetCreateAws` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
