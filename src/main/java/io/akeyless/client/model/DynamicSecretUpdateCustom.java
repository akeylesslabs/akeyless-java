...
public class DynamicSecretUpdateCustom {
  ...
  public DynamicSecretUpdateCustom adminRotationIntervalDays(@javax.annotation.Nullable Long adminRotationIntervalDays) {
  ...
  public DynamicSecretUpdateCustom createSyncUrl(@javax.annotation.Nonnull String createSyncUrl) {
  ...
  public DynamicSecretUpdateCustom deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public DynamicSecretUpdateCustom description(@javax.annotation.Nullable String description) {
  ...
  public DynamicSecretUpdateCustom enableAdminRotation(@javax.annotation.Nullable Boolean enableAdminRotation) {
  ...
  public DynamicSecretUpdateCustom inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public DynamicSecretUpdateCustom addInputRuleItem(String inputRuleItem) {
  ...
  public DynamicSecretUpdateCustom itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public DynamicSecretUpdateCustom putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public DynamicSecretUpdateCustom json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public DynamicSecretUpdateCustom name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public DynamicSecretUpdateCustom newName(@javax.annotation.Nullable String newName) {
  ...
  public DynamicSecretUpdateCustom outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public DynamicSecretUpdateCustom addOutputRuleItem(String outputRuleItem) {
  ...
  public DynamicSecretUpdateCustom payload(@javax.annotation.Nullable String payload) {
  ...
  public DynamicSecretUpdateCustom producerEncryptionKeyName(@javax.annotation.Nullable String producerEncryptionKeyName) {
  ...
  public DynamicSecretUpdateCustom revokeSyncUrl(@javax.annotation.Nonnull String revokeSyncUrl) {
  ...
  public DynamicSecretUpdateCustom rotateSyncUrl(@javax.annotation.Nullable String rotateSyncUrl) {
  ...
  public DynamicSecretUpdateCustom tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public DynamicSecretUpdateCustom timeoutSec(@javax.annotation.Nullable Long timeoutSec) {
  ...
  public DynamicSecretUpdateCustom token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public DynamicSecretUpdateCustom uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public DynamicSecretUpdateCustom userTtl(@javax.annotation.Nullable String userTtl) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.adminRotationIntervalDays, dynamicSecretUpdateCustom.adminRotationIntervalDays) &&
        ...
        Objects.equals(this.inputRule, dynamicSecretUpdateCustom.inputRule) &&
        Objects.equals(this.itemCustomFields, dynamicSecretUpdateCustom.itemCustomFields) &&
        ...
        Objects.equals(this.outputRule, dynamicSecretUpdateCustom.outputRule) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(adminRotationIntervalDays, createSyncUrl, deleteProtection, description, enableAdminRotation, inputRule, itemCustomFields, json, name, newName, outputRule, payload, producerEncryptionKeyName, revokeSyncUrl, rotateSyncUrl, tags, timeoutSec, token, uidToken, userTtl);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DynamicSecretUpdateCustom
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicSecretUpdateCustom.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicSecretUpdateCustom is not found in the empty JSON string", DynamicSecretUpdateCustom.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicSecretUpdateCustom.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DynamicSecretUpdateCustom` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DynamicSecretUpdateCustom.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DynamicSecretUpdateCustom.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DynamicSecretUpdateCustom' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DynamicSecretUpdateCustom> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DynamicSecretUpdateCustom.class));

       return (TypeAdapter<T>) new TypeAdapter<DynamicSecretUpdateCustom>() {
           @Override
           public void write(JsonWriter out, DynamicSecretUpdateCustom value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DynamicSecretUpdateCustom read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DynamicSecretUpdateCustom given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DynamicSecretUpdateCustom
   * @throws IOException if the JSON string is invalid with respect to DynamicSecretUpdateCustom
   */
  public static DynamicSecretUpdateCustom fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DynamicSecretUpdateCustom.class);
  }

  /**
   * Convert an instance of DynamicSecretUpdateCustom to an JSON string
   *
   * @return JSON string
   */
