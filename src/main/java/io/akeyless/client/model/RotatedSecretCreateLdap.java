...
public class RotatedSecretCreateLdap {
  ...
  public RotatedSecretCreateLdap providerType(@javax.annotation.Nullable String providerType) {
  ...
  public RotatedSecretCreateLdap authenticationCredentials(@javax.annotation.Nullable String authenticationCredentials) {
  ...
  public RotatedSecretCreateLdap autoRotate(@javax.annotation.Nullable String autoRotate) {
  ...
  public RotatedSecretCreateLdap deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public RotatedSecretCreateLdap description(@javax.annotation.Nullable String description) {
  ...
  public RotatedSecretCreateLdap hostProvider(@javax.annotation.Nullable String hostProvider) {
  ...
  public RotatedSecretCreateLdap inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public RotatedSecretCreateLdap addInputRuleItem(String inputRuleItem) {
  ...
  public RotatedSecretCreateLdap json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public RotatedSecretCreateLdap key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public RotatedSecretCreateLdap name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public RotatedSecretCreateLdap outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public RotatedSecretCreateLdap addOutputRuleItem(String outputRuleItem) {
  ...
  public RotatedSecretCreateLdap passwordLength(@javax.annotation.Nullable String passwordLength) {
  ...
  public RotatedSecretCreateLdap rotateAfterDisconnect(@javax.annotation.Nullable String rotateAfterDisconnect) {
  ...
  public RotatedSecretCreateLdap rotatedPassword(@javax.annotation.Nullable String rotatedPassword) {
  ...
  public RotatedSecretCreateLdap rotatedUsername(@javax.annotation.Nullable String rotatedUsername) {
  ...
  public RotatedSecretCreateLdap rotationEventIn(@javax.annotation.Nullable List<String> rotationEventIn) {
  ...
  public RotatedSecretCreateLdap rotationHour(@javax.annotation.Nullable Integer rotationHour) {
  ...
  public RotatedSecretCreateLdap rotationInterval(@javax.annotation.Nullable String rotationInterval) {
  ...
  public RotatedSecretCreateLdap rotatorType(@javax.annotation.Nonnull String rotatorType) {
  ...
  public RotatedSecretCreateLdap secureAccessBastionIssuer(@javax.annotation.Nullable String secureAccessBastionIssuer) {
  ...
  public RotatedSecretCreateLdap secureAccessCertificateIssuer(@javax.annotation.Nullable String secureAccessCertificateIssuer) {
  ...
  public RotatedSecretCreateLdap secureAccessEnable(@javax.annotation.Nullable String secureAccessEnable) {
  ...
  public RotatedSecretCreateLdap secureAccessHost(@javax.annotation.Nullable List<String> secureAccessHost) {
  ...
  public RotatedSecretCreateLdap secureAccessRdpDomain(@javax.annotation.Nullable String secureAccessRdpDomain) {
  ...
  public RotatedSecretCreateLdap secureAccessUrl(@javax.annotation.Nullable String secureAccessUrl) {
  ...
  public RotatedSecretCreateLdap secureAccessWeb(@javax.annotation.Nullable Boolean secureAccessWeb) {
  ...
  public RotatedSecretCreateLdap secureAccessWebBrowsing(@javax.annotation.Nullable Boolean secureAccessWebBrowsing) {
  ...
  public RotatedSecretCreateLdap secureAccessWebProxy(@javax.annotation.Nullable Boolean secureAccessWebProxy) {
  ...
  public RotatedSecretCreateLdap tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public RotatedSecretCreateLdap target(@javax.annotation.Nullable List<String> target) {
    this.target = target;
    return this;
  }
  ...
  public RotatedSecretCreateLdap targetName(@javax.annotation.Nonnull String targetName) {
  ...
  public RotatedSecretCreateLdap token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public RotatedSecretCreateLdap uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public RotatedSecretCreateLdap useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public RotatedSecretCreateLdap useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public RotatedSecretCreateLdap useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public RotatedSecretCreateLdap useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public RotatedSecretCreateLdap userAttribute(@javax.annotation.Nullable String userAttribute) {
  ...
  public RotatedSecretCreateLdap userDn(@javax.annotation.Nullable String userDn) {
    this.userDn = userDn;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.providerType, rotatedSecretCreateLdap.providerType) &&
        ...
        Objects.equals(this.inputRule, rotatedSecretCreateLdap.inputRule) &&
        ...
        Objects.equals(this.outputRule, rotatedSecretCreateLdap.outputRule) &&
        ...
        Objects.equals(this.secureAccessBastionIssuer, rotatedSecretCreateLdap.secureAccessBastionIssuer) &&
        Objects.equals(this.secureAccessCertificateIssuer, rotatedSecretCreateLdap.secureAccessCertificateIssuer) &&
        ...
        Objects.equals(this.useCapitalLetters, rotatedSecretCreateLdap.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, rotatedSecretCreateLdap.useLowerLetters) &&
        Objects.equals(this.useNumbers, rotatedSecretCreateLdap.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, rotatedSecretCreateLdap.useSpecialCharacters) &&
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("ProviderType", "authentication-credentials", "auto-rotate", "delete_protection", "description", "host-provider", "input-rule", "item-custom-fields", "json", "key", "lock-during-sra-session", "max-versions", "name", "output-rule", "password-length", "rotate-after-disconnect", "rotated-password", "rotated-username", "rotation-event-in", "rotation-hour", "rotation-interval", "rotator-type", "secure-access-bastion-issuer", "secure-access-certificate-issuer", "secure-access-enable", "secure-access-host", "secure-access-rdp-domain", "secure-access-url", "secure-access-web", "secure-access-web-browsing", "secure-access-web-proxy", "tags", "target", "target-name", "token", "uid-token", "use-capital-letters", "use-lower-letters", "use-numbers", "use-special-characters", "user-attribute", "user-dn"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to RotatedSecretCreateLdap
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RotatedSecretCreateLdap.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RotatedSecretCreateLdap is not found in the empty JSON string", RotatedSecretCreateLdap.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RotatedSecretCreateLdap.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RotatedSecretCreateLdap` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RotatedSecretCreateLdap.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RotatedSecretCreateLdap.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RotatedSecretCreateLdap' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RotatedSecretCreateLdap> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RotatedSecretCreateLdap.class));

       return (TypeAdapter<T>) new TypeAdapter<RotatedSecretCreateLdap>() {
           @Override
           public void write(JsonWriter out, RotatedSecretCreateLdap value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RotatedSecretCreateLdap read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RotatedSecretCreateLdap given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RotatedSecretCreateLdap
   * @throws IOException if the JSON string is invalid with respect to RotatedSecretCreateLdap
   */
  public static RotatedSecretCreateLdap fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RotatedSecretCreateLdap.class);
  }

  /**
   * Convert an instance of RotatedSecretCreateLdap to an JSON string
   *
   * @return JSON string
   */
