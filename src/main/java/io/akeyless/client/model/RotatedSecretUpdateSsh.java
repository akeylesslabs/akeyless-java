...
public class RotatedSecretUpdateSsh {
  ...
  public RotatedSecretUpdateSsh inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public RotatedSecretUpdateSsh addInputRuleItem(String inputRuleItem) {
  ...
  public RotatedSecretUpdateSsh lockDuringSraSession(@javax.annotation.Nullable String lockDuringSraSession) {
  ...
  public RotatedSecretUpdateSsh outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public RotatedSecretUpdateSsh addOutputRuleItem(String outputRuleItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.addTag, rotatedSecretUpdateSsh.addTag) &&
        ...
        Objects.equals(this.inputRule, rotatedSecretUpdateSsh.inputRule) &&
        ...
        Objects.equals(this.lockDuringSraSession, rotatedSecretUpdateSsh.lockDuringSraSession) &&
        ...
        Objects.equals(this.outputRule, rotatedSecretUpdateSsh.outputRule) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RotatedSecretUpdateSsh.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RotatedSecretUpdateSsh is not found in the empty JSON string", RotatedSecretUpdateSsh.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RotatedSecretUpdateSsh.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RotatedSecretUpdateSsh` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("key-data-base64") != null && !jsonObj.get("key-data-base64").isJsonNull()) && !jsonObj.get("key-data-base64").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `key-data-base64` to be a primitive type in the JSON string but got `%s`", jsonObj.get("key-data-base64").toString()));
      }
      ...
      if ((jsonObj.get("public-key-remote-path") != null && !jsonObj.get("public-key-remote-path").isJsonNull()) && !jsonObj.get("public-key-remote-path").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `public-key-remote-path` to be a primitive type in the JSON string but got `%s`", jsonObj.get("public-key-remote-path").toString()));
      }
      // ensure the optional json data is an array if present
      ...
      if ((jsonObj.get("secure-access-target-type") != null && !jsonObj.get("secure-access-target-type").isJsonNull()) && !jsonObj.get("secure-access-target-type").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `secure-access-target-type` to be a primitive type in the JSON string but got `%s`", jsonObj.get("secure-access-target-type").toString()));
      }
