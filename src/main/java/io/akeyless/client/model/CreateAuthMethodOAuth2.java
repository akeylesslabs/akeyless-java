...
public class CreateAuthMethodOAuth2 {
  ...
  public CreateAuthMethodOAuth2 accessExpires(@javax.annotation.Nullable Long accessExpires) {
  ...
  public CreateAuthMethodOAuth2 allowedClientType(@javax.annotation.Nullable List<String> allowedClientType) {
    this.allowedClientType = allowedClientType;
    return this;
  }

  public CreateAuthMethodOAuth2 addAllowedClientTypeItem(String allowedClientTypeItem) {
  ...
  public CreateAuthMethodOAuth2 audience(@javax.annotation.Nullable String audience) {
  ...
  public CreateAuthMethodOAuth2 auditLogsClaims(@javax.annotation.Nullable List<String> auditLogsClaims) {
  ...
  public CreateAuthMethodOAuth2 boundClientIds(@javax.annotation.Nullable List<String> boundClientIds) {
  ...
  public CreateAuthMethodOAuth2 boundIps(@javax.annotation.Nullable List<String> boundIps) {
  ...
  public CreateAuthMethodOAuth2 cert(@javax.annotation.Nullable String cert) {
    this.cert = cert;
    return this;
  }
  ...
  public CreateAuthMethodOAuth2 certFileData(@javax.annotation.Nullable String certFileData) {
  ...
  public CreateAuthMethodOAuth2 deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public CreateAuthMethodOAuth2 description(@javax.annotation.Nullable String description) {
  ...
  public CreateAuthMethodOAuth2 expirationEventIn(@javax.annotation.Nullable List<String> expirationEventIn) {
    this.expirationEventIn = expirationEventIn;
    return this;
  }

  public CreateAuthMethodOAuth2 addExpirationEventInItem(String expirationEventInItem) {
  ...
  public CreateAuthMethodOAuth2 forceSubClaims(@javax.annotation.Nullable Boolean forceSubClaims) {
  ...
  public CreateAuthMethodOAuth2 gatewayUrl(@javax.annotation.Nullable String gatewayUrl) {
  ...
  public CreateAuthMethodOAuth2 gwBoundIps(@javax.annotation.Nullable List<String> gwBoundIps) {
  ...
  public CreateAuthMethodOAuth2 issuer(@javax.annotation.Nullable String issuer) {
    this.issuer = issuer;
    return this;
  }
  ...
  public CreateAuthMethodOAuth2 json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public CreateAuthMethodOAuth2 jwksJsonData(@javax.annotation.Nullable String jwksJsonData) {
  ...
  public CreateAuthMethodOAuth2 jwksUri(@javax.annotation.Nullable String jwksUri) {
  ...
  public CreateAuthMethodOAuth2 jwtTtl(@javax.annotation.Nullable Long jwtTtl) {
    this.jwtTtl = jwtTtl;
    return this;
  }
  ...
  public CreateAuthMethodOAuth2 name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateAuthMethodOAuth2 productType(@javax.annotation.Nullable List<String> productType) {
  ...
  public CreateAuthMethodOAuth2 subclaimsDelimiters(@javax.annotation.Nullable List<String> subclaimsDelimiters) {
  ...
  public CreateAuthMethodOAuth2 token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public CreateAuthMethodOAuth2 uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public CreateAuthMethodOAuth2 uniqueIdentifier(@javax.annotation.Nonnull String uniqueIdentifier) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessExpires, createAuthMethodOAuth2.accessExpires) &&
        Objects.equals(this.allowedClientType, createAuthMethodOAuth2.allowedClientType) &&
        ...
        Objects.equals(this.expirationEventIn, createAuthMethodOAuth2.expirationEventIn) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessExpires, allowedClientType, audience, auditLogsClaims, boundClientIds, boundIps, cert, certFileData, deleteProtection, description, expirationEventIn, forceSubClaims, gatewayUrl, gwBoundIps, issuer, json, jwksJsonData, jwksUri, jwtTtl, name, productType, subclaimsDelimiters, token, uidToken, uniqueIdentifier);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateAuthMethodOAuth2
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateAuthMethodOAuth2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateAuthMethodOAuth2 is not found in the empty JSON string", CreateAuthMethodOAuth2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateAuthMethodOAuth2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateAuthMethodOAuth2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateAuthMethodOAuth2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateAuthMethodOAuth2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateAuthMethodOAuth2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateAuthMethodOAuth2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateAuthMethodOAuth2.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateAuthMethodOAuth2>() {
           @Override
           public void write(JsonWriter out, CreateAuthMethodOAuth2 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateAuthMethodOAuth2 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateAuthMethodOAuth2 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateAuthMethodOAuth2
   * @throws IOException if the JSON string is invalid with respect to CreateAuthMethodOAuth2
   */
  public static CreateAuthMethodOAuth2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAuthMethodOAuth2.class);
  }

  /**
   * Convert an instance of CreateAuthMethodOAuth2 to an JSON string
   *
   * @return JSON string
   */
