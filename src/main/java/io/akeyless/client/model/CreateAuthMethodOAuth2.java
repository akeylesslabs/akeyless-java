...
public class CreateAuthMethodOAuth2 {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessExpires, audience, boundClientIds, boundIps, forceSubClaims, gwBoundIps, issuer, jwksUri, jwtTtl, name, token, uidToken, uniqueIdentifier);
  }
