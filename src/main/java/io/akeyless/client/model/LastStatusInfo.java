...
public class LastStatusInfo {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("migrations_status", "producers_errors", "was_migrations_copied_to_new_table"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LastStatusInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in LastStatusInfo is not found in the empty JSON string", LastStatusInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LastStatusInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `LastStatusInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
