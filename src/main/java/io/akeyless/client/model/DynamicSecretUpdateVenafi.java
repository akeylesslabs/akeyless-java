 ...
 */
@ApiModel(description = "dynamicSecretUpdateVenafi is a command that updates a Venafi dynamic secret to dynamically update certificates generated by Venafi or have Akeyless generated certificates using PKI be monitored by Venafi")
...
public class DynamicSecretUpdateVenafi {
  ...
  public DynamicSecretUpdateVenafi adminRotationIntervalDays(Long adminRotationIntervalDays) {
  ...
  **/
  ...
  public DynamicSecretUpdateVenafi allowSubdomains(Boolean allowSubdomains) {
  ...
  **/
  ...
  public DynamicSecretUpdateVenafi allowedDomains(List<String> allowedDomains) {
  ...
  **/
  ...
  public DynamicSecretUpdateVenafi autoGeneratedFolder(String autoGeneratedFolder) {
  ...
  **/
  ...
  public DynamicSecretUpdateVenafi deleteProtection(String deleteProtection) {
  ...
  **/
  ...
  public DynamicSecretUpdateVenafi description(String description) {
  ...
  **/
  ...
  public DynamicSecretUpdateVenafi enableAdminRotation(Boolean enableAdminRotation) {
  ...
  **/
  ...
  public DynamicSecretUpdateVenafi json(Boolean json) {
  ...
  **/
  ...
  public DynamicSecretUpdateVenafi name(String name) {
  ...
  **/
  ...
  public DynamicSecretUpdateVenafi newName(String newName) {
  ...
  **/
  ...
  public DynamicSecretUpdateVenafi producerEncryptionKeyName(String producerEncryptionKeyName) {
  ...
  **/
  ...
  public DynamicSecretUpdateVenafi rootFirstInChain(Boolean rootFirstInChain) {
  ...
  **/
  ...
  public DynamicSecretUpdateVenafi signUsingAkeylessPki(Boolean signUsingAkeylessPki) {
  ...
  **/
  ...
  public DynamicSecretUpdateVenafi signerKeyName(String signerKeyName) {
  ...
  **/
  ...
  public DynamicSecretUpdateVenafi storePrivateKey(Boolean storePrivateKey) {
  ...
  **/
  ...
  public DynamicSecretUpdateVenafi tags(List<String> tags) {
  ...
  **/
  ...
  public DynamicSecretUpdateVenafi targetName(String targetName) {
  ...
  **/
  ...
  public DynamicSecretUpdateVenafi token(String token) {
  ...
  **/
  ...
  public DynamicSecretUpdateVenafi uidToken(String uidToken) {
  ...
  **/
  ...
  public DynamicSecretUpdateVenafi userTtl(String userTtl) {
  ...
  **/
  ...
  public DynamicSecretUpdateVenafi venafiAccessToken(String venafiAccessToken) {
  ...
  **/
  ...
  public DynamicSecretUpdateVenafi venafiApiKey(String venafiApiKey) {
  ...
  **/
  ...
  public DynamicSecretUpdateVenafi venafiBaseurl(String venafiBaseurl) {
  ...
  **/
  ...
  public DynamicSecretUpdateVenafi venafiClientId(String venafiClientId) {
  ...
  **/
  ...
  public DynamicSecretUpdateVenafi venafiRefreshToken(String venafiRefreshToken) {
  ...
  **/
  ...
  public DynamicSecretUpdateVenafi venafiUseTpp(Boolean venafiUseTpp) {
  ...
  **/
  ...
  public DynamicSecretUpdateVenafi venafiZone(String venafiZone) {
