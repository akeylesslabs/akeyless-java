...
public class AWSSecretsMigration {
  ...
  public AWSSecretsMigration general(@javax.annotation.Nullable MigrationGeneral general) {
  ...
  public AWSSecretsMigration payload(@javax.annotation.Nullable AWSPayload payload) {
  ...
  public void setPayload(@javax.annotation.Nullable AWSPayload payload) {
    this.payload = payload;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AWSSecretsMigration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("payload") != null && !jsonObj.get("payload").isJsonNull()) {
        AWSPayload.validateJsonElement(jsonObj.get("payload"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AWSSecretsMigration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AWSSecretsMigration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AWSSecretsMigration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AWSSecretsMigration.class));

       return (TypeAdapter<T>) new TypeAdapter<AWSSecretsMigration>() {
           @Override
           public void write(JsonWriter out, AWSSecretsMigration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AWSSecretsMigration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AWSSecretsMigration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AWSSecretsMigration
   * @throws IOException if the JSON string is invalid with respect to AWSSecretsMigration
   */
  public static AWSSecretsMigration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AWSSecretsMigration.class);
  }

  /**
   * Convert an instance of AWSSecretsMigration to an JSON string
   *
   * @return JSON string
   */
