...
public class CreateHashiVaultTarget {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("description", "hashi-url", "json", "key", "max-versions", "name", "namespace", "token", "uid-token", "vault-token"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateHashiVaultTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateHashiVaultTarget is not found in the empty JSON string", CreateHashiVaultTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateHashiVaultTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateHashiVaultTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
