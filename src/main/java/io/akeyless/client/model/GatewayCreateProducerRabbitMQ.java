...
public class GatewayCreateProducerRabbitMQ {
  ...
  public GatewayCreateProducerRabbitMQ deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public GatewayCreateProducerRabbitMQ inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public GatewayCreateProducerRabbitMQ addInputRuleItem(String inputRuleItem) {
  ...
  public GatewayCreateProducerRabbitMQ itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public GatewayCreateProducerRabbitMQ putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public GatewayCreateProducerRabbitMQ json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public GatewayCreateProducerRabbitMQ name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public GatewayCreateProducerRabbitMQ outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public GatewayCreateProducerRabbitMQ addOutputRuleItem(String outputRuleItem) {
  ...
  public GatewayCreateProducerRabbitMQ passwordLength(@javax.annotation.Nullable String passwordLength) {
  ...
  public GatewayCreateProducerRabbitMQ producerEncryptionKeyName(@javax.annotation.Nullable String producerEncryptionKeyName) {
  ...
  public GatewayCreateProducerRabbitMQ rabbitmqAdminPwd(@javax.annotation.Nullable String rabbitmqAdminPwd) {
  ...
  public GatewayCreateProducerRabbitMQ rabbitmqAdminUser(@javax.annotation.Nullable String rabbitmqAdminUser) {
  ...
  public GatewayCreateProducerRabbitMQ rabbitmqServerUri(@javax.annotation.Nullable String rabbitmqServerUri) {
  ...
  public GatewayCreateProducerRabbitMQ rabbitmqUserConfPermission(@javax.annotation.Nullable String rabbitmqUserConfPermission) {
  ...
  public GatewayCreateProducerRabbitMQ rabbitmqUserReadPermission(@javax.annotation.Nullable String rabbitmqUserReadPermission) {
  ...
  public GatewayCreateProducerRabbitMQ rabbitmqUserTags(@javax.annotation.Nullable String rabbitmqUserTags) {
  ...
  public GatewayCreateProducerRabbitMQ rabbitmqUserVhost(@javax.annotation.Nullable String rabbitmqUserVhost) {
  ...
  public GatewayCreateProducerRabbitMQ rabbitmqUserWritePermission(@javax.annotation.Nullable String rabbitmqUserWritePermission) {
  ...
  public GatewayCreateProducerRabbitMQ secureAccessEnable(@javax.annotation.Nullable String secureAccessEnable) {
  ...
  public GatewayCreateProducerRabbitMQ secureAccessUrl(@javax.annotation.Nullable String secureAccessUrl) {
  ...
  public GatewayCreateProducerRabbitMQ secureAccessWeb(@javax.annotation.Nullable Boolean secureAccessWeb) {
  ...
  public GatewayCreateProducerRabbitMQ secureAccessWebBrowsing(@javax.annotation.Nullable Boolean secureAccessWebBrowsing) {
  ...
  public GatewayCreateProducerRabbitMQ secureAccessWebProxy(@javax.annotation.Nullable Boolean secureAccessWebProxy) {
  ...
  public GatewayCreateProducerRabbitMQ tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public GatewayCreateProducerRabbitMQ targetName(@javax.annotation.Nullable String targetName) {
  ...
  public GatewayCreateProducerRabbitMQ token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public GatewayCreateProducerRabbitMQ uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public GatewayCreateProducerRabbitMQ useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public GatewayCreateProducerRabbitMQ useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public GatewayCreateProducerRabbitMQ useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public GatewayCreateProducerRabbitMQ useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public GatewayCreateProducerRabbitMQ userTtl(@javax.annotation.Nullable String userTtl) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.deleteProtection, gatewayCreateProducerRabbitMQ.deleteProtection) &&
        Objects.equals(this.inputRule, gatewayCreateProducerRabbitMQ.inputRule) &&
        Objects.equals(this.itemCustomFields, gatewayCreateProducerRabbitMQ.itemCustomFields) &&
        Objects.equals(this.json, gatewayCreateProducerRabbitMQ.json) &&
        Objects.equals(this.name, gatewayCreateProducerRabbitMQ.name) &&
        Objects.equals(this.outputRule, gatewayCreateProducerRabbitMQ.outputRule) &&
        Objects.equals(this.passwordLength, gatewayCreateProducerRabbitMQ.passwordLength) &&
        ...
        Objects.equals(this.useCapitalLetters, gatewayCreateProducerRabbitMQ.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, gatewayCreateProducerRabbitMQ.useLowerLetters) &&
        Objects.equals(this.useNumbers, gatewayCreateProducerRabbitMQ.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, gatewayCreateProducerRabbitMQ.useSpecialCharacters) &&
        Objects.equals(this.userTtl, gatewayCreateProducerRabbitMQ.userTtl);
  }

  @Override
  public int hashCode() {
    return Objects.hash(deleteProtection, inputRule, itemCustomFields, json, name, outputRule, passwordLength, producerEncryptionKeyName, rabbitmqAdminPwd, rabbitmqAdminUser, rabbitmqServerUri, rabbitmqUserConfPermission, rabbitmqUserReadPermission, rabbitmqUserTags, rabbitmqUserVhost, rabbitmqUserWritePermission, secureAccessEnable, secureAccessUrl, secureAccessWeb, secureAccessWebBrowsing, secureAccessWebProxy, tags, targetName, token, uidToken, useCapitalLetters, useLowerLetters, useNumbers, useSpecialCharacters, userTtl);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GatewayCreateProducerRabbitMQ
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GatewayCreateProducerRabbitMQ.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GatewayCreateProducerRabbitMQ is not found in the empty JSON string", GatewayCreateProducerRabbitMQ.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GatewayCreateProducerRabbitMQ.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GatewayCreateProducerRabbitMQ` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GatewayCreateProducerRabbitMQ.openapiRequiredFields) {
      ...
      if ((jsonObj.get("rabbitmq-admin-pwd") != null && !jsonObj.get("rabbitmq-admin-pwd").isJsonNull()) && !jsonObj.get("rabbitmq-admin-pwd").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `rabbitmq-admin-pwd` to be a primitive type in the JSON string but got `%s`", jsonObj.get("rabbitmq-admin-pwd").toString()));
      }
      if ((jsonObj.get("rabbitmq-admin-user") != null && !jsonObj.get("rabbitmq-admin-user").isJsonNull()) && !jsonObj.get("rabbitmq-admin-user").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `rabbitmq-admin-user` to be a primitive type in the JSON string but got `%s`", jsonObj.get("rabbitmq-admin-user").toString()));
      }
      if ((jsonObj.get("rabbitmq-server-uri") != null && !jsonObj.get("rabbitmq-server-uri").isJsonNull()) && !jsonObj.get("rabbitmq-server-uri").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `rabbitmq-server-uri` to be a primitive type in the JSON string but got `%s`", jsonObj.get("rabbitmq-server-uri").toString()));
      }
      if ((jsonObj.get("rabbitmq-user-conf-permission") != null && !jsonObj.get("rabbitmq-user-conf-permission").isJsonNull()) && !jsonObj.get("rabbitmq-user-conf-permission").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `rabbitmq-user-conf-permission` to be a primitive type in the JSON string but got `%s`", jsonObj.get("rabbitmq-user-conf-permission").toString()));
      }
      if ((jsonObj.get("rabbitmq-user-read-permission") != null && !jsonObj.get("rabbitmq-user-read-permission").isJsonNull()) && !jsonObj.get("rabbitmq-user-read-permission").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `rabbitmq-user-read-permission` to be a primitive type in the JSON string but got `%s`", jsonObj.get("rabbitmq-user-read-permission").toString()));
      }
      if ((jsonObj.get("rabbitmq-user-tags") != null && !jsonObj.get("rabbitmq-user-tags").isJsonNull()) && !jsonObj.get("rabbitmq-user-tags").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `rabbitmq-user-tags` to be a primitive type in the JSON string but got `%s`", jsonObj.get("rabbitmq-user-tags").toString()));
      }
      if ((jsonObj.get("rabbitmq-user-vhost") != null && !jsonObj.get("rabbitmq-user-vhost").isJsonNull()) && !jsonObj.get("rabbitmq-user-vhost").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `rabbitmq-user-vhost` to be a primitive type in the JSON string but got `%s`", jsonObj.get("rabbitmq-user-vhost").toString()));
      }
      if ((jsonObj.get("rabbitmq-user-write-permission") != null && !jsonObj.get("rabbitmq-user-write-permission").isJsonNull()) && !jsonObj.get("rabbitmq-user-write-permission").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `rabbitmq-user-write-permission` to be a primitive type in the JSON string but got `%s`", jsonObj.get("rabbitmq-user-write-permission").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GatewayCreateProducerRabbitMQ.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GatewayCreateProducerRabbitMQ' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GatewayCreateProducerRabbitMQ> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GatewayCreateProducerRabbitMQ.class));

       return (TypeAdapter<T>) new TypeAdapter<GatewayCreateProducerRabbitMQ>() {
           @Override
           public void write(JsonWriter out, GatewayCreateProducerRabbitMQ value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GatewayCreateProducerRabbitMQ read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GatewayCreateProducerRabbitMQ given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GatewayCreateProducerRabbitMQ
   * @throws IOException if the JSON string is invalid with respect to GatewayCreateProducerRabbitMQ
   */
  public static GatewayCreateProducerRabbitMQ fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GatewayCreateProducerRabbitMQ.class);
  }

  /**
   * Convert an instance of GatewayCreateProducerRabbitMQ to an JSON string
   *
   * @return JSON string
   */
