...
public class SetRoleRule {
  ...
  public SetRoleRule capability(@javax.annotation.Nonnull List<String> capability) {
  ...
  public SetRoleRule json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public SetRoleRule path(@javax.annotation.Nonnull String path) {
    this.path = path;
    return this;
  }
  ...
  public SetRoleRule roleName(@javax.annotation.Nonnull String roleName) {
  ...
  public SetRoleRule ruleType(@javax.annotation.Nullable String ruleType) {
  ...
  public SetRoleRule token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public SetRoleRule ttl(@javax.annotation.Nullable Integer ttl) {
    this.ttl = ttl;
    return this;
  }
  ...
  public SetRoleRule uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("capability", "json", "path", "role-name", "rule-type", "token", "ttl", "uid-token"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("capability", "path", "role-name"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SetRoleRule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetRoleRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SetRoleRule is not found in the empty JSON string", SetRoleRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SetRoleRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SetRoleRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SetRoleRule.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SetRoleRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SetRoleRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SetRoleRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SetRoleRule.class));

       return (TypeAdapter<T>) new TypeAdapter<SetRoleRule>() {
           @Override
           public void write(JsonWriter out, SetRoleRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SetRoleRule read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SetRoleRule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SetRoleRule
   * @throws IOException if the JSON string is invalid with respect to SetRoleRule
   */
  public static SetRoleRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SetRoleRule.class);
  }

  /**
   * Convert an instance of SetRoleRule to an JSON string
   *
   * @return JSON string
   */
