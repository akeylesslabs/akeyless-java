...
public class ListTargets {
  ...
  public ListTargets filter(@javax.annotation.Nullable String filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ListTargets json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public ListTargets paginationToken(@javax.annotation.Nullable String paginationToken) {
  ...
  public ListTargets token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public ListTargets type(@javax.annotation.Nullable List<String> type) {
    this.type = type;
    return this;
  }
  ...
  public ListTargets uidToken(@javax.annotation.Nullable String uidToken) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListTargets
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListTargets.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ListTargets is not found in the empty JSON string", ListTargets.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListTargets.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ListTargets` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListTargets.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListTargets' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListTargets> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListTargets.class));

       return (TypeAdapter<T>) new TypeAdapter<ListTargets>() {
           @Override
           public void write(JsonWriter out, ListTargets value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListTargets read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListTargets given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListTargets
   * @throws IOException if the JSON string is invalid with respect to ListTargets
   */
  public static ListTargets fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListTargets.class);
  }

  /**
   * Convert an instance of ListTargets to an JSON string
   *
   * @return JSON string
   */
