...
public class AuthMethodCreateLdap {
  ...
  public AuthMethodCreateLdap() {
  }

  public AuthMethodCreateLdap accessExpires(@javax.annotation.Nullable Long accessExpires) {
  ...
  public AuthMethodCreateLdap allowedClientType(@javax.annotation.Nullable List<String> allowedClientType) {
    this.allowedClientType = allowedClientType;
    return this;
  }

  public AuthMethodCreateLdap addAllowedClientTypeItem(String allowedClientTypeItem) {
  ...
  public AuthMethodCreateLdap auditLogsClaims(@javax.annotation.Nullable List<String> auditLogsClaims) {
    this.auditLogsClaims = auditLogsClaims;
    return this;
  }

  public AuthMethodCreateLdap addAuditLogsClaimsItem(String auditLogsClaimsItem) {
  ...
  public AuthMethodCreateLdap boundIps(@javax.annotation.Nullable List<String> boundIps) {
    this.boundIps = boundIps;
    return this;
  }

  public AuthMethodCreateLdap addBoundIpsItem(String boundIpsItem) {
  ...
  public AuthMethodCreateLdap deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public AuthMethodCreateLdap description(@javax.annotation.Nullable String description) {
  ...
  public AuthMethodCreateLdap expirationEventIn(@javax.annotation.Nullable List<String> expirationEventIn) {
    this.expirationEventIn = expirationEventIn;
    return this;
  }

  public AuthMethodCreateLdap addExpirationEventInItem(String expirationEventInItem) {
  ...
  public AuthMethodCreateLdap forceSubClaims(@javax.annotation.Nullable Boolean forceSubClaims) {
  ...
  public AuthMethodCreateLdap genKey(@javax.annotation.Nullable String genKey) {
    this.genKey = genKey;
    return this;
  }
  ...
  public AuthMethodCreateLdap gwBoundIps(@javax.annotation.Nullable List<String> gwBoundIps) {
    this.gwBoundIps = gwBoundIps;
    return this;
  }

  public AuthMethodCreateLdap addGwBoundIpsItem(String gwBoundIpsItem) {
  ...
  public AuthMethodCreateLdap json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public AuthMethodCreateLdap jwtTtl(@javax.annotation.Nullable Long jwtTtl) {
    this.jwtTtl = jwtTtl;
    return this;
  }
  ...
  public AuthMethodCreateLdap name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public AuthMethodCreateLdap productType(@javax.annotation.Nullable List<String> productType) {
    this.productType = productType;
    return this;
  }

  public AuthMethodCreateLdap addProductTypeItem(String productTypeItem) {
  ...
  public AuthMethodCreateLdap publicKeyData(@javax.annotation.Nullable String publicKeyData) {
  ...
  public AuthMethodCreateLdap token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public AuthMethodCreateLdap uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public AuthMethodCreateLdap uniqueIdentifier(@javax.annotation.Nullable String uniqueIdentifier) {
  ...
  public boolean equals(Object o) {
    ...
    AuthMethodCreateLdap authMethodCreateLdap = (AuthMethodCreateLdap) o;
    return Objects.equals(this.accessExpires, authMethodCreateLdap.accessExpires) &&
        Objects.equals(this.allowedClientType, authMethodCreateLdap.allowedClientType) &&
        Objects.equals(this.auditLogsClaims, authMethodCreateLdap.auditLogsClaims) &&
        Objects.equals(this.boundIps, authMethodCreateLdap.boundIps) &&
        Objects.equals(this.deleteProtection, authMethodCreateLdap.deleteProtection) &&
        Objects.equals(this.description, authMethodCreateLdap.description) &&
        Objects.equals(this.expirationEventIn, authMethodCreateLdap.expirationEventIn) &&
        Objects.equals(this.forceSubClaims, authMethodCreateLdap.forceSubClaims) &&
        Objects.equals(this.genKey, authMethodCreateLdap.genKey) &&
        Objects.equals(this.gwBoundIps, authMethodCreateLdap.gwBoundIps) &&
        Objects.equals(this.json, authMethodCreateLdap.json) &&
        Objects.equals(this.jwtTtl, authMethodCreateLdap.jwtTtl) &&
        Objects.equals(this.name, authMethodCreateLdap.name) &&
        Objects.equals(this.productType, authMethodCreateLdap.productType) &&
        Objects.equals(this.publicKeyData, authMethodCreateLdap.publicKeyData) &&
        Objects.equals(this.token, authMethodCreateLdap.token) &&
        Objects.equals(this.uidToken, authMethodCreateLdap.uidToken) &&
        Objects.equals(this.uniqueIdentifier, authMethodCreateLdap.uniqueIdentifier);
  }
  ...
  public String toString() {
    ...
    sb.append("class AuthMethodCreateLdap {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("access-expires", "allowed-client-type", "audit-logs-claims", "bound-ips", "delete_protection", "description", "expiration-event-in", "force-sub-claims", "gen-key", "gw-bound-ips", "json", "jwt-ttl", "name", "product-type", "public-key-data", "token", "uid-token", "unique-identifier"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to AuthMethodCreateLdap
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthMethodCreateLdap.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AuthMethodCreateLdap is not found in the empty JSON string", AuthMethodCreateLdap.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthMethodCreateLdap.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AuthMethodCreateLdap` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AuthMethodCreateLdap.openapiRequiredFields) {
      ...
      if ((jsonObj.get("public-key-data") != null && !jsonObj.get("public-key-data").isJsonNull()) && !jsonObj.get("public-key-data").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `public-key-data` to be a primitive type in the JSON string but got `%s`", jsonObj.get("public-key-data").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuthMethodCreateLdap.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuthMethodCreateLdap' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuthMethodCreateLdap> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuthMethodCreateLdap.class));

       return (TypeAdapter<T>) new TypeAdapter<AuthMethodCreateLdap>() {
           @Override
           public void write(JsonWriter out, AuthMethodCreateLdap value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AuthMethodCreateLdap read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AuthMethodCreateLdap given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AuthMethodCreateLdap
   * @throws IOException if the JSON string is invalid with respect to AuthMethodCreateLdap
   */
  public static AuthMethodCreateLdap fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuthMethodCreateLdap.class);
  }

  /**
   * Convert an instance of AuthMethodCreateLdap to an JSON string
   *
   * @return JSON string
   */
