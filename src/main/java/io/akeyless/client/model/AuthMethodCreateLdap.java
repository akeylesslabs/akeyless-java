...
public class AuthMethodCreateLdap {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessExpires, auditLogsClaims, boundIps, deleteProtection, description, expirationEventIn, forceSubClaims, genKey, gwBoundIps, json, jwtTtl, name, productType, publicKeyData, token, uidToken, uniqueIdentifier);
  }
