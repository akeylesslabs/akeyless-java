...
public class RotatedSecretCreateSplunk {
  ...
  public static final String SERIALIZED_NAME_HEC_TOKEN_NAME = "hec-token-name";
  ...
  public RotatedSecretCreateSplunk() {
  }

  public RotatedSecretCreateSplunk audience(@javax.annotation.Nullable String audience) {
  ...
  public RotatedSecretCreateSplunk authenticationCredentials(@javax.annotation.Nullable String authenticationCredentials) {
  ...
  public RotatedSecretCreateSplunk autoRotate(@javax.annotation.Nullable String autoRotate) {
  ...
  public RotatedSecretCreateSplunk deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public RotatedSecretCreateSplunk description(@javax.annotation.Nullable String description) {
  ...
  public RotatedSecretCreateSplunk expirationDate(@javax.annotation.Nullable String expirationDate) {
  ...
  public RotatedSecretCreateSplunk hecToken(@javax.annotation.Nullable String hecToken) {
  ...
  public RotatedSecretCreateSplunk hecTokenName(@javax.annotation.Nullable String hecTokenName) {
  ...
  public RotatedSecretCreateSplunk putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public RotatedSecretCreateSplunk json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public RotatedSecretCreateSplunk key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public RotatedSecretCreateSplunk maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public RotatedSecretCreateSplunk name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public RotatedSecretCreateSplunk passwordLength(@javax.annotation.Nullable String passwordLength) {
  ...
  public RotatedSecretCreateSplunk rotatedPassword(@javax.annotation.Nullable String rotatedPassword) {
  ...
  public RotatedSecretCreateSplunk rotatedUsername(@javax.annotation.Nullable String rotatedUsername) {
  ...
  public RotatedSecretCreateSplunk rotationEventIn(@javax.annotation.Nullable List<String> rotationEventIn) {
    this.rotationEventIn = rotationEventIn;
    return this;
  }

  public RotatedSecretCreateSplunk addRotationEventInItem(String rotationEventInItem) {
  ...
  public RotatedSecretCreateSplunk rotationHour(@javax.annotation.Nullable Integer rotationHour) {
  ...
  public RotatedSecretCreateSplunk rotationInterval(@javax.annotation.Nullable String rotationInterval) {
  ...
  public RotatedSecretCreateSplunk rotatorType(@javax.annotation.Nonnull String rotatorType) {
  ...
  public RotatedSecretCreateSplunk splunkToken(@javax.annotation.Nullable String splunkToken) {
  ...
  public RotatedSecretCreateSplunk tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }

  public RotatedSecretCreateSplunk addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public RotatedSecretCreateSplunk targetName(@javax.annotation.Nonnull String targetName) {
  ...
  public RotatedSecretCreateSplunk token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public RotatedSecretCreateSplunk tokenOwner(@javax.annotation.Nullable String tokenOwner) {
  ...
  public RotatedSecretCreateSplunk uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public RotatedSecretCreateSplunk useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public RotatedSecretCreateSplunk useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public RotatedSecretCreateSplunk useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public RotatedSecretCreateSplunk useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    RotatedSecretCreateSplunk rotatedSecretCreateSplunk = (RotatedSecretCreateSplunk) o;
    return Objects.equals(this.audience, rotatedSecretCreateSplunk.audience) &&
        Objects.equals(this.authenticationCredentials, rotatedSecretCreateSplunk.authenticationCredentials) &&
        Objects.equals(this.autoRotate, rotatedSecretCreateSplunk.autoRotate) &&
        Objects.equals(this.deleteProtection, rotatedSecretCreateSplunk.deleteProtection) &&
        Objects.equals(this.description, rotatedSecretCreateSplunk.description) &&
        ...
        Objects.equals(this.rotationEventIn, rotatedSecretCreateSplunk.rotationEventIn) &&
        Objects.equals(this.rotationHour, rotatedSecretCreateSplunk.rotationHour) &&
        Objects.equals(this.rotationInterval, rotatedSecretCreateSplunk.rotationInterval) &&
        Objects.equals(this.rotatorType, rotatedSecretCreateSplunk.rotatorType) &&
        Objects.equals(this.splunkToken, rotatedSecretCreateSplunk.splunkToken) &&
        Objects.equals(this.tags, rotatedSecretCreateSplunk.tags) &&
        Objects.equals(this.targetName, rotatedSecretCreateSplunk.targetName) &&
        Objects.equals(this.token, rotatedSecretCreateSplunk.token) &&
        Objects.equals(this.tokenOwner, rotatedSecretCreateSplunk.tokenOwner) &&
        Objects.equals(this.uidToken, rotatedSecretCreateSplunk.uidToken) &&
        Objects.equals(this.useCapitalLetters, rotatedSecretCreateSplunk.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, rotatedSecretCreateSplunk.useLowerLetters) &&
        Objects.equals(this.useNumbers, rotatedSecretCreateSplunk.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, rotatedSecretCreateSplunk.useSpecialCharacters);
  }
  ...
  public String toString() {
    ...
    sb.append("class RotatedSecretCreateSplunk {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("audience", "authentication-credentials", "auto-rotate", "delete_protection", "description", "expiration-date", "hec-token", "hec-token-name", "input-rule", "item-custom-fields", "json", "key", "max-versions", "name", "output-rule", "password-length", "rotated-password", "rotated-username", "rotation-event-in", "rotation-hour", "rotation-interval", "rotator-type", "splunk-token", "tags", "target-name", "token", "token-owner", "uid-token", "use-capital-letters", "use-lower-letters", "use-numbers", "use-special-characters"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to RotatedSecretCreateSplunk
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RotatedSecretCreateSplunk.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RotatedSecretCreateSplunk is not found in the empty JSON string", RotatedSecretCreateSplunk.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RotatedSecretCreateSplunk.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RotatedSecretCreateSplunk` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RotatedSecretCreateSplunk.openapiRequiredFields) {
      ...
      if ((jsonObj.get("hec-token-name") != null && !jsonObj.get("hec-token-name").isJsonNull()) && !jsonObj.get("hec-token-name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `hec-token-name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("hec-token-name").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RotatedSecretCreateSplunk.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RotatedSecretCreateSplunk' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RotatedSecretCreateSplunk> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RotatedSecretCreateSplunk.class));

       return (TypeAdapter<T>) new TypeAdapter<RotatedSecretCreateSplunk>() {
           @Override
           public void write(JsonWriter out, RotatedSecretCreateSplunk value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RotatedSecretCreateSplunk read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RotatedSecretCreateSplunk given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RotatedSecretCreateSplunk
   * @throws IOException if the JSON string is invalid with respect to RotatedSecretCreateSplunk
   */
  public static RotatedSecretCreateSplunk fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RotatedSecretCreateSplunk.class);
  }

  /**
   * Convert an instance of RotatedSecretCreateSplunk to an JSON string
   *
   * @return JSON string
   */
