...
public class DynamicSecretCreateMySql {
  ...
  public DynamicSecretCreateMySql() {
  }

  public DynamicSecretCreateMySql customUsernameTemplate(@javax.annotation.Nullable String customUsernameTemplate) {
  ...
  public DynamicSecretCreateMySql dbServerCertificates(@javax.annotation.Nullable String dbServerCertificates) {
  ...
  public DynamicSecretCreateMySql dbServerName(@javax.annotation.Nullable String dbServerName) {
  ...
  public DynamicSecretCreateMySql deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public DynamicSecretCreateMySql description(@javax.annotation.Nullable String description) {
  ...
  public DynamicSecretCreateMySql inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public DynamicSecretCreateMySql addInputRuleItem(String inputRuleItem) {
  ...
  public DynamicSecretCreateMySql itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public DynamicSecretCreateMySql putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public DynamicSecretCreateMySql json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public DynamicSecretCreateMySql mysqlDbname(@javax.annotation.Nullable String mysqlDbname) {
  ...
  public DynamicSecretCreateMySql mysqlHost(@javax.annotation.Nullable String mysqlHost) {
  ...
  public DynamicSecretCreateMySql mysqlPassword(@javax.annotation.Nullable String mysqlPassword) {
  ...
  public DynamicSecretCreateMySql mysqlPort(@javax.annotation.Nullable String mysqlPort) {
  ...
  public DynamicSecretCreateMySql mysqlRevocationStatements(@javax.annotation.Nullable String mysqlRevocationStatements) {
  ...
  public DynamicSecretCreateMySql mysqlScreationStatements(@javax.annotation.Nullable String mysqlScreationStatements) {
  ...
  public DynamicSecretCreateMySql mysqlUsername(@javax.annotation.Nullable String mysqlUsername) {
  ...
  public DynamicSecretCreateMySql name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public DynamicSecretCreateMySql outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public DynamicSecretCreateMySql addOutputRuleItem(String outputRuleItem) {
  ...
  public DynamicSecretCreateMySql passwordLength(@javax.annotation.Nullable String passwordLength) {
  ...
  public DynamicSecretCreateMySql producerEncryptionKeyName(@javax.annotation.Nullable String producerEncryptionKeyName) {
  ...
  public DynamicSecretCreateMySql secureAccessBastionIssuer(@javax.annotation.Nullable String secureAccessBastionIssuer) {
  ...
  public DynamicSecretCreateMySql secureAccessCertificateIssuer(@javax.annotation.Nullable String secureAccessCertificateIssuer) {
  ...
  public DynamicSecretCreateMySql secureAccessDbName(@javax.annotation.Nullable String secureAccessDbName) {
  ...
  public DynamicSecretCreateMySql secureAccessDelay(@javax.annotation.Nullable Long secureAccessDelay) {
  ...
  public DynamicSecretCreateMySql secureAccessEnable(@javax.annotation.Nullable String secureAccessEnable) {
  ...
  public DynamicSecretCreateMySql secureAccessHost(@javax.annotation.Nullable List<String> secureAccessHost) {
    this.secureAccessHost = secureAccessHost;
    return this;
  }

  public DynamicSecretCreateMySql addSecureAccessHostItem(String secureAccessHostItem) {
  ...
  public DynamicSecretCreateMySql secureAccessWeb(@javax.annotation.Nullable Boolean secureAccessWeb) {
  ...
  public DynamicSecretCreateMySql ssl(@javax.annotation.Nullable Boolean ssl) {
    this.ssl = ssl;
    return this;
  }
  ...
  public DynamicSecretCreateMySql sslCertificate(@javax.annotation.Nullable String sslCertificate) {
  ...
  public DynamicSecretCreateMySql tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }

  public DynamicSecretCreateMySql addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public DynamicSecretCreateMySql targetName(@javax.annotation.Nullable String targetName) {
  ...
  public DynamicSecretCreateMySql token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public DynamicSecretCreateMySql uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public DynamicSecretCreateMySql useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public DynamicSecretCreateMySql useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public DynamicSecretCreateMySql useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public DynamicSecretCreateMySql useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public DynamicSecretCreateMySql userTtl(@javax.annotation.Nullable String userTtl) {
  ...
  public boolean equals(Object o) {
    ...
    DynamicSecretCreateMySql dynamicSecretCreateMySql = (DynamicSecretCreateMySql) o;
    return Objects.equals(this.customUsernameTemplate, dynamicSecretCreateMySql.customUsernameTemplate) &&
        Objects.equals(this.dbServerCertificates, dynamicSecretCreateMySql.dbServerCertificates) &&
        Objects.equals(this.dbServerName, dynamicSecretCreateMySql.dbServerName) &&
        Objects.equals(this.deleteProtection, dynamicSecretCreateMySql.deleteProtection) &&
        Objects.equals(this.description, dynamicSecretCreateMySql.description) &&
        Objects.equals(this.inputRule, dynamicSecretCreateMySql.inputRule) &&
        Objects.equals(this.itemCustomFields, dynamicSecretCreateMySql.itemCustomFields) &&
        Objects.equals(this.json, dynamicSecretCreateMySql.json) &&
        Objects.equals(this.mysqlDbname, dynamicSecretCreateMySql.mysqlDbname) &&
        Objects.equals(this.mysqlHost, dynamicSecretCreateMySql.mysqlHost) &&
        Objects.equals(this.mysqlPassword, dynamicSecretCreateMySql.mysqlPassword) &&
        Objects.equals(this.mysqlPort, dynamicSecretCreateMySql.mysqlPort) &&
        Objects.equals(this.mysqlRevocationStatements, dynamicSecretCreateMySql.mysqlRevocationStatements) &&
        Objects.equals(this.mysqlScreationStatements, dynamicSecretCreateMySql.mysqlScreationStatements) &&
        Objects.equals(this.mysqlUsername, dynamicSecretCreateMySql.mysqlUsername) &&
        Objects.equals(this.name, dynamicSecretCreateMySql.name) &&
        Objects.equals(this.outputRule, dynamicSecretCreateMySql.outputRule) &&
        Objects.equals(this.passwordLength, dynamicSecretCreateMySql.passwordLength) &&
        Objects.equals(this.producerEncryptionKeyName, dynamicSecretCreateMySql.producerEncryptionKeyName) &&
        Objects.equals(this.secureAccessBastionIssuer, dynamicSecretCreateMySql.secureAccessBastionIssuer) &&
        Objects.equals(this.secureAccessCertificateIssuer, dynamicSecretCreateMySql.secureAccessCertificateIssuer) &&
        Objects.equals(this.secureAccessDbName, dynamicSecretCreateMySql.secureAccessDbName) &&
        Objects.equals(this.secureAccessDelay, dynamicSecretCreateMySql.secureAccessDelay) &&
        Objects.equals(this.secureAccessEnable, dynamicSecretCreateMySql.secureAccessEnable) &&
        Objects.equals(this.secureAccessHost, dynamicSecretCreateMySql.secureAccessHost) &&
        Objects.equals(this.secureAccessWeb, dynamicSecretCreateMySql.secureAccessWeb) &&
        Objects.equals(this.ssl, dynamicSecretCreateMySql.ssl) &&
        Objects.equals(this.sslCertificate, dynamicSecretCreateMySql.sslCertificate) &&
        Objects.equals(this.tags, dynamicSecretCreateMySql.tags) &&
        Objects.equals(this.targetName, dynamicSecretCreateMySql.targetName) &&
        Objects.equals(this.token, dynamicSecretCreateMySql.token) &&
        Objects.equals(this.uidToken, dynamicSecretCreateMySql.uidToken) &&
        Objects.equals(this.useCapitalLetters, dynamicSecretCreateMySql.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, dynamicSecretCreateMySql.useLowerLetters) &&
        Objects.equals(this.useNumbers, dynamicSecretCreateMySql.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, dynamicSecretCreateMySql.useSpecialCharacters) &&
        Objects.equals(this.userTtl, dynamicSecretCreateMySql.userTtl);
  }

  @Override
  public int hashCode() {
    return Objects.hash(customUsernameTemplate, dbServerCertificates, dbServerName, deleteProtection, description, inputRule, itemCustomFields, json, mysqlDbname, mysqlHost, mysqlPassword, mysqlPort, mysqlRevocationStatements, mysqlScreationStatements, mysqlUsername, name, outputRule, passwordLength, producerEncryptionKeyName, secureAccessBastionIssuer, secureAccessCertificateIssuer, secureAccessDbName, secureAccessDelay, secureAccessEnable, secureAccessHost, secureAccessWeb, ssl, sslCertificate, tags, targetName, token, uidToken, useCapitalLetters, useLowerLetters, useNumbers, useSpecialCharacters, userTtl);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DynamicSecretCreateMySql {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("custom-username-template", "db-server-certificates", "db-server-name", "delete_protection", "description", "input-rule", "item-custom-fields", "json", "mysql-dbname", "mysql-host", "mysql-password", "mysql-port", "mysql-revocation-statements", "mysql-screation-statements", "mysql-username", "name", "output-rule", "password-length", "producer-encryption-key-name", "secure-access-bastion-issuer", "secure-access-certificate-issuer", "secure-access-db-name", "secure-access-delay", "secure-access-enable", "secure-access-host", "secure-access-web", "ssl", "ssl-certificate", "tags", "target-name", "token", "uid-token", "use-capital-letters", "use-lower-letters", "use-numbers", "use-special-characters", "user-ttl"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to DynamicSecretCreateMySql
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicSecretCreateMySql.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicSecretCreateMySql is not found in the empty JSON string", DynamicSecretCreateMySql.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicSecretCreateMySql.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DynamicSecretCreateMySql` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DynamicSecretCreateMySql.openapiRequiredFields) {
      ...
      if ((jsonObj.get("mysql-dbname") != null && !jsonObj.get("mysql-dbname").isJsonNull()) && !jsonObj.get("mysql-dbname").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `mysql-dbname` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mysql-dbname").toString()));
      }
      if ((jsonObj.get("mysql-host") != null && !jsonObj.get("mysql-host").isJsonNull()) && !jsonObj.get("mysql-host").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `mysql-host` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mysql-host").toString()));
      }
      if ((jsonObj.get("mysql-password") != null && !jsonObj.get("mysql-password").isJsonNull()) && !jsonObj.get("mysql-password").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `mysql-password` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mysql-password").toString()));
      }
      if ((jsonObj.get("mysql-port") != null && !jsonObj.get("mysql-port").isJsonNull()) && !jsonObj.get("mysql-port").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `mysql-port` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mysql-port").toString()));
      }
      if ((jsonObj.get("mysql-revocation-statements") != null && !jsonObj.get("mysql-revocation-statements").isJsonNull()) && !jsonObj.get("mysql-revocation-statements").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `mysql-revocation-statements` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mysql-revocation-statements").toString()));
      }
      if ((jsonObj.get("mysql-screation-statements") != null && !jsonObj.get("mysql-screation-statements").isJsonNull()) && !jsonObj.get("mysql-screation-statements").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `mysql-screation-statements` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mysql-screation-statements").toString()));
      }
      if ((jsonObj.get("mysql-username") != null && !jsonObj.get("mysql-username").isJsonNull()) && !jsonObj.get("mysql-username").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `mysql-username` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mysql-username").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DynamicSecretCreateMySql.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DynamicSecretCreateMySql' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DynamicSecretCreateMySql> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DynamicSecretCreateMySql.class));

       return (TypeAdapter<T>) new TypeAdapter<DynamicSecretCreateMySql>() {
           @Override
           public void write(JsonWriter out, DynamicSecretCreateMySql value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DynamicSecretCreateMySql read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DynamicSecretCreateMySql given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DynamicSecretCreateMySql
   * @throws IOException if the JSON string is invalid with respect to DynamicSecretCreateMySql
   */
  public static DynamicSecretCreateMySql fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DynamicSecretCreateMySql.class);
  }

  /**
   * Convert an instance of DynamicSecretCreateMySql to an JSON string
   *
   * @return JSON string
   */
