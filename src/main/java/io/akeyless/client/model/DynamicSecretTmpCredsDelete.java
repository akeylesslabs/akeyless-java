...
public class DynamicSecretTmpCredsDelete {
  ...
  public DynamicSecretTmpCredsDelete inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public DynamicSecretTmpCredsDelete addInputRuleItem(String inputRuleItem) {
  ...
  public DynamicSecretTmpCredsDelete outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public DynamicSecretTmpCredsDelete addOutputRuleItem(String outputRuleItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.host, dynamicSecretTmpCredsDelete.host) &&
        Objects.equals(this.inputRule, dynamicSecretTmpCredsDelete.inputRule) &&
        Objects.equals(this.json, dynamicSecretTmpCredsDelete.json) &&
        Objects.equals(this.name, dynamicSecretTmpCredsDelete.name) &&
        Objects.equals(this.outputRule, dynamicSecretTmpCredsDelete.outputRule) &&
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("host", "input-rule", "json", "name", "output-rule", "revoke-all", "soft-delete", "tmp-creds-id", "token", "uid-token"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicSecretTmpCredsDelete.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicSecretTmpCredsDelete is not found in the empty JSON string", DynamicSecretTmpCredsDelete.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicSecretTmpCredsDelete.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DynamicSecretTmpCredsDelete` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("tmp-creds-id") != null && !jsonObj.get("tmp-creds-id").isJsonNull()) && !jsonObj.get("tmp-creds-id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `tmp-creds-id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("tmp-creds-id").toString()));
      }
