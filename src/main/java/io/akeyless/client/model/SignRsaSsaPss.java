...
public class SignRsaSsaPss {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("display-id", "hash-function", "item-id", "json", "key-name", "message", "prehashed", "token", "uid-token", "version"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SignRsaSsaPss.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SignRsaSsaPss is not found in the empty JSON string", SignRsaSsaPss.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SignRsaSsaPss.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SignRsaSsaPss` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("hash-function") != null && !jsonObj.get("hash-function").isJsonNull()) && !jsonObj.get("hash-function").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `hash-function` to be a primitive type in the JSON string but got `%s`", jsonObj.get("hash-function").toString()));
      }
