...
public class CreateESM {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("azure-kv-name", "delete_protection", "description", "gcp-project-id", "json", "k8s-namespace", "name", "tags", "target-to-associate", "token", "uid-token"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateESM.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateESM is not found in the empty JSON string", CreateESM.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateESM.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateESM` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
