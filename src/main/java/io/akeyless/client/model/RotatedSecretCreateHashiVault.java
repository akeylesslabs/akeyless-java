...
public class RotatedSecretCreateHashiVault {
  ...
  public RotatedSecretCreateHashiVault() {
  }

  public RotatedSecretCreateHashiVault autoRotate(@javax.annotation.Nullable String autoRotate) {
  ...
  public RotatedSecretCreateHashiVault deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public RotatedSecretCreateHashiVault description(@javax.annotation.Nullable String description) {
  ...
  public RotatedSecretCreateHashiVault inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public RotatedSecretCreateHashiVault addInputRuleItem(String inputRuleItem) {
  ...
  public RotatedSecretCreateHashiVault itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public RotatedSecretCreateHashiVault putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public RotatedSecretCreateHashiVault json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public RotatedSecretCreateHashiVault key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public RotatedSecretCreateHashiVault maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public RotatedSecretCreateHashiVault name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public RotatedSecretCreateHashiVault outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public RotatedSecretCreateHashiVault addOutputRuleItem(String outputRuleItem) {
  ...
  public RotatedSecretCreateHashiVault passwordLength(@javax.annotation.Nullable String passwordLength) {
  ...
  public RotatedSecretCreateHashiVault rotationEventIn(@javax.annotation.Nullable List<String> rotationEventIn) {
    this.rotationEventIn = rotationEventIn;
    return this;
  }

  public RotatedSecretCreateHashiVault addRotationEventInItem(String rotationEventInItem) {
  ...
  public RotatedSecretCreateHashiVault rotationHour(@javax.annotation.Nullable Integer rotationHour) {
  ...
  public RotatedSecretCreateHashiVault rotationInterval(@javax.annotation.Nullable String rotationInterval) {
  ...
  public RotatedSecretCreateHashiVault tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }

  public RotatedSecretCreateHashiVault addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public RotatedSecretCreateHashiVault targetName(@javax.annotation.Nonnull String targetName) {
  ...
  public RotatedSecretCreateHashiVault token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public RotatedSecretCreateHashiVault uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public RotatedSecretCreateHashiVault useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public RotatedSecretCreateHashiVault useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public RotatedSecretCreateHashiVault useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public RotatedSecretCreateHashiVault useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    RotatedSecretCreateHashiVault rotatedSecretCreateHashiVault = (RotatedSecretCreateHashiVault) o;
    return Objects.equals(this.autoRotate, rotatedSecretCreateHashiVault.autoRotate) &&
        Objects.equals(this.deleteProtection, rotatedSecretCreateHashiVault.deleteProtection) &&
        Objects.equals(this.description, rotatedSecretCreateHashiVault.description) &&
        Objects.equals(this.inputRule, rotatedSecretCreateHashiVault.inputRule) &&
        Objects.equals(this.itemCustomFields, rotatedSecretCreateHashiVault.itemCustomFields) &&
        Objects.equals(this.json, rotatedSecretCreateHashiVault.json) &&
        Objects.equals(this.key, rotatedSecretCreateHashiVault.key) &&
        Objects.equals(this.maxVersions, rotatedSecretCreateHashiVault.maxVersions) &&
        Objects.equals(this.name, rotatedSecretCreateHashiVault.name) &&
        Objects.equals(this.outputRule, rotatedSecretCreateHashiVault.outputRule) &&
        Objects.equals(this.passwordLength, rotatedSecretCreateHashiVault.passwordLength) &&
        Objects.equals(this.rotationEventIn, rotatedSecretCreateHashiVault.rotationEventIn) &&
        Objects.equals(this.rotationHour, rotatedSecretCreateHashiVault.rotationHour) &&
        Objects.equals(this.rotationInterval, rotatedSecretCreateHashiVault.rotationInterval) &&
        Objects.equals(this.tags, rotatedSecretCreateHashiVault.tags) &&
        Objects.equals(this.targetName, rotatedSecretCreateHashiVault.targetName) &&
        Objects.equals(this.token, rotatedSecretCreateHashiVault.token) &&
        Objects.equals(this.uidToken, rotatedSecretCreateHashiVault.uidToken) &&
        Objects.equals(this.useCapitalLetters, rotatedSecretCreateHashiVault.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, rotatedSecretCreateHashiVault.useLowerLetters) &&
        Objects.equals(this.useNumbers, rotatedSecretCreateHashiVault.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, rotatedSecretCreateHashiVault.useSpecialCharacters);
  }

  @Override
  public int hashCode() {
    return Objects.hash(autoRotate, deleteProtection, description, inputRule, itemCustomFields, json, key, maxVersions, name, outputRule, passwordLength, rotationEventIn, rotationHour, rotationInterval, tags, targetName, token, uidToken, useCapitalLetters, useLowerLetters, useNumbers, useSpecialCharacters);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RotatedSecretCreateHashiVault {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RotatedSecretCreateHashiVault
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RotatedSecretCreateHashiVault.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RotatedSecretCreateHashiVault is not found in the empty JSON string", RotatedSecretCreateHashiVault.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RotatedSecretCreateHashiVault.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RotatedSecretCreateHashiVault` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RotatedSecretCreateHashiVault.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RotatedSecretCreateHashiVault.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RotatedSecretCreateHashiVault' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RotatedSecretCreateHashiVault> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RotatedSecretCreateHashiVault.class));

       return (TypeAdapter<T>) new TypeAdapter<RotatedSecretCreateHashiVault>() {
           @Override
           public void write(JsonWriter out, RotatedSecretCreateHashiVault value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RotatedSecretCreateHashiVault read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RotatedSecretCreateHashiVault given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RotatedSecretCreateHashiVault
   * @throws IOException if the JSON string is invalid with respect to RotatedSecretCreateHashiVault
   */
  public static RotatedSecretCreateHashiVault fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RotatedSecretCreateHashiVault.class);
  }

  /**
   * Convert an instance of RotatedSecretCreateHashiVault to an JSON string
   *
   * @return JSON string
   */
