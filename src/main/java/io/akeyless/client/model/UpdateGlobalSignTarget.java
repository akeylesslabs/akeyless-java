...
public class UpdateGlobalSignTarget {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(comment, contactEmail, contactFirstName, contactLastName, contactPhone, description, json, keepPrevVersion, key, name, newName, password, profileId, timeout, token, uidToken, updateVersion, username);
  }
