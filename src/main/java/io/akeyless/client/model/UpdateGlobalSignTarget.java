...
public class UpdateGlobalSignTarget {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("comment", "contact-email", "contact-first-name", "contact-last-name", "contact-phone", "description", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "password", "profile-id", "timeout", "token", "uid-token", "update-version", "username"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateGlobalSignTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateGlobalSignTarget is not found in the empty JSON string", UpdateGlobalSignTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateGlobalSignTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateGlobalSignTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
