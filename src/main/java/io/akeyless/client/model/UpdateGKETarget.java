...
public class UpdateGKETarget {
  ...
  public UpdateGKETarget comment(@javax.annotation.Nullable String comment) {
  ...
  public UpdateGKETarget description(@javax.annotation.Nullable String description) {
  ...
  public UpdateGKETarget gkeAccountKey(@javax.annotation.Nullable String gkeAccountKey) {
  ...
  public UpdateGKETarget gkeClusterCert(@javax.annotation.Nullable String gkeClusterCert) {
  ...
  public UpdateGKETarget gkeClusterEndpoint(@javax.annotation.Nullable String gkeClusterEndpoint) {
  ...
  public UpdateGKETarget gkeClusterName(@javax.annotation.Nullable String gkeClusterName) {
  ...
  public UpdateGKETarget gkeServiceAccountEmail(@javax.annotation.Nullable String gkeServiceAccountEmail) {
  ...
  public UpdateGKETarget json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public UpdateGKETarget keepPrevVersion(@javax.annotation.Nullable String keepPrevVersion) {
  ...
  public UpdateGKETarget key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public UpdateGKETarget maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public UpdateGKETarget name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateGKETarget newName(@javax.annotation.Nullable String newName) {
  ...
  public UpdateGKETarget token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public UpdateGKETarget uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public UpdateGKETarget updateVersion(@javax.annotation.Nullable Boolean updateVersion) {
  ...
  public UpdateGKETarget useGwCloudIdentity(@javax.annotation.Nullable Boolean useGwCloudIdentity) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("comment", "description", "gke-account-key", "gke-cluster-cert", "gke-cluster-endpoint", "gke-cluster-name", "gke-service-account-email", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "token", "uid-token", "update-version", "use-gw-cloud-identity"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateGKETarget
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateGKETarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateGKETarget is not found in the empty JSON string", UpdateGKETarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateGKETarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateGKETarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateGKETarget.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateGKETarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateGKETarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateGKETarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateGKETarget.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateGKETarget>() {
           @Override
           public void write(JsonWriter out, UpdateGKETarget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateGKETarget read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateGKETarget given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateGKETarget
   * @throws IOException if the JSON string is invalid with respect to UpdateGKETarget
   */
  public static UpdateGKETarget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateGKETarget.class);
  }

  /**
   * Convert an instance of UpdateGKETarget to an JSON string
   *
   * @return JSON string
   */
