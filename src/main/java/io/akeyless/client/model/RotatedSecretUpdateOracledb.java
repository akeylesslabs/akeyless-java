...
public class RotatedSecretUpdateOracledb {
  ...
  public RotatedSecretUpdateOracledb() {
  }

  public RotatedSecretUpdateOracledb addTag(@javax.annotation.Nullable List<String> addTag) {
    this.addTag = addTag;
    return this;
  }

  public RotatedSecretUpdateOracledb addAddTagItem(String addTagItem) {
    if (this.addTag == null) {
  ...
  public RotatedSecretUpdateOracledb authenticationCredentials(@javax.annotation.Nullable String authenticationCredentials) {
  ...
  public RotatedSecretUpdateOracledb autoRotate(@javax.annotation.Nullable String autoRotate) {
  ...
  public RotatedSecretUpdateOracledb deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public RotatedSecretUpdateOracledb description(@javax.annotation.Nullable String description) {
  ...
  public RotatedSecretUpdateOracledb inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public RotatedSecretUpdateOracledb addInputRuleItem(String inputRuleItem) {
  ...
  public RotatedSecretUpdateOracledb itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public RotatedSecretUpdateOracledb putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public RotatedSecretUpdateOracledb json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public RotatedSecretUpdateOracledb keepPrevVersion(@javax.annotation.Nullable String keepPrevVersion) {
  ...
  public RotatedSecretUpdateOracledb key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public RotatedSecretUpdateOracledb lockDuringSraSession(@javax.annotation.Nullable String lockDuringSraSession) {
  ...
  public RotatedSecretUpdateOracledb maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public RotatedSecretUpdateOracledb name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public RotatedSecretUpdateOracledb newName(@javax.annotation.Nullable String newName) {
  ...
  public RotatedSecretUpdateOracledb outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public RotatedSecretUpdateOracledb addOutputRuleItem(String outputRuleItem) {
  ...
  public RotatedSecretUpdateOracledb passwordLength(@javax.annotation.Nullable String passwordLength) {
  ...
  public RotatedSecretUpdateOracledb rmTag(@javax.annotation.Nullable List<String> rmTag) {
    this.rmTag = rmTag;
    return this;
  }

  public RotatedSecretUpdateOracledb addRmTagItem(String rmTagItem) {
    if (this.rmTag == null) {
  ...
  public RotatedSecretUpdateOracledb rotateAfterDisconnect(@javax.annotation.Nullable String rotateAfterDisconnect) {
  ...
  public RotatedSecretUpdateOracledb rotatedPassword(@javax.annotation.Nullable String rotatedPassword) {
  ...
  public RotatedSecretUpdateOracledb rotatedUsername(@javax.annotation.Nullable String rotatedUsername) {
  ...
  public RotatedSecretUpdateOracledb rotationEventIn(@javax.annotation.Nullable List<String> rotationEventIn) {
  ...
  public RotatedSecretUpdateOracledb rotationHour(@javax.annotation.Nullable Integer rotationHour) {
  ...
  public RotatedSecretUpdateOracledb rotationInterval(@javax.annotation.Nullable String rotationInterval) {
  ...
  public RotatedSecretUpdateOracledb secureAccessDbName(@javax.annotation.Nullable String secureAccessDbName) {
  ...
  public RotatedSecretUpdateOracledb secureAccessEnable(@javax.annotation.Nullable String secureAccessEnable) {
  ...
  public RotatedSecretUpdateOracledb secureAccessHost(@javax.annotation.Nullable List<String> secureAccessHost) {
    this.secureAccessHost = secureAccessHost;
    return this;
  }

  public RotatedSecretUpdateOracledb addSecureAccessHostItem(String secureAccessHostItem) {
  ...
  public RotatedSecretUpdateOracledb secureAccessWeb(@javax.annotation.Nullable Boolean secureAccessWeb) {
  ...
  public RotatedSecretUpdateOracledb token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public RotatedSecretUpdateOracledb uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public RotatedSecretUpdateOracledb useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public RotatedSecretUpdateOracledb useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public RotatedSecretUpdateOracledb useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public RotatedSecretUpdateOracledb useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    RotatedSecretUpdateOracledb rotatedSecretUpdateOracledb = (RotatedSecretUpdateOracledb) o;
    return Objects.equals(this.addTag, rotatedSecretUpdateOracledb.addTag) &&
        Objects.equals(this.authenticationCredentials, rotatedSecretUpdateOracledb.authenticationCredentials) &&
        Objects.equals(this.autoRotate, rotatedSecretUpdateOracledb.autoRotate) &&
        Objects.equals(this.deleteProtection, rotatedSecretUpdateOracledb.deleteProtection) &&
        Objects.equals(this.description, rotatedSecretUpdateOracledb.description) &&
        Objects.equals(this.inputRule, rotatedSecretUpdateOracledb.inputRule) &&
        Objects.equals(this.itemCustomFields, rotatedSecretUpdateOracledb.itemCustomFields) &&
        ...
        Objects.equals(this.lockDuringSraSession, rotatedSecretUpdateOracledb.lockDuringSraSession) &&
        ...
        Objects.equals(this.outputRule, rotatedSecretUpdateOracledb.outputRule) &&
        Objects.equals(this.passwordLength, rotatedSecretUpdateOracledb.passwordLength) &&
        Objects.equals(this.rmTag, rotatedSecretUpdateOracledb.rmTag) &&
        ...
        Objects.equals(this.secureAccessEnable, rotatedSecretUpdateOracledb.secureAccessEnable) &&
        Objects.equals(this.secureAccessHost, rotatedSecretUpdateOracledb.secureAccessHost) &&
        Objects.equals(this.secureAccessWeb, rotatedSecretUpdateOracledb.secureAccessWeb) &&
        Objects.equals(this.token, rotatedSecretUpdateOracledb.token) &&
        Objects.equals(this.uidToken, rotatedSecretUpdateOracledb.uidToken) &&
        Objects.equals(this.useCapitalLetters, rotatedSecretUpdateOracledb.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, rotatedSecretUpdateOracledb.useLowerLetters) &&
        Objects.equals(this.useNumbers, rotatedSecretUpdateOracledb.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, rotatedSecretUpdateOracledb.useSpecialCharacters);
  }

  @Override
  public int hashCode() {
    return Objects.hash(addTag, authenticationCredentials, autoRotate, deleteProtection, description, inputRule, itemCustomFields, json, keepPrevVersion, key, lockDuringSraSession, maxVersions, name, newName, outputRule, passwordLength, rmTag, rotateAfterDisconnect, rotatedPassword, rotatedUsername, rotationEventIn, rotationHour, rotationInterval, secureAccessDbName, secureAccessEnable, secureAccessHost, secureAccessWeb, token, uidToken, useCapitalLetters, useLowerLetters, useNumbers, useSpecialCharacters);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RotatedSecretUpdateOracledb {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RotatedSecretUpdateOracledb
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RotatedSecretUpdateOracledb.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RotatedSecretUpdateOracledb is not found in the empty JSON string", RotatedSecretUpdateOracledb.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RotatedSecretUpdateOracledb.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RotatedSecretUpdateOracledb` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RotatedSecretUpdateOracledb.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RotatedSecretUpdateOracledb.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RotatedSecretUpdateOracledb' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RotatedSecretUpdateOracledb> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RotatedSecretUpdateOracledb.class));

       return (TypeAdapter<T>) new TypeAdapter<RotatedSecretUpdateOracledb>() {
           @Override
           public void write(JsonWriter out, RotatedSecretUpdateOracledb value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RotatedSecretUpdateOracledb read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RotatedSecretUpdateOracledb given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RotatedSecretUpdateOracledb
   * @throws IOException if the JSON string is invalid with respect to RotatedSecretUpdateOracledb
   */
  public static RotatedSecretUpdateOracledb fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RotatedSecretUpdateOracledb.class);
  }

  /**
   * Convert an instance of RotatedSecretUpdateOracledb to an JSON string
   *
   * @return JSON string
   */
