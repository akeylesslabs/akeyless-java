...
public class EventForwarderUpdateTeams {
  ...
  public EventForwarderUpdateTeams() {
  }

  public EventForwarderUpdateTeams authMethodsEventSourceLocations(@javax.annotation.Nullable List<String> authMethodsEventSourceLocations) {
    this.authMethodsEventSourceLocations = authMethodsEventSourceLocations;
    return this;
  }

  public EventForwarderUpdateTeams addAuthMethodsEventSourceLocationsItem(String authMethodsEventSourceLocationsItem) {
  ...
  public EventForwarderUpdateTeams description(@javax.annotation.Nullable String description) {
  ...
  public EventForwarderUpdateTeams enable(@javax.annotation.Nullable String enable) {
    this.enable = enable;
    return this;
  }
  ...
  public EventForwarderUpdateTeams eventTypes(@javax.annotation.Nullable List<String> eventTypes) {
    this.eventTypes = eventTypes;
    return this;
  }

  public EventForwarderUpdateTeams addEventTypesItem(String eventTypesItem) {
  ...
  public EventForwarderUpdateTeams gatewaysEventSourceLocations(@javax.annotation.Nonnull List<String> gatewaysEventSourceLocations) {
    this.gatewaysEventSourceLocations = gatewaysEventSourceLocations;
    return this;
  }

  public EventForwarderUpdateTeams addGatewaysEventSourceLocationsItem(String gatewaysEventSourceLocationsItem) {
  ...
  public EventForwarderUpdateTeams itemsEventSourceLocations(@javax.annotation.Nullable List<String> itemsEventSourceLocations) {
    this.itemsEventSourceLocations = itemsEventSourceLocations;
    return this;
  }

  public EventForwarderUpdateTeams addItemsEventSourceLocationsItem(String itemsEventSourceLocationsItem) {
  ...
  public EventForwarderUpdateTeams json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public EventForwarderUpdateTeams keepPrevVersion(@javax.annotation.Nullable String keepPrevVersion) {
  ...
  public EventForwarderUpdateTeams key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public EventForwarderUpdateTeams name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public EventForwarderUpdateTeams newName(@javax.annotation.Nullable String newName) {
  ...
  public EventForwarderUpdateTeams targetsEventSourceLocations(@javax.annotation.Nullable List<String> targetsEventSourceLocations) {
    this.targetsEventSourceLocations = targetsEventSourceLocations;
    return this;
  }

  public EventForwarderUpdateTeams addTargetsEventSourceLocationsItem(String targetsEventSourceLocationsItem) {
  ...
  public EventForwarderUpdateTeams token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public EventForwarderUpdateTeams uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public EventForwarderUpdateTeams url(@javax.annotation.Nonnull String url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    EventForwarderUpdateTeams eventForwarderUpdateTeams = (EventForwarderUpdateTeams) o;
    return Objects.equals(this.authMethodsEventSourceLocations, eventForwarderUpdateTeams.authMethodsEventSourceLocations) &&
        Objects.equals(this.description, eventForwarderUpdateTeams.description) &&
        Objects.equals(this.enable, eventForwarderUpdateTeams.enable) &&
        Objects.equals(this.eventTypes, eventForwarderUpdateTeams.eventTypes) &&
        Objects.equals(this.gatewaysEventSourceLocations, eventForwarderUpdateTeams.gatewaysEventSourceLocations) &&
        Objects.equals(this.itemsEventSourceLocations, eventForwarderUpdateTeams.itemsEventSourceLocations) &&
        Objects.equals(this.json, eventForwarderUpdateTeams.json) &&
        Objects.equals(this.keepPrevVersion, eventForwarderUpdateTeams.keepPrevVersion) &&
        Objects.equals(this.key, eventForwarderUpdateTeams.key) &&
        Objects.equals(this.name, eventForwarderUpdateTeams.name) &&
        Objects.equals(this.newName, eventForwarderUpdateTeams.newName) &&
        Objects.equals(this.targetsEventSourceLocations, eventForwarderUpdateTeams.targetsEventSourceLocations) &&
        Objects.equals(this.token, eventForwarderUpdateTeams.token) &&
        Objects.equals(this.uidToken, eventForwarderUpdateTeams.uidToken) &&
        Objects.equals(this.url, eventForwarderUpdateTeams.url);
  }
  ...
  public String toString() {
    ...
    sb.append("class EventForwarderUpdateTeams {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to EventForwarderUpdateTeams
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventForwarderUpdateTeams.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in EventForwarderUpdateTeams is not found in the empty JSON string", EventForwarderUpdateTeams.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EventForwarderUpdateTeams.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `EventForwarderUpdateTeams` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EventForwarderUpdateTeams.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventForwarderUpdateTeams.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventForwarderUpdateTeams' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventForwarderUpdateTeams> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventForwarderUpdateTeams.class));

       return (TypeAdapter<T>) new TypeAdapter<EventForwarderUpdateTeams>() {
           @Override
           public void write(JsonWriter out, EventForwarderUpdateTeams value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public EventForwarderUpdateTeams read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of EventForwarderUpdateTeams given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of EventForwarderUpdateTeams
   * @throws IOException if the JSON string is invalid with respect to EventForwarderUpdateTeams
   */
  public static EventForwarderUpdateTeams fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EventForwarderUpdateTeams.class);
  }

  /**
   * Convert an instance of EventForwarderUpdateTeams to an JSON string
   *
   * @return JSON string
   */
