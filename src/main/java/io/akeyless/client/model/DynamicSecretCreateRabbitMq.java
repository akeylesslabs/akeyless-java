 ...
 */
@ApiModel(description = "dynamicSecretCreateRabbitMq is a command that creates rabbitmq dynamic secret")
...
public class DynamicSecretCreateRabbitMq {
  ...
  public DynamicSecretCreateRabbitMq deleteProtection(String deleteProtection) {
  ...
  **/
  ...
  public DynamicSecretCreateRabbitMq description(String description) {
  ...
  **/
  ...
  public DynamicSecretCreateRabbitMq json(Boolean json) {
  ...
  **/
  ...
  public DynamicSecretCreateRabbitMq name(String name) {
  ...
  **/
  ...
  public DynamicSecretCreateRabbitMq passwordLength(String passwordLength) {
  ...
  **/
  ...
  public DynamicSecretCreateRabbitMq producerEncryptionKeyName(String producerEncryptionKeyName) {
  ...
  **/
  ...
  public DynamicSecretCreateRabbitMq rabbitmqAdminPwd(String rabbitmqAdminPwd) {
  ...
  **/
  ...
  public DynamicSecretCreateRabbitMq rabbitmqAdminUser(String rabbitmqAdminUser) {
  ...
  **/
  ...
  public DynamicSecretCreateRabbitMq rabbitmqServerUri(String rabbitmqServerUri) {
  ...
  **/
  ...
  public DynamicSecretCreateRabbitMq rabbitmqUserConfPermission(String rabbitmqUserConfPermission) {
  ...
  **/
  ...
  public DynamicSecretCreateRabbitMq rabbitmqUserReadPermission(String rabbitmqUserReadPermission) {
  ...
  **/
  ...
  public DynamicSecretCreateRabbitMq rabbitmqUserTags(String rabbitmqUserTags) {
  ...
  **/
  ...
  public DynamicSecretCreateRabbitMq rabbitmqUserVhost(String rabbitmqUserVhost) {
  ...
  **/
  ...
  public DynamicSecretCreateRabbitMq rabbitmqUserWritePermission(String rabbitmqUserWritePermission) {
  ...
  **/
  ...
  public DynamicSecretCreateRabbitMq secureAccessEnable(String secureAccessEnable) {
  ...
  **/
  ...
  public DynamicSecretCreateRabbitMq secureAccessUrl(String secureAccessUrl) {
  ...
  **/
  ...
  public DynamicSecretCreateRabbitMq secureAccessWeb(Boolean secureAccessWeb) {
  ...
  **/
  ...
  public DynamicSecretCreateRabbitMq secureAccessWebBrowsing(Boolean secureAccessWebBrowsing) {
  ...
  **/
  ...
  public DynamicSecretCreateRabbitMq secureAccessWebProxy(Boolean secureAccessWebProxy) {
  ...
  **/
  ...
  public DynamicSecretCreateRabbitMq tags(List<String> tags) {
  ...
  **/
  ...
  public DynamicSecretCreateRabbitMq targetName(String targetName) {
  ...
  **/
  ...
  public DynamicSecretCreateRabbitMq token(String token) {
  ...
  **/
  ...
  public DynamicSecretCreateRabbitMq uidToken(String uidToken) {
  ...
  **/
  ...
  public DynamicSecretCreateRabbitMq userTtl(String userTtl) {
