...
public class DynamicSecretCreateRabbitMq {
  ...
  public DynamicSecretCreateRabbitMq inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public DynamicSecretCreateRabbitMq addInputRuleItem(String inputRuleItem) {
  ...
  public DynamicSecretCreateRabbitMq outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public DynamicSecretCreateRabbitMq addOutputRuleItem(String outputRuleItem) {
  ...
  public DynamicSecretCreateRabbitMq useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public DynamicSecretCreateRabbitMq useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public DynamicSecretCreateRabbitMq useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public DynamicSecretCreateRabbitMq useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.deleteProtection, dynamicSecretCreateRabbitMq.deleteProtection) &&
        ...
        Objects.equals(this.inputRule, dynamicSecretCreateRabbitMq.inputRule) &&
        ...
        Objects.equals(this.outputRule, dynamicSecretCreateRabbitMq.outputRule) &&
        ...
        Objects.equals(this.useCapitalLetters, dynamicSecretCreateRabbitMq.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, dynamicSecretCreateRabbitMq.useLowerLetters) &&
        Objects.equals(this.useNumbers, dynamicSecretCreateRabbitMq.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, dynamicSecretCreateRabbitMq.useSpecialCharacters) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicSecretCreateRabbitMq.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicSecretCreateRabbitMq is not found in the empty JSON string", DynamicSecretCreateRabbitMq.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicSecretCreateRabbitMq.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DynamicSecretCreateRabbitMq` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
