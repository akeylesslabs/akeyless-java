...
public class CreatePKICertIssuer {
  ...
  public CreatePKICertIssuer createPrivateOcsp(@javax.annotation.Nullable Boolean createPrivateOcsp) {
  ...
  public CreatePKICertIssuer createPublicOcsp(@javax.annotation.Nullable Boolean createPublicOcsp) {
  ...
  public CreatePKICertIssuer itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public CreatePKICertIssuer putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public CreatePKICertIssuer ocspTtl(@javax.annotation.Nullable String ocspTtl) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allowAnyName, createPKICertIssuer.allowAnyName) &&
        ...
        Objects.equals(this.createPrivateOcsp, createPKICertIssuer.createPrivateOcsp) &&
        Objects.equals(this.createPublicCrl, createPKICertIssuer.createPublicCrl) &&
        Objects.equals(this.createPublicOcsp, createPKICertIssuer.createPublicOcsp) &&
        ...
        Objects.equals(this.itemCustomFields, createPKICertIssuer.itemCustomFields) &&
        ...
        Objects.equals(this.ocspTtl, createPKICertIssuer.ocspTtl) &&
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("allow-any-name", "allow-copy-ext-from-csr", "allow-subdomains", "allowed-domains", "allowed-extra-extensions", "allowed-ip-sans", "allowed-uri-sans", "auto-renew", "basic-constraints", "ca-target", "client-flag", "code-signing-flag", "country", "create-private-crl", "create-private-ocsp", "create-public-crl", "create-public-ocsp", "critical-key-usage", "delete_protection", "description", "destination-path", "disable-wildcards", "enable-acme", "expiration-event-in", "gw-cluster-url", "is-ca", "item-custom-fields", "json", "key-usage", "locality", "max-path-len", "metadata", "name", "not-enforce-hostnames", "not-require-cn", "ocsp-ttl", "organizational-units", "organizations", "postal-code", "protect-certificates", "province", "scheduled-renew", "server-flag", "signer-key-name", "street-address", "tag", "token", "ttl", "uid-token"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreatePKICertIssuer.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreatePKICertIssuer is not found in the empty JSON string", CreatePKICertIssuer.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreatePKICertIssuer.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreatePKICertIssuer` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("ca-target") != null && !jsonObj.get("ca-target").isJsonNull()) && !jsonObj.get("ca-target").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `ca-target` to be a primitive type in the JSON string but got `%s`", jsonObj.get("ca-target").toString()));
      }
