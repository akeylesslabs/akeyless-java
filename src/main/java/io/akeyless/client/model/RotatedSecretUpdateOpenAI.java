...
public class RotatedSecretUpdateOpenAI {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(addTag, apiKey, apiKeyId, authenticationCredentials, autoRotate, deleteProtection, description, itemCustomFields, json, keepPrevVersion, key, maxVersions, name, newName, passwordLength, rmTag, rotationEventIn, rotationHour, rotationInterval, token, uidToken);
  }
