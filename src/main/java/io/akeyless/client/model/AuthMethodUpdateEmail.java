...
public class AuthMethodUpdateEmail {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessExpires, auditLogsClaims, boundIps, deleteProtection, description, enableMfa, expirationEventIn, forceSubClaims, gwBoundIps, json, jwtTtl, mfaType, name, newName, productType, token, uidToken);
  }
