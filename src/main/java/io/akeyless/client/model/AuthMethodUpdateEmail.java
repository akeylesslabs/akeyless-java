...
public class AuthMethodUpdateEmail {
  ...
  public AuthMethodUpdateEmail accessExpires(@javax.annotation.Nullable Long accessExpires) {
  ...
  public AuthMethodUpdateEmail allowedClientType(@javax.annotation.Nullable List<String> allowedClientType) {
    this.allowedClientType = allowedClientType;
    return this;
  }

  public AuthMethodUpdateEmail addAllowedClientTypeItem(String allowedClientTypeItem) {
  ...
  public AuthMethodUpdateEmail auditLogsClaims(@javax.annotation.Nullable List<String> auditLogsClaims) {
  ...
  public AuthMethodUpdateEmail boundIps(@javax.annotation.Nullable List<String> boundIps) {
  ...
  public AuthMethodUpdateEmail deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public AuthMethodUpdateEmail description(@javax.annotation.Nullable String description) {
  ...
  public AuthMethodUpdateEmail enableMfa(@javax.annotation.Nullable String enableMfa) {
  ...
  public AuthMethodUpdateEmail expirationEventIn(@javax.annotation.Nullable List<String> expirationEventIn) {
    this.expirationEventIn = expirationEventIn;
    return this;
  }

  public AuthMethodUpdateEmail addExpirationEventInItem(String expirationEventInItem) {
  ...
  public AuthMethodUpdateEmail forceSubClaims(@javax.annotation.Nullable Boolean forceSubClaims) {
  ...
  public AuthMethodUpdateEmail gwBoundIps(@javax.annotation.Nullable List<String> gwBoundIps) {
  ...
  public AuthMethodUpdateEmail json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public AuthMethodUpdateEmail jwtTtl(@javax.annotation.Nullable Long jwtTtl) {
    this.jwtTtl = jwtTtl;
    return this;
  }
  ...
  public AuthMethodUpdateEmail mfaType(@javax.annotation.Nullable String mfaType) {
  ...
  public AuthMethodUpdateEmail name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public AuthMethodUpdateEmail newName(@javax.annotation.Nullable String newName) {
  ...
  public AuthMethodUpdateEmail productType(@javax.annotation.Nullable List<String> productType) {
  ...
  public AuthMethodUpdateEmail token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public AuthMethodUpdateEmail uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessExpires, authMethodUpdateEmail.accessExpires) &&
        Objects.equals(this.allowedClientType, authMethodUpdateEmail.allowedClientType) &&
        ...
        Objects.equals(this.enableMfa, authMethodUpdateEmail.enableMfa) &&
        Objects.equals(this.expirationEventIn, authMethodUpdateEmail.expirationEventIn) &&
        ...
        Objects.equals(this.mfaType, authMethodUpdateEmail.mfaType) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessExpires, allowedClientType, auditLogsClaims, boundIps, deleteProtection, description, enableMfa, expirationEventIn, forceSubClaims, gwBoundIps, json, jwtTtl, mfaType, name, newName, productType, token, uidToken);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("access-expires", "allowed-client-type", "audit-logs-claims", "bound-ips", "delete_protection", "description", "enable-mfa", "expiration-event-in", "force-sub-claims", "gw-bound-ips", "json", "jwt-ttl", "mfa-type", "name", "new-name", "product-type", "token", "uid-token"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to AuthMethodUpdateEmail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthMethodUpdateEmail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AuthMethodUpdateEmail is not found in the empty JSON string", AuthMethodUpdateEmail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthMethodUpdateEmail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AuthMethodUpdateEmail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AuthMethodUpdateEmail.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuthMethodUpdateEmail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuthMethodUpdateEmail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuthMethodUpdateEmail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuthMethodUpdateEmail.class));

       return (TypeAdapter<T>) new TypeAdapter<AuthMethodUpdateEmail>() {
           @Override
           public void write(JsonWriter out, AuthMethodUpdateEmail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AuthMethodUpdateEmail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AuthMethodUpdateEmail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AuthMethodUpdateEmail
   * @throws IOException if the JSON string is invalid with respect to AuthMethodUpdateEmail
   */
  public static AuthMethodUpdateEmail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuthMethodUpdateEmail.class);
  }

  /**
   * Convert an instance of AuthMethodUpdateEmail to an JSON string
   *
   * @return JSON string
   */
