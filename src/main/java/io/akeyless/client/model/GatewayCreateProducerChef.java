...
public class GatewayCreateProducerChef {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(chefOrgs, chefServerKey, chefServerUrl, chefServerUsername, customUsernameTemplate, deleteProtection, inputRule, itemCustomFields, json, name, outputRule, passwordLength, producerEncryptionKeyName, skipSsl, tags, targetName, token, uidToken, userTtl);
  }
