...
public class TargetUpdateGlobalSignAtlas {
  ...
  public TargetUpdateGlobalSignAtlas deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.apiKey, targetUpdateGlobalSignAtlas.apiKey) &&
        ...
        Objects.equals(this.deleteProtection, targetUpdateGlobalSignAtlas.deleteProtection) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(apiKey, apiSecret, deleteProtection, description, json, keepPrevVersion, key, maxVersions, mtlsCertDataBase64, mtlsKeyDataBase64, name, newName, timeout, token, uidToken);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("api-key", "api-secret", "delete_protection", "description", "json", "keep-prev-version", "key", "max-versions", "mtls-cert-data-base64", "mtls-key-data-base64", "name", "new-name", "timeout", "token", "uid-token"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TargetUpdateGlobalSignAtlas.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TargetUpdateGlobalSignAtlas is not found in the empty JSON string", TargetUpdateGlobalSignAtlas.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TargetUpdateGlobalSignAtlas.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TargetUpdateGlobalSignAtlas` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
