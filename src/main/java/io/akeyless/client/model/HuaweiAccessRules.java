...
public class HuaweiAccessRules {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("auth_endpoint", "domain_id", "domain_name", "tenant_id", "tenant_name", "user_id", "user_name"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!HuaweiAccessRules.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in HuaweiAccessRules is not found in the empty JSON string", HuaweiAccessRules.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!HuaweiAccessRules.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `HuaweiAccessRules` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("auth_endpoint") != null && !jsonObj.get("auth_endpoint").isJsonNull()) && !jsonObj.get("auth_endpoint").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `auth_endpoint` to be a primitive type in the JSON string but got `%s`", jsonObj.get("auth_endpoint").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("domain_id") != null && !jsonObj.get("domain_id").isJsonNull() && !jsonObj.get("domain_id").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `domain_id` to be an array in the JSON string but got `%s`", jsonObj.get("domain_id").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("domain_name") != null && !jsonObj.get("domain_name").isJsonNull() && !jsonObj.get("domain_name").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `domain_name` to be an array in the JSON string but got `%s`", jsonObj.get("domain_name").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("tenant_id") != null && !jsonObj.get("tenant_id").isJsonNull() && !jsonObj.get("tenant_id").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `tenant_id` to be an array in the JSON string but got `%s`", jsonObj.get("tenant_id").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("tenant_name") != null && !jsonObj.get("tenant_name").isJsonNull() && !jsonObj.get("tenant_name").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `tenant_name` to be an array in the JSON string but got `%s`", jsonObj.get("tenant_name").toString()));
      }
      // ensure the optional json data is an array if present
