...
public class DynamicSecretUpdateK8s {
  ...
  public DynamicSecretUpdateK8s inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public DynamicSecretUpdateK8s addInputRuleItem(String inputRuleItem) {
  ...
  public DynamicSecretUpdateK8s itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public DynamicSecretUpdateK8s putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public DynamicSecretUpdateK8s outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public DynamicSecretUpdateK8s addOutputRuleItem(String outputRuleItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.customUsernameTemplate, dynamicSecretUpdateK8s.customUsernameTemplate) &&
        ...
        Objects.equals(this.inputRule, dynamicSecretUpdateK8s.inputRule) &&
        Objects.equals(this.itemCustomFields, dynamicSecretUpdateK8s.itemCustomFields) &&
        ...
        Objects.equals(this.outputRule, dynamicSecretUpdateK8s.outputRule) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicSecretUpdateK8s.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicSecretUpdateK8s is not found in the empty JSON string", DynamicSecretUpdateK8s.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicSecretUpdateK8s.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DynamicSecretUpdateK8s` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
