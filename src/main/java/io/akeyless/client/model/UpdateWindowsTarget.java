...
public class UpdateWindowsTarget {
  ...
  public UpdateWindowsTarget certificate(@javax.annotation.Nullable String certificate) {
  ...
  public UpdateWindowsTarget connectionType(@javax.annotation.Nullable String connectionType) {
  ...
  public UpdateWindowsTarget description(@javax.annotation.Nullable String description) {
  ...
  public UpdateWindowsTarget domain(@javax.annotation.Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public UpdateWindowsTarget hostname(@javax.annotation.Nonnull String hostname) {
  ...
  public UpdateWindowsTarget json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public UpdateWindowsTarget keepPrevVersion(@javax.annotation.Nullable String keepPrevVersion) {
  ...
  public UpdateWindowsTarget key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public UpdateWindowsTarget maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public UpdateWindowsTarget name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateWindowsTarget newName(@javax.annotation.Nullable String newName) {
  ...
  public UpdateWindowsTarget parentTargetName(@javax.annotation.Nullable String parentTargetName) {
  ...
  public UpdateWindowsTarget password(@javax.annotation.Nonnull String password) {
  ...
  public UpdateWindowsTarget port(@javax.annotation.Nullable String port) {
    this.port = port;
    return this;
  }
  ...
  public UpdateWindowsTarget token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public UpdateWindowsTarget uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public UpdateWindowsTarget updateVersion(@javax.annotation.Nullable Boolean updateVersion) {
  ...
  public UpdateWindowsTarget useTls(@javax.annotation.Nullable String useTls) {
    this.useTls = useTls;
    return this;
  }
  ...
  public UpdateWindowsTarget username(@javax.annotation.Nonnull String username) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.certificate, updateWindowsTarget.certificate) &&
        Objects.equals(this.connectionType, updateWindowsTarget.connectionType) &&
        ...
        Objects.equals(this.parentTargetName, updateWindowsTarget.parentTargetName) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(certificate, connectionType, description, domain, hostname, json, keepPrevVersion, key, maxVersions, name, newName, parentTargetName, password, port, token, uidToken, updateVersion, useTls, username);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("certificate", "connection-type", "description", "domain", "hostname", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "parent-target-name", "password", "port", "token", "uid-token", "update-version", "use-tls", "username"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("hostname", "name", "password", "username"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateWindowsTarget
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateWindowsTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateWindowsTarget is not found in the empty JSON string", UpdateWindowsTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateWindowsTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateWindowsTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateWindowsTarget.openapiRequiredFields) {
      ...
      if ((jsonObj.get("use-tls") != null && !jsonObj.get("use-tls").isJsonNull()) && !jsonObj.get("use-tls").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `use-tls` to be a primitive type in the JSON string but got `%s`", jsonObj.get("use-tls").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateWindowsTarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateWindowsTarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateWindowsTarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateWindowsTarget.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateWindowsTarget>() {
           @Override
           public void write(JsonWriter out, UpdateWindowsTarget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateWindowsTarget read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateWindowsTarget given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateWindowsTarget
   * @throws IOException if the JSON string is invalid with respect to UpdateWindowsTarget
   */
  public static UpdateWindowsTarget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateWindowsTarget.class);
  }

  /**
   * Convert an instance of UpdateWindowsTarget to an JSON string
   *
   * @return JSON string
   */
