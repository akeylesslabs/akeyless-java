...
public class Update {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("artifact-repository", "json", "show-changelog", "version"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("artifact-repository") != null && !jsonObj.get("artifact-repository").isJsonNull()) && !jsonObj.get("artifact-repository").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `artifact-repository` to be a primitive type in the JSON string but got `%s`", jsonObj.get("artifact-repository").toString()));
      }
