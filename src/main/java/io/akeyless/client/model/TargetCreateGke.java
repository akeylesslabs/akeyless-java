...
public class TargetCreateGke {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("delete_protection", "description", "gke-account-key", "gke-cluster-cert", "gke-cluster-endpoint", "gke-cluster-name", "gke-service-account-email", "json", "key", "max-versions", "name", "token", "uid-token", "use-gw-cloud-identity"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TargetCreateGke.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TargetCreateGke is not found in the empty JSON string", TargetCreateGke.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TargetCreateGke.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TargetCreateGke` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
