...
public class UpdateNativeK8STarget {
  ...
  public UpdateNativeK8STarget comment(@javax.annotation.Nullable String comment) {
  ...
  public UpdateNativeK8STarget description(@javax.annotation.Nullable String description) {
  ...
  public UpdateNativeK8STarget json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public UpdateNativeK8STarget k8sAuthType(@javax.annotation.Nullable String k8sAuthType) {
  ...
  public UpdateNativeK8STarget k8sClientCertificate(@javax.annotation.Nullable String k8sClientCertificate) {
  ...
  public UpdateNativeK8STarget k8sClientKey(@javax.annotation.Nullable String k8sClientKey) {
  ...
  public UpdateNativeK8STarget k8sClusterCaCert(@javax.annotation.Nullable String k8sClusterCaCert) {
  ...
  public UpdateNativeK8STarget k8sClusterEndpoint(@javax.annotation.Nullable String k8sClusterEndpoint) {
  ...
  public UpdateNativeK8STarget k8sClusterName(@javax.annotation.Nullable String k8sClusterName) {
  ...
  public UpdateNativeK8STarget k8sClusterToken(@javax.annotation.Nullable String k8sClusterToken) {
  ...
  public UpdateNativeK8STarget keepPrevVersion(@javax.annotation.Nullable String keepPrevVersion) {
  ...
  public UpdateNativeK8STarget key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public UpdateNativeK8STarget maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public UpdateNativeK8STarget name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateNativeK8STarget newName(@javax.annotation.Nullable String newName) {
  ...
  public UpdateNativeK8STarget token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public UpdateNativeK8STarget uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public UpdateNativeK8STarget updateVersion(@javax.annotation.Nullable Boolean updateVersion) {
  ...
  public UpdateNativeK8STarget useGwServiceAccount(@javax.annotation.Nullable Boolean useGwServiceAccount) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("comment", "description", "json", "k8s-auth-type", "k8s-client-certificate", "k8s-client-key", "k8s-cluster-ca-cert", "k8s-cluster-endpoint", "k8s-cluster-name", "k8s-cluster-token", "keep-prev-version", "key", "max-versions", "name", "new-name", "token", "uid-token", "update-version", "use-gw-service-account"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateNativeK8STarget
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateNativeK8STarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateNativeK8STarget is not found in the empty JSON string", UpdateNativeK8STarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateNativeK8STarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateNativeK8STarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateNativeK8STarget.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateNativeK8STarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateNativeK8STarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateNativeK8STarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateNativeK8STarget.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateNativeK8STarget>() {
           @Override
           public void write(JsonWriter out, UpdateNativeK8STarget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateNativeK8STarget read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateNativeK8STarget given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateNativeK8STarget
   * @throws IOException if the JSON string is invalid with respect to UpdateNativeK8STarget
   */
  public static UpdateNativeK8STarget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateNativeK8STarget.class);
  }

  /**
   * Convert an instance of UpdateNativeK8STarget to an JSON string
   *
   * @return JSON string
   */
