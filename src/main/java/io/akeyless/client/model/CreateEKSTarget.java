...
public class CreateEKSTarget {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("comment", "description", "eks-access-key-id", "eks-cluster-ca-cert", "eks-cluster-endpoint", "eks-cluster-name", "eks-region", "eks-secret-access-key", "json", "key", "max-versions", "name", "token", "uid-token", "use-gw-cloud-identity"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateEKSTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateEKSTarget is not found in the empty JSON string", CreateEKSTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateEKSTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateEKSTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
