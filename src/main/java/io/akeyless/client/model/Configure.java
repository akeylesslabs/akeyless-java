...
public class Configure {
  ...
  public Configure azureCloud(@javax.annotation.Nullable String azureCloud) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessId, configure.accessId) &&
        ...
        Objects.equals(this.azureCloud, configure.azureCloud) &&
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("access-id", "access-key", "access-type", "account-id", "admin-email", "admin-password", "azure-ad-object-id", "azure-cloud", "cert-data", "cert-issuer-name", "cert-username", "default-location-prefix", "disable-pafxfast", "gateway-spn", "gcp-audience", "json", "k8s-auth-config-name", "kerberos-token", "kerberos-username", "key-data", "keytab-data", "krb5-conf-data", "legacy-signing-alg-name", "oci-auth-type", "oci-group-ocid"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Configure.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Configure is not found in the empty JSON string", Configure.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Configure.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Configure` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("azure-ad-object-id") != null && !jsonObj.get("azure-ad-object-id").isJsonNull()) && !jsonObj.get("azure-ad-object-id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `azure-ad-object-id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("azure-ad-object-id").toString()));
      }
      ...
      if ((jsonObj.get("cert-username") != null && !jsonObj.get("cert-username").isJsonNull()) && !jsonObj.get("cert-username").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `cert-username` to be a primitive type in the JSON string but got `%s`", jsonObj.get("cert-username").toString()));
      }
      if ((jsonObj.get("default-location-prefix") != null && !jsonObj.get("default-location-prefix").isJsonNull()) && !jsonObj.get("default-location-prefix").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `default-location-prefix` to be a primitive type in the JSON string but got `%s`", jsonObj.get("default-location-prefix").toString()));
      }
