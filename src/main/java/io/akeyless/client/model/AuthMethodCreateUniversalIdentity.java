...
public class AuthMethodCreateUniversalIdentity {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessExpires, auditLogsClaims, boundIps, deleteProtection, denyInheritance, denyRotate, description, expirationEventIn, forceSubClaims, gwBoundIps, json, jwtTtl, name, productType, token, ttl, uidToken);
  }
