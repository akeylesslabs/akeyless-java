...
public class AuthMethodCreateUniversalIdentity {
  ...
  public AuthMethodCreateUniversalIdentity() {
  }

  public AuthMethodCreateUniversalIdentity accessExpires(@javax.annotation.Nullable Long accessExpires) {
  ...
  public AuthMethodCreateUniversalIdentity allowedClientType(@javax.annotation.Nullable List<String> allowedClientType) {
    this.allowedClientType = allowedClientType;
    return this;
  }

  public AuthMethodCreateUniversalIdentity addAllowedClientTypeItem(String allowedClientTypeItem) {
  ...
  public AuthMethodCreateUniversalIdentity auditLogsClaims(@javax.annotation.Nullable List<String> auditLogsClaims) {
    this.auditLogsClaims = auditLogsClaims;
    return this;
  }

  public AuthMethodCreateUniversalIdentity addAuditLogsClaimsItem(String auditLogsClaimsItem) {
  ...
  public AuthMethodCreateUniversalIdentity boundIps(@javax.annotation.Nullable List<String> boundIps) {
    this.boundIps = boundIps;
    return this;
  }

  public AuthMethodCreateUniversalIdentity addBoundIpsItem(String boundIpsItem) {
  ...
  public AuthMethodCreateUniversalIdentity deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public AuthMethodCreateUniversalIdentity denyInheritance(@javax.annotation.Nullable Boolean denyInheritance) {
  ...
  public AuthMethodCreateUniversalIdentity denyRotate(@javax.annotation.Nullable Boolean denyRotate) {
  ...
  public AuthMethodCreateUniversalIdentity description(@javax.annotation.Nullable String description) {
  ...
  public AuthMethodCreateUniversalIdentity expirationEventIn(@javax.annotation.Nullable List<String> expirationEventIn) {
    this.expirationEventIn = expirationEventIn;
    return this;
  }

  public AuthMethodCreateUniversalIdentity addExpirationEventInItem(String expirationEventInItem) {
  ...
  public AuthMethodCreateUniversalIdentity forceSubClaims(@javax.annotation.Nullable Boolean forceSubClaims) {
  ...
  public AuthMethodCreateUniversalIdentity gwBoundIps(@javax.annotation.Nullable List<String> gwBoundIps) {
    this.gwBoundIps = gwBoundIps;
    return this;
  }

  public AuthMethodCreateUniversalIdentity addGwBoundIpsItem(String gwBoundIpsItem) {
  ...
  public AuthMethodCreateUniversalIdentity json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public AuthMethodCreateUniversalIdentity jwtTtl(@javax.annotation.Nullable Long jwtTtl) {
    this.jwtTtl = jwtTtl;
    return this;
  }
  ...
  public AuthMethodCreateUniversalIdentity name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public AuthMethodCreateUniversalIdentity productType(@javax.annotation.Nullable List<String> productType) {
    this.productType = productType;
    return this;
  }

  public AuthMethodCreateUniversalIdentity addProductTypeItem(String productTypeItem) {
  ...
  public AuthMethodCreateUniversalIdentity token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public AuthMethodCreateUniversalIdentity uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public boolean equals(Object o) {
    ...
    AuthMethodCreateUniversalIdentity authMethodCreateUniversalIdentity = (AuthMethodCreateUniversalIdentity) o;
    return Objects.equals(this.accessExpires, authMethodCreateUniversalIdentity.accessExpires) &&
        ...
        Objects.equals(this.expirationEventIn, authMethodCreateUniversalIdentity.expirationEventIn) &&
        Objects.equals(this.forceSubClaims, authMethodCreateUniversalIdentity.forceSubClaims) &&
        Objects.equals(this.gwBoundIps, authMethodCreateUniversalIdentity.gwBoundIps) &&
        Objects.equals(this.json, authMethodCreateUniversalIdentity.json) &&
        Objects.equals(this.jwtTtl, authMethodCreateUniversalIdentity.jwtTtl) &&
  ...
  public String toString() {
    ...
    sb.append("class AuthMethodCreateUniversalIdentity {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("access-expires", "allowed-client-type", "audit-logs-claims", "bound-ips", "child-ttl-limit", "delete_protection", "deny-inheritance", "deny-rotate", "description", "expiration-event-in", "force-sub-claims", "gw-bound-ips", "json", "jwt-ttl", "name", "product-type", "token", "tree-length", "ttl", "uid-token"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to AuthMethodCreateUniversalIdentity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthMethodCreateUniversalIdentity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AuthMethodCreateUniversalIdentity is not found in the empty JSON string", AuthMethodCreateUniversalIdentity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthMethodCreateUniversalIdentity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AuthMethodCreateUniversalIdentity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AuthMethodCreateUniversalIdentity.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuthMethodCreateUniversalIdentity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuthMethodCreateUniversalIdentity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuthMethodCreateUniversalIdentity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuthMethodCreateUniversalIdentity.class));

       return (TypeAdapter<T>) new TypeAdapter<AuthMethodCreateUniversalIdentity>() {
           @Override
           public void write(JsonWriter out, AuthMethodCreateUniversalIdentity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AuthMethodCreateUniversalIdentity read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AuthMethodCreateUniversalIdentity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AuthMethodCreateUniversalIdentity
   * @throws IOException if the JSON string is invalid with respect to AuthMethodCreateUniversalIdentity
   */
  public static AuthMethodCreateUniversalIdentity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuthMethodCreateUniversalIdentity.class);
  }

  /**
   * Convert an instance of AuthMethodCreateUniversalIdentity to an JSON string
   *
   * @return JSON string
   */
