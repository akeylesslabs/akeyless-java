...
public class CreateClassicKeyOutput {
  ...
  public CreateClassicKeyOutput classicKeyId(@javax.annotation.Nullable String classicKeyId) {
  ...
  public CreateClassicKeyOutput classicKeyName(@javax.annotation.Nullable String classicKeyName) {
  ...
  public CreateClassicKeyOutput classicKeyType(@javax.annotation.Nullable String classicKeyType) {
  ...
  public CreateClassicKeyOutput publicKey(@javax.annotation.Nullable String publicKey) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateClassicKeyOutput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateClassicKeyOutput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateClassicKeyOutput is not found in the empty JSON string", CreateClassicKeyOutput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateClassicKeyOutput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateClassicKeyOutput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateClassicKeyOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateClassicKeyOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateClassicKeyOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateClassicKeyOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateClassicKeyOutput>() {
           @Override
           public void write(JsonWriter out, CreateClassicKeyOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateClassicKeyOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateClassicKeyOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateClassicKeyOutput
   * @throws IOException if the JSON string is invalid with respect to CreateClassicKeyOutput
   */
  public static CreateClassicKeyOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateClassicKeyOutput.class);
  }

  /**
   * Convert an instance of CreateClassicKeyOutput to an JSON string
   *
   * @return JSON string
   */
