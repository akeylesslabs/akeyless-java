...
public class GatewayGetK8SAuthConfigOutput {
  ...
  **/
  ...
  public GatewayGetK8SAuthConfigOutput authMethodAccessId(String authMethodAccessId) {
  ...
  **/
  ...
  public GatewayGetK8SAuthConfigOutput authMethodPrvKeyPem(String authMethodPrvKeyPem) {
  ...
  **/
  ...
  public GatewayGetK8SAuthConfigOutput clusterApiType(String clusterApiType) {
  ...
  **/
  ...
  public GatewayGetK8SAuthConfigOutput disableIssValidation(Boolean disableIssValidation) {
  ...
  **/
  ...
  public GatewayGetK8SAuthConfigOutput id(String id) {
  ...
  **/
  ...
  public GatewayGetK8SAuthConfigOutput k8sHost(String k8sHost) {
  ...
  **/
  ...
  public GatewayGetK8SAuthConfigOutput k8sIssuer(String k8sIssuer) {
  ...
  **/
  ...
  public GatewayGetK8SAuthConfigOutput k8sPubKeysPem(List<String> k8sPubKeysPem) {
  ...
  **/
  ...
  public GatewayGetK8SAuthConfigOutput k8sTokenReviewerJwt(String k8sTokenReviewerJwt) {
  ...
  **/
  ...
  public GatewayGetK8SAuthConfigOutput name(String name) {
  ...
  **/
  ...
  public GatewayGetK8SAuthConfigOutput protectionKey(String protectionKey) {
  ...
  **/
  ...
  public GatewayGetK8SAuthConfigOutput rancherApiKey(String rancherApiKey) {
  ...
  **/
  ...
  public GatewayGetK8SAuthConfigOutput rancherClusterId(String rancherClusterId) {
  ...
  **/
  ...
  public GatewayGetK8SAuthConfigOutput useLocalCaJwt(Boolean useLocalCaJwt) {
