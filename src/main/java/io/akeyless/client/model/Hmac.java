...
public class Hmac {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("display-id", "hash-function", "input-format", "item-id", "json", "key-name", "plaintext", "token", "uid-token"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Hmac.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Hmac is not found in the empty JSON string", Hmac.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Hmac.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Hmac` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
