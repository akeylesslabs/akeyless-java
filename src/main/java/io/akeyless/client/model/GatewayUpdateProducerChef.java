...
public class GatewayUpdateProducerChef {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(chefOrgs, chefServerKey, chefServerUrl, chefServerUsername, customUsernameTemplate, deleteProtection, json, name, newName, passwordLength, producerEncryptionKeyName, skipSsl, tags, targetName, token, uidToken, userTtl);
  }
