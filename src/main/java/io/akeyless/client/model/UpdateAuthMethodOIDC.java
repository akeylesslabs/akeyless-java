...
public class UpdateAuthMethodOIDC {
  ...
  public UpdateAuthMethodOIDC allowedClientType(@javax.annotation.Nullable List<String> allowedClientType) {
    this.allowedClientType = allowedClientType;
    return this;
  }

  public UpdateAuthMethodOIDC addAllowedClientTypeItem(String allowedClientTypeItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessExpires, updateAuthMethodOIDC.accessExpires) &&
        Objects.equals(this.allowedClientType, updateAuthMethodOIDC.allowedClientType) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateAuthMethodOIDC.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateAuthMethodOIDC is not found in the empty JSON string", UpdateAuthMethodOIDC.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateAuthMethodOIDC.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateAuthMethodOIDC` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
