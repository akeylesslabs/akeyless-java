...
public class UpdateDockerhubTarget {
  ...
  public UpdateDockerhubTarget() {
  }

  public UpdateDockerhubTarget comment(@javax.annotation.Nullable String comment) {
  ...
  public UpdateDockerhubTarget description(@javax.annotation.Nullable String description) {
  ...
  public UpdateDockerhubTarget dockerhubPassword(@javax.annotation.Nullable String dockerhubPassword) {
  ...
  public UpdateDockerhubTarget dockerhubUsername(@javax.annotation.Nullable String dockerhubUsername) {
  ...
  public UpdateDockerhubTarget json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public UpdateDockerhubTarget keepPrevVersion(@javax.annotation.Nullable String keepPrevVersion) {
  ...
  public UpdateDockerhubTarget key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public UpdateDockerhubTarget maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public UpdateDockerhubTarget name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateDockerhubTarget newName(@javax.annotation.Nullable String newName) {
  ...
  public UpdateDockerhubTarget token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public UpdateDockerhubTarget uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public UpdateDockerhubTarget updateVersion(@javax.annotation.Nullable Boolean updateVersion) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.comment, updateDockerhubTarget.comment) &&
        ...
        Objects.equals(this.maxVersions, updateDockerhubTarget.maxVersions) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(comment, description, dockerhubPassword, dockerhubUsername, json, keepPrevVersion, key, maxVersions, name, newName, token, uidToken, updateVersion);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("comment", "description", "dockerhub-password", "dockerhub-username", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "token", "uid-token", "update-version"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateDockerhubTarget
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateDockerhubTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateDockerhubTarget is not found in the empty JSON string", UpdateDockerhubTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateDockerhubTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateDockerhubTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateDockerhubTarget.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateDockerhubTarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateDockerhubTarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateDockerhubTarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateDockerhubTarget.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateDockerhubTarget>() {
           @Override
           public void write(JsonWriter out, UpdateDockerhubTarget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateDockerhubTarget read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateDockerhubTarget given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateDockerhubTarget
   * @throws IOException if the JSON string is invalid with respect to UpdateDockerhubTarget
   */
  public static UpdateDockerhubTarget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateDockerhubTarget.class);
  }

  /**
   * Convert an instance of UpdateDockerhubTarget to an JSON string
   *
   * @return JSON string
   */
