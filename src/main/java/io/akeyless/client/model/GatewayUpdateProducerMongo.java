...
public class GatewayUpdateProducerMongo {
  ...
  public GatewayUpdateProducerMongo inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public GatewayUpdateProducerMongo addInputRuleItem(String inputRuleItem) {
  ...
  public GatewayUpdateProducerMongo mongodbScopes(@javax.annotation.Nullable String mongodbScopes) {
  ...
  public GatewayUpdateProducerMongo outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public GatewayUpdateProducerMongo addOutputRuleItem(String outputRuleItem) {
  ...
  public GatewayUpdateProducerMongo useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public GatewayUpdateProducerMongo useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public GatewayUpdateProducerMongo useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public GatewayUpdateProducerMongo useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.customUsernameTemplate, gatewayUpdateProducerMongo.customUsernameTemplate) &&
        ...
        Objects.equals(this.inputRule, gatewayUpdateProducerMongo.inputRule) &&
        ...
        Objects.equals(this.mongodbScopes, gatewayUpdateProducerMongo.mongodbScopes) &&
        ...
        Objects.equals(this.outputRule, gatewayUpdateProducerMongo.outputRule) &&
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("custom-username-template", "delete_protection", "input-rule", "item-custom-fields", "json", "mongodb-atlas-api-private-key", "mongodb-atlas-api-public-key", "mongodb-atlas-project-id", "mongodb-custom-data", "mongodb-default-auth-db", "mongodb-host-port", "mongodb-name", "mongodb-password", "mongodb-roles", "mongodb-scopes", "mongodb-server-uri", "mongodb-uri-options", "mongodb-username", "name", "new-name", "output-rule", "password-length", "producer-encryption-key-name", "secure-access-bastion-issuer", "secure-access-certificate-issuer", "secure-access-db-name", "secure-access-delay", "secure-access-enable", "secure-access-host", "secure-access-web", "tags", "target-name", "token", "uid-token", "use-capital-letters", "use-lower-letters", "use-numbers", "use-special-characters", "user-ttl"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GatewayUpdateProducerMongo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GatewayUpdateProducerMongo is not found in the empty JSON string", GatewayUpdateProducerMongo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GatewayUpdateProducerMongo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GatewayUpdateProducerMongo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("mongodb-custom-data") != null && !jsonObj.get("mongodb-custom-data").isJsonNull()) && !jsonObj.get("mongodb-custom-data").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `mongodb-custom-data` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mongodb-custom-data").toString()));
      }
      ...
      if ((jsonObj.get("mongodb-host-port") != null && !jsonObj.get("mongodb-host-port").isJsonNull()) && !jsonObj.get("mongodb-host-port").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `mongodb-host-port` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mongodb-host-port").toString()));
      }
      if ((jsonObj.get("mongodb-name") != null && !jsonObj.get("mongodb-name").isJsonNull()) && !jsonObj.get("mongodb-name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `mongodb-name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mongodb-name").toString()));
      }
      if ((jsonObj.get("mongodb-password") != null && !jsonObj.get("mongodb-password").isJsonNull()) && !jsonObj.get("mongodb-password").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `mongodb-password` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mongodb-password").toString()));
      }
      if ((jsonObj.get("mongodb-roles") != null && !jsonObj.get("mongodb-roles").isJsonNull()) && !jsonObj.get("mongodb-roles").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `mongodb-roles` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mongodb-roles").toString()));
      }
      if ((jsonObj.get("mongodb-scopes") != null && !jsonObj.get("mongodb-scopes").isJsonNull()) && !jsonObj.get("mongodb-scopes").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `mongodb-scopes` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mongodb-scopes").toString()));
      }
      if ((jsonObj.get("mongodb-server-uri") != null && !jsonObj.get("mongodb-server-uri").isJsonNull()) && !jsonObj.get("mongodb-server-uri").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `mongodb-server-uri` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mongodb-server-uri").toString()));
      }
      ...
      if ((jsonObj.get("mongodb-username") != null && !jsonObj.get("mongodb-username").isJsonNull()) && !jsonObj.get("mongodb-username").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `mongodb-username` to be a primitive type in the JSON string but got `%s`", jsonObj.get("mongodb-username").toString()));
      }
