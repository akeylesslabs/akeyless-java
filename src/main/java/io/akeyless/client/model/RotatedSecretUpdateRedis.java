...
public class RotatedSecretUpdateRedis {
  ...
  public RotatedSecretUpdateRedis addTag(@javax.annotation.Nullable List<String> addTag) {
    this.addTag = addTag;
    return this;
  }
  ...
  public RotatedSecretUpdateRedis authenticationCredentials(@javax.annotation.Nullable String authenticationCredentials) {
  ...
  public RotatedSecretUpdateRedis autoRotate(@javax.annotation.Nullable String autoRotate) {
  ...
  public RotatedSecretUpdateRedis deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public RotatedSecretUpdateRedis description(@javax.annotation.Nullable String description) {
  ...
  public RotatedSecretUpdateRedis inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public RotatedSecretUpdateRedis addInputRuleItem(String inputRuleItem) {
  ...
  public RotatedSecretUpdateRedis json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public RotatedSecretUpdateRedis keepPrevVersion(@javax.annotation.Nullable String keepPrevVersion) {
  ...
  public RotatedSecretUpdateRedis key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public RotatedSecretUpdateRedis maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public RotatedSecretUpdateRedis name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public RotatedSecretUpdateRedis newName(@javax.annotation.Nullable String newName) {
  ...
  public RotatedSecretUpdateRedis outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public RotatedSecretUpdateRedis addOutputRuleItem(String outputRuleItem) {
  ...
  public RotatedSecretUpdateRedis passwordLength(@javax.annotation.Nullable String passwordLength) {
  ...
  public RotatedSecretUpdateRedis rmTag(@javax.annotation.Nullable List<String> rmTag) {
    this.rmTag = rmTag;
    return this;
  }
  ...
  public RotatedSecretUpdateRedis rotatedPassword(@javax.annotation.Nullable String rotatedPassword) {
  ...
  public RotatedSecretUpdateRedis rotatedUsername(@javax.annotation.Nullable String rotatedUsername) {
  ...
  public RotatedSecretUpdateRedis rotationEventIn(@javax.annotation.Nullable List<String> rotationEventIn) {
  ...
  public RotatedSecretUpdateRedis rotationHour(@javax.annotation.Nullable Integer rotationHour) {
  ...
  public RotatedSecretUpdateRedis rotationInterval(@javax.annotation.Nullable String rotationInterval) {
  ...
  public RotatedSecretUpdateRedis token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public RotatedSecretUpdateRedis uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public RotatedSecretUpdateRedis useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public RotatedSecretUpdateRedis useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public RotatedSecretUpdateRedis useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public RotatedSecretUpdateRedis useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.addTag, rotatedSecretUpdateRedis.addTag) &&
        ...
        Objects.equals(this.inputRule, rotatedSecretUpdateRedis.inputRule) &&
        ...
        Objects.equals(this.outputRule, rotatedSecretUpdateRedis.outputRule) &&
        ...
        Objects.equals(this.useCapitalLetters, rotatedSecretUpdateRedis.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, rotatedSecretUpdateRedis.useLowerLetters) &&
        Objects.equals(this.useNumbers, rotatedSecretUpdateRedis.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, rotatedSecretUpdateRedis.useSpecialCharacters);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RotatedSecretUpdateRedis
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RotatedSecretUpdateRedis.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RotatedSecretUpdateRedis is not found in the empty JSON string", RotatedSecretUpdateRedis.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RotatedSecretUpdateRedis.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RotatedSecretUpdateRedis` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RotatedSecretUpdateRedis.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RotatedSecretUpdateRedis.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RotatedSecretUpdateRedis' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RotatedSecretUpdateRedis> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RotatedSecretUpdateRedis.class));

       return (TypeAdapter<T>) new TypeAdapter<RotatedSecretUpdateRedis>() {
           @Override
           public void write(JsonWriter out, RotatedSecretUpdateRedis value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RotatedSecretUpdateRedis read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RotatedSecretUpdateRedis given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RotatedSecretUpdateRedis
   * @throws IOException if the JSON string is invalid with respect to RotatedSecretUpdateRedis
   */
  public static RotatedSecretUpdateRedis fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RotatedSecretUpdateRedis.class);
  }

  /**
   * Convert an instance of RotatedSecretUpdateRedis to an JSON string
   *
   * @return JSON string
   */
