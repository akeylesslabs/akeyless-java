...
public class TargetUpdateEks {
  ...
  public TargetUpdateEks eksAccessKeyId(@javax.annotation.Nonnull String eksAccessKeyId) {
  ...
  public TargetUpdateEks eksClusterCaCert(@javax.annotation.Nonnull String eksClusterCaCert) {
  ...
  public TargetUpdateEks eksClusterEndpoint(@javax.annotation.Nonnull String eksClusterEndpoint) {
  ...
  public TargetUpdateEks eksClusterName(@javax.annotation.Nonnull String eksClusterName) {
  ...
  public TargetUpdateEks eksRegion(@javax.annotation.Nullable String eksRegion) {
  ...
  public TargetUpdateEks eksSecretAccessKey(@javax.annotation.Nonnull String eksSecretAccessKey) {
  ...
  public TargetUpdateEks json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public TargetUpdateEks keepPrevVersion(@javax.annotation.Nullable String keepPrevVersion) {
  ...
  public TargetUpdateEks key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public TargetUpdateEks maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public TargetUpdateEks name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public TargetUpdateEks newName(@javax.annotation.Nullable String newName) {
  ...
  public TargetUpdateEks token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public TargetUpdateEks uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public TargetUpdateEks useGwCloudIdentity(@javax.annotation.Nullable Boolean useGwCloudIdentity) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.deleteProtection, targetUpdateEks.deleteProtection) &&
        ...
        Objects.equals(this.eksClusterName, targetUpdateEks.eksClusterName) &&
        Objects.equals(this.eksRegion, targetUpdateEks.eksRegion) &&
        Objects.equals(this.eksSecretAccessKey, targetUpdateEks.eksSecretAccessKey) &&
        Objects.equals(this.json, targetUpdateEks.json) &&
        Objects.equals(this.keepPrevVersion, targetUpdateEks.keepPrevVersion) &&
        Objects.equals(this.key, targetUpdateEks.key) &&
        Objects.equals(this.maxVersions, targetUpdateEks.maxVersions) &&
        Objects.equals(this.name, targetUpdateEks.name) &&
        Objects.equals(this.newName, targetUpdateEks.newName) &&
        Objects.equals(this.token, targetUpdateEks.token) &&
        Objects.equals(this.uidToken, targetUpdateEks.uidToken) &&
        Objects.equals(this.useGwCloudIdentity, targetUpdateEks.useGwCloudIdentity);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("delete_protection", "description", "eks-access-key-id", "eks-cluster-ca-cert", "eks-cluster-endpoint", "eks-cluster-name", "eks-region", "eks-secret-access-key", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "token", "uid-token", "use-gw-cloud-identity"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("eks-access-key-id", "eks-cluster-ca-cert", "eks-cluster-endpoint", "eks-cluster-name", "eks-secret-access-key", "name"));
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TargetUpdateEks
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TargetUpdateEks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TargetUpdateEks is not found in the empty JSON string", TargetUpdateEks.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TargetUpdateEks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TargetUpdateEks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TargetUpdateEks.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TargetUpdateEks.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TargetUpdateEks' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TargetUpdateEks> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TargetUpdateEks.class));

       return (TypeAdapter<T>) new TypeAdapter<TargetUpdateEks>() {
           @Override
           public void write(JsonWriter out, TargetUpdateEks value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TargetUpdateEks read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TargetUpdateEks given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TargetUpdateEks
   * @throws IOException if the JSON string is invalid with respect to TargetUpdateEks
   */
  public static TargetUpdateEks fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TargetUpdateEks.class);
  }

  /**
   * Convert an instance of TargetUpdateEks to an JSON string
   *
   * @return JSON string
   */
