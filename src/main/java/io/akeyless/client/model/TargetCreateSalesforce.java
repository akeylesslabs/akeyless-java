...
public class TargetCreateSalesforce {
  ...
  public TargetCreateSalesforce() {
  }

  public TargetCreateSalesforce appPrivateKeyData(@javax.annotation.Nullable String appPrivateKeyData) {
  ...
  public TargetCreateSalesforce authFlow(@javax.annotation.Nonnull String authFlow) {
  ...
  public TargetCreateSalesforce caCertData(@javax.annotation.Nullable String caCertData) {
  ...
  public TargetCreateSalesforce caCertName(@javax.annotation.Nullable String caCertName) {
  ...
  public TargetCreateSalesforce clientId(@javax.annotation.Nonnull String clientId) {
  ...
  public TargetCreateSalesforce clientSecret(@javax.annotation.Nullable String clientSecret) {
  ...
  public TargetCreateSalesforce description(@javax.annotation.Nullable String description) {
  ...
  public TargetCreateSalesforce email(@javax.annotation.Nonnull String email) {
    this.email = email;
    return this;
  }
  ...
  public TargetCreateSalesforce json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public TargetCreateSalesforce key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public TargetCreateSalesforce maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public TargetCreateSalesforce name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public TargetCreateSalesforce password(@javax.annotation.Nullable String password) {
  ...
  public TargetCreateSalesforce securityToken(@javax.annotation.Nullable String securityToken) {
  ...
  public TargetCreateSalesforce tenantUrl(@javax.annotation.Nonnull String tenantUrl) {
  ...
  public TargetCreateSalesforce token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public TargetCreateSalesforce uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public boolean equals(Object o) {
    ...
    TargetCreateSalesforce targetCreateSalesforce = (TargetCreateSalesforce) o;
    return Objects.equals(this.appPrivateKeyData, targetCreateSalesforce.appPrivateKeyData) &&
        Objects.equals(this.authFlow, targetCreateSalesforce.authFlow) &&
        Objects.equals(this.caCertData, targetCreateSalesforce.caCertData) &&
        ...
        Objects.equals(this.key, targetCreateSalesforce.key) &&
        Objects.equals(this.maxVersions, targetCreateSalesforce.maxVersions) &&
        Objects.equals(this.name, targetCreateSalesforce.name) &&
        Objects.equals(this.password, targetCreateSalesforce.password) &&
        Objects.equals(this.securityToken, targetCreateSalesforce.securityToken) &&
        Objects.equals(this.tenantUrl, targetCreateSalesforce.tenantUrl) &&
        Objects.equals(this.token, targetCreateSalesforce.token) &&
        Objects.equals(this.uidToken, targetCreateSalesforce.uidToken);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("app-private-key-data", "auth-flow", "ca-cert-data", "ca-cert-name", "client-id", "client-secret", "delete_protection", "description", "email", "json", "key", "max-versions", "name", "password", "security-token", "tenant-url", "token", "uid-token"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to TargetCreateSalesforce
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TargetCreateSalesforce.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TargetCreateSalesforce is not found in the empty JSON string", TargetCreateSalesforce.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TargetCreateSalesforce.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TargetCreateSalesforce` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TargetCreateSalesforce.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TargetCreateSalesforce.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TargetCreateSalesforce' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TargetCreateSalesforce> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TargetCreateSalesforce.class));

       return (TypeAdapter<T>) new TypeAdapter<TargetCreateSalesforce>() {
           @Override
           public void write(JsonWriter out, TargetCreateSalesforce value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TargetCreateSalesforce read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TargetCreateSalesforce given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TargetCreateSalesforce
   * @throws IOException if the JSON string is invalid with respect to TargetCreateSalesforce
   */
  public static TargetCreateSalesforce fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TargetCreateSalesforce.class);
  }

  /**
   * Convert an instance of TargetCreateSalesforce to an JSON string
   *
   * @return JSON string
   */
