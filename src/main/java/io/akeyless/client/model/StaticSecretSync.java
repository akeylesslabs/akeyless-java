...
public class StaticSecretSync {
  ...
  public StaticSecretSync deleteRemote(@javax.annotation.Nullable Boolean deleteRemote) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.deleteRemote, staticSecretSync.deleteRemote) &&
        Objects.equals(this.filterSecretValue, staticSecretSync.filterSecretValue) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StaticSecretSync.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in StaticSecretSync is not found in the empty JSON string", StaticSecretSync.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!StaticSecretSync.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `StaticSecretSync` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
