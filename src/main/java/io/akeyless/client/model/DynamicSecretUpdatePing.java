 ...
 */
@ApiModel(description = "dynamicSecretUpdatePing is a command that updates Ping dynamic secret")
...
public class DynamicSecretUpdatePing {
  ...
  public DynamicSecretUpdatePing deleteProtection(String deleteProtection) {
  ...
  **/
  ...
  public DynamicSecretUpdatePing description(String description) {
  ...
  **/
  ...
  public DynamicSecretUpdatePing json(Boolean json) {
  ...
  **/
  ...
  public DynamicSecretUpdatePing name(String name) {
  ...
  **/
  ...
  public DynamicSecretUpdatePing newName(String newName) {
  ...
  **/
  ...
  public DynamicSecretUpdatePing pingAdministrativePort(String pingAdministrativePort) {
  ...
  **/
  ...
  public DynamicSecretUpdatePing pingAtmId(String pingAtmId) {
  ...
  **/
  ...
  public DynamicSecretUpdatePing pingAuthorizationPort(String pingAuthorizationPort) {
  ...
  **/
  ...
  public DynamicSecretUpdatePing pingCertSubjectDn(String pingCertSubjectDn) {
  ...
  **/
  ...
  public DynamicSecretUpdatePing pingClientAuthenticationType(String pingClientAuthenticationType) {
  ...
  **/
  ...
  public DynamicSecretUpdatePing pingEnforceReplayPrevention(String pingEnforceReplayPrevention) {
  ...
  **/
  ...
  public DynamicSecretUpdatePing pingGrantTypes(List<String> pingGrantTypes) {
  ...
  **/
  ...
  public DynamicSecretUpdatePing pingIssuerDn(String pingIssuerDn) {
  ...
  **/
  ...
  public DynamicSecretUpdatePing pingJwks(String pingJwks) {
  ...
  **/
  ...
  public DynamicSecretUpdatePing pingJwksUrl(String pingJwksUrl) {
  ...
  **/
  ...
  public DynamicSecretUpdatePing pingPassword(String pingPassword) {
  ...
  **/
  ...
  public DynamicSecretUpdatePing pingPrivilegedUser(String pingPrivilegedUser) {
  ...
  **/
  ...
  public DynamicSecretUpdatePing pingRedirectUris(List<String> pingRedirectUris) {
  ...
  **/
  ...
  public DynamicSecretUpdatePing pingRestrictedScopes(List<String> pingRestrictedScopes) {
  ...
  **/
  ...
  public DynamicSecretUpdatePing pingSigningAlgo(String pingSigningAlgo) {
  ...
  **/
  ...
  public DynamicSecretUpdatePing pingUrl(String pingUrl) {
  ...
  **/
  ...
  public DynamicSecretUpdatePing producerEncryptionKeyName(String producerEncryptionKeyName) {
  ...
  **/
  ...
  public DynamicSecretUpdatePing tags(List<String> tags) {
  ...
  **/
  ...
  public DynamicSecretUpdatePing targetName(String targetName) {
  ...
  **/
  ...
  public DynamicSecretUpdatePing token(String token) {
  ...
  **/
  ...
  public DynamicSecretUpdatePing uidToken(String uidToken) {
  ...
  **/
  ...
  public DynamicSecretUpdatePing userTtl(String userTtl) {
