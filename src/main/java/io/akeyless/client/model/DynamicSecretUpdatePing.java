...
public class DynamicSecretUpdatePing {
  ...
  public DynamicSecretUpdatePing inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public DynamicSecretUpdatePing addInputRuleItem(String inputRuleItem) {
  ...
  public DynamicSecretUpdatePing itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public DynamicSecretUpdatePing putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public DynamicSecretUpdatePing outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public DynamicSecretUpdatePing addOutputRuleItem(String outputRuleItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.deleteProtection, dynamicSecretUpdatePing.deleteProtection) &&
        ...
        Objects.equals(this.inputRule, dynamicSecretUpdatePing.inputRule) &&
        Objects.equals(this.itemCustomFields, dynamicSecretUpdatePing.itemCustomFields) &&
        ...
        Objects.equals(this.outputRule, dynamicSecretUpdatePing.outputRule) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicSecretUpdatePing.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicSecretUpdatePing is not found in the empty JSON string", DynamicSecretUpdatePing.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicSecretUpdatePing.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DynamicSecretUpdatePing` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
