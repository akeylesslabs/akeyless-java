...
public class TargetItemVersion {
  ...
  public TargetItemVersion accessDate(@javax.annotation.Nullable OffsetDateTime accessDate) {
  ...
  public TargetItemVersion accessDateDisplay(@javax.annotation.Nullable String accessDateDisplay) {
  ...
  public TargetItemVersion accessId(@javax.annotation.Nullable String accessId) {
  ...
  public TargetItemVersion certificateVersionInfo(@javax.annotation.Nullable CertificateVersionInfo certificateVersionInfo) {
  ...
  public TargetItemVersion creationDate(@javax.annotation.Nullable OffsetDateTime creationDate) {
  ...
  public TargetItemVersion customerFragmentId(@javax.annotation.Nullable String customerFragmentId) {
  ...
  public TargetItemVersion deletionDate(@javax.annotation.Nullable OffsetDateTime deletionDate) {
  ...
  public TargetItemVersion itemVersionState(@javax.annotation.Nullable String itemVersionState) {
  ...
  public TargetItemVersion latestVersion(@javax.annotation.Nullable Boolean latestVersion) {
  ...
  public void setLatestVersion(@javax.annotation.Nullable Boolean latestVersion) {
    this.latestVersion = latestVersion;
  }


  public TargetItemVersion modificationDate(@javax.annotation.Nullable OffsetDateTime modificationDate) {
  ...
  public TargetItemVersion protectionKeyName(@javax.annotation.Nullable String protectionKeyName) {
  ...
  public TargetItemVersion targetName(@javax.annotation.Nullable String targetName) {
  ...
  public TargetItemVersion uniqueIdentifier(@javax.annotation.Nullable String uniqueIdentifier) {
  ...
  public TargetItemVersion version(@javax.annotation.Nullable Integer version) {
  ...
  public TargetItemVersion withCustomerFragment(@javax.annotation.Nullable Boolean withCustomerFragment) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessDate, targetItemVersion.accessDate) &&
        ...
        Objects.equals(this.accessId, targetItemVersion.accessId) &&
        ...
        Objects.equals(this.uniqueIdentifier, targetItemVersion.uniqueIdentifier) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessDate, accessDateDisplay, accessId, certificateVersionInfo, creationDate, customerFragmentId, deletionDate, itemVersionState, latestVersion, modificationDate, protectionKeyName, targetName, uniqueIdentifier, version, withCustomerFragment);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("access_date", "access_date_display", "access_id", "certificate_version_info", "creation_date", "customer_fragment_id", "deletion_date", "item_version_state", "latest_version", "modification_date", "protection_key_name", "target_name", "unique_identifier", "version", "with_customer_fragment"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to TargetItemVersion
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TargetItemVersion.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TargetItemVersion is not found in the empty JSON string", TargetItemVersion.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TargetItemVersion.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TargetItemVersion` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("item_version_state") != null && !jsonObj.get("item_version_state").isJsonNull()) && !jsonObj.get("item_version_state").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `item_version_state` to be a primitive type in the JSON string but got `%s`", jsonObj.get("item_version_state").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TargetItemVersion.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TargetItemVersion' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TargetItemVersion> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TargetItemVersion.class));

       return (TypeAdapter<T>) new TypeAdapter<TargetItemVersion>() {
           @Override
           public void write(JsonWriter out, TargetItemVersion value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TargetItemVersion read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TargetItemVersion given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TargetItemVersion
   * @throws IOException if the JSON string is invalid with respect to TargetItemVersion
   */
  public static TargetItemVersion fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TargetItemVersion.class);
  }

  /**
   * Convert an instance of TargetItemVersion to an JSON string
   *
   * @return JSON string
   */
