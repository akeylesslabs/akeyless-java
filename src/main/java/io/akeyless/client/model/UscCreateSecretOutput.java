...
public class UscCreateSecretOutput {
  ...
  public UscCreateSecretOutput secretId(@javax.annotation.Nullable String secretId) {
  ...
  public UscCreateSecretOutput versionId(@javax.annotation.Nullable String versionId) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to UscCreateSecretOutput
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UscCreateSecretOutput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UscCreateSecretOutput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UscCreateSecretOutput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UscCreateSecretOutput.class));

       return (TypeAdapter<T>) new TypeAdapter<UscCreateSecretOutput>() {
           @Override
           public void write(JsonWriter out, UscCreateSecretOutput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UscCreateSecretOutput read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UscCreateSecretOutput given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UscCreateSecretOutput
   * @throws IOException if the JSON string is invalid with respect to UscCreateSecretOutput
   */
  public static UscCreateSecretOutput fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UscCreateSecretOutput.class);
  }

  /**
   * Convert an instance of UscCreateSecretOutput to an JSON string
   *
   * @return JSON string
   */
