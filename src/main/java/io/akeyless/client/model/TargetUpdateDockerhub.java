...
public class TargetUpdateDockerhub {
  ...
  public TargetUpdateDockerhub deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.deleteProtection, targetUpdateDockerhub.deleteProtection) &&
        Objects.equals(this.description, targetUpdateDockerhub.description) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(deleteProtection, description, dockerhubPassword, dockerhubUsername, json, keepPrevVersion, key, maxVersions, name, newName, token, uidToken);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("delete_protection", "description", "dockerhub-password", "dockerhub-username", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "token", "uid-token"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TargetUpdateDockerhub.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TargetUpdateDockerhub is not found in the empty JSON string", TargetUpdateDockerhub.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TargetUpdateDockerhub.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TargetUpdateDockerhub` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
