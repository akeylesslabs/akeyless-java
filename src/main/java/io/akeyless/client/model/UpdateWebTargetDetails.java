...
public class UpdateWebTargetDetails {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("json", "keep-prev-version", "name", "new-version", "protection_key", "token", "uid-token", "url"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateWebTargetDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateWebTargetDetails is not found in the empty JSON string", UpdateWebTargetDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateWebTargetDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateWebTargetDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
