...
public class DynamicSecretCreatePing {
  ...
  public DynamicSecretCreatePing deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public DynamicSecretCreatePing description(@javax.annotation.Nullable String description) {
  ...
  public DynamicSecretCreatePing inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public DynamicSecretCreatePing addInputRuleItem(String inputRuleItem) {
  ...
  public DynamicSecretCreatePing json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public DynamicSecretCreatePing name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public DynamicSecretCreatePing outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public DynamicSecretCreatePing addOutputRuleItem(String outputRuleItem) {
  ...
  public DynamicSecretCreatePing pingAdministrativePort(@javax.annotation.Nullable String pingAdministrativePort) {
  ...
  public DynamicSecretCreatePing pingAtmId(@javax.annotation.Nullable String pingAtmId) {
  ...
  public DynamicSecretCreatePing pingAuthorizationPort(@javax.annotation.Nullable String pingAuthorizationPort) {
  ...
  public DynamicSecretCreatePing pingCertSubjectDn(@javax.annotation.Nullable String pingCertSubjectDn) {
  ...
  public DynamicSecretCreatePing pingClientAuthenticationType(@javax.annotation.Nullable String pingClientAuthenticationType) {
  ...
  public DynamicSecretCreatePing pingEnforceReplayPrevention(@javax.annotation.Nullable String pingEnforceReplayPrevention) {
  ...
  public DynamicSecretCreatePing pingGrantTypes(@javax.annotation.Nullable List<String> pingGrantTypes) {
  ...
  public DynamicSecretCreatePing pingIssuerDn(@javax.annotation.Nullable String pingIssuerDn) {
  ...
  public DynamicSecretCreatePing pingJwks(@javax.annotation.Nullable String pingJwks) {
  ...
  public DynamicSecretCreatePing pingJwksUrl(@javax.annotation.Nullable String pingJwksUrl) {
  ...
  public DynamicSecretCreatePing pingPassword(@javax.annotation.Nullable String pingPassword) {
  ...
  public DynamicSecretCreatePing pingPrivilegedUser(@javax.annotation.Nullable String pingPrivilegedUser) {
  ...
  public DynamicSecretCreatePing pingRedirectUris(@javax.annotation.Nullable List<String> pingRedirectUris) {
  ...
  public DynamicSecretCreatePing pingRestrictedScopes(@javax.annotation.Nullable List<String> pingRestrictedScopes) {
  ...
  public DynamicSecretCreatePing pingSigningAlgo(@javax.annotation.Nullable String pingSigningAlgo) {
  ...
  public DynamicSecretCreatePing pingUrl(@javax.annotation.Nullable String pingUrl) {
  ...
  public DynamicSecretCreatePing producerEncryptionKeyName(@javax.annotation.Nullable String producerEncryptionKeyName) {
  ...
  public DynamicSecretCreatePing tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public DynamicSecretCreatePing targetName(@javax.annotation.Nullable String targetName) {
  ...
  public DynamicSecretCreatePing token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public DynamicSecretCreatePing uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public DynamicSecretCreatePing userTtl(@javax.annotation.Nullable String userTtl) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.deleteProtection, dynamicSecretCreatePing.deleteProtection) &&
        ...
        Objects.equals(this.inputRule, dynamicSecretCreatePing.inputRule) &&
        ...
        Objects.equals(this.outputRule, dynamicSecretCreatePing.outputRule) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to DynamicSecretCreatePing
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicSecretCreatePing.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicSecretCreatePing is not found in the empty JSON string", DynamicSecretCreatePing.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicSecretCreatePing.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DynamicSecretCreatePing` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DynamicSecretCreatePing.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DynamicSecretCreatePing.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DynamicSecretCreatePing' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DynamicSecretCreatePing> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DynamicSecretCreatePing.class));

       return (TypeAdapter<T>) new TypeAdapter<DynamicSecretCreatePing>() {
           @Override
           public void write(JsonWriter out, DynamicSecretCreatePing value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DynamicSecretCreatePing read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DynamicSecretCreatePing given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DynamicSecretCreatePing
   * @throws IOException if the JSON string is invalid with respect to DynamicSecretCreatePing
   */
  public static DynamicSecretCreatePing fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DynamicSecretCreatePing.class);
  }

  /**
   * Convert an instance of DynamicSecretCreatePing to an JSON string
   *
   * @return JSON string
   */
