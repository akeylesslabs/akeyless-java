...
public class VerifyRsaSsaPss {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("display-id", "hash-function", "item-id", "json", "key-name", "message", "prehashed", "signature", "token", "uid-token", "version"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("message", "signature"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VerifyRsaSsaPss.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in VerifyRsaSsaPss is not found in the empty JSON string", VerifyRsaSsaPss.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VerifyRsaSsaPss.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `VerifyRsaSsaPss` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
