...
public class RotatedSecretCreateCassandra {
  ...
  public RotatedSecretCreateCassandra authenticationCredentials(@javax.annotation.Nullable String authenticationCredentials) {
  ...
  public RotatedSecretCreateCassandra autoRotate(@javax.annotation.Nullable String autoRotate) {
  ...
  public RotatedSecretCreateCassandra deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public RotatedSecretCreateCassandra description(@javax.annotation.Nullable String description) {
  ...
  public RotatedSecretCreateCassandra inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public RotatedSecretCreateCassandra addInputRuleItem(String inputRuleItem) {
  ...
  public RotatedSecretCreateCassandra itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public RotatedSecretCreateCassandra putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public RotatedSecretCreateCassandra json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public RotatedSecretCreateCassandra key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public RotatedSecretCreateCassandra maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public RotatedSecretCreateCassandra name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public RotatedSecretCreateCassandra outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public RotatedSecretCreateCassandra addOutputRuleItem(String outputRuleItem) {
  ...
  public RotatedSecretCreateCassandra passwordLength(@javax.annotation.Nullable String passwordLength) {
  ...
  public RotatedSecretCreateCassandra rotatedPassword(@javax.annotation.Nullable String rotatedPassword) {
  ...
  public RotatedSecretCreateCassandra rotatedUsername(@javax.annotation.Nullable String rotatedUsername) {
  ...
  public RotatedSecretCreateCassandra rotationEventIn(@javax.annotation.Nullable List<String> rotationEventIn) {
    this.rotationEventIn = rotationEventIn;
    return this;
  }

  public RotatedSecretCreateCassandra addRotationEventInItem(String rotationEventInItem) {
  ...
  public RotatedSecretCreateCassandra rotationHour(@javax.annotation.Nullable Integer rotationHour) {
  ...
  public RotatedSecretCreateCassandra rotationInterval(@javax.annotation.Nullable String rotationInterval) {
  ...
  public RotatedSecretCreateCassandra rotatorType(@javax.annotation.Nonnull String rotatorType) {
  ...
  public RotatedSecretCreateCassandra tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public RotatedSecretCreateCassandra targetName(@javax.annotation.Nonnull String targetName) {
  ...
  public RotatedSecretCreateCassandra token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public RotatedSecretCreateCassandra uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public RotatedSecretCreateCassandra useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public RotatedSecretCreateCassandra useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public RotatedSecretCreateCassandra useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public RotatedSecretCreateCassandra useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authenticationCredentials, rotatedSecretCreateCassandra.authenticationCredentials) &&
        ...
        Objects.equals(this.inputRule, rotatedSecretCreateCassandra.inputRule) &&
        Objects.equals(this.itemCustomFields, rotatedSecretCreateCassandra.itemCustomFields) &&
        Objects.equals(this.json, rotatedSecretCreateCassandra.json) &&
        Objects.equals(this.key, rotatedSecretCreateCassandra.key) &&
        Objects.equals(this.maxVersions, rotatedSecretCreateCassandra.maxVersions) &&
        Objects.equals(this.name, rotatedSecretCreateCassandra.name) &&
        Objects.equals(this.outputRule, rotatedSecretCreateCassandra.outputRule) &&
        ...
        Objects.equals(this.rotationEventIn, rotatedSecretCreateCassandra.rotationEventIn) &&
        ...
        Objects.equals(this.useCapitalLetters, rotatedSecretCreateCassandra.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, rotatedSecretCreateCassandra.useLowerLetters) &&
        Objects.equals(this.useNumbers, rotatedSecretCreateCassandra.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, rotatedSecretCreateCassandra.useSpecialCharacters);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RotatedSecretCreateCassandra
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RotatedSecretCreateCassandra.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RotatedSecretCreateCassandra is not found in the empty JSON string", RotatedSecretCreateCassandra.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RotatedSecretCreateCassandra.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RotatedSecretCreateCassandra` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RotatedSecretCreateCassandra.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RotatedSecretCreateCassandra.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RotatedSecretCreateCassandra' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RotatedSecretCreateCassandra> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RotatedSecretCreateCassandra.class));

       return (TypeAdapter<T>) new TypeAdapter<RotatedSecretCreateCassandra>() {
           @Override
           public void write(JsonWriter out, RotatedSecretCreateCassandra value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RotatedSecretCreateCassandra read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RotatedSecretCreateCassandra given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RotatedSecretCreateCassandra
   * @throws IOException if the JSON string is invalid with respect to RotatedSecretCreateCassandra
   */
  public static RotatedSecretCreateCassandra fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RotatedSecretCreateCassandra.class);
  }

  /**
   * Convert an instance of RotatedSecretCreateCassandra to an JSON string
   *
   * @return JSON string
   */
