...
public class AzureTargetDetails {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(azureClientId, azureClientSecret, azureResourceGroupName, azureResourceName, azureSubscriptionId, azureTenantId, azureUsername, expirationDate, useGwCloudIdentity);
  }
