...
public class AkeylessGatewayConfig {
  ...
  @javax.annotation.Nullable
  private CaCertificatesConfigPart caCertificates;
  ...
  public AkeylessGatewayConfig caCertificates(@javax.annotation.Nullable CaCertificatesConfigPart caCertificates) {
   ...
   */
  @javax.annotation.Nullable
  public CaCertificatesConfigPart getCaCertificates() {
    return caCertificates;
  }

  public void setCaCertificates(@javax.annotation.Nullable CaCertificatesConfigPart caCertificates) {
    this.caCertificates = caCertificates;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("admins", "ai_insights", "ca_certificates", "cache", "cf", "config_protection_key_name", "general", "k8s_auths", "kerberos", "kmip_clients", "ldap", "leadership", "log_forwarding", "message_queue_info", "migrations", "producers", "rotators", "saml", "version"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AkeylessGatewayConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AkeylessGatewayConfig is not found in the empty JSON string", AkeylessGatewayConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AkeylessGatewayConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AkeylessGatewayConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("ca_certificates") != null && !jsonObj.get("ca_certificates").isJsonNull()) {
        CaCertificatesConfigPart.validateJsonElement(jsonObj.get("ca_certificates"));
      }
      ...
      if ((jsonObj.get("config_protection_key_name") != null && !jsonObj.get("config_protection_key_name").isJsonNull()) && !jsonObj.get("config_protection_key_name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `config_protection_key_name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("config_protection_key_name").toString()));
      }
