...
public class DynamicSecretUpdateCassandra {
  ...
  public DynamicSecretUpdateCassandra cassandraCreationStatements(@javax.annotation.Nullable String cassandraCreationStatements) {
  ...
  public DynamicSecretUpdateCassandra cassandraHosts(@javax.annotation.Nullable String cassandraHosts) {
  ...
  public DynamicSecretUpdateCassandra cassandraPassword(@javax.annotation.Nullable String cassandraPassword) {
  ...
  public DynamicSecretUpdateCassandra cassandraPort(@javax.annotation.Nullable String cassandraPort) {
  ...
  public DynamicSecretUpdateCassandra cassandraUsername(@javax.annotation.Nullable String cassandraUsername) {
  ...
  public DynamicSecretUpdateCassandra customUsernameTemplate(@javax.annotation.Nullable String customUsernameTemplate) {
  ...
  public DynamicSecretUpdateCassandra deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public DynamicSecretUpdateCassandra description(@javax.annotation.Nullable String description) {
  ...
  public DynamicSecretUpdateCassandra inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public DynamicSecretUpdateCassandra addInputRuleItem(String inputRuleItem) {
  ...
  public DynamicSecretUpdateCassandra json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public DynamicSecretUpdateCassandra name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public DynamicSecretUpdateCassandra newName(@javax.annotation.Nullable String newName) {
  ...
  public DynamicSecretUpdateCassandra outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public DynamicSecretUpdateCassandra addOutputRuleItem(String outputRuleItem) {
  ...
  public DynamicSecretUpdateCassandra passwordLength(@javax.annotation.Nullable String passwordLength) {
  ...
  public DynamicSecretUpdateCassandra producerEncryptionKeyName(@javax.annotation.Nullable String producerEncryptionKeyName) {
  ...
  public DynamicSecretUpdateCassandra ssl(@javax.annotation.Nullable Boolean ssl) {
    this.ssl = ssl;
    return this;
  }
  ...
  public DynamicSecretUpdateCassandra sslCertificate(@javax.annotation.Nullable String sslCertificate) {
  ...
  public DynamicSecretUpdateCassandra tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public DynamicSecretUpdateCassandra targetName(@javax.annotation.Nullable String targetName) {
  ...
  public DynamicSecretUpdateCassandra token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public DynamicSecretUpdateCassandra uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public DynamicSecretUpdateCassandra useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public DynamicSecretUpdateCassandra useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public DynamicSecretUpdateCassandra useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public DynamicSecretUpdateCassandra useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public DynamicSecretUpdateCassandra userTtl(@javax.annotation.Nullable String userTtl) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cassandraCreationStatements, dynamicSecretUpdateCassandra.cassandraCreationStatements) &&
        ...
        Objects.equals(this.inputRule, dynamicSecretUpdateCassandra.inputRule) &&
        ...
        Objects.equals(this.outputRule, dynamicSecretUpdateCassandra.outputRule) &&
        ...
        Objects.equals(this.useCapitalLetters, dynamicSecretUpdateCassandra.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, dynamicSecretUpdateCassandra.useLowerLetters) &&
        Objects.equals(this.useNumbers, dynamicSecretUpdateCassandra.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, dynamicSecretUpdateCassandra.useSpecialCharacters) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to DynamicSecretUpdateCassandra
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicSecretUpdateCassandra.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicSecretUpdateCassandra is not found in the empty JSON string", DynamicSecretUpdateCassandra.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicSecretUpdateCassandra.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DynamicSecretUpdateCassandra` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DynamicSecretUpdateCassandra.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DynamicSecretUpdateCassandra.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DynamicSecretUpdateCassandra' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DynamicSecretUpdateCassandra> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DynamicSecretUpdateCassandra.class));

       return (TypeAdapter<T>) new TypeAdapter<DynamicSecretUpdateCassandra>() {
           @Override
           public void write(JsonWriter out, DynamicSecretUpdateCassandra value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DynamicSecretUpdateCassandra read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DynamicSecretUpdateCassandra given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DynamicSecretUpdateCassandra
   * @throws IOException if the JSON string is invalid with respect to DynamicSecretUpdateCassandra
   */
  public static DynamicSecretUpdateCassandra fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DynamicSecretUpdateCassandra.class);
  }

  /**
   * Convert an instance of DynamicSecretUpdateCassandra to an JSON string
   *
   * @return JSON string
   */
