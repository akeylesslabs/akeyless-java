...
public class GatewayUpdateProducerCustom {
  ...
  public GatewayUpdateProducerCustom putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GatewayUpdateProducerCustom.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GatewayUpdateProducerCustom is not found in the empty JSON string", GatewayUpdateProducerCustom.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GatewayUpdateProducerCustom.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GatewayUpdateProducerCustom` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
