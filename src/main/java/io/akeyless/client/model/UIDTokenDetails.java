...
public class UIDTokenDetails {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("children", "comment", "deny_inheritance", "deny_rotate", "depth", "expired_date", "id", "last_rotate", "revoked", "ttl"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UIDTokenDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UIDTokenDetails is not found in the empty JSON string", UIDTokenDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UIDTokenDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UIDTokenDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("expired_date") != null && !jsonObj.get("expired_date").isJsonNull()) && !jsonObj.get("expired_date").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `expired_date` to be a primitive type in the JSON string but got `%s`", jsonObj.get("expired_date").toString()));
      }
      ...
      if ((jsonObj.get("last_rotate") != null && !jsonObj.get("last_rotate").isJsonNull()) && !jsonObj.get("last_rotate").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `last_rotate` to be a primitive type in the JSON string but got `%s`", jsonObj.get("last_rotate").toString()));
      }
  }
