...
public class GatewayCreateProducerAws {
  ...
  public GatewayCreateProducerAws accessMode(@javax.annotation.Nullable String accessMode) {
  ...
  public GatewayCreateProducerAws adminRotationIntervalDays(@javax.annotation.Nullable Long adminRotationIntervalDays) {
  ...
  public GatewayCreateProducerAws awsAccessKeyId(@javax.annotation.Nullable String awsAccessKeyId) {
  ...
  public GatewayCreateProducerAws awsAccessSecretKey(@javax.annotation.Nullable String awsAccessSecretKey) {
  ...
  public GatewayCreateProducerAws awsExternalId(@javax.annotation.Nullable String awsExternalId) {
  ...
  public GatewayCreateProducerAws awsRoleArns(@javax.annotation.Nullable String awsRoleArns) {
  ...
  public GatewayCreateProducerAws awsUserConsoleAccess(@javax.annotation.Nullable Boolean awsUserConsoleAccess) {
  ...
  public GatewayCreateProducerAws awsUserGroups(@javax.annotation.Nullable String awsUserGroups) {
  ...
  public GatewayCreateProducerAws awsUserPolicies(@javax.annotation.Nullable String awsUserPolicies) {
  ...
  public GatewayCreateProducerAws awsUserProgrammaticAccess(@javax.annotation.Nullable Boolean awsUserProgrammaticAccess) {
  ...
  public GatewayCreateProducerAws customUsernameTemplate(@javax.annotation.Nullable String customUsernameTemplate) {
  ...
  public GatewayCreateProducerAws deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public GatewayCreateProducerAws enableAdminRotation(@javax.annotation.Nullable Boolean enableAdminRotation) {
  ...
  public GatewayCreateProducerAws inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public GatewayCreateProducerAws addInputRuleItem(String inputRuleItem) {
  ...
  public GatewayCreateProducerAws json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public GatewayCreateProducerAws name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public GatewayCreateProducerAws outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public GatewayCreateProducerAws addOutputRuleItem(String outputRuleItem) {
  ...
  public GatewayCreateProducerAws passwordLength(@javax.annotation.Nullable String passwordLength) {
  ...
  public GatewayCreateProducerAws producerEncryptionKeyName(@javax.annotation.Nullable String producerEncryptionKeyName) {
  ...
  public GatewayCreateProducerAws region(@javax.annotation.Nullable String region) {
    this.region = region;
    return this;
  }
  ...
  public GatewayCreateProducerAws secureAccessAwsAccountId(@javax.annotation.Nullable String secureAccessAwsAccountId) {
  ...
  public GatewayCreateProducerAws secureAccessAwsNativeCli(@javax.annotation.Nullable Boolean secureAccessAwsNativeCli) {
  ...
  public GatewayCreateProducerAws secureAccessBastionIssuer(@javax.annotation.Nullable String secureAccessBastionIssuer) {
  ...
  public GatewayCreateProducerAws secureAccessCertificateIssuer(@javax.annotation.Nullable String secureAccessCertificateIssuer) {
  ...
  public GatewayCreateProducerAws secureAccessDelay(@javax.annotation.Nullable Long secureAccessDelay) {
  ...
  public GatewayCreateProducerAws secureAccessEnable(@javax.annotation.Nullable String secureAccessEnable) {
  ...
  public GatewayCreateProducerAws secureAccessWeb(@javax.annotation.Nullable Boolean secureAccessWeb) {
  ...
  public GatewayCreateProducerAws secureAccessWebBrowsing(@javax.annotation.Nullable Boolean secureAccessWebBrowsing) {
  ...
  public GatewayCreateProducerAws secureAccessWebProxy(@javax.annotation.Nullable Boolean secureAccessWebProxy) {
  ...
  public GatewayCreateProducerAws sessionTags(@javax.annotation.Nullable String sessionTags) {
  ...
  public GatewayCreateProducerAws tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public GatewayCreateProducerAws targetName(@javax.annotation.Nullable String targetName) {
  ...
  public GatewayCreateProducerAws token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public GatewayCreateProducerAws transitiveTagKeys(@javax.annotation.Nullable String transitiveTagKeys) {
  ...
  public GatewayCreateProducerAws uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public GatewayCreateProducerAws useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public GatewayCreateProducerAws useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public GatewayCreateProducerAws useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public GatewayCreateProducerAws useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public GatewayCreateProducerAws userTtl(@javax.annotation.Nullable String userTtl) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessMode, gatewayCreateProducerAws.accessMode) &&
        ...
        Objects.equals(this.awsExternalId, gatewayCreateProducerAws.awsExternalId) &&
        ...
        Objects.equals(this.inputRule, gatewayCreateProducerAws.inputRule) &&
        ...
        Objects.equals(this.outputRule, gatewayCreateProducerAws.outputRule) &&
        ...
        Objects.equals(this.secureAccessCertificateIssuer, gatewayCreateProducerAws.secureAccessCertificateIssuer) &&
        Objects.equals(this.secureAccessDelay, gatewayCreateProducerAws.secureAccessDelay) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to GatewayCreateProducerAws
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GatewayCreateProducerAws.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GatewayCreateProducerAws is not found in the empty JSON string", GatewayCreateProducerAws.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GatewayCreateProducerAws.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GatewayCreateProducerAws` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GatewayCreateProducerAws.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GatewayCreateProducerAws.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GatewayCreateProducerAws' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GatewayCreateProducerAws> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GatewayCreateProducerAws.class));

       return (TypeAdapter<T>) new TypeAdapter<GatewayCreateProducerAws>() {
           @Override
           public void write(JsonWriter out, GatewayCreateProducerAws value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GatewayCreateProducerAws read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GatewayCreateProducerAws given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GatewayCreateProducerAws
   * @throws IOException if the JSON string is invalid with respect to GatewayCreateProducerAws
   */
  public static GatewayCreateProducerAws fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GatewayCreateProducerAws.class);
  }

  /**
   * Convert an instance of GatewayCreateProducerAws to an JSON string
   *
   * @return JSON string
   */
