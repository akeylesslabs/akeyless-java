...
public class TargetUpdateAws {
  ...
  public TargetUpdateAws deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessKey, targetUpdateAws.accessKey) &&
        ...
        Objects.equals(this.deleteProtection, targetUpdateAws.deleteProtection) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessKey, accessKeyId, deleteProtection, description, generateExternalId, json, keepPrevVersion, key, maxVersions, name, newName, region, roleArn, sessionToken, token, uidToken, useGwCloudIdentity);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("access-key", "access-key-id", "delete_protection", "description", "generate-external-id", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "region", "role-arn", "session-token", "token", "uid-token", "use-gw-cloud-identity"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TargetUpdateAws.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TargetUpdateAws is not found in the empty JSON string", TargetUpdateAws.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TargetUpdateAws.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TargetUpdateAws` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
