...
public class DynamicSecretCreatePostgreSql {
  ...
  public DynamicSecretCreatePostgreSql customUsernameTemplate(@javax.annotation.Nullable String customUsernameTemplate) {
  ...
  public DynamicSecretCreatePostgreSql inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public DynamicSecretCreatePostgreSql addInputRuleItem(String inputRuleItem) {
  ...
  public DynamicSecretCreatePostgreSql itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public DynamicSecretCreatePostgreSql putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public DynamicSecretCreatePostgreSql outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public DynamicSecretCreatePostgreSql addOutputRuleItem(String outputRuleItem) {
  ...
  public DynamicSecretCreatePostgreSql useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public DynamicSecretCreatePostgreSql useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public DynamicSecretCreatePostgreSql useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public DynamicSecretCreatePostgreSql useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.creationStatements, dynamicSecretCreatePostgreSql.creationStatements) &&
        Objects.equals(this.customUsernameTemplate, dynamicSecretCreatePostgreSql.customUsernameTemplate) &&
        ...
        Objects.equals(this.inputRule, dynamicSecretCreatePostgreSql.inputRule) &&
        Objects.equals(this.itemCustomFields, dynamicSecretCreatePostgreSql.itemCustomFields) &&
        Objects.equals(this.json, dynamicSecretCreatePostgreSql.json) &&
        Objects.equals(this.name, dynamicSecretCreatePostgreSql.name) &&
        Objects.equals(this.outputRule, dynamicSecretCreatePostgreSql.outputRule) &&
        ...
        Objects.equals(this.useCapitalLetters, dynamicSecretCreatePostgreSql.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, dynamicSecretCreatePostgreSql.useLowerLetters) &&
        Objects.equals(this.useNumbers, dynamicSecretCreatePostgreSql.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, dynamicSecretCreatePostgreSql.useSpecialCharacters) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicSecretCreatePostgreSql.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicSecretCreatePostgreSql is not found in the empty JSON string", DynamicSecretCreatePostgreSql.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicSecretCreatePostgreSql.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DynamicSecretCreatePostgreSql` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
