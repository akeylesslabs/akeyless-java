...
public class AuthMethodCreateOIDC {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessExpires, allowedRedirectUri, audience, auditLogsClaims, boundIps, clientId, clientSecret, deleteProtection, description, expirationEventIn, forceSubClaims, gwBoundIps, issuer, json, jwtTtl, name, productType, requiredScopes, requiredScopesPrefix, subclaimsDelimiters, token, uidToken, uniqueIdentifier);
  }
