...
public class AuthMethodCreateOIDC {
  ...
  public AuthMethodCreateOIDC accessExpires(@javax.annotation.Nullable Long accessExpires) {
  ...
  public AuthMethodCreateOIDC allowedClientType(@javax.annotation.Nullable List<String> allowedClientType) {
    this.allowedClientType = allowedClientType;
    return this;
  }

  public AuthMethodCreateOIDC addAllowedClientTypeItem(String allowedClientTypeItem) {
  ...
  public AuthMethodCreateOIDC allowedRedirectUri(@javax.annotation.Nullable List<String> allowedRedirectUri) {
  ...
  public AuthMethodCreateOIDC audience(@javax.annotation.Nullable String audience) {
  ...
  public AuthMethodCreateOIDC auditLogsClaims(@javax.annotation.Nullable List<String> auditLogsClaims) {
  ...
  public AuthMethodCreateOIDC boundIps(@javax.annotation.Nullable List<String> boundIps) {
  ...
  public AuthMethodCreateOIDC clientId(@javax.annotation.Nullable String clientId) {
  ...
  public AuthMethodCreateOIDC clientSecret(@javax.annotation.Nullable String clientSecret) {
  ...
  public AuthMethodCreateOIDC deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public AuthMethodCreateOIDC description(@javax.annotation.Nullable String description) {
  ...
  public AuthMethodCreateOIDC expirationEventIn(@javax.annotation.Nullable List<String> expirationEventIn) {
    this.expirationEventIn = expirationEventIn;
    return this;
  }

  public AuthMethodCreateOIDC addExpirationEventInItem(String expirationEventInItem) {
  ...
  public AuthMethodCreateOIDC forceSubClaims(@javax.annotation.Nullable Boolean forceSubClaims) {
  ...
  public AuthMethodCreateOIDC gwBoundIps(@javax.annotation.Nullable List<String> gwBoundIps) {
  ...
  public AuthMethodCreateOIDC issuer(@javax.annotation.Nullable String issuer) {
    this.issuer = issuer;
    return this;
  }
  ...
  public AuthMethodCreateOIDC json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public AuthMethodCreateOIDC jwtTtl(@javax.annotation.Nullable Long jwtTtl) {
    this.jwtTtl = jwtTtl;
    return this;
  }
  ...
  public AuthMethodCreateOIDC name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public AuthMethodCreateOIDC productType(@javax.annotation.Nullable List<String> productType) {
  ...
  public AuthMethodCreateOIDC requiredScopes(@javax.annotation.Nullable List<String> requiredScopes) {
  ...
  public AuthMethodCreateOIDC requiredScopesPrefix(@javax.annotation.Nullable String requiredScopesPrefix) {
  ...
  public AuthMethodCreateOIDC subclaimsDelimiters(@javax.annotation.Nullable List<String> subclaimsDelimiters) {
  ...
  public AuthMethodCreateOIDC token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public AuthMethodCreateOIDC uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public AuthMethodCreateOIDC uniqueIdentifier(@javax.annotation.Nonnull String uniqueIdentifier) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessExpires, authMethodCreateOIDC.accessExpires) &&
        Objects.equals(this.allowedClientType, authMethodCreateOIDC.allowedClientType) &&
        ...
        Objects.equals(this.expirationEventIn, authMethodCreateOIDC.expirationEventIn) &&
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("access-expires", "allowed-client-type", "allowed-redirect-uri", "audience", "audit-logs-claims", "bound-ips", "client-id", "client-secret", "delete_protection", "description", "expiration-event-in", "force-sub-claims", "gw-bound-ips", "issuer", "json", "jwt-ttl", "name", "product-type", "required-scopes", "required-scopes-prefix", "subclaims-delimiters", "token", "uid-token", "unique-identifier"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to AuthMethodCreateOIDC
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthMethodCreateOIDC.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AuthMethodCreateOIDC is not found in the empty JSON string", AuthMethodCreateOIDC.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthMethodCreateOIDC.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AuthMethodCreateOIDC` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AuthMethodCreateOIDC.openapiRequiredFields) {
      ...
      if (jsonObj.get("allowed-redirect-uri") != null && !jsonObj.get("allowed-redirect-uri").isJsonNull() && !jsonObj.get("allowed-redirect-uri").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `allowed-redirect-uri` to be an array in the JSON string but got `%s`", jsonObj.get("allowed-redirect-uri").toString()));
      }
      ...
      if ((jsonObj.get("client-id") != null && !jsonObj.get("client-id").isJsonNull()) && !jsonObj.get("client-id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `client-id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("client-id").toString()));
      }
      if ((jsonObj.get("client-secret") != null && !jsonObj.get("client-secret").isJsonNull()) && !jsonObj.get("client-secret").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `client-secret` to be a primitive type in the JSON string but got `%s`", jsonObj.get("client-secret").toString()));
      }
      ...
      if (jsonObj.get("required-scopes") != null && !jsonObj.get("required-scopes").isJsonNull() && !jsonObj.get("required-scopes").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `required-scopes` to be an array in the JSON string but got `%s`", jsonObj.get("required-scopes").toString()));
      }
      if ((jsonObj.get("required-scopes-prefix") != null && !jsonObj.get("required-scopes-prefix").isJsonNull()) && !jsonObj.get("required-scopes-prefix").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `required-scopes-prefix` to be a primitive type in the JSON string but got `%s`", jsonObj.get("required-scopes-prefix").toString()));
      }
      // ensure the optional json data is an array if present
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuthMethodCreateOIDC.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuthMethodCreateOIDC' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuthMethodCreateOIDC> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuthMethodCreateOIDC.class));

       return (TypeAdapter<T>) new TypeAdapter<AuthMethodCreateOIDC>() {
           @Override
           public void write(JsonWriter out, AuthMethodCreateOIDC value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AuthMethodCreateOIDC read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AuthMethodCreateOIDC given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AuthMethodCreateOIDC
   * @throws IOException if the JSON string is invalid with respect to AuthMethodCreateOIDC
   */
  public static AuthMethodCreateOIDC fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuthMethodCreateOIDC.class);
  }

  /**
   * Convert an instance of AuthMethodCreateOIDC to an JSON string
   *
   * @return JSON string
   */
