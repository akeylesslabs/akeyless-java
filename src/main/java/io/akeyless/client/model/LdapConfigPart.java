...
public class LdapConfigPart {
  ...
  public LdapConfigPart() {
  }

  public LdapConfigPart ldapAccessId(@javax.annotation.Nullable String ldapAccessId) {
  ...
  public LdapConfigPart ldapAnonymousSearch(@javax.annotation.Nullable Boolean ldapAnonymousSearch) {
  ...
  public LdapConfigPart ldapBindDn(@javax.annotation.Nullable String ldapBindDn) {
  ...
  public LdapConfigPart ldapBindPassword(@javax.annotation.Nullable String ldapBindPassword) {
  ...
  public LdapConfigPart ldapCert(@javax.annotation.Nullable String ldapCert) {
  ...
  public LdapConfigPart ldapEnable(@javax.annotation.Nullable Boolean ldapEnable) {
  ...
  public LdapConfigPart ldapGroupAttr(@javax.annotation.Nullable String ldapGroupAttr) {
  ...
  public LdapConfigPart ldapGroupDn(@javax.annotation.Nullable String ldapGroupDn) {
  ...
  public LdapConfigPart ldapGroupFilter(@javax.annotation.Nullable String ldapGroupFilter) {
  ...
  public LdapConfigPart ldapPrivateKey(@javax.annotation.Nullable String ldapPrivateKey) {
  ...
  public LdapConfigPart ldapTokenExpiration(@javax.annotation.Nullable String ldapTokenExpiration) {
  ...
  public LdapConfigPart ldapUrl(@javax.annotation.Nullable String ldapUrl) {
  ...
  public LdapConfigPart ldapUserAttr(@javax.annotation.Nullable String ldapUserAttr) {
  ...
  public LdapConfigPart ldapUserDn(@javax.annotation.Nullable String ldapUserDn) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to LdapConfigPart
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LdapConfigPart.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LdapConfigPart' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LdapConfigPart> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LdapConfigPart.class));

       return (TypeAdapter<T>) new TypeAdapter<LdapConfigPart>() {
           @Override
           public void write(JsonWriter out, LdapConfigPart value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LdapConfigPart read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LdapConfigPart given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LdapConfigPart
   * @throws IOException if the JSON string is invalid with respect to LdapConfigPart
   */
  public static LdapConfigPart fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LdapConfigPart.class);
  }

  /**
   * Convert an instance of LdapConfigPart to an JSON string
   *
   * @return JSON string
   */
