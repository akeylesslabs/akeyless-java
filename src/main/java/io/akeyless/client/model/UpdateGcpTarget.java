...
public class UpdateGcpTarget {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("comment", "description", "gcp-key", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "token", "uid-token", "update-version", "use-gw-cloud-identity"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateGcpTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateGcpTarget is not found in the empty JSON string", UpdateGcpTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateGcpTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateGcpTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
