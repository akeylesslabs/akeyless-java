...
public class DynamicSecretCreateEks {
  ...
  public DynamicSecretCreateEks inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public DynamicSecretCreateEks addInputRuleItem(String inputRuleItem) {
  ...
  public DynamicSecretCreateEks outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public DynamicSecretCreateEks addOutputRuleItem(String outputRuleItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.deleteProtection, dynamicSecretCreateEks.deleteProtection) &&
        ...
        Objects.equals(this.inputRule, dynamicSecretCreateEks.inputRule) &&
        ...
        Objects.equals(this.outputRule, dynamicSecretCreateEks.outputRule) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicSecretCreateEks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicSecretCreateEks is not found in the empty JSON string", DynamicSecretCreateEks.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicSecretCreateEks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DynamicSecretCreateEks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
