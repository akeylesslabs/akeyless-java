...
public class TargetUpdateGithub {
  ...
  public TargetUpdateGithub deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.deleteProtection, targetUpdateGithub.deleteProtection) &&
        Objects.equals(this.description, targetUpdateGithub.description) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(deleteProtection, description, githubAppId, githubAppPrivateKey, githubBaseUrl, json, keepPrevVersion, key, maxVersions, name, newName, token, uidToken);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("delete_protection", "description", "github-app-id", "github-app-private-key", "github-base-url", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "token", "uid-token"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TargetUpdateGithub.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TargetUpdateGithub is not found in the empty JSON string", TargetUpdateGithub.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TargetUpdateGithub.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TargetUpdateGithub` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
