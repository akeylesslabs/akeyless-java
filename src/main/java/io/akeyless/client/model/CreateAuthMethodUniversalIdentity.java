...
public class CreateAuthMethodUniversalIdentity {
  ...
  public CreateAuthMethodUniversalIdentity accessExpires(@javax.annotation.Nullable Long accessExpires) {
  ...
  public CreateAuthMethodUniversalIdentity allowedClientType(@javax.annotation.Nullable List<String> allowedClientType) {
    this.allowedClientType = allowedClientType;
    return this;
  }

  public CreateAuthMethodUniversalIdentity addAllowedClientTypeItem(String allowedClientTypeItem) {
  ...
  public CreateAuthMethodUniversalIdentity auditLogsClaims(@javax.annotation.Nullable List<String> auditLogsClaims) {
  ...
  public CreateAuthMethodUniversalIdentity boundIps(@javax.annotation.Nullable List<String> boundIps) {
  ...
  public CreateAuthMethodUniversalIdentity childTtlLimit(@javax.annotation.Nullable Integer childTtlLimit) {
  ...
  public CreateAuthMethodUniversalIdentity deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public CreateAuthMethodUniversalIdentity denyInheritance(@javax.annotation.Nullable Boolean denyInheritance) {
  ...
  public CreateAuthMethodUniversalIdentity denyRotate(@javax.annotation.Nullable Boolean denyRotate) {
  ...
  public CreateAuthMethodUniversalIdentity description(@javax.annotation.Nullable String description) {
  ...
  public CreateAuthMethodUniversalIdentity expirationEventIn(@javax.annotation.Nullable List<String> expirationEventIn) {
    this.expirationEventIn = expirationEventIn;
    return this;
  }

  public CreateAuthMethodUniversalIdentity addExpirationEventInItem(String expirationEventInItem) {
  ...
  public CreateAuthMethodUniversalIdentity forceSubClaims(@javax.annotation.Nullable Boolean forceSubClaims) {
  ...
  public CreateAuthMethodUniversalIdentity gwBoundIps(@javax.annotation.Nullable List<String> gwBoundIps) {
  ...
  public CreateAuthMethodUniversalIdentity json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public CreateAuthMethodUniversalIdentity jwtTtl(@javax.annotation.Nullable Long jwtTtl) {
    this.jwtTtl = jwtTtl;
    return this;
  }
  ...
  public CreateAuthMethodUniversalIdentity name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateAuthMethodUniversalIdentity productType(@javax.annotation.Nullable List<String> productType) {
  ...
  public CreateAuthMethodUniversalIdentity token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public CreateAuthMethodUniversalIdentity treeLength(@javax.annotation.Nullable Integer treeLength) {
  ...
  public CreateAuthMethodUniversalIdentity ttl(@javax.annotation.Nullable Integer ttl) {
    this.ttl = ttl;
    return this;
  }
  ...
  public CreateAuthMethodUniversalIdentity uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessExpires, createAuthMethodUniversalIdentity.accessExpires) &&
        Objects.equals(this.allowedClientType, createAuthMethodUniversalIdentity.allowedClientType) &&
        ...
        Objects.equals(this.childTtlLimit, createAuthMethodUniversalIdentity.childTtlLimit) &&
        Objects.equals(this.deleteProtection, createAuthMethodUniversalIdentity.deleteProtection) &&
        ...
        Objects.equals(this.expirationEventIn, createAuthMethodUniversalIdentity.expirationEventIn) &&
        ...
        Objects.equals(this.treeLength, createAuthMethodUniversalIdentity.treeLength) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateAuthMethodUniversalIdentity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateAuthMethodUniversalIdentity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateAuthMethodUniversalIdentity is not found in the empty JSON string", CreateAuthMethodUniversalIdentity.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateAuthMethodUniversalIdentity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateAuthMethodUniversalIdentity` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateAuthMethodUniversalIdentity.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateAuthMethodUniversalIdentity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateAuthMethodUniversalIdentity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateAuthMethodUniversalIdentity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateAuthMethodUniversalIdentity.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateAuthMethodUniversalIdentity>() {
           @Override
           public void write(JsonWriter out, CreateAuthMethodUniversalIdentity value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateAuthMethodUniversalIdentity read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateAuthMethodUniversalIdentity given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateAuthMethodUniversalIdentity
   * @throws IOException if the JSON string is invalid with respect to CreateAuthMethodUniversalIdentity
   */
  public static CreateAuthMethodUniversalIdentity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAuthMethodUniversalIdentity.class);
  }

  /**
   * Convert an instance of CreateAuthMethodUniversalIdentity to an JSON string
   *
   * @return JSON string
   */
