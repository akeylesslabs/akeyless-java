...
public class RotatedSecretCreatePostgresql {
  ...
  public RotatedSecretCreatePostgresql() {
  }

  public RotatedSecretCreatePostgresql authenticationCredentials(@javax.annotation.Nullable String authenticationCredentials) {
  ...
  public RotatedSecretCreatePostgresql autoRotate(@javax.annotation.Nullable String autoRotate) {
  ...
  public RotatedSecretCreatePostgresql deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public RotatedSecretCreatePostgresql description(@javax.annotation.Nullable String description) {
  ...
  public RotatedSecretCreatePostgresql inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public RotatedSecretCreatePostgresql addInputRuleItem(String inputRuleItem) {
  ...
  public RotatedSecretCreatePostgresql itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public RotatedSecretCreatePostgresql putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public RotatedSecretCreatePostgresql json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public RotatedSecretCreatePostgresql key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public RotatedSecretCreatePostgresql lockDuringSraSession(@javax.annotation.Nullable String lockDuringSraSession) {
  ...
  public RotatedSecretCreatePostgresql maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public RotatedSecretCreatePostgresql name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public RotatedSecretCreatePostgresql outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public RotatedSecretCreatePostgresql addOutputRuleItem(String outputRuleItem) {
  ...
  public RotatedSecretCreatePostgresql passwordLength(@javax.annotation.Nullable String passwordLength) {
  ...
  public RotatedSecretCreatePostgresql rotateAfterDisconnect(@javax.annotation.Nullable String rotateAfterDisconnect) {
  ...
  public RotatedSecretCreatePostgresql rotatedPassword(@javax.annotation.Nullable String rotatedPassword) {
  ...
  public RotatedSecretCreatePostgresql rotatedUsername(@javax.annotation.Nullable String rotatedUsername) {
  ...
  public RotatedSecretCreatePostgresql rotationEventIn(@javax.annotation.Nullable List<String> rotationEventIn) {
  ...
  public RotatedSecretCreatePostgresql rotationHour(@javax.annotation.Nullable Integer rotationHour) {
  ...
  public RotatedSecretCreatePostgresql rotationInterval(@javax.annotation.Nullable String rotationInterval) {
  ...
  public RotatedSecretCreatePostgresql rotatorType(@javax.annotation.Nonnull String rotatorType) {
  ...
  public RotatedSecretCreatePostgresql secureAccessBastionIssuer(@javax.annotation.Nullable String secureAccessBastionIssuer) {
  ...
  public RotatedSecretCreatePostgresql secureAccessCertificateIssuer(@javax.annotation.Nullable String secureAccessCertificateIssuer) {
  ...
  public RotatedSecretCreatePostgresql secureAccessDbName(@javax.annotation.Nullable String secureAccessDbName) {
  ...
  public RotatedSecretCreatePostgresql secureAccessDbSchema(@javax.annotation.Nullable String secureAccessDbSchema) {
  ...
  public RotatedSecretCreatePostgresql secureAccessEnable(@javax.annotation.Nullable String secureAccessEnable) {
  ...
  public RotatedSecretCreatePostgresql secureAccessHost(@javax.annotation.Nullable List<String> secureAccessHost) {
    this.secureAccessHost = secureAccessHost;
    return this;
  }

  public RotatedSecretCreatePostgresql addSecureAccessHostItem(String secureAccessHostItem) {
  ...
  public RotatedSecretCreatePostgresql secureAccessWeb(@javax.annotation.Nullable Boolean secureAccessWeb) {
  ...
  public RotatedSecretCreatePostgresql tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }

  public RotatedSecretCreatePostgresql addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public RotatedSecretCreatePostgresql targetName(@javax.annotation.Nonnull String targetName) {
  ...
  public RotatedSecretCreatePostgresql token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public RotatedSecretCreatePostgresql uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public RotatedSecretCreatePostgresql useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public RotatedSecretCreatePostgresql useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public RotatedSecretCreatePostgresql useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public RotatedSecretCreatePostgresql useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    RotatedSecretCreatePostgresql rotatedSecretCreatePostgresql = (RotatedSecretCreatePostgresql) o;
    return Objects.equals(this.authenticationCredentials, rotatedSecretCreatePostgresql.authenticationCredentials) &&
        Objects.equals(this.autoRotate, rotatedSecretCreatePostgresql.autoRotate) &&
        Objects.equals(this.deleteProtection, rotatedSecretCreatePostgresql.deleteProtection) &&
        Objects.equals(this.description, rotatedSecretCreatePostgresql.description) &&
        Objects.equals(this.inputRule, rotatedSecretCreatePostgresql.inputRule) &&
        Objects.equals(this.itemCustomFields, rotatedSecretCreatePostgresql.itemCustomFields) &&
        Objects.equals(this.json, rotatedSecretCreatePostgresql.json) &&
        Objects.equals(this.key, rotatedSecretCreatePostgresql.key) &&
        Objects.equals(this.lockDuringSraSession, rotatedSecretCreatePostgresql.lockDuringSraSession) &&
        Objects.equals(this.maxVersions, rotatedSecretCreatePostgresql.maxVersions) &&
        Objects.equals(this.name, rotatedSecretCreatePostgresql.name) &&
        Objects.equals(this.outputRule, rotatedSecretCreatePostgresql.outputRule) &&
        Objects.equals(this.passwordLength, rotatedSecretCreatePostgresql.passwordLength) &&
        ...
        Objects.equals(this.secureAccessBastionIssuer, rotatedSecretCreatePostgresql.secureAccessBastionIssuer) &&
        Objects.equals(this.secureAccessCertificateIssuer, rotatedSecretCreatePostgresql.secureAccessCertificateIssuer) &&
        Objects.equals(this.secureAccessDbName, rotatedSecretCreatePostgresql.secureAccessDbName) &&
        Objects.equals(this.secureAccessDbSchema, rotatedSecretCreatePostgresql.secureAccessDbSchema) &&
        Objects.equals(this.secureAccessEnable, rotatedSecretCreatePostgresql.secureAccessEnable) &&
        Objects.equals(this.secureAccessHost, rotatedSecretCreatePostgresql.secureAccessHost) &&
        Objects.equals(this.secureAccessWeb, rotatedSecretCreatePostgresql.secureAccessWeb) &&
        Objects.equals(this.tags, rotatedSecretCreatePostgresql.tags) &&
        Objects.equals(this.targetName, rotatedSecretCreatePostgresql.targetName) &&
        Objects.equals(this.token, rotatedSecretCreatePostgresql.token) &&
        Objects.equals(this.uidToken, rotatedSecretCreatePostgresql.uidToken) &&
        Objects.equals(this.useCapitalLetters, rotatedSecretCreatePostgresql.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, rotatedSecretCreatePostgresql.useLowerLetters) &&
        Objects.equals(this.useNumbers, rotatedSecretCreatePostgresql.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, rotatedSecretCreatePostgresql.useSpecialCharacters);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authenticationCredentials, autoRotate, deleteProtection, description, inputRule, itemCustomFields, json, key, lockDuringSraSession, maxVersions, name, outputRule, passwordLength, rotateAfterDisconnect, rotatedPassword, rotatedUsername, rotationEventIn, rotationHour, rotationInterval, rotatorType, secureAccessBastionIssuer, secureAccessCertificateIssuer, secureAccessDbName, secureAccessDbSchema, secureAccessEnable, secureAccessHost, secureAccessWeb, tags, targetName, token, uidToken, useCapitalLetters, useLowerLetters, useNumbers, useSpecialCharacters);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RotatedSecretCreatePostgresql {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to RotatedSecretCreatePostgresql
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RotatedSecretCreatePostgresql.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RotatedSecretCreatePostgresql is not found in the empty JSON string", RotatedSecretCreatePostgresql.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RotatedSecretCreatePostgresql.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RotatedSecretCreatePostgresql` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RotatedSecretCreatePostgresql.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RotatedSecretCreatePostgresql.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RotatedSecretCreatePostgresql' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RotatedSecretCreatePostgresql> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RotatedSecretCreatePostgresql.class));

       return (TypeAdapter<T>) new TypeAdapter<RotatedSecretCreatePostgresql>() {
           @Override
           public void write(JsonWriter out, RotatedSecretCreatePostgresql value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RotatedSecretCreatePostgresql read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RotatedSecretCreatePostgresql given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RotatedSecretCreatePostgresql
   * @throws IOException if the JSON string is invalid with respect to RotatedSecretCreatePostgresql
   */
  public static RotatedSecretCreatePostgresql fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RotatedSecretCreatePostgresql.class);
  }

  /**
   * Convert an instance of RotatedSecretCreatePostgresql to an JSON string
   *
   * @return JSON string
   */
