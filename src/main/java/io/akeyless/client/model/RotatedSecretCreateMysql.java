...
public class RotatedSecretCreateMysql {
  ...
  public RotatedSecretCreateMysql() {
  }

  public RotatedSecretCreateMysql authenticationCredentials(@javax.annotation.Nullable String authenticationCredentials) {
  ...
  public RotatedSecretCreateMysql autoRotate(@javax.annotation.Nullable String autoRotate) {
  ...
  public RotatedSecretCreateMysql deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public RotatedSecretCreateMysql description(@javax.annotation.Nullable String description) {
  ...
  public RotatedSecretCreateMysql inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public RotatedSecretCreateMysql addInputRuleItem(String inputRuleItem) {
  ...
  public RotatedSecretCreateMysql itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public RotatedSecretCreateMysql putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public RotatedSecretCreateMysql json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public RotatedSecretCreateMysql key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public RotatedSecretCreateMysql name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public RotatedSecretCreateMysql outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public RotatedSecretCreateMysql addOutputRuleItem(String outputRuleItem) {
  ...
  public RotatedSecretCreateMysql passwordLength(@javax.annotation.Nullable String passwordLength) {
  ...
  public RotatedSecretCreateMysql rotateAfterDisconnect(@javax.annotation.Nullable String rotateAfterDisconnect) {
  ...
  public RotatedSecretCreateMysql rotatedPassword(@javax.annotation.Nullable String rotatedPassword) {
  ...
  public RotatedSecretCreateMysql rotatedUsername(@javax.annotation.Nullable String rotatedUsername) {
  ...
  public RotatedSecretCreateMysql rotationEventIn(@javax.annotation.Nullable List<String> rotationEventIn) {
    this.rotationEventIn = rotationEventIn;
    return this;
  }

  public RotatedSecretCreateMysql addRotationEventInItem(String rotationEventInItem) {
  ...
  public RotatedSecretCreateMysql rotationHour(@javax.annotation.Nullable Integer rotationHour) {
  ...
  public RotatedSecretCreateMysql rotationInterval(@javax.annotation.Nullable String rotationInterval) {
  ...
  public RotatedSecretCreateMysql rotatorType(@javax.annotation.Nonnull String rotatorType) {
  ...
  public RotatedSecretCreateMysql secureAccessBastionIssuer(@javax.annotation.Nullable String secureAccessBastionIssuer) {
  ...
  public RotatedSecretCreateMysql secureAccessCertificateIssuer(@javax.annotation.Nullable String secureAccessCertificateIssuer) {
  ...
  public RotatedSecretCreateMysql secureAccessDbName(@javax.annotation.Nullable String secureAccessDbName) {
  ...
  public RotatedSecretCreateMysql secureAccessEnable(@javax.annotation.Nullable String secureAccessEnable) {
  ...
  public RotatedSecretCreateMysql secureAccessHost(@javax.annotation.Nullable List<String> secureAccessHost) {
    this.secureAccessHost = secureAccessHost;
    return this;
  }

  public RotatedSecretCreateMysql addSecureAccessHostItem(String secureAccessHostItem) {
  ...
  public RotatedSecretCreateMysql secureAccessWeb(@javax.annotation.Nullable Boolean secureAccessWeb) {
  ...
  public RotatedSecretCreateMysql tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }

  public RotatedSecretCreateMysql addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public RotatedSecretCreateMysql targetName(@javax.annotation.Nonnull String targetName) {
  ...
  public RotatedSecretCreateMysql token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public RotatedSecretCreateMysql uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public RotatedSecretCreateMysql useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public RotatedSecretCreateMysql useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public RotatedSecretCreateMysql useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public RotatedSecretCreateMysql useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    RotatedSecretCreateMysql rotatedSecretCreateMysql = (RotatedSecretCreateMysql) o;
    return Objects.equals(this.authenticationCredentials, rotatedSecretCreateMysql.authenticationCredentials) &&
        Objects.equals(this.autoRotate, rotatedSecretCreateMysql.autoRotate) &&
        Objects.equals(this.deleteProtection, rotatedSecretCreateMysql.deleteProtection) &&
        Objects.equals(this.description, rotatedSecretCreateMysql.description) &&
        Objects.equals(this.inputRule, rotatedSecretCreateMysql.inputRule) &&
        ...
        Objects.equals(this.outputRule, rotatedSecretCreateMysql.outputRule) &&
        Objects.equals(this.passwordLength, rotatedSecretCreateMysql.passwordLength) &&
        Objects.equals(this.rotateAfterDisconnect, rotatedSecretCreateMysql.rotateAfterDisconnect) &&
        Objects.equals(this.rotatedPassword, rotatedSecretCreateMysql.rotatedPassword) &&
        Objects.equals(this.rotatedUsername, rotatedSecretCreateMysql.rotatedUsername) &&
        Objects.equals(this.rotationEventIn, rotatedSecretCreateMysql.rotationEventIn) &&
        Objects.equals(this.rotationHour, rotatedSecretCreateMysql.rotationHour) &&
        Objects.equals(this.rotationInterval, rotatedSecretCreateMysql.rotationInterval) &&
        Objects.equals(this.rotatorType, rotatedSecretCreateMysql.rotatorType) &&
        Objects.equals(this.secureAccessBastionIssuer, rotatedSecretCreateMysql.secureAccessBastionIssuer) &&
        Objects.equals(this.secureAccessCertificateIssuer, rotatedSecretCreateMysql.secureAccessCertificateIssuer) &&
        Objects.equals(this.secureAccessDbName, rotatedSecretCreateMysql.secureAccessDbName) &&
        Objects.equals(this.secureAccessEnable, rotatedSecretCreateMysql.secureAccessEnable) &&
        Objects.equals(this.secureAccessHost, rotatedSecretCreateMysql.secureAccessHost) &&
        Objects.equals(this.secureAccessWeb, rotatedSecretCreateMysql.secureAccessWeb) &&
        Objects.equals(this.tags, rotatedSecretCreateMysql.tags) &&
        Objects.equals(this.targetName, rotatedSecretCreateMysql.targetName) &&
        Objects.equals(this.token, rotatedSecretCreateMysql.token) &&
        Objects.equals(this.uidToken, rotatedSecretCreateMysql.uidToken) &&
        Objects.equals(this.useCapitalLetters, rotatedSecretCreateMysql.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, rotatedSecretCreateMysql.useLowerLetters) &&
        Objects.equals(this.useNumbers, rotatedSecretCreateMysql.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, rotatedSecretCreateMysql.useSpecialCharacters);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RotatedSecretCreateMysql
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RotatedSecretCreateMysql.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RotatedSecretCreateMysql is not found in the empty JSON string", RotatedSecretCreateMysql.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RotatedSecretCreateMysql.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RotatedSecretCreateMysql` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RotatedSecretCreateMysql.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RotatedSecretCreateMysql.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RotatedSecretCreateMysql' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RotatedSecretCreateMysql> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RotatedSecretCreateMysql.class));

       return (TypeAdapter<T>) new TypeAdapter<RotatedSecretCreateMysql>() {
           @Override
           public void write(JsonWriter out, RotatedSecretCreateMysql value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RotatedSecretCreateMysql read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RotatedSecretCreateMysql given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RotatedSecretCreateMysql
   * @throws IOException if the JSON string is invalid with respect to RotatedSecretCreateMysql
   */
  public static RotatedSecretCreateMysql fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RotatedSecretCreateMysql.class);
  }

  /**
   * Convert an instance of RotatedSecretCreateMysql to an JSON string
   *
   * @return JSON string
   */
