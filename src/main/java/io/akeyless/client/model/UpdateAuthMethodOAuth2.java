...
public class UpdateAuthMethodOAuth2 {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("access-expires", "allowed-client-type", "audience", "audit-logs-claims", "bound-client-ids", "bound-ips", "cert", "cert-file-data", "delete_protection", "description", "expiration-event-in", "force-sub-claims", "gateway-url", "gw-bound-ips", "issuer", "json", "jwks-json-data", "jwks-uri", "jwt-ttl", "name", "new-name", "product-type", "subclaims-delimiters", "token", "uid-token", "unique-identifier"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateAuthMethodOAuth2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateAuthMethodOAuth2 is not found in the empty JSON string", UpdateAuthMethodOAuth2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateAuthMethodOAuth2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateAuthMethodOAuth2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("bound-client-ids") != null && !jsonObj.get("bound-client-ids").isJsonNull() && !jsonObj.get("bound-client-ids").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `bound-client-ids` to be an array in the JSON string but got `%s`", jsonObj.get("bound-client-ids").toString()));
      }
      // ensure the optional json data is an array if present
      ...
      if ((jsonObj.get("cert") != null && !jsonObj.get("cert").isJsonNull()) && !jsonObj.get("cert").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `cert` to be a primitive type in the JSON string but got `%s`", jsonObj.get("cert").toString()));
      }
      ...
      if ((jsonObj.get("jwks-json-data") != null && !jsonObj.get("jwks-json-data").isJsonNull()) && !jsonObj.get("jwks-json-data").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `jwks-json-data` to be a primitive type in the JSON string but got `%s`", jsonObj.get("jwks-json-data").toString()));
      }
