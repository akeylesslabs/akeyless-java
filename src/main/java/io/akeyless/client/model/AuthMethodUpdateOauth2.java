...
public class AuthMethodUpdateOauth2 {
  ...
  public AuthMethodUpdateOauth2 allowedClientType(@javax.annotation.Nullable List<String> allowedClientType) {
    this.allowedClientType = allowedClientType;
    return this;
  }

  public AuthMethodUpdateOauth2 addAllowedClientTypeItem(String allowedClientTypeItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessExpires, authMethodUpdateOauth2.accessExpires) &&
        Objects.equals(this.allowedClientType, authMethodUpdateOauth2.allowedClientType) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthMethodUpdateOauth2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AuthMethodUpdateOauth2 is not found in the empty JSON string", AuthMethodUpdateOauth2.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AuthMethodUpdateOauth2.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AuthMethodUpdateOauth2` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
