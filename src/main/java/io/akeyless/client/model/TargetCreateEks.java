...
public class TargetCreateEks {
  ...
  public TargetCreateEks deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.deleteProtection, targetCreateEks.deleteProtection) &&
        Objects.equals(this.description, targetCreateEks.description) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(deleteProtection, description, eksAccessKeyId, eksClusterCaCert, eksClusterEndpoint, eksClusterName, eksRegion, eksSecretAccessKey, json, key, maxVersions, name, token, uidToken, useGwCloudIdentity);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("delete_protection", "description", "eks-access-key-id", "eks-cluster-ca-cert", "eks-cluster-endpoint", "eks-cluster-name", "eks-region", "eks-secret-access-key", "json", "key", "max-versions", "name", "token", "uid-token", "use-gw-cloud-identity"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TargetCreateEks.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TargetCreateEks is not found in the empty JSON string", TargetCreateEks.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TargetCreateEks.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TargetCreateEks` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
