...
public class UpdateGodaddyTarget {
  ...
  public UpdateGodaddyTarget() {
  }

  public UpdateGodaddyTarget apiKey(@javax.annotation.Nonnull String apiKey) {
    this.apiKey = apiKey;
    return this;
  }
  ...
  public UpdateGodaddyTarget comment(@javax.annotation.Nullable String comment) {
  ...
  public UpdateGodaddyTarget description(@javax.annotation.Nullable String description) {
  ...
  public UpdateGodaddyTarget imapFqdn(@javax.annotation.Nonnull String imapFqdn) {
  ...
  public UpdateGodaddyTarget imapPassword(@javax.annotation.Nonnull String imapPassword) {
  ...
  public UpdateGodaddyTarget imapPort(@javax.annotation.Nullable String imapPort) {
  ...
  public UpdateGodaddyTarget imapUsername(@javax.annotation.Nonnull String imapUsername) {
  ...
  public UpdateGodaddyTarget json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public UpdateGodaddyTarget keepPrevVersion(@javax.annotation.Nullable String keepPrevVersion) {
  ...
  public UpdateGodaddyTarget key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public UpdateGodaddyTarget maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public UpdateGodaddyTarget name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateGodaddyTarget newName(@javax.annotation.Nullable String newName) {
  ...
  public UpdateGodaddyTarget secret(@javax.annotation.Nonnull String secret) {
    this.secret = secret;
    return this;
  }
  ...
  public UpdateGodaddyTarget timeout(@javax.annotation.Nullable String timeout) {
  ...
  public UpdateGodaddyTarget token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public UpdateGodaddyTarget uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public UpdateGodaddyTarget updateVersion(@javax.annotation.Nullable Boolean updateVersion) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.apiKey, updateGodaddyTarget.apiKey) &&
        ...
        Objects.equals(this.imapPort, updateGodaddyTarget.imapPort) &&
        Objects.equals(this.imapUsername, updateGodaddyTarget.imapUsername) &&
        ...
        Objects.equals(this.timeout, updateGodaddyTarget.timeout) &&
        Objects.equals(this.token, updateGodaddyTarget.token) &&
        Objects.equals(this.uidToken, updateGodaddyTarget.uidToken) &&
        Objects.equals(this.updateVersion, updateGodaddyTarget.updateVersion);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("api-key", "comment", "customer_id", "description", "imap-fqdn", "imap-password", "imap-port", "imap-username", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "secret", "timeout", "token", "uid-token", "update-version"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateGodaddyTarget
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateGodaddyTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateGodaddyTarget is not found in the empty JSON string", UpdateGodaddyTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateGodaddyTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateGodaddyTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateGodaddyTarget.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateGodaddyTarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateGodaddyTarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateGodaddyTarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateGodaddyTarget.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateGodaddyTarget>() {
           @Override
           public void write(JsonWriter out, UpdateGodaddyTarget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateGodaddyTarget read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateGodaddyTarget given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateGodaddyTarget
   * @throws IOException if the JSON string is invalid with respect to UpdateGodaddyTarget
   */
  public static UpdateGodaddyTarget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateGodaddyTarget.class);
  }

  /**
   * Convert an instance of UpdateGodaddyTarget to an JSON string
   *
   * @return JSON string
   */
