...
public class UpdateAuthMethodOCI {
  ...
  public UpdateAuthMethodOCI() {
  }

  public UpdateAuthMethodOCI accessExpires(@javax.annotation.Nullable Long accessExpires) {
  ...
  public UpdateAuthMethodOCI allowedClientType(@javax.annotation.Nullable List<String> allowedClientType) {
    this.allowedClientType = allowedClientType;
    return this;
  }

  public UpdateAuthMethodOCI addAllowedClientTypeItem(String allowedClientTypeItem) {
  ...
  public UpdateAuthMethodOCI auditLogsClaims(@javax.annotation.Nullable List<String> auditLogsClaims) {
  ...
  public UpdateAuthMethodOCI boundIps(@javax.annotation.Nullable List<String> boundIps) {
    this.boundIps = boundIps;
    return this;
  }

  public UpdateAuthMethodOCI addBoundIpsItem(String boundIpsItem) {
  ...
  public UpdateAuthMethodOCI deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public UpdateAuthMethodOCI description(@javax.annotation.Nullable String description) {
  ...
  public UpdateAuthMethodOCI expirationEventIn(@javax.annotation.Nullable List<String> expirationEventIn) {
    this.expirationEventIn = expirationEventIn;
    return this;
  }

  public UpdateAuthMethodOCI addExpirationEventInItem(String expirationEventInItem) {
  ...
  public UpdateAuthMethodOCI forceSubClaims(@javax.annotation.Nullable Boolean forceSubClaims) {
  ...
  public UpdateAuthMethodOCI groupOcid(@javax.annotation.Nonnull List<String> groupOcid) {
    this.groupOcid = groupOcid;
    return this;
  }

  public UpdateAuthMethodOCI addGroupOcidItem(String groupOcidItem) {
  ...
  public UpdateAuthMethodOCI gwBoundIps(@javax.annotation.Nullable List<String> gwBoundIps) {
    this.gwBoundIps = gwBoundIps;
    return this;
  }

  public UpdateAuthMethodOCI addGwBoundIpsItem(String gwBoundIpsItem) {
  ...
  public UpdateAuthMethodOCI json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public UpdateAuthMethodOCI jwtTtl(@javax.annotation.Nullable Long jwtTtl) {
    this.jwtTtl = jwtTtl;
    return this;
  }
  ...
  public UpdateAuthMethodOCI name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public UpdateAuthMethodOCI newName(@javax.annotation.Nullable String newName) {
  ...
  public UpdateAuthMethodOCI productType(@javax.annotation.Nullable List<String> productType) {
  ...
  public UpdateAuthMethodOCI tenantOcid(@javax.annotation.Nonnull String tenantOcid) {
  ...
  public UpdateAuthMethodOCI token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public UpdateAuthMethodOCI uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessExpires, updateAuthMethodOCI.accessExpires) &&
        Objects.equals(this.allowedClientType, updateAuthMethodOCI.allowedClientType) &&
        ...
        Objects.equals(this.expirationEventIn, updateAuthMethodOCI.expirationEventIn) &&
        ...
        Objects.equals(this.gwBoundIps, updateAuthMethodOCI.gwBoundIps) &&
        Objects.equals(this.json, updateAuthMethodOCI.json) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateAuthMethodOCI
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateAuthMethodOCI.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateAuthMethodOCI is not found in the empty JSON string", UpdateAuthMethodOCI.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateAuthMethodOCI.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateAuthMethodOCI` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UpdateAuthMethodOCI.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateAuthMethodOCI.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateAuthMethodOCI' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateAuthMethodOCI> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateAuthMethodOCI.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateAuthMethodOCI>() {
           @Override
           public void write(JsonWriter out, UpdateAuthMethodOCI value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateAuthMethodOCI read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateAuthMethodOCI given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateAuthMethodOCI
   * @throws IOException if the JSON string is invalid with respect to UpdateAuthMethodOCI
   */
  public static UpdateAuthMethodOCI fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateAuthMethodOCI.class);
  }

  /**
   * Convert an instance of UpdateAuthMethodOCI to an JSON string
   *
   * @return JSON string
   */
