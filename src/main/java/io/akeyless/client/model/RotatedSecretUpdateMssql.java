...
public class RotatedSecretUpdateMssql {
  ...
  public RotatedSecretUpdateMssql addTag(List<String> addTag) {
  ...
  **/
  ...
  public RotatedSecretUpdateMssql authenticationCredentials(String authenticationCredentials) {
  ...
  **/
  ...
  public RotatedSecretUpdateMssql autoRotate(String autoRotate) {
  ...
  **/
  ...
  public RotatedSecretUpdateMssql deleteProtection(String deleteProtection) {
  ...
  **/
  ...
  public RotatedSecretUpdateMssql description(String description) {
  ...
  **/
  ...
  public RotatedSecretUpdateMssql json(Boolean json) {
  ...
  **/
  ...
  public RotatedSecretUpdateMssql keepPrevVersion(String keepPrevVersion) {
  ...
  **/
  ...
  public RotatedSecretUpdateMssql key(String key) {
  ...
  **/
  ...
  public RotatedSecretUpdateMssql maxVersions(String maxVersions) {
  ...
  **/
  ...
  public RotatedSecretUpdateMssql name(String name) {
  ...
  **/
  ...
  public RotatedSecretUpdateMssql newName(String newName) {
  ...
  **/
  ...
  public RotatedSecretUpdateMssql passwordLength(String passwordLength) {
  ...
  **/
  ...
  public RotatedSecretUpdateMssql rmTag(List<String> rmTag) {
  ...
  **/
  ...
  public RotatedSecretUpdateMssql rotateAfterDisconnect(String rotateAfterDisconnect) {
  ...
  **/
  ...
  public RotatedSecretUpdateMssql rotatedPassword(String rotatedPassword) {
  ...
  **/
  ...
  public RotatedSecretUpdateMssql rotatedUsername(String rotatedUsername) {
  ...
  **/
  ...
  public RotatedSecretUpdateMssql rotationInterval(String rotationInterval) {
  ...
  **/
  ...
  public RotatedSecretUpdateMssql secureAccessBastionIssuer(String secureAccessBastionIssuer) {
  ...
  **/
  ...
  public RotatedSecretUpdateMssql secureAccessDbName(String secureAccessDbName) {
  ...
  **/
  ...
  public RotatedSecretUpdateMssql secureAccessDbSchema(String secureAccessDbSchema) {
  ...
  **/
  ...
  public RotatedSecretUpdateMssql secureAccessEnable(String secureAccessEnable) {
  ...
  **/
  ...
  public RotatedSecretUpdateMssql secureAccessHost(List<String> secureAccessHost) {
  ...
  **/
  ...
  public RotatedSecretUpdateMssql secureAccessWeb(Boolean secureAccessWeb) {
  ...
  **/
  ...
  public RotatedSecretUpdateMssql token(String token) {
  ...
  **/
  ...
  public RotatedSecretUpdateMssql uidToken(String uidToken) {
