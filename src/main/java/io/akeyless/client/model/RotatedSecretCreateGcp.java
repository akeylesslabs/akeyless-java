...
public class RotatedSecretCreateGcp {
  ...
  public RotatedSecretCreateGcp inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public RotatedSecretCreateGcp addInputRuleItem(String inputRuleItem) {
  ...
  public RotatedSecretCreateGcp itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public RotatedSecretCreateGcp putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public RotatedSecretCreateGcp outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public RotatedSecretCreateGcp addOutputRuleItem(String outputRuleItem) {
  ...
  public RotatedSecretCreateGcp useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public RotatedSecretCreateGcp useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public RotatedSecretCreateGcp useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public RotatedSecretCreateGcp useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authenticationCredentials, rotatedSecretCreateGcp.authenticationCredentials) &&
        ...
        Objects.equals(this.inputRule, rotatedSecretCreateGcp.inputRule) &&
        ...
        Objects.equals(this.outputRule, rotatedSecretCreateGcp.outputRule) &&
        ...
        Objects.equals(this.useCapitalLetters, rotatedSecretCreateGcp.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, rotatedSecretCreateGcp.useLowerLetters) &&
        Objects.equals(this.useNumbers, rotatedSecretCreateGcp.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, rotatedSecretCreateGcp.useSpecialCharacters);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RotatedSecretCreateGcp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RotatedSecretCreateGcp is not found in the empty JSON string", RotatedSecretCreateGcp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RotatedSecretCreateGcp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RotatedSecretCreateGcp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
