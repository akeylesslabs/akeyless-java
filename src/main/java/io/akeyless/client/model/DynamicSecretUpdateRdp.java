 ...
 */
@ApiModel(description = "dynamicSecretUpdateRdp is a command that updates rdp dynamic secret")
...
public class DynamicSecretUpdateRdp {
  ...
  public DynamicSecretUpdateRdp allowUserExtendSession(Long allowUserExtendSession) {
  ...
  **/
  ...
  public DynamicSecretUpdateRdp deleteProtection(String deleteProtection) {
  ...
  **/
  ...
  public DynamicSecretUpdateRdp description(String description) {
  ...
  **/
  ...
  public DynamicSecretUpdateRdp fixedUserOnly(String fixedUserOnly) {
  ...
  **/
  ...
  public DynamicSecretUpdateRdp json(Boolean json) {
  ...
  **/
  ...
  public DynamicSecretUpdateRdp name(String name) {
  ...
  **/
  ...
  public DynamicSecretUpdateRdp newName(String newName) {
  ...
  **/
  ...
  public DynamicSecretUpdateRdp passwordLength(String passwordLength) {
  ...
  **/
  ...
  public DynamicSecretUpdateRdp producerEncryptionKeyName(String producerEncryptionKeyName) {
  ...
  **/
  ...
  public DynamicSecretUpdateRdp rdpAdminName(String rdpAdminName) {
  ...
  **/
  ...
  public DynamicSecretUpdateRdp rdpAdminPwd(String rdpAdminPwd) {
  ...
  **/
  ...
  public DynamicSecretUpdateRdp rdpHostName(String rdpHostName) {
  ...
  **/
  ...
  public DynamicSecretUpdateRdp rdpHostPort(String rdpHostPort) {
  ...
  **/
  ...
  public DynamicSecretUpdateRdp rdpUserGroups(String rdpUserGroups) {
  ...
  **/
  ...
  public DynamicSecretUpdateRdp secureAccessAllowExternalUser(Boolean secureAccessAllowExternalUser) {
  ...
  **/
  ...
  public DynamicSecretUpdateRdp secureAccessEnable(String secureAccessEnable) {
  ...
  **/
  ...
  public DynamicSecretUpdateRdp secureAccessHost(List<String> secureAccessHost) {
  ...
  **/
  ...
  public DynamicSecretUpdateRdp secureAccessRdGatewayServer(String secureAccessRdGatewayServer) {
  ...
  **/
  ...
  public DynamicSecretUpdateRdp secureAccessRdpDomain(String secureAccessRdpDomain) {
  ...
  **/
  ...
  public DynamicSecretUpdateRdp secureAccessRdpUser(String secureAccessRdpUser) {
  ...
  **/
  ...
  public DynamicSecretUpdateRdp tags(List<String> tags) {
  ...
  **/
  ...
  public DynamicSecretUpdateRdp targetName(String targetName) {
  ...
  **/
  ...
  public DynamicSecretUpdateRdp token(String token) {
  ...
  **/
  ...
  public DynamicSecretUpdateRdp uidToken(String uidToken) {
  ...
  **/
  ...
  public DynamicSecretUpdateRdp userTtl(String userTtl) {
  ...
  **/
  ...
  public DynamicSecretUpdateRdp warnUserBeforeExpiration(Long warnUserBeforeExpiration) {
