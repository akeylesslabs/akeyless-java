...
public class DynamicSecretUpdateRdp {
  ...
  public DynamicSecretUpdateRdp inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public DynamicSecretUpdateRdp addInputRuleItem(String inputRuleItem) {
  ...
  public DynamicSecretUpdateRdp outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public DynamicSecretUpdateRdp addOutputRuleItem(String outputRuleItem) {
  ...
  public DynamicSecretUpdateRdp useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public DynamicSecretUpdateRdp useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public DynamicSecretUpdateRdp useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public DynamicSecretUpdateRdp useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allowUserExtendSession, dynamicSecretUpdateRdp.allowUserExtendSession) &&
        ...
        Objects.equals(this.inputRule, dynamicSecretUpdateRdp.inputRule) &&
        ...
        Objects.equals(this.outputRule, dynamicSecretUpdateRdp.outputRule) &&
        ...
        Objects.equals(this.useCapitalLetters, dynamicSecretUpdateRdp.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, dynamicSecretUpdateRdp.useLowerLetters) &&
        Objects.equals(this.useNumbers, dynamicSecretUpdateRdp.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, dynamicSecretUpdateRdp.useSpecialCharacters) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicSecretUpdateRdp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicSecretUpdateRdp is not found in the empty JSON string", DynamicSecretUpdateRdp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicSecretUpdateRdp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DynamicSecretUpdateRdp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
