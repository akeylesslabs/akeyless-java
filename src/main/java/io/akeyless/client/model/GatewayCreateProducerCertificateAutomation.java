...
public class GatewayCreateProducerCertificateAutomation {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(adminRotationIntervalDays, allowSubdomains, allowedDomains, autoGeneratedFolder, enableAdminRotation, gatewayUrl, name, producerEncryptionKeyName, rootFirstInChain, signUsingAkeylessPki, signerKeyName, storePrivateKey, token, uidToken, userTtl, venafiApiKey, venafiBaseurl, venafiPassword, venafiUseTpp, venafiUsername, venafiZone);
  }
