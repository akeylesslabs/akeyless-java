 ...
 */
@ApiModel(description = "CreateTargetItemAssocOutput defines output of CreateTargetItemAssoc operation.")
...
public class CreateTargetItemAssocOutput {
  ...
  public CreateTargetItemAssocOutput assocId(String assocId) {
