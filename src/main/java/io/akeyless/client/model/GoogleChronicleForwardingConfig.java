...
public class GoogleChronicleForwardingConfig {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("customer_id", "log_type", "region", "service_account_key"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GoogleChronicleForwardingConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GoogleChronicleForwardingConfig is not found in the empty JSON string", GoogleChronicleForwardingConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GoogleChronicleForwardingConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GoogleChronicleForwardingConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("service_account_key") != null && !jsonObj.get("service_account_key").isJsonNull()) && !jsonObj.get("service_account_key").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `service_account_key` to be a primitive type in the JSON string but got `%s`", jsonObj.get("service_account_key").toString()));
      }
  }
