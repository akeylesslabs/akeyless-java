...
public class TargetCreateGlobalSign {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("contact-email", "contact-first-name", "contact-last-name", "contact-phone", "delete_protection", "description", "json", "key", "max-versions", "name", "password", "profile-id", "timeout", "token", "uid-token", "username"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TargetCreateGlobalSign.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TargetCreateGlobalSign is not found in the empty JSON string", TargetCreateGlobalSign.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TargetCreateGlobalSign.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TargetCreateGlobalSign` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
