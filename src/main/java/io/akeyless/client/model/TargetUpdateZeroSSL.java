...
public class TargetUpdateZeroSSL {
  ...
  public TargetUpdateZeroSSL deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.apiKey, targetUpdateZeroSSL.apiKey) &&
        Objects.equals(this.deleteProtection, targetUpdateZeroSSL.deleteProtection) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(apiKey, deleteProtection, description, imapFqdn, imapPassword, imapPort, imapTargetEmail, imapUsername, json, keepPrevVersion, key, maxVersions, name, newName, timeout, token, uidToken);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("api-key", "delete_protection", "description", "imap-fqdn", "imap-password", "imap-port", "imap-target-email", "imap-username", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "timeout", "token", "uid-token"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TargetUpdateZeroSSL.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TargetUpdateZeroSSL is not found in the empty JSON string", TargetUpdateZeroSSL.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TargetUpdateZeroSSL.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TargetUpdateZeroSSL` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
