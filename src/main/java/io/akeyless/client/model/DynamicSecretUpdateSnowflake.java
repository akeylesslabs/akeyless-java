...
public class DynamicSecretUpdateSnowflake {
  ...
  public DynamicSecretUpdateSnowflake inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public DynamicSecretUpdateSnowflake addInputRuleItem(String inputRuleItem) {
  ...
  public DynamicSecretUpdateSnowflake outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public DynamicSecretUpdateSnowflake addOutputRuleItem(String outputRuleItem) {
  ...
  public DynamicSecretUpdateSnowflake useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public DynamicSecretUpdateSnowflake useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public DynamicSecretUpdateSnowflake useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public DynamicSecretUpdateSnowflake useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.account, dynamicSecretUpdateSnowflake.account) &&
        ...
        Objects.equals(this.inputRule, dynamicSecretUpdateSnowflake.inputRule) &&
        ...
        Objects.equals(this.outputRule, dynamicSecretUpdateSnowflake.outputRule) &&
        ...
        Objects.equals(this.useCapitalLetters, dynamicSecretUpdateSnowflake.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, dynamicSecretUpdateSnowflake.useLowerLetters) &&
        Objects.equals(this.useNumbers, dynamicSecretUpdateSnowflake.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, dynamicSecretUpdateSnowflake.useSpecialCharacters) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(account, accountPassword, accountUsername, authMode, customUsernameTemplate, dbName, deleteProtection, description, inputRule, itemCustomFields, json, keyAlgo, name, newName, outputRule, passwordLength, privateKey, privateKeyPassphrase, role, tags, targetName, token, uidToken, useCapitalLetters, useLowerLetters, useNumbers, useSpecialCharacters, userTtl, warehouse);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("account", "account-password", "account-username", "auth-mode", "custom-username-template", "db-name", "delete_protection", "description", "input-rule", "item-custom-fields", "json", "key-algo", "name", "new-name", "output-rule", "password-length", "private-key", "private-key-passphrase", "role", "tags", "target-name", "token", "uid-token", "use-capital-letters", "use-lower-letters", "use-numbers", "use-special-characters", "user-ttl", "warehouse"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicSecretUpdateSnowflake.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicSecretUpdateSnowflake is not found in the empty JSON string", DynamicSecretUpdateSnowflake.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicSecretUpdateSnowflake.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DynamicSecretUpdateSnowflake` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
