...
public class DynamicSecretUpdateSnowflake {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(account, accountPassword, accountUsername, authMode, customUsernameTemplate, dbName, deleteProtection, description, inputRule, itemCustomFields, json, keyAlgo, name, newName, outputRule, passwordLength, privateKey, privateKeyPassphrase, role, tags, targetName, token, uidToken, userTtl, warehouse);
  }
