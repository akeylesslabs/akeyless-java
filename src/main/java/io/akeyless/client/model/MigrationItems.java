...
public class MigrationItems {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("failed", "migrated", "skipped", "total", "updated"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MigrationItems.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MigrationItems is not found in the empty JSON string", MigrationItems.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MigrationItems.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `MigrationItems` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
