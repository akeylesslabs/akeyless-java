...
public class GwUpdateRemoteAccessSessionLogsLogzIo {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("enable", "json", "logz-io-token", "output-format", "protocol", "pull-interval", "token", "uid-token"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GwUpdateRemoteAccessSessionLogsLogzIo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GwUpdateRemoteAccessSessionLogsLogzIo is not found in the empty JSON string", GwUpdateRemoteAccessSessionLogsLogzIo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GwUpdateRemoteAccessSessionLogsLogzIo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GwUpdateRemoteAccessSessionLogsLogzIo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("logz-io-token") != null && !jsonObj.get("logz-io-token").isJsonNull()) && !jsonObj.get("logz-io-token").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `logz-io-token` to be a primitive type in the JSON string but got `%s`", jsonObj.get("logz-io-token").toString()));
      }
