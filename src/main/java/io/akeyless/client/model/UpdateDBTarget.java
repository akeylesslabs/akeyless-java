...
public class UpdateDBTarget {
  ...
  public UpdateDBTarget clientCertificate(@javax.annotation.Nullable String clientCertificate) {
  ...
  public UpdateDBTarget clientKeyPassphrase(@javax.annotation.Nullable String clientKeyPassphrase) {
  ...
  public UpdateDBTarget clientPrivateKey(@javax.annotation.Nullable String clientPrivateKey) {
  ...
  public UpdateDBTarget enableMtls(@javax.annotation.Nullable Boolean enableMtls) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.azureClientId, updateDBTarget.azureClientId) &&
        ...
        Objects.equals(this.clientCertificate, updateDBTarget.clientCertificate) &&
        Objects.equals(this.clientKeyPassphrase, updateDBTarget.clientKeyPassphrase) &&
        Objects.equals(this.clientPrivateKey, updateDBTarget.clientPrivateKey) &&
        ...
        Objects.equals(this.enableMtls, updateDBTarget.enableMtls) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateDBTarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateDBTarget is not found in the empty JSON string", UpdateDBTarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateDBTarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateDBTarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
