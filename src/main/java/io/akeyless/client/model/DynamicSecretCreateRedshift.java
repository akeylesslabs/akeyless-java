 ...
 */
@ApiModel(description = "dynamicSecretCreateRedshift is a command that creates redshift dynamic secret")
...
public class DynamicSecretCreateRedshift {
  ...
  public DynamicSecretCreateRedshift creationStatements(String creationStatements) {
  ...
  **/
  ...
  public DynamicSecretCreateRedshift deleteProtection(String deleteProtection) {
  ...
  **/
  ...
  public DynamicSecretCreateRedshift description(String description) {
  ...
  **/
  ...
  public DynamicSecretCreateRedshift json(Boolean json) {
  ...
  **/
  ...
  public DynamicSecretCreateRedshift name(String name) {
  ...
  **/
  ...
  public DynamicSecretCreateRedshift passwordLength(String passwordLength) {
  ...
  **/
  ...
  public DynamicSecretCreateRedshift producerEncryptionKey(String producerEncryptionKey) {
  ...
  **/
  ...
  public DynamicSecretCreateRedshift redshiftDbName(String redshiftDbName) {
  ...
  **/
  ...
  public DynamicSecretCreateRedshift redshiftHost(String redshiftHost) {
  ...
  **/
  ...
  public DynamicSecretCreateRedshift redshiftPassword(String redshiftPassword) {
  ...
  **/
  ...
  public DynamicSecretCreateRedshift redshiftPort(String redshiftPort) {
  ...
  **/
  ...
  public DynamicSecretCreateRedshift redshiftUsername(String redshiftUsername) {
  ...
  **/
  ...
  public DynamicSecretCreateRedshift secureAccessEnable(String secureAccessEnable) {
  ...
  **/
  ...
  public DynamicSecretCreateRedshift secureAccessHost(List<String> secureAccessHost) {
  ...
  **/
  ...
  public DynamicSecretCreateRedshift ssl(Boolean ssl) {
  ...
  **/
  ...
  public DynamicSecretCreateRedshift tags(List<String> tags) {
  ...
  **/
  ...
  public DynamicSecretCreateRedshift targetName(String targetName) {
  ...
  **/
  ...
  public DynamicSecretCreateRedshift token(String token) {
  ...
  **/
  ...
  public DynamicSecretCreateRedshift uidToken(String uidToken) {
  ...
  **/
  ...
  public DynamicSecretCreateRedshift userTtl(String userTtl) {
