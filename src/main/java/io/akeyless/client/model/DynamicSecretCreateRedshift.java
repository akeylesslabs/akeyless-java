...
public class DynamicSecretCreateRedshift {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(creationStatements, customUsernameTemplate, deleteProtection, description, itemCustomFields, json, name, passwordLength, producerEncryptionKey, redshiftDbName, redshiftHost, redshiftPassword, redshiftPort, redshiftUsername, secureAccessEnable, secureAccessHost, ssl, tags, targetName, token, uidToken, userTtl);
  }
