...
public class DynamicSecretCreateRedshift {
  ...
  public DynamicSecretCreateRedshift() {
  }

  public DynamicSecretCreateRedshift creationStatements(@javax.annotation.Nullable String creationStatements) {
  ...
  public DynamicSecretCreateRedshift customUsernameTemplate(@javax.annotation.Nullable String customUsernameTemplate) {
  ...
  public DynamicSecretCreateRedshift deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public DynamicSecretCreateRedshift description(@javax.annotation.Nullable String description) {
  ...
  public DynamicSecretCreateRedshift inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public DynamicSecretCreateRedshift addInputRuleItem(String inputRuleItem) {
  ...
  public DynamicSecretCreateRedshift itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public DynamicSecretCreateRedshift putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public DynamicSecretCreateRedshift json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public DynamicSecretCreateRedshift name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public DynamicSecretCreateRedshift outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public DynamicSecretCreateRedshift addOutputRuleItem(String outputRuleItem) {
  ...
  public DynamicSecretCreateRedshift passwordLength(@javax.annotation.Nullable String passwordLength) {
  ...
  public DynamicSecretCreateRedshift producerEncryptionKey(@javax.annotation.Nullable String producerEncryptionKey) {
  ...
  public DynamicSecretCreateRedshift redshiftDbName(@javax.annotation.Nullable String redshiftDbName) {
  ...
  public DynamicSecretCreateRedshift redshiftHost(@javax.annotation.Nullable String redshiftHost) {
  ...
  public DynamicSecretCreateRedshift redshiftPassword(@javax.annotation.Nullable String redshiftPassword) {
  ...
  public DynamicSecretCreateRedshift redshiftPort(@javax.annotation.Nullable String redshiftPort) {
  ...
  public DynamicSecretCreateRedshift redshiftUsername(@javax.annotation.Nullable String redshiftUsername) {
  ...
  public DynamicSecretCreateRedshift secureAccessEnable(@javax.annotation.Nullable String secureAccessEnable) {
  ...
  public DynamicSecretCreateRedshift secureAccessHost(@javax.annotation.Nullable List<String> secureAccessHost) {
    this.secureAccessHost = secureAccessHost;
    return this;
  }

  public DynamicSecretCreateRedshift addSecureAccessHostItem(String secureAccessHostItem) {
  ...
  public DynamicSecretCreateRedshift ssl(@javax.annotation.Nullable Boolean ssl) {
    this.ssl = ssl;
    return this;
  }
  ...
  public DynamicSecretCreateRedshift tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }

  public DynamicSecretCreateRedshift addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public DynamicSecretCreateRedshift targetName(@javax.annotation.Nullable String targetName) {
  ...
  public DynamicSecretCreateRedshift token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public DynamicSecretCreateRedshift uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public DynamicSecretCreateRedshift useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public DynamicSecretCreateRedshift useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public DynamicSecretCreateRedshift useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public DynamicSecretCreateRedshift useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public DynamicSecretCreateRedshift userTtl(@javax.annotation.Nullable String userTtl) {
  ...
  public boolean equals(Object o) {
    ...
    DynamicSecretCreateRedshift dynamicSecretCreateRedshift = (DynamicSecretCreateRedshift) o;
    return Objects.equals(this.creationStatements, dynamicSecretCreateRedshift.creationStatements) &&
        Objects.equals(this.customUsernameTemplate, dynamicSecretCreateRedshift.customUsernameTemplate) &&
        Objects.equals(this.deleteProtection, dynamicSecretCreateRedshift.deleteProtection) &&
        Objects.equals(this.description, dynamicSecretCreateRedshift.description) &&
        Objects.equals(this.inputRule, dynamicSecretCreateRedshift.inputRule) &&
        Objects.equals(this.itemCustomFields, dynamicSecretCreateRedshift.itemCustomFields) &&
        Objects.equals(this.json, dynamicSecretCreateRedshift.json) &&
        Objects.equals(this.name, dynamicSecretCreateRedshift.name) &&
        Objects.equals(this.outputRule, dynamicSecretCreateRedshift.outputRule) &&
        Objects.equals(this.passwordLength, dynamicSecretCreateRedshift.passwordLength) &&
        Objects.equals(this.producerEncryptionKey, dynamicSecretCreateRedshift.producerEncryptionKey) &&
        Objects.equals(this.redshiftDbName, dynamicSecretCreateRedshift.redshiftDbName) &&
        Objects.equals(this.redshiftHost, dynamicSecretCreateRedshift.redshiftHost) &&
        Objects.equals(this.redshiftPassword, dynamicSecretCreateRedshift.redshiftPassword) &&
        Objects.equals(this.redshiftPort, dynamicSecretCreateRedshift.redshiftPort) &&
        Objects.equals(this.redshiftUsername, dynamicSecretCreateRedshift.redshiftUsername) &&
        Objects.equals(this.secureAccessEnable, dynamicSecretCreateRedshift.secureAccessEnable) &&
        Objects.equals(this.secureAccessHost, dynamicSecretCreateRedshift.secureAccessHost) &&
        Objects.equals(this.ssl, dynamicSecretCreateRedshift.ssl) &&
        Objects.equals(this.tags, dynamicSecretCreateRedshift.tags) &&
        Objects.equals(this.targetName, dynamicSecretCreateRedshift.targetName) &&
        Objects.equals(this.token, dynamicSecretCreateRedshift.token) &&
        Objects.equals(this.uidToken, dynamicSecretCreateRedshift.uidToken) &&
        Objects.equals(this.useCapitalLetters, dynamicSecretCreateRedshift.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, dynamicSecretCreateRedshift.useLowerLetters) &&
        Objects.equals(this.useNumbers, dynamicSecretCreateRedshift.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, dynamicSecretCreateRedshift.useSpecialCharacters) &&
        Objects.equals(this.userTtl, dynamicSecretCreateRedshift.userTtl);
  }

  @Override
  public int hashCode() {
    return Objects.hash(creationStatements, customUsernameTemplate, deleteProtection, description, inputRule, itemCustomFields, json, name, outputRule, passwordLength, producerEncryptionKey, redshiftDbName, redshiftHost, redshiftPassword, redshiftPort, redshiftUsername, secureAccessEnable, secureAccessHost, ssl, tags, targetName, token, uidToken, useCapitalLetters, useLowerLetters, useNumbers, useSpecialCharacters, userTtl);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DynamicSecretCreateRedshift
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicSecretCreateRedshift.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicSecretCreateRedshift is not found in the empty JSON string", DynamicSecretCreateRedshift.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicSecretCreateRedshift.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DynamicSecretCreateRedshift` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DynamicSecretCreateRedshift.openapiRequiredFields) {
      ...
      if ((jsonObj.get("redshift-db-name") != null && !jsonObj.get("redshift-db-name").isJsonNull()) && !jsonObj.get("redshift-db-name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `redshift-db-name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("redshift-db-name").toString()));
      }
      if ((jsonObj.get("redshift-host") != null && !jsonObj.get("redshift-host").isJsonNull()) && !jsonObj.get("redshift-host").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `redshift-host` to be a primitive type in the JSON string but got `%s`", jsonObj.get("redshift-host").toString()));
      }
      if ((jsonObj.get("redshift-password") != null && !jsonObj.get("redshift-password").isJsonNull()) && !jsonObj.get("redshift-password").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `redshift-password` to be a primitive type in the JSON string but got `%s`", jsonObj.get("redshift-password").toString()));
      }
      if ((jsonObj.get("redshift-port") != null && !jsonObj.get("redshift-port").isJsonNull()) && !jsonObj.get("redshift-port").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `redshift-port` to be a primitive type in the JSON string but got `%s`", jsonObj.get("redshift-port").toString()));
      }
      if ((jsonObj.get("redshift-username") != null && !jsonObj.get("redshift-username").isJsonNull()) && !jsonObj.get("redshift-username").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `redshift-username` to be a primitive type in the JSON string but got `%s`", jsonObj.get("redshift-username").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DynamicSecretCreateRedshift.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DynamicSecretCreateRedshift' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DynamicSecretCreateRedshift> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DynamicSecretCreateRedshift.class));

       return (TypeAdapter<T>) new TypeAdapter<DynamicSecretCreateRedshift>() {
           @Override
           public void write(JsonWriter out, DynamicSecretCreateRedshift value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DynamicSecretCreateRedshift read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DynamicSecretCreateRedshift given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DynamicSecretCreateRedshift
   * @throws IOException if the JSON string is invalid with respect to DynamicSecretCreateRedshift
   */
  public static DynamicSecretCreateRedshift fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DynamicSecretCreateRedshift.class);
  }

  /**
   * Convert an instance of DynamicSecretCreateRedshift to an JSON string
   *
   * @return JSON string
   */
