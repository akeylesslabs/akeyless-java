...
public class TargetCreateSectigo {
  ...
  public TargetCreateSectigo deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.certificateProfileId, targetCreateSectigo.certificateProfileId) &&
        ...
        Objects.equals(this.deleteProtection, targetCreateSectigo.deleteProtection) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(certificateProfileId, customerUri, deleteProtection, description, externalRequester, json, key, maxVersions, name, organizationId, password, timeout, token, uidToken, username);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("certificate-profile-id", "customer-uri", "delete_protection", "description", "external-requester", "json", "key", "max-versions", "name", "organization-id", "password", "timeout", "token", "uid-token", "username"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TargetCreateSectigo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TargetCreateSectigo is not found in the empty JSON string", TargetCreateSectigo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TargetCreateSectigo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TargetCreateSectigo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
