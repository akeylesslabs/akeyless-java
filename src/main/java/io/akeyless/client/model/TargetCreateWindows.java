...
public class TargetCreateWindows {
  ...
  public TargetCreateWindows deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.certificate, targetCreateWindows.certificate) &&
        ...
        Objects.equals(this.deleteProtection, targetCreateWindows.deleteProtection) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(certificate, connectionType, deleteProtection, description, domain, hostname, json, key, maxVersions, name, parentTargetName, password, port, token, uidToken, useTls, username);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("certificate", "connection-type", "delete_protection", "description", "domain", "hostname", "json", "key", "max-versions", "name", "parent-target-name", "password", "port", "token", "uid-token", "use-tls", "username"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TargetCreateWindows.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TargetCreateWindows is not found in the empty JSON string", TargetCreateWindows.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TargetCreateWindows.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TargetCreateWindows` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
