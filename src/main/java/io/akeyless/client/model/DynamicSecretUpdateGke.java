...
public class DynamicSecretUpdateGke {
  ...
  public DynamicSecretUpdateGke inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public DynamicSecretUpdateGke addInputRuleItem(String inputRuleItem) {
  ...
  public DynamicSecretUpdateGke outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public DynamicSecretUpdateGke addOutputRuleItem(String outputRuleItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.deleteProtection, dynamicSecretUpdateGke.deleteProtection) &&
        ...
        Objects.equals(this.inputRule, dynamicSecretUpdateGke.inputRule) &&
        ...
        Objects.equals(this.outputRule, dynamicSecretUpdateGke.outputRule) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicSecretUpdateGke.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicSecretUpdateGke is not found in the empty JSON string", DynamicSecretUpdateGke.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicSecretUpdateGke.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DynamicSecretUpdateGke` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
