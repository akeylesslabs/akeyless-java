...
public class GatewayCreateAllowedAccess {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("SubClaimsCaseInsensitive", "access-id", "case-sensitive", "description", "json", "name", "permissions", "sub-claims", "token", "uid-token"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("access-id", "name"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GatewayCreateAllowedAccess.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GatewayCreateAllowedAccess is not found in the empty JSON string", GatewayCreateAllowedAccess.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GatewayCreateAllowedAccess.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GatewayCreateAllowedAccess` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("case-sensitive") != null && !jsonObj.get("case-sensitive").isJsonNull()) && !jsonObj.get("case-sensitive").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `case-sensitive` to be a primitive type in the JSON string but got `%s`", jsonObj.get("case-sensitive").toString()));
      }
