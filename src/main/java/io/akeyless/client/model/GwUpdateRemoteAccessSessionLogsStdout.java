...
public class GwUpdateRemoteAccessSessionLogsStdout {
  ...
  public GwUpdateRemoteAccessSessionLogsStdout enable(@javax.annotation.Nullable String enable) {
    this.enable = enable;
    return this;
  }
  ...
  public GwUpdateRemoteAccessSessionLogsStdout json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public GwUpdateRemoteAccessSessionLogsStdout outputFormat(@javax.annotation.Nullable String outputFormat) {
  ...
  public GwUpdateRemoteAccessSessionLogsStdout pullInterval(@javax.annotation.Nullable String pullInterval) {
  ...
  public GwUpdateRemoteAccessSessionLogsStdout token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public GwUpdateRemoteAccessSessionLogsStdout uidToken(@javax.annotation.Nullable String uidToken) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to GwUpdateRemoteAccessSessionLogsStdout
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GwUpdateRemoteAccessSessionLogsStdout.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GwUpdateRemoteAccessSessionLogsStdout is not found in the empty JSON string", GwUpdateRemoteAccessSessionLogsStdout.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GwUpdateRemoteAccessSessionLogsStdout.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GwUpdateRemoteAccessSessionLogsStdout` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GwUpdateRemoteAccessSessionLogsStdout.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GwUpdateRemoteAccessSessionLogsStdout' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GwUpdateRemoteAccessSessionLogsStdout> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GwUpdateRemoteAccessSessionLogsStdout.class));

       return (TypeAdapter<T>) new TypeAdapter<GwUpdateRemoteAccessSessionLogsStdout>() {
           @Override
           public void write(JsonWriter out, GwUpdateRemoteAccessSessionLogsStdout value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GwUpdateRemoteAccessSessionLogsStdout read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GwUpdateRemoteAccessSessionLogsStdout given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GwUpdateRemoteAccessSessionLogsStdout
   * @throws IOException if the JSON string is invalid with respect to GwUpdateRemoteAccessSessionLogsStdout
   */
  public static GwUpdateRemoteAccessSessionLogsStdout fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GwUpdateRemoteAccessSessionLogsStdout.class);
  }

  /**
   * Convert an instance of GwUpdateRemoteAccessSessionLogsStdout to an JSON string
   *
   * @return JSON string
   */
