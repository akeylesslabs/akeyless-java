...
public class RotatedSecretCreateHanadb {
  ...
  public RotatedSecretCreateHanadb authenticationCredentials(@javax.annotation.Nullable String authenticationCredentials) {
  ...
  public RotatedSecretCreateHanadb autoRotate(@javax.annotation.Nullable String autoRotate) {
  ...
  public RotatedSecretCreateHanadb deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public RotatedSecretCreateHanadb description(@javax.annotation.Nullable String description) {
  ...
  public RotatedSecretCreateHanadb inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public RotatedSecretCreateHanadb addInputRuleItem(String inputRuleItem) {
  ...
  public RotatedSecretCreateHanadb itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public RotatedSecretCreateHanadb putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public RotatedSecretCreateHanadb json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public RotatedSecretCreateHanadb key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public RotatedSecretCreateHanadb maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public RotatedSecretCreateHanadb name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public RotatedSecretCreateHanadb outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public RotatedSecretCreateHanadb addOutputRuleItem(String outputRuleItem) {
  ...
  public RotatedSecretCreateHanadb passwordLength(@javax.annotation.Nullable String passwordLength) {
  ...
  public RotatedSecretCreateHanadb rotatedPassword(@javax.annotation.Nullable String rotatedPassword) {
  ...
  public RotatedSecretCreateHanadb rotatedUsername(@javax.annotation.Nullable String rotatedUsername) {
  ...
  public RotatedSecretCreateHanadb rotationEventIn(@javax.annotation.Nullable List<String> rotationEventIn) {
    this.rotationEventIn = rotationEventIn;
    return this;
  }

  public RotatedSecretCreateHanadb addRotationEventInItem(String rotationEventInItem) {
  ...
  public RotatedSecretCreateHanadb rotationHour(@javax.annotation.Nullable Integer rotationHour) {
  ...
  public RotatedSecretCreateHanadb rotationInterval(@javax.annotation.Nullable String rotationInterval) {
  ...
  public RotatedSecretCreateHanadb rotatorType(@javax.annotation.Nonnull String rotatorType) {
  ...
  public RotatedSecretCreateHanadb tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public RotatedSecretCreateHanadb targetName(@javax.annotation.Nonnull String targetName) {
  ...
  public RotatedSecretCreateHanadb token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public RotatedSecretCreateHanadb uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public RotatedSecretCreateHanadb useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public RotatedSecretCreateHanadb useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public RotatedSecretCreateHanadb useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public RotatedSecretCreateHanadb useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authenticationCredentials, rotatedSecretCreateHanadb.authenticationCredentials) &&
        ...
        Objects.equals(this.inputRule, rotatedSecretCreateHanadb.inputRule) &&
        Objects.equals(this.itemCustomFields, rotatedSecretCreateHanadb.itemCustomFields) &&
        Objects.equals(this.json, rotatedSecretCreateHanadb.json) &&
        Objects.equals(this.key, rotatedSecretCreateHanadb.key) &&
        Objects.equals(this.maxVersions, rotatedSecretCreateHanadb.maxVersions) &&
        Objects.equals(this.name, rotatedSecretCreateHanadb.name) &&
        Objects.equals(this.outputRule, rotatedSecretCreateHanadb.outputRule) &&
        ...
        Objects.equals(this.rotationEventIn, rotatedSecretCreateHanadb.rotationEventIn) &&
        ...
        Objects.equals(this.useCapitalLetters, rotatedSecretCreateHanadb.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, rotatedSecretCreateHanadb.useLowerLetters) &&
        Objects.equals(this.useNumbers, rotatedSecretCreateHanadb.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, rotatedSecretCreateHanadb.useSpecialCharacters);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RotatedSecretCreateHanadb
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RotatedSecretCreateHanadb.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RotatedSecretCreateHanadb is not found in the empty JSON string", RotatedSecretCreateHanadb.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RotatedSecretCreateHanadb.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RotatedSecretCreateHanadb` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RotatedSecretCreateHanadb.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RotatedSecretCreateHanadb.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RotatedSecretCreateHanadb' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RotatedSecretCreateHanadb> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RotatedSecretCreateHanadb.class));

       return (TypeAdapter<T>) new TypeAdapter<RotatedSecretCreateHanadb>() {
           @Override
           public void write(JsonWriter out, RotatedSecretCreateHanadb value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RotatedSecretCreateHanadb read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RotatedSecretCreateHanadb given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RotatedSecretCreateHanadb
   * @throws IOException if the JSON string is invalid with respect to RotatedSecretCreateHanadb
   */
  public static RotatedSecretCreateHanadb fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RotatedSecretCreateHanadb.class);
  }

  /**
   * Convert an instance of RotatedSecretCreateHanadb to an JSON string
   *
   * @return JSON string
   */
