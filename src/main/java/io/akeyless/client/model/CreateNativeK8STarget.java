...
public class CreateNativeK8STarget {
  ...
  public CreateNativeK8STarget comment(@javax.annotation.Nullable String comment) {
  ...
  public CreateNativeK8STarget description(@javax.annotation.Nullable String description) {
  ...
  public CreateNativeK8STarget json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public CreateNativeK8STarget k8sAuthType(@javax.annotation.Nullable String k8sAuthType) {
  ...
  public CreateNativeK8STarget k8sClientCertificate(@javax.annotation.Nullable String k8sClientCertificate) {
  ...
  public CreateNativeK8STarget k8sClientKey(@javax.annotation.Nullable String k8sClientKey) {
  ...
  public CreateNativeK8STarget k8sClusterCaCert(@javax.annotation.Nullable String k8sClusterCaCert) {
  ...
  public CreateNativeK8STarget k8sClusterEndpoint(@javax.annotation.Nullable String k8sClusterEndpoint) {
  ...
  public CreateNativeK8STarget k8sClusterName(@javax.annotation.Nullable String k8sClusterName) {
  ...
  public CreateNativeK8STarget k8sClusterToken(@javax.annotation.Nullable String k8sClusterToken) {
  ...
  public CreateNativeK8STarget key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public CreateNativeK8STarget maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public CreateNativeK8STarget name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateNativeK8STarget token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public CreateNativeK8STarget uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public CreateNativeK8STarget useGwServiceAccount(@javax.annotation.Nullable Boolean useGwServiceAccount) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("comment", "description", "json", "k8s-auth-type", "k8s-client-certificate", "k8s-client-key", "k8s-cluster-ca-cert", "k8s-cluster-endpoint", "k8s-cluster-name", "k8s-cluster-token", "key", "max-versions", "name", "token", "uid-token", "use-gw-service-account"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateNativeK8STarget
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateNativeK8STarget.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateNativeK8STarget is not found in the empty JSON string", CreateNativeK8STarget.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateNativeK8STarget.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateNativeK8STarget` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateNativeK8STarget.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateNativeK8STarget.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateNativeK8STarget' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateNativeK8STarget> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateNativeK8STarget.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateNativeK8STarget>() {
           @Override
           public void write(JsonWriter out, CreateNativeK8STarget value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateNativeK8STarget read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateNativeK8STarget given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateNativeK8STarget
   * @throws IOException if the JSON string is invalid with respect to CreateNativeK8STarget
   */
  public static CreateNativeK8STarget fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateNativeK8STarget.class);
  }

  /**
   * Convert an instance of CreateNativeK8STarget to an JSON string
   *
   * @return JSON string
   */
