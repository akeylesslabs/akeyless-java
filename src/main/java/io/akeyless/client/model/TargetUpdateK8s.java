...
public class TargetUpdateK8s {
  ...
  public TargetUpdateK8s deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public TargetUpdateK8s description(@javax.annotation.Nullable String description) {
  ...
  public TargetUpdateK8s json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public TargetUpdateK8s k8sAuthType(@javax.annotation.Nullable String k8sAuthType) {
  ...
  public TargetUpdateK8s k8sClientCertificate(@javax.annotation.Nullable String k8sClientCertificate) {
  ...
  public TargetUpdateK8s k8sClientKey(@javax.annotation.Nullable String k8sClientKey) {
  ...
  public TargetUpdateK8s k8sClusterCaCert(@javax.annotation.Nullable String k8sClusterCaCert) {
  ...
  public TargetUpdateK8s k8sClusterEndpoint(@javax.annotation.Nullable String k8sClusterEndpoint) {
  ...
  public TargetUpdateK8s k8sClusterName(@javax.annotation.Nullable String k8sClusterName) {
  ...
  public TargetUpdateK8s k8sClusterToken(@javax.annotation.Nullable String k8sClusterToken) {
  ...
  public TargetUpdateK8s keepPrevVersion(@javax.annotation.Nullable String keepPrevVersion) {
  ...
  public TargetUpdateK8s key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public TargetUpdateK8s maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public TargetUpdateK8s name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public TargetUpdateK8s newName(@javax.annotation.Nullable String newName) {
  ...
  public TargetUpdateK8s token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public TargetUpdateK8s uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public TargetUpdateK8s useGwServiceAccount(@javax.annotation.Nullable Boolean useGwServiceAccount) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.deleteProtection, targetUpdateK8s.deleteProtection) &&
        Objects.equals(this.description, targetUpdateK8s.description) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(deleteProtection, description, json, k8sAuthType, k8sClientCertificate, k8sClientKey, k8sClusterCaCert, k8sClusterEndpoint, k8sClusterName, k8sClusterToken, keepPrevVersion, key, maxVersions, name, newName, token, uidToken, useGwServiceAccount);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("delete_protection", "description", "json", "k8s-auth-type", "k8s-client-certificate", "k8s-client-key", "k8s-cluster-ca-cert", "k8s-cluster-endpoint", "k8s-cluster-name", "k8s-cluster-token", "keep-prev-version", "key", "max-versions", "name", "new-name", "token", "uid-token", "use-gw-service-account"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to TargetUpdateK8s
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TargetUpdateK8s.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TargetUpdateK8s is not found in the empty JSON string", TargetUpdateK8s.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TargetUpdateK8s.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TargetUpdateK8s` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TargetUpdateK8s.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TargetUpdateK8s.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TargetUpdateK8s' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TargetUpdateK8s> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TargetUpdateK8s.class));

       return (TypeAdapter<T>) new TypeAdapter<TargetUpdateK8s>() {
           @Override
           public void write(JsonWriter out, TargetUpdateK8s value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TargetUpdateK8s read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TargetUpdateK8s given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TargetUpdateK8s
   * @throws IOException if the JSON string is invalid with respect to TargetUpdateK8s
   */
  public static TargetUpdateK8s fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TargetUpdateK8s.class);
  }

  /**
   * Convert an instance of TargetUpdateK8s to an JSON string
   *
   * @return JSON string
   */
