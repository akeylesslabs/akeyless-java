...
public class DeleteRoleRule {
  ...
  public DeleteRoleRule json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public DeleteRoleRule path(@javax.annotation.Nonnull String path) {
    this.path = path;
    return this;
  }
  ...
  public DeleteRoleRule roleName(@javax.annotation.Nonnull String roleName) {
  ...
  public DeleteRoleRule ruleType(@javax.annotation.Nullable String ruleType) {
  ...
  public DeleteRoleRule token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public DeleteRoleRule uidToken(@javax.annotation.Nullable String uidToken) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteRoleRule
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteRoleRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteRoleRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteRoleRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteRoleRule.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteRoleRule>() {
           @Override
           public void write(JsonWriter out, DeleteRoleRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteRoleRule read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteRoleRule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteRoleRule
   * @throws IOException if the JSON string is invalid with respect to DeleteRoleRule
   */
  public static DeleteRoleRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteRoleRule.class);
  }

  /**
   * Convert an instance of DeleteRoleRule to an JSON string
   *
   * @return JSON string
   */
