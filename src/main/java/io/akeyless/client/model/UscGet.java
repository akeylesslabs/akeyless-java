...
public class UscGet {
  ...
  public UscGet objectType(@javax.annotation.Nullable String objectType) {
  ...
  public UscGet selectedRepositories(@javax.annotation.Nullable String selectedRepositories) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.json, uscGet.json) &&
        ...
        Objects.equals(this.objectType, uscGet.objectType) &&
        Objects.equals(this.secretId, uscGet.secretId) &&
        Objects.equals(this.selectedRepositories, uscGet.selectedRepositories) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(json, namespace, objectType, secretId, selectedRepositories, token, uidToken, uscName, versionId);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("json", "namespace", "object-type", "secret-id", "selected-repositories", "token", "uid-token", "usc-name", "version-id"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("secret-id", "usc-name"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UscGet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UscGet is not found in the empty JSON string", UscGet.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UscGet.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UscGet` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("selected-repositories") != null && !jsonObj.get("selected-repositories").isJsonNull()) && !jsonObj.get("selected-repositories").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `selected-repositories` to be a primitive type in the JSON string but got `%s`", jsonObj.get("selected-repositories").toString()));
      }
      ...
      if ((jsonObj.get("version-id") != null && !jsonObj.get("version-id").isJsonNull()) && !jsonObj.get("version-id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `version-id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("version-id").toString()));
      }
  }
