...
public class GatewayUpdateLogForwardingAwsS3 {
  ...
  public GatewayUpdateLogForwardingAwsS3 accessId(@javax.annotation.Nullable String accessId) {
  ...
  public GatewayUpdateLogForwardingAwsS3 accessKey(@javax.annotation.Nullable String accessKey) {
  ...
  public GatewayUpdateLogForwardingAwsS3 authType(@javax.annotation.Nullable String authType) {
  ...
  public GatewayUpdateLogForwardingAwsS3 bucketName(@javax.annotation.Nullable String bucketName) {
  ...
  public GatewayUpdateLogForwardingAwsS3 enable(@javax.annotation.Nullable String enable) {
    this.enable = enable;
    return this;
  }
  ...
  public GatewayUpdateLogForwardingAwsS3 json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public GatewayUpdateLogForwardingAwsS3 logFolder(@javax.annotation.Nullable String logFolder) {
  ...
  public GatewayUpdateLogForwardingAwsS3 outputFormat(@javax.annotation.Nullable String outputFormat) {
  ...
  public GatewayUpdateLogForwardingAwsS3 pullInterval(@javax.annotation.Nullable String pullInterval) {
  ...
  public GatewayUpdateLogForwardingAwsS3 region(@javax.annotation.Nullable String region) {
    this.region = region;
    return this;
  }
  ...
  public GatewayUpdateLogForwardingAwsS3 roleArn(@javax.annotation.Nullable String roleArn) {
  ...
  public GatewayUpdateLogForwardingAwsS3 token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public GatewayUpdateLogForwardingAwsS3 uidToken(@javax.annotation.Nullable String uidToken) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to GatewayUpdateLogForwardingAwsS3
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GatewayUpdateLogForwardingAwsS3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GatewayUpdateLogForwardingAwsS3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GatewayUpdateLogForwardingAwsS3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GatewayUpdateLogForwardingAwsS3.class));

       return (TypeAdapter<T>) new TypeAdapter<GatewayUpdateLogForwardingAwsS3>() {
           @Override
           public void write(JsonWriter out, GatewayUpdateLogForwardingAwsS3 value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GatewayUpdateLogForwardingAwsS3 read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GatewayUpdateLogForwardingAwsS3 given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GatewayUpdateLogForwardingAwsS3
   * @throws IOException if the JSON string is invalid with respect to GatewayUpdateLogForwardingAwsS3
   */
  public static GatewayUpdateLogForwardingAwsS3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GatewayUpdateLogForwardingAwsS3.class);
  }

  /**
   * Convert an instance of GatewayUpdateLogForwardingAwsS3 to an JSON string
   *
   * @return JSON string
   */
