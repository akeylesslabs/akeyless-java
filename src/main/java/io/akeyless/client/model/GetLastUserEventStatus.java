...
public class GetLastUserEventStatus {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("event-source", "event-type", "item-name", "item-type", "json", "time-back", "token", "uid-token"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetLastUserEventStatus.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetLastUserEventStatus is not found in the empty JSON string", GetLastUserEventStatus.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetLastUserEventStatus.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetLastUserEventStatus` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("time-back") != null && !jsonObj.get("time-back").isJsonNull()) && !jsonObj.get("time-back").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `time-back` to be a primitive type in the JSON string but got `%s`", jsonObj.get("time-back").toString()));
      }
