...
public class GatewayUpdateAllowedAccess {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("SubClaimsCaseInsensitive", "access-id", "case-sensitive", "description", "json", "name", "new-name", "permissions", "sub-claims", "token", "uid-token"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GatewayUpdateAllowedAccess.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GatewayUpdateAllowedAccess is not found in the empty JSON string", GatewayUpdateAllowedAccess.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GatewayUpdateAllowedAccess.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GatewayUpdateAllowedAccess` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
