...
public class DynamicSecretUpdateMySql {
  ...
  public DynamicSecretUpdateMySql customUsernameTemplate(@javax.annotation.Nullable String customUsernameTemplate) {
  ...
  public DynamicSecretUpdateMySql inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public DynamicSecretUpdateMySql addInputRuleItem(String inputRuleItem) {
  ...
  public DynamicSecretUpdateMySql itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public DynamicSecretUpdateMySql putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public DynamicSecretUpdateMySql outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public DynamicSecretUpdateMySql addOutputRuleItem(String outputRuleItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.customUsernameTemplate, dynamicSecretUpdateMySql.customUsernameTemplate) &&
        Objects.equals(this.dbServerCertificates, dynamicSecretUpdateMySql.dbServerCertificates) &&
        ...
        Objects.equals(this.inputRule, dynamicSecretUpdateMySql.inputRule) &&
        Objects.equals(this.itemCustomFields, dynamicSecretUpdateMySql.itemCustomFields) &&
        ...
        Objects.equals(this.outputRule, dynamicSecretUpdateMySql.outputRule) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicSecretUpdateMySql.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicSecretUpdateMySql is not found in the empty JSON string", DynamicSecretUpdateMySql.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicSecretUpdateMySql.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DynamicSecretUpdateMySql` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
