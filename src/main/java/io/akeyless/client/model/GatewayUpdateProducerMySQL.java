...
public class GatewayUpdateProducerMySQL {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(customUsernameTemplate, dbServerCertificates, dbServerName, deleteProtection, itemCustomFields, json, mysqlDbname, mysqlHost, mysqlPassword, mysqlPort, mysqlRevocationStatements, mysqlScreationStatements, mysqlUsername, name, newName, passwordLength, producerEncryptionKeyName, secureAccessBastionIssuer, secureAccessCertificateIssuer, secureAccessDbName, secureAccessDelay, secureAccessEnable, secureAccessHost, secureAccessWeb, ssl, sslCertificate, tags, targetName, token, uidToken, userTtl);
  }
