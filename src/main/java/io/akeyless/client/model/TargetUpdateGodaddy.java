...
public class TargetUpdateGodaddy {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(apiKey, description, imapFqdn, imapPassword, imapPort, imapUsername, json, keepPrevVersion, key, maxVersions, name, newName, secret, timeout, token, uidToken);
  }
