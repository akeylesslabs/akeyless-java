...
public class DynamicSecretCreateLdap {
  ...
  public DynamicSecretCreateLdap customUsernameTemplate(@javax.annotation.Nullable String customUsernameTemplate) {
  ...
  public DynamicSecretCreateLdap inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public DynamicSecretCreateLdap addInputRuleItem(String inputRuleItem) {
  ...
  public DynamicSecretCreateLdap itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public DynamicSecretCreateLdap putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public DynamicSecretCreateLdap outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public DynamicSecretCreateLdap addOutputRuleItem(String outputRuleItem) {
  ...
  public DynamicSecretCreateLdap secureAccessBastionIssuer(@javax.annotation.Nullable String secureAccessBastionIssuer) {
  ...
  public DynamicSecretCreateLdap secureAccessCertificateIssuer(@javax.annotation.Nullable String secureAccessCertificateIssuer) {
  ...
  public DynamicSecretCreateLdap useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public DynamicSecretCreateLdap useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public DynamicSecretCreateLdap useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public DynamicSecretCreateLdap useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.providerType, dynamicSecretCreateLdap.providerType) &&
        ...
        Objects.equals(this.customUsernameTemplate, dynamicSecretCreateLdap.customUsernameTemplate) &&
        ...
        Objects.equals(this.inputRule, dynamicSecretCreateLdap.inputRule) &&
        Objects.equals(this.itemCustomFields, dynamicSecretCreateLdap.itemCustomFields) &&
        ...
        Objects.equals(this.outputRule, dynamicSecretCreateLdap.outputRule) &&
        ...
        Objects.equals(this.secureAccessBastionIssuer, dynamicSecretCreateLdap.secureAccessBastionIssuer) &&
        Objects.equals(this.secureAccessCertificateIssuer, dynamicSecretCreateLdap.secureAccessCertificateIssuer) &&
        ...
        Objects.equals(this.useCapitalLetters, dynamicSecretCreateLdap.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, dynamicSecretCreateLdap.useLowerLetters) &&
        Objects.equals(this.useNumbers, dynamicSecretCreateLdap.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, dynamicSecretCreateLdap.useSpecialCharacters) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(providerType, bindDn, bindDnPassword, customUsernameTemplate, deleteProtection, description, externalUsername, fixedUserClaimKeyname, groupDn, hostProvider, inputRule, itemCustomFields, json, ldapCaCert, ldapUrl, name, outputRule, passwordLength, producerEncryptionKeyName, secureAccessBastionIssuer, secureAccessCertificateIssuer, secureAccessDelay, secureAccessEnable, secureAccessHost, secureAccessRdGatewayServer, secureAccessRdpDomain, tags, target, targetName, token, tokenExpiration, uidToken, useCapitalLetters, useLowerLetters, useNumbers, useSpecialCharacters, userAttribute, userDn, userTtl);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("ProviderType", "bind-dn", "bind-dn-password", "custom-username-template", "delete_protection", "description", "external-username", "fixed-user-claim-keyname", "group-dn", "host-provider", "input-rule", "item-custom-fields", "json", "ldap-ca-cert", "ldap-url", "name", "output-rule", "password-length", "producer-encryption-key-name", "secure-access-bastion-issuer", "secure-access-certificate-issuer", "secure-access-delay", "secure-access-enable", "secure-access-host", "secure-access-rd-gateway-server", "secure-access-rdp-domain", "tags", "target", "target-name", "token", "token-expiration", "uid-token", "use-capital-letters", "use-lower-letters", "use-numbers", "use-special-characters", "user-attribute", "user-dn", "user-ttl"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicSecretCreateLdap.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicSecretCreateLdap is not found in the empty JSON string", DynamicSecretCreateLdap.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicSecretCreateLdap.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DynamicSecretCreateLdap` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("external-username") != null && !jsonObj.get("external-username").isJsonNull()) && !jsonObj.get("external-username").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `external-username` to be a primitive type in the JSON string but got `%s`", jsonObj.get("external-username").toString()));
      }
      ...
      if ((jsonObj.get("group-dn") != null && !jsonObj.get("group-dn").isJsonNull()) && !jsonObj.get("group-dn").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `group-dn` to be a primitive type in the JSON string but got `%s`", jsonObj.get("group-dn").toString()));
      }
