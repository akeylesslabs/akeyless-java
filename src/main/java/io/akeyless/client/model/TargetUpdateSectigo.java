...
public class TargetUpdateSectigo {
  ...
  public TargetUpdateSectigo deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.certificateProfileId, targetUpdateSectigo.certificateProfileId) &&
        ...
        Objects.equals(this.deleteProtection, targetUpdateSectigo.deleteProtection) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(certificateProfileId, customerUri, deleteProtection, description, externalRequester, json, keepPrevVersion, key, maxVersions, name, newName, organizationId, password, timeout, token, uidToken, username);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("certificate-profile-id", "customer-uri", "delete_protection", "description", "external-requester", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "organization-id", "password", "timeout", "token", "uid-token", "username"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("certificate-profile-id", "customer-uri", "external-requester", "name", "organization-id", "password", "username"));
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TargetUpdateSectigo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TargetUpdateSectigo is not found in the empty JSON string", TargetUpdateSectigo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TargetUpdateSectigo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TargetUpdateSectigo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("customer-uri").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `customer-uri` to be a primitive type in the JSON string but got `%s`", jsonObj.get("customer-uri").toString()));
      }
      ...
      if (!jsonObj.get("external-requester").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `external-requester` to be a primitive type in the JSON string but got `%s`", jsonObj.get("external-requester").toString()));
      }
