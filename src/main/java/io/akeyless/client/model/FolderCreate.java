...
public class FolderCreate {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("accessibility", "delete_protection", "description", "json", "name", "tags", "token", "type", "uid-token"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FolderCreate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in FolderCreate is not found in the empty JSON string", FolderCreate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!FolderCreate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `FolderCreate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
