...
public class CreateRole {
  ...
  public CreateRole araReportsAccess(@javax.annotation.Nullable String araReportsAccess) {
  ...
  public CreateRole isiAccess(@javax.annotation.Nullable String isiAccess) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.analyticsAccess, createRole.analyticsAccess) &&
        Objects.equals(this.araReportsAccess, createRole.araReportsAccess) &&
        ...
        Objects.equals(this.isiAccess, createRole.isiAccess) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(analyticsAccess, araReportsAccess, auditAccess, comment, deleteProtection, description, eventCenterAccess, eventForwardersAccess, eventForwardersName, gwAnalyticsAccess, isiAccess, json, name, reverseRbacAccess, sraReportsAccess, token, uidToken, usageReportsAccess);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("analytics-access", "ara-reports-access", "audit-access", "comment", "delete_protection", "description", "event-center-access", "event-forwarders-access", "event-forwarders-name", "gw-analytics-access", "isi-access", "json", "name", "reverse-rbac-access", "sra-reports-access", "token", "uid-token", "usage-reports-access"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateRole.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateRole is not found in the empty JSON string", CreateRole.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateRole.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateRole` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("event-forwarders-access") != null && !jsonObj.get("event-forwarders-access").isJsonNull()) && !jsonObj.get("event-forwarders-access").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `event-forwarders-access` to be a primitive type in the JSON string but got `%s`", jsonObj.get("event-forwarders-access").toString()));
      }
      ...
      if (jsonObj.get("event-forwarders-name") != null && !jsonObj.get("event-forwarders-name").isJsonNull() && !jsonObj.get("event-forwarders-name").isJsonArray()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `event-forwarders-name` to be an array in the JSON string but got `%s`", jsonObj.get("event-forwarders-name").toString()));
      }
