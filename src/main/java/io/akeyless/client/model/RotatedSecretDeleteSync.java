...
public class RotatedSecretDeleteSync {
  ...
  public RotatedSecretDeleteSync() {
  }

  public RotatedSecretDeleteSync deleteFromUsc(@javax.annotation.Nullable Boolean deleteFromUsc) {
  ...
  public RotatedSecretDeleteSync json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public RotatedSecretDeleteSync name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public RotatedSecretDeleteSync token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public RotatedSecretDeleteSync uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public RotatedSecretDeleteSync uscName(@javax.annotation.Nonnull String uscName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.deleteFromUsc, rotatedSecretDeleteSync.deleteFromUsc) &&
        Objects.equals(this.json, rotatedSecretDeleteSync.json) &&
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("delete-from-usc", "json", "name", "remote-secret-name", "token", "uid-token", "usc-name"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to RotatedSecretDeleteSync
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RotatedSecretDeleteSync.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in RotatedSecretDeleteSync is not found in the empty JSON string", RotatedSecretDeleteSync.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RotatedSecretDeleteSync.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `RotatedSecretDeleteSync` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RotatedSecretDeleteSync.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RotatedSecretDeleteSync.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RotatedSecretDeleteSync' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RotatedSecretDeleteSync> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RotatedSecretDeleteSync.class));

       return (TypeAdapter<T>) new TypeAdapter<RotatedSecretDeleteSync>() {
           @Override
           public void write(JsonWriter out, RotatedSecretDeleteSync value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RotatedSecretDeleteSync read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of RotatedSecretDeleteSync given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of RotatedSecretDeleteSync
   * @throws IOException if the JSON string is invalid with respect to RotatedSecretDeleteSync
   */
  public static RotatedSecretDeleteSync fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RotatedSecretDeleteSync.class);
  }

  /**
   * Convert an instance of RotatedSecretDeleteSync to an JSON string
   *
   * @return JSON string
   */
