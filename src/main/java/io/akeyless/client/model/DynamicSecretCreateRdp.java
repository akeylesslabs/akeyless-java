...
public class DynamicSecretCreateRdp {
  ...
  public DynamicSecretCreateRdp customUsernameTemplate(@javax.annotation.Nullable String customUsernameTemplate) {
  ...
  public DynamicSecretCreateRdp inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public DynamicSecretCreateRdp addInputRuleItem(String inputRuleItem) {
  ...
  public DynamicSecretCreateRdp outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public DynamicSecretCreateRdp addOutputRuleItem(String outputRuleItem) {
  ...
  public DynamicSecretCreateRdp secureAccessBastionIssuer(@javax.annotation.Nullable String secureAccessBastionIssuer) {
  ...
  public DynamicSecretCreateRdp secureAccessCertificateIssuer(@javax.annotation.Nullable String secureAccessCertificateIssuer) {
  ...
  public DynamicSecretCreateRdp useCapitalLetters(@javax.annotation.Nullable String useCapitalLetters) {
  ...
  public DynamicSecretCreateRdp useLowerLetters(@javax.annotation.Nullable String useLowerLetters) {
  ...
  public DynamicSecretCreateRdp useNumbers(@javax.annotation.Nullable String useNumbers) {
  ...
  public DynamicSecretCreateRdp useSpecialCharacters(@javax.annotation.Nullable String useSpecialCharacters) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.allowUserExtendSession, dynamicSecretCreateRdp.allowUserExtendSession) &&
        Objects.equals(this.customUsernameTemplate, dynamicSecretCreateRdp.customUsernameTemplate) &&
        ...
        Objects.equals(this.inputRule, dynamicSecretCreateRdp.inputRule) &&
        ...
        Objects.equals(this.outputRule, dynamicSecretCreateRdp.outputRule) &&
        ...
        Objects.equals(this.secureAccessBastionIssuer, dynamicSecretCreateRdp.secureAccessBastionIssuer) &&
        Objects.equals(this.secureAccessCertificateIssuer, dynamicSecretCreateRdp.secureAccessCertificateIssuer) &&
        ...
        Objects.equals(this.useCapitalLetters, dynamicSecretCreateRdp.useCapitalLetters) &&
        Objects.equals(this.useLowerLetters, dynamicSecretCreateRdp.useLowerLetters) &&
        Objects.equals(this.useNumbers, dynamicSecretCreateRdp.useNumbers) &&
        Objects.equals(this.useSpecialCharacters, dynamicSecretCreateRdp.useSpecialCharacters) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowUserExtendSession, customUsernameTemplate, deleteProtection, description, fixedUserClaimKeyname, fixedUserOnly, inputRule, itemCustomFields, json, name, outputRule, passwordLength, producerEncryptionKeyName, rdpAdminName, rdpAdminPwd, rdpHostName, rdpHostPort, rdpUserGroups, secureAccessAllowExternalUser, secureAccessBastionIssuer, secureAccessCertificateIssuer, secureAccessDelay, secureAccessEnable, secureAccessHost, secureAccessRdGatewayServer, secureAccessRdpDomain, secureAccessRdpUser, tags, targetName, token, uidToken, useCapitalLetters, useLowerLetters, useNumbers, useSpecialCharacters, userTtl, warnUserBeforeExpiration);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("allow-user-extend-session", "custom-username-template", "delete_protection", "description", "fixed-user-claim-keyname", "fixed-user-only", "input-rule", "item-custom-fields", "json", "name", "output-rule", "password-length", "producer-encryption-key-name", "rdp-admin-name", "rdp-admin-pwd", "rdp-host-name", "rdp-host-port", "rdp-user-groups", "secure-access-allow-external-user", "secure-access-bastion-issuer", "secure-access-certificate-issuer", "secure-access-delay", "secure-access-enable", "secure-access-host", "secure-access-rd-gateway-server", "secure-access-rdp-domain", "secure-access-rdp-user", "tags", "target-name", "token", "uid-token", "use-capital-letters", "use-lower-letters", "use-numbers", "use-special-characters", "user-ttl", "warn-user-before-expiration"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicSecretCreateRdp.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicSecretCreateRdp is not found in the empty JSON string", DynamicSecretCreateRdp.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicSecretCreateRdp.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DynamicSecretCreateRdp` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("fixed-user-only") != null && !jsonObj.get("fixed-user-only").isJsonNull()) && !jsonObj.get("fixed-user-only").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `fixed-user-only` to be a primitive type in the JSON string but got `%s`", jsonObj.get("fixed-user-only").toString()));
      }
      ...
      if ((jsonObj.get("rdp-admin-name") != null && !jsonObj.get("rdp-admin-name").isJsonNull()) && !jsonObj.get("rdp-admin-name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `rdp-admin-name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("rdp-admin-name").toString()));
      }
      if ((jsonObj.get("rdp-admin-pwd") != null && !jsonObj.get("rdp-admin-pwd").isJsonNull()) && !jsonObj.get("rdp-admin-pwd").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `rdp-admin-pwd` to be a primitive type in the JSON string but got `%s`", jsonObj.get("rdp-admin-pwd").toString()));
      }
      if ((jsonObj.get("rdp-host-name") != null && !jsonObj.get("rdp-host-name").isJsonNull()) && !jsonObj.get("rdp-host-name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `rdp-host-name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("rdp-host-name").toString()));
      }
      if ((jsonObj.get("rdp-host-port") != null && !jsonObj.get("rdp-host-port").isJsonNull()) && !jsonObj.get("rdp-host-port").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `rdp-host-port` to be a primitive type in the JSON string but got `%s`", jsonObj.get("rdp-host-port").toString()));
      }
      if ((jsonObj.get("rdp-user-groups") != null && !jsonObj.get("rdp-user-groups").isJsonNull()) && !jsonObj.get("rdp-user-groups").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `rdp-user-groups` to be a primitive type in the JSON string but got `%s`", jsonObj.get("rdp-user-groups").toString()));
      }
      ...
      if ((jsonObj.get("secure-access-rd-gateway-server") != null && !jsonObj.get("secure-access-rd-gateway-server").isJsonNull()) && !jsonObj.get("secure-access-rd-gateway-server").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `secure-access-rd-gateway-server` to be a primitive type in the JSON string but got `%s`", jsonObj.get("secure-access-rd-gateway-server").toString()));
      }
