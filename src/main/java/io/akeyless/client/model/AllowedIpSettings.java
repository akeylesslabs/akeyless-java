...
public class AllowedIpSettings {
  ...
  public AllowedIpSettings cidrWhitelist(@javax.annotation.Nullable String cidrWhitelist) {
  ...
  public AllowedIpSettings lock(@javax.annotation.Nullable Boolean lock) {
    this.lock = lock;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    AllowedIpSettings allowedIpSettings = (AllowedIpSettings) o;
    return Objects.equals(this.cidrWhitelist, allowedIpSettings.cidrWhitelist) &&
        Objects.equals(this.lock, allowedIpSettings.lock);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cidrWhitelist, lock);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AllowedIpSettings
   */
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AllowedIpSettings.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AllowedIpSettings' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AllowedIpSettings> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AllowedIpSettings.class));

       return (TypeAdapter<T>) new TypeAdapter<AllowedIpSettings>() {
           @Override
           public void write(JsonWriter out, AllowedIpSettings value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AllowedIpSettings read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AllowedIpSettings given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AllowedIpSettings
   * @throws IOException if the JSON string is invalid with respect to AllowedIpSettings
   */
  public static AllowedIpSettings fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AllowedIpSettings.class);
  }

  /**
   * Convert an instance of AllowedIpSettings to an JSON string
   *
   * @return JSON string
   */
