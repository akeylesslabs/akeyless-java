...
public class DynamicSecretUpdateGitlab {
  ...
  public DynamicSecretUpdateGitlab inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public DynamicSecretUpdateGitlab addInputRuleItem(String inputRuleItem) {
  ...
  public DynamicSecretUpdateGitlab outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public DynamicSecretUpdateGitlab addOutputRuleItem(String outputRuleItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.deleteProtection, dynamicSecretUpdateGitlab.deleteProtection) &&
        ...
        Objects.equals(this.inputRule, dynamicSecretUpdateGitlab.inputRule) &&
        ...
        Objects.equals(this.outputRule, dynamicSecretUpdateGitlab.outputRule) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(deleteProtection, description, gitlabAccessToken, gitlabAccessType, gitlabCertificate, gitlabRole, gitlabTokenScopes, gitlabUrl, groupName, inputRule, installationOrganization, itemCustomFields, json, name, newName, outputRule, tags, targetName, token, ttl, uidToken);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("delete_protection", "description", "gitlab-access-token", "gitlab-access-type", "gitlab-certificate", "gitlab-role", "gitlab-token-scopes", "gitlab-url", "group-name", "input-rule", "installation-organization", "item-custom-fields", "json", "name", "new-name", "output-rule", "tags", "target-name", "token", "ttl", "uid-token"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DynamicSecretUpdateGitlab.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DynamicSecretUpdateGitlab is not found in the empty JSON string", DynamicSecretUpdateGitlab.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DynamicSecretUpdateGitlab.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DynamicSecretUpdateGitlab` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
