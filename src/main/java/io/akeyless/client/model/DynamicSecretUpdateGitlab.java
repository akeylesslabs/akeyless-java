 ...
 */
@ApiModel(description = "dynamicSecretUpdateGitlab is a command that updates gitlab dynamic secret")
...
public class DynamicSecretUpdateGitlab {
  ...
  public DynamicSecretUpdateGitlab deleteProtection(String deleteProtection) {
  ...
  **/
  ...
  public DynamicSecretUpdateGitlab description(String description) {
  ...
  **/
  ...
  public DynamicSecretUpdateGitlab gitlabAccessToken(String gitlabAccessToken) {
  ...
  **/
  ...
  public DynamicSecretUpdateGitlab gitlabAccessType(String gitlabAccessType) {
  ...
  **/
  ...
  public DynamicSecretUpdateGitlab gitlabCertificate(String gitlabCertificate) {
  ...
  **/
  ...
  public DynamicSecretUpdateGitlab gitlabRole(String gitlabRole) {
  ...
  **/
  ...
  public DynamicSecretUpdateGitlab gitlabTokenScopes(String gitlabTokenScopes) {
  ...
  **/
  ...
  public DynamicSecretUpdateGitlab gitlabUrl(String gitlabUrl) {
  ...
  **/
  ...
  public DynamicSecretUpdateGitlab groupName(String groupName) {
  ...
  **/
  ...
  public DynamicSecretUpdateGitlab installationOrganization(String installationOrganization) {
  ...
  **/
  ...
  public DynamicSecretUpdateGitlab json(Boolean json) {
  ...
  **/
  ...
  public DynamicSecretUpdateGitlab name(String name) {
  ...
  **/
  ...
  public DynamicSecretUpdateGitlab newName(String newName) {
  ...
  **/
  ...
  public DynamicSecretUpdateGitlab tags(List<String> tags) {
  ...
  **/
  ...
  public DynamicSecretUpdateGitlab targetName(String targetName) {
  ...
  **/
  ...
  public DynamicSecretUpdateGitlab token(String token) {
  ...
  **/
  ...
  public DynamicSecretUpdateGitlab ttl(String ttl) {
  ...
  **/
  ...
  public DynamicSecretUpdateGitlab uidToken(String uidToken) {
