...
public class TargetUpdateSsh {
  ...
  public TargetUpdateSsh host(@javax.annotation.Nullable String host) {
    this.host = host;
    return this;
  }
  ...
  public TargetUpdateSsh json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public TargetUpdateSsh keepPrevVersion(@javax.annotation.Nullable String keepPrevVersion) {
  ...
  public TargetUpdateSsh key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public TargetUpdateSsh maxVersions(@javax.annotation.Nullable String maxVersions) {
  ...
  public TargetUpdateSsh name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public TargetUpdateSsh newName(@javax.annotation.Nullable String newName) {
  ...
  public TargetUpdateSsh port(@javax.annotation.Nullable String port) {
    this.port = port;
    return this;
  }
  ...
  public TargetUpdateSsh privateKey(@javax.annotation.Nullable String privateKey) {
  ...
  public TargetUpdateSsh privateKeyPassword(@javax.annotation.Nullable String privateKeyPassword) {
  ...
  public TargetUpdateSsh sshPassword(@javax.annotation.Nullable String sshPassword) {
  ...
  public TargetUpdateSsh sshUsername(@javax.annotation.Nullable String sshUsername) {
  ...
  public TargetUpdateSsh token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public TargetUpdateSsh uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("delete_protection", "description", "host", "json", "keep-prev-version", "key", "max-versions", "name", "new-name", "port", "private-key", "private-key-password", "ssh-password", "ssh-username", "token", "uid-token"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to TargetUpdateSsh
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TargetUpdateSsh.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TargetUpdateSsh is not found in the empty JSON string", TargetUpdateSsh.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TargetUpdateSsh.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TargetUpdateSsh` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TargetUpdateSsh.openapiRequiredFields) {
      ...
      if ((jsonObj.get("private-key-password") != null && !jsonObj.get("private-key-password").isJsonNull()) && !jsonObj.get("private-key-password").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "Expected the field `private-key-password` to be a primitive type in the JSON string but got `%s`", jsonObj.get("private-key-password").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TargetUpdateSsh.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TargetUpdateSsh' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TargetUpdateSsh> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TargetUpdateSsh.class));

       return (TypeAdapter<T>) new TypeAdapter<TargetUpdateSsh>() {
           @Override
           public void write(JsonWriter out, TargetUpdateSsh value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TargetUpdateSsh read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TargetUpdateSsh given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TargetUpdateSsh
   * @throws IOException if the JSON string is invalid with respect to TargetUpdateSsh
   */
  public static TargetUpdateSsh fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TargetUpdateSsh.class);
  }

  /**
   * Convert an instance of TargetUpdateSsh to an JSON string
   *
   * @return JSON string
   */
