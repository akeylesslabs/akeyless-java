...
public class KMIPClient {
  ...
  public KMIPClient expirationEvents(@javax.annotation.Nullable List<CertificateExpirationEvent> expirationEvents) {
    this.expirationEvents = expirationEvents;
    return this;
  }

  public KMIPClient addExpirationEventsItem(CertificateExpirationEvent expirationEventsItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.activateKeysOnCreation, kmIPClient.activateKeysOnCreation) &&
        ...
        Objects.equals(this.expirationEvents, kmIPClient.expirationEvents) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(activateKeysOnCreation, certificateIssueDate, certificateTtlInSeconds, expirationEvents, id, name, rules);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("activate_keys_on_creation", "certificate_issue_date", "certificate_ttl_in_seconds", "expiration_events", "id", "name", "rules"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!KMIPClient.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in KMIPClient is not found in the empty JSON string", KMIPClient.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!KMIPClient.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `KMIPClient` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
