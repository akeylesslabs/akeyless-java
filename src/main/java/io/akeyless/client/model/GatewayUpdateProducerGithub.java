...
public class GatewayUpdateProducerGithub {
  ...
  public GatewayUpdateProducerGithub deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public GatewayUpdateProducerGithub githubAppId(@javax.annotation.Nullable Long githubAppId) {
  ...
  public GatewayUpdateProducerGithub githubAppPrivateKey(@javax.annotation.Nullable String githubAppPrivateKey) {
  ...
  public GatewayUpdateProducerGithub githubBaseUrl(@javax.annotation.Nullable String githubBaseUrl) {
  ...
  public GatewayUpdateProducerGithub inputRule(@javax.annotation.Nullable List<String> inputRule) {
    this.inputRule = inputRule;
    return this;
  }

  public GatewayUpdateProducerGithub addInputRuleItem(String inputRuleItem) {
  ...
  public GatewayUpdateProducerGithub installationId(@javax.annotation.Nullable Long installationId) {
  ...
  public GatewayUpdateProducerGithub installationOrganization(@javax.annotation.Nullable String installationOrganization) {
  ...
  public GatewayUpdateProducerGithub installationRepository(@javax.annotation.Nullable String installationRepository) {
  ...
  public GatewayUpdateProducerGithub itemCustomFields(@javax.annotation.Nullable Map<String, String> itemCustomFields) {
    this.itemCustomFields = itemCustomFields;
    return this;
  }

  public GatewayUpdateProducerGithub putItemCustomFieldsItem(String key, String itemCustomFieldsItem) {
  ...
  public GatewayUpdateProducerGithub json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public GatewayUpdateProducerGithub name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public GatewayUpdateProducerGithub newName(@javax.annotation.Nullable String newName) {
  ...
  public GatewayUpdateProducerGithub outputRule(@javax.annotation.Nullable List<String> outputRule) {
    this.outputRule = outputRule;
    return this;
  }

  public GatewayUpdateProducerGithub addOutputRuleItem(String outputRuleItem) {
  ...
  public GatewayUpdateProducerGithub tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public GatewayUpdateProducerGithub targetName(@javax.annotation.Nullable String targetName) {
  ...
  public GatewayUpdateProducerGithub token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public GatewayUpdateProducerGithub tokenPermissions(@javax.annotation.Nullable List<String> tokenPermissions) {
  ...
  public GatewayUpdateProducerGithub tokenRepositories(@javax.annotation.Nullable List<String> tokenRepositories) {
  ...
  public GatewayUpdateProducerGithub tokenTtl(@javax.annotation.Nullable String tokenTtl) {
  ...
  public GatewayUpdateProducerGithub uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.deleteProtection, gatewayUpdateProducerGithub.deleteProtection) &&
        ...
        Objects.equals(this.inputRule, gatewayUpdateProducerGithub.inputRule) &&
        ...
        Objects.equals(this.itemCustomFields, gatewayUpdateProducerGithub.itemCustomFields) &&
        ...
        Objects.equals(this.outputRule, gatewayUpdateProducerGithub.outputRule) &&
        ...
        Objects.equals(this.tokenTtl, gatewayUpdateProducerGithub.tokenTtl) &&
        Objects.equals(this.uidToken, gatewayUpdateProducerGithub.uidToken);
  }

  @Override
  public int hashCode() {
    return Objects.hash(deleteProtection, githubAppId, githubAppPrivateKey, githubBaseUrl, inputRule, installationId, installationOrganization, installationRepository, itemCustomFields, json, name, newName, outputRule, tags, targetName, token, tokenPermissions, tokenRepositories, tokenTtl, uidToken);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("delete_protection", "github-app-id", "github-app-private-key", "github-base-url", "input-rule", "installation-id", "installation-organization", "installation-repository", "item-custom-fields", "json", "name", "new-name", "output-rule", "tags", "target-name", "token", "token-permissions", "token-repositories", "token-ttl", "uid-token"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to GatewayUpdateProducerGithub
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GatewayUpdateProducerGithub.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GatewayUpdateProducerGithub is not found in the empty JSON string", GatewayUpdateProducerGithub.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GatewayUpdateProducerGithub.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GatewayUpdateProducerGithub` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GatewayUpdateProducerGithub.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GatewayUpdateProducerGithub.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GatewayUpdateProducerGithub' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GatewayUpdateProducerGithub> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GatewayUpdateProducerGithub.class));

       return (TypeAdapter<T>) new TypeAdapter<GatewayUpdateProducerGithub>() {
           @Override
           public void write(JsonWriter out, GatewayUpdateProducerGithub value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GatewayUpdateProducerGithub read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GatewayUpdateProducerGithub given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GatewayUpdateProducerGithub
   * @throws IOException if the JSON string is invalid with respect to GatewayUpdateProducerGithub
   */
  public static GatewayUpdateProducerGithub fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GatewayUpdateProducerGithub.class);
  }

  /**
   * Convert an instance of GatewayUpdateProducerGithub to an JSON string
   *
   * @return JSON string
   */
