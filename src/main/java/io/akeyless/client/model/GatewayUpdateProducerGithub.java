...
public class GatewayUpdateProducerGithub {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(deleteProtection, githubAppId, githubAppPrivateKey, githubBaseUrl, installationId, installationOrganization, installationRepository, itemCustomFields, json, name, newName, tags, targetName, token, tokenPermissions, tokenRepositories, tokenTtl, uidToken);
  }
