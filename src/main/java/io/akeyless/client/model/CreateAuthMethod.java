...
public class CreateAuthMethod {
  ...
  public CreateAuthMethod accessExpires(@javax.annotation.Nullable Long accessExpires) {
  ...
  public CreateAuthMethod allowedClientType(@javax.annotation.Nullable List<String> allowedClientType) {
    this.allowedClientType = allowedClientType;
    return this;
  }

  public CreateAuthMethod addAllowedClientTypeItem(String allowedClientTypeItem) {
  ...
  public CreateAuthMethod auditLogsClaims(@javax.annotation.Nullable List<String> auditLogsClaims) {
    this.auditLogsClaims = auditLogsClaims;
    return this;
  }

  public CreateAuthMethod addAuditLogsClaimsItem(String auditLogsClaimsItem) {
  ...
  public CreateAuthMethod boundIps(@javax.annotation.Nullable List<String> boundIps) {
  ...
  public CreateAuthMethod deleteProtection(@javax.annotation.Nullable String deleteProtection) {
  ...
  public CreateAuthMethod description(@javax.annotation.Nullable String description) {
  ...
  public CreateAuthMethod expirationEventIn(@javax.annotation.Nullable List<String> expirationEventIn) {
    this.expirationEventIn = expirationEventIn;
    return this;
  }

  public CreateAuthMethod addExpirationEventInItem(String expirationEventInItem) {
  ...
  public CreateAuthMethod forceSubClaims(@javax.annotation.Nullable Boolean forceSubClaims) {
  ...
  public CreateAuthMethod gwBoundIps(@javax.annotation.Nullable List<String> gwBoundIps) {
  ...
  public CreateAuthMethod json(@javax.annotation.Nullable Boolean json) {
    this.json = json;
    return this;
  }
  ...
  public CreateAuthMethod jwtTtl(@javax.annotation.Nullable Long jwtTtl) {
    this.jwtTtl = jwtTtl;
    return this;
  }
  ...
  public CreateAuthMethod name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public CreateAuthMethod productType(@javax.annotation.Nullable List<String> productType) {
    this.productType = productType;
    return this;
  }

  public CreateAuthMethod addProductTypeItem(String productTypeItem) {
  ...
  public CreateAuthMethod token(@javax.annotation.Nullable String token) {
    this.token = token;
    return this;
  }
  ...
  public CreateAuthMethod uidToken(@javax.annotation.Nullable String uidToken) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.accessExpires, createAuthMethod.accessExpires) &&
        Objects.equals(this.allowedClientType, createAuthMethod.allowedClientType) &&
        ...
        Objects.equals(this.expirationEventIn, createAuthMethod.expirationEventIn) &&
        ...
        Objects.equals(this.productType, createAuthMethod.productType) &&
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("access-expires", "allowed-client-type", "audit-logs-claims", "bound-ips", "delete_protection", "description", "expiration-event-in", "force-sub-claims", "gw-bound-ips", "json", "jwt-ttl", "name", "product-type", "token", "uid-token"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateAuthMethod
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateAuthMethod.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateAuthMethod is not found in the empty JSON string", CreateAuthMethod.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateAuthMethod.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateAuthMethod` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateAuthMethod.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateAuthMethod.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateAuthMethod' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateAuthMethod> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateAuthMethod.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateAuthMethod>() {
           @Override
           public void write(JsonWriter out, CreateAuthMethod value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateAuthMethod read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateAuthMethod given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateAuthMethod
   * @throws IOException if the JSON string is invalid with respect to CreateAuthMethod
   */
  public static CreateAuthMethod fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAuthMethod.class);
  }

  /**
   * Convert an instance of CreateAuthMethod to an JSON string
   *
   * @return JSON string
   */
