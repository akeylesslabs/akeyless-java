...
**k8sTempRoleBindingDefinition** | **List&lt;Integer&gt;** | Yaml/Json definition of temporary role binding that will be created and deleted when TTL is due. Must have as subject name of Service Account specified in K8sServiceAccount field |  [optional]
**k8sTempRoleDefinition** | **List&lt;Integer&gt;** | Yaml/Json definition of temporary role that will be created and deleted when TTL is due |  [optional]
